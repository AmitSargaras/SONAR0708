...
<table width="70%" align="center" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td><h3><bean:message key="title.property.valuation.item.by.index.add"/> District </h3></td>
    </tr>
    ...
    <tr> 
      <td>
      	...
      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblInput">
            ...
            <tr class="even">
              <td class="fieldname"><bean:message key="label.property.valuation.by.index.district"/>&nbsp;<font color="#0000FF">*</font></td>
