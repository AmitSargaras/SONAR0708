...
function submitForm(event) {
	...
	if(event=="maker_update_save_process")
		{
		document.forms[0].action="ValuationAgency.do?event=maker_save_update";
	  }else{
    	document.forms[0].action="ValuationAgency.do?event=maker_save_create";
      }
    document.forms[0].submit();
}
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
            ...
            <tr class="even">
              ...
              <td class="fieldname" width="20%">Valuation Agency Code<font color="red">*</font> </td>
              <td><%=valuationAgencyForm.getValuationAgencyCode()%>&nbsp;</br>
