...
function submitForm() {
	document.forms[0].action="ValuationAgency.do?event=maker_enable_valuationAgency";
	var r=confirm("Would you like to Enable the record ? \n Please press OK or Cancel button");
	if (r==true)
	  {
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											...
											<tr class="even">
												...
												<td> <integro:empty-if-null value="<%=valuationAgencyForm.getCityTown()%>"/>&nbsp;
												</td>
											</tr>
											<tr class="odd">
												<td class="fieldname">
												...
												<td><integro:empty-if-null value="<%=valuationAgencyForm.getState() %>"/>&nbsp;
												</td>
												<td class="fieldname">
													Region
												</td>
												<td><integro:empty-if-null value="<%=valuationAgencyForm.getRegion()%>"/>&nbsp;
												</td>
											</tr>
											<tr class="even">
												...
												<td><integro:empty-if-null value="<%=valuationAgencyForm.getCountry()%>"/>&nbsp;
												</td>
												<td class="fieldname">
