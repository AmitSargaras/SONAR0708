...
IDirectorMasterTrxValue directorMasterTrx = (IDirectorMasterTrxValue)session.getAttribute("com.integrosys.cms.ui.directorMaster.MaintainDirectorMasterAction.IDirectorMasterTrxValue");
	...
	String rejectEvent = "checker_reject_disable";
	int sno = 0;
	int startIndex = 0;
%>
<%@page import="com.integrosys.cms.app.directorMaster.bus.IDirectorMaster"%><html>
<head>
...
function approvePage() {
	document.forms[0].action="directorMaster.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="directorMaster.do?event=<%=rejectEvent%>";
    document.forms[0].submit();
}
function cancelPage(){
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											<tr class="odd">
												...
												<td width="30%"><bean:write property="directorCode" name="MaintainDirectorMasterForm"/>&nbsp;
												</td>
												<td class="fieldname" width="20%">
													Director Name
												</td>
												<td width="30%"><bean:write property="name" name="MaintainDirectorMasterForm"/>&nbsp;
												</td>
											</tr>
											<tr class="odd">
												...
												<td width="30%"><bean:write property="dinNo" name="MaintainDirectorMasterForm"/>&nbsp;
												</td>
												<td class="fieldname" width="20%">
...
<html:hidden name="MaintainDirectorMasterForm" property="deprecated" />
