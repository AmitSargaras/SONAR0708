    ...
    <head>
        ...
        <script type="text/javascript" >
         <!--
			...
			{
				document.getElementById( 'event' ).value = '<%=ShareCounterConstants.SHARE_COUNTER_MAKER_PREPARE_CLOSE%>'  ;
    ...
    for ( int loop = offset.intValue () ; loop < params.length && loop < offset.intValue () + length.intValue () ; loop ++ )
    {
        ...
        <table width="150"  border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                %>
                <td width="100" valign="baseline" align="center">
                    <a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/close2a.gif',1)" onClick="closeItem()" >
