      ...
      <td colspan="2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
          <tbody>
            ...
            <tr class="even">
              <%if (parameters.getProductType().equals("LONG_FX_FWD")) {%>
              <td class="fieldname"><bean:message key="label.isda.deal.amount"/></td>
              <td><integro:amount param="all" amount="<%=parameters.getDealAmount()%>" decimal="4"/>&nbsp;</td>
              <%}else if (parameters.getProductType().equals("FX_OPTIONS")) {%>
              <td class="fieldname"><bean:message key="label.isda.deal.national"/></td>
