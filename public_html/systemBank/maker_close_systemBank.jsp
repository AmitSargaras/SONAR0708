...
<%@ page
	...
	com.integrosys.cms.ui.systemBank.MaintainSystemBankForm,com.integrosys.cms.app.systemBank.trx.ISystemBankTrxValue,com.integrosys.cms.app.systemBank.trx.OBSystemBankTrxValue"%>
<%
...
function submitPage (event) {
	...
	document.forms[0].action="systemBank.do?event=maker_confirm_draft_close";
	
}else{
  
	document.forms[0].action="systemBank.do?event=maker_confirm_close";
}
    document.forms[0].submit();
}
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											...
											<tr class="even">
												...
												<%=systemBankTrx.getStagingSystemBank().getCountry().getCountryName()%>
											...
											<td class="fieldname">
												...
												<%=systemBankTrx.getStagingSystemBank().getRegion().getRegionName()%>
												<%} %>&nbsp;
												</td>
												<td class="fieldname">
													State
												...
												<%=systemBankTrx.getStagingSystemBank().getState().getStateName()%>
												<%} %>&nbsp;
												</td>
											...
											<tr class="even">
												...
												<%=systemBankTrx.getStagingSystemBank().getCityTown().getCityName()%>
												<%} %>
												&nbsp;
												</td>
												<td class="fieldname">
											...
											<tr class="odd">
												...
												<td><integro:empty-if-null value="<%=systemBankForm.getFaxNumber()%>"/>&nbsp;
												</td>
