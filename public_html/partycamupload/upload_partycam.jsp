...
function submitForm() {
 	document.forms[0].action="Partycamupload.do?event=partycamupload";
...
-->
	...
	<html:form action="/Partycamupload" enctype="multipart/form-data">
		<body >
				...
				<tbody>
					<tr>
						<td valign="bottom" align="center">
							<html:file property="fileUpload" size="50"></html:file></br><html:errors property="partycamfileuploadError"/>
						</td>
					</tr>
					<%
