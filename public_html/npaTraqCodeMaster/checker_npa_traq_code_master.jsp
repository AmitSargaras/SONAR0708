...
function approvePage() {
    document.forms[0].action="npaTraqCodeMaster.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="npaTraqCodeMaster.do?event=<%=rejectEvent%>";
	document.forms[0].submit();
}
function cancelPage() {
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tbody>
								...
								<tr>
									...
									<td class="even"><%=npaTraqCodeMasterTrx.getUserInfo()%>&nbsp;</td>
								</tr>
								<tr class="odd">
									<td class="fieldname">Last Remarks Made</td>
									<td><%=npaTraqCodeMasterTrx.getRemarks() != null ? npaTraqCodeMasterTrx.getRemarks() : ""%>&nbsp;</td>
								</tr>
							</tbody>
						</table>
					</td>
