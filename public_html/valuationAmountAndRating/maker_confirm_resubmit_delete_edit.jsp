...
function submitForm() {
		document.forms[0].action = "valuationAmountAndRating.do?event=maker_confirm_resubmit_edit";
		document.forms[0].submit();
	}
...
function searchCustomer(){ //v3.0
	...
	document.forms[0].action = "valuationAmountAndRating.do?event=listDeleteRejected";
	document.forms[0].submit();
}
	...
	<body>
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<thead>
				...
				<tr>
					<td>
						<h3>Edit Resubmit Valuation amount and Rating Master</h3>
					</td>
				</tr>
				<tr>
					<td>
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tbody>
						...
						<tr class="odd">
							...
							<td><%=valuationAmountAndRatingTrx.getRemarks() != null
						? valuationAmountAndRatingTrx.getRemarks()
						: ""%>&nbsp;</td>
						</tr>
					</tbody>
				</table>
