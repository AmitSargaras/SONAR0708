...
function fccBranchCreate() {

 	document.forms[0].action="fccBranch.do?event=maker_prepare_create_fccBranch";
    document.forms[0].submit();
}


function submitPage(){
	var url="fccBranch.do?event=maker_list_fccBranch&startIndex=0&go=Y";
...
function searchFCCBranch()
{
	...
	if(searchType == '' && searchText == '')
    {
        ...
        document.forms[0].event.value       = "maker_list_fccBranch";
        document.forms[0].submit();
    }
    else
    {
   ...
   <td valign="top">
                   ...
                   <td>&nbsp;</td>
                    <td  valign="bottom" align="right">
						<input type="button" name="Submit" value="Add New" class="btnNormal" onclick="fccBranchCreate()"/>
					</td>
					 <tr>
		...
		<tr>
              ...
              <%}else{ %>Disable<%} %>&nbsp;</td>
                                  <td> <select name="menu1" onchange="MM_jumpMenu('self',this,0)" style="width:110">
                                      ...
                                      <option value='fccBranch.do?event=maker_view_fccBranch&branchCode=<%=ob.getId()%>&startIndex=<%=startIndex%>'>View</option>
								
                                      <option value='fccBranch.do?event=maker_edit_fccBranch_read&branchCode=<%=ob.getId()%>&startIndex=<%=startIndex%>'>Edit</option>
                       ...
                       <% //String pageIndexUrl = "user.do?event=maker_list_user&"+form.getName()!=null&&form.getName().trim().equals("")?"name="+form.getName():""+"&startIndex=";%>
                        <%
                            String pageIndexUrl=null;
                            	 ...
                            	 pageIndexUrl = "fccBranch.do?event=list_pagination&startIndex=";
