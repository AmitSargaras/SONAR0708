...
List releaselinedetailsList =(List) session.getAttribute("com.integrosys.cms.ui.releaselinedetailsupload.ReleaselinedetailsUploadAction.List");
...
function submitPage(){
    ...
    document.forms[0].action="Releaselinedetailsupload.do?event=maker_close_releaselinedetails_file";
