...
<%
	...
	int sno = 0;
	int startIndex = 0;
	LimitsOfAuthorityMasterForm form = (LimitsOfAuthorityMasterForm) request.getAttribute("LimitsOfAuthorityMasterForm");
...
function submitForm() {
		...
		document.forms[0].action = "LimitsOfAuthorityMaster.do?event=maker_edit_update_limits_of_authority";
		document.forms[0].submit();
}
	...
	<body>
		<table width="70%" border="0" align="center" cellpadding="0"
			...
			<thead>
				<tr>
					<td>
						<h3>Update Limits of Authority (LOA) Master</h3>
					</td>
				</tr>
				<tr>
					<td>
