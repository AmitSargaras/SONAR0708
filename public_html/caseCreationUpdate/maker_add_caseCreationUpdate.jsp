...
function submitForm() {
 	...
 	document.forms[0].action="holiday.do?event=maker_create_holiday";
    document.forms[0].submit();
}

function saveForm() {

 	document.forms[0].action="holiday.do?event=maker_draft_holiday";
    document.forms[0].submit();
}
...
<html:form action="/holiday" onreset="showSpanCustodian()">
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput" id="choiceTable">
          ...
          <tbody>
            ...
            <tr class="odd">
              ...
              <td class="fieldname" width="20%">Description <font color="red">*</font></td>
              <td width="30%"><html:text property="description" maxlength="50"/>&nbsp; 
              <html:errors property="descriptionError"/></td>
 ...
 <html:hidden name="MaintainHolidayForm" property="createBy" value="SA_MAKER"/>
 <html:hidden name="MaintainHolidayForm" property="lastUpdateBy" value="SA_MAKER"/>
  <html:hidden name="MaintainHolidayForm" property="lastUpdateDate"/>
    <html:hidden name="MaintainHolidayForm" property="creationDate"/>
     <html:hidden name="MaintainHolidayForm" property="deprecated" value="N"/>
