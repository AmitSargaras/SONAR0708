...
function cancelPage(){
    document.forms[0].action="user.do?event=maker_list_user&startIndex=0&name=";
...
function submitForm() {
	if(''==document.forms[0].fileUpload.value){
 	...
 	document.forms[0].action="user.do?event=maker_event_upload_user";
    document.forms[0].submit();
	}
}
...
<html:form action="/user" enctype="multipart/form-data">
