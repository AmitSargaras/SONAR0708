...
<html>
	<head>
		<script type="text/javascript">
			function submitForm() {
			 	document.forms[0].action="Stockdetailsupload.do?event=excelupload";
	...
	<html:form action="/Stockdetailsupload" enctype="multipart/form-data">
		<body>
				...
				<logic:equal value="false" name="stillPending">	
					<thead>
						...
						<tr>
							<td align="center">
								<h3>
									<bean:message key="menu.uploads.stockdetailsupload.name" />
								</h3>
							</td>
						</tr>
						<tr>
