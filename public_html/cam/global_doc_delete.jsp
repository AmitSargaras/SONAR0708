...
<%@page import="com.integrosys.cms.ui.cam.CAMGlobalForm"%><html><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<html:hidden name="CAMGlobalForm"  property="itemCode" />
<html:hidden name="CAMGlobalForm"  property="itemDesc" />
<html:hidden name="CAMGlobalForm"  property="expDate" />
<html:hidden name="CAMGlobalForm"  property="tenureCount" />
<html:hidden name="CAMGlobalForm"  property="status" />
<html:hidden name="CAMGlobalForm"  property="tenureType" />
<html:hidden name="CAMGlobalForm"  property="deprecated" value="Y" />
  ...
  <tr>
    <td width="100" valign="baseline" align="center"><a href="#"
			...
			<td width="100" valign="baseline" align="center">
			 ...
			 <a href="CAMGlobal.do?event=global_list&type=CAM&go=N&startIndex=<%=startIndex %>"
				onmouseout="MM_swapImgRestore()"
