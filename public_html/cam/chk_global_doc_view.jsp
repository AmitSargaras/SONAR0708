...
<%
    OBDocumentItemTrxValue trxVal = (OBDocumentItemTrxValue) session.getAttribute("com.integrosys.cms.ui.cam.CAMGlobalAction.docTrxObj");
    CAMGlobalForm secGlobalForm = (CAMGlobalForm)request.getAttribute("CAMGlobalForm");
      ...
      <td> <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
          ...
          <% if(isDocCodePresent) { %>
            <tr class="even">
              ...
              <td>&nbsp;<bean:write name="CAMGlobalForm" scope="request" property="itemCode" />
...
<!--            </tr>-->
 			<tr class="even">
             <td class="fieldname" >Tenure&nbsp;<font color="red">* </font></td>
...
<!--            <tr class="odd">-->
<!--              <td class="<%=CompareOBUtil.compOB(stageOb,ob,"expiryDate")? "fieldname":"fieldnamediff"%>" >Expiry Date</td>-->
