...
* $Header: /home/cms2/cvsroot/cms2/public_html/commoditydeal/generalinfo/cashdeposit/view_cash_deposit.jsp,v 1.7 2006/10/27 08:40:53 hmbao Exp $
*
    ...
    <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
        ...
        <tr class="odd">
          ...
          <td><bean:write name="CashDepositForm" property="cashLocation"/>&nbsp;
          </td>
        </tr>
        <tr class="even">
