<%@ page import="com.integrosys.cms.ui.commoditydeal.finance.FinanceAction,
                 ...
                 com.integrosys.cms.ui.commoditydeal.finance.FinanceForm,
...
* $Header: /home/cms2/cvsroot/cms2/public_html/commoditydeal/finance/finance_update.jsp,v 1.25 2006/11/15 10:57:02 hmbao Exp $
*
...
function editPS() {
    document.forms[0].event.value="<%=CommodityDealConstant.PURCHASE_SALE%>"+"_"+"<%=FinanceAction.EVENT_PREPARE_UPDATE_SUB%>";
    document.forms[0].submit();
}

function editHedging() {
    document.forms[0].event.value="<%=CommodityDealConstant.HEDGING%>"+"_"+"<%=FinanceAction.EVENT_PREPARE_UPDATE_SUB%>";
    document.forms[0].submit();
}

function gotopage (aLocation) {
    document.forms[1].action=aLocation;
    document.forms[1].target = 'new';
    document.forms[1].submit();
}

function addSettlement() {
    document.forms[0].event.value = "<%=CommodityDealConstant.SETTLEMENT%>"+"_"+"<%=FinanceAction.EVENT_PREPARE%>";
    document.forms[0].indexID.value = "-1";
    document.forms[0].submit();
}

function addRelease() {
    document.forms[0].event.value = "<%=CommodityDealConstant.RELEASE%>"+"_"+"<%=FinanceAction.EVENT_PREPARE%>";
    document.forms[0].indexID.value = "-1";
    document.forms[0].submit();
}

function editSettlement(index) {
    document.forms[0].event.value = "<%=CommodityDealConstant.SETTLEMENT%>"+"_"+"<%=FinanceAction.EVENT_PREPARE_UPDATE_SUB%>";
    document.forms[0].indexID.value = index;

    document.forms[0].submit();
}

function editRelease(index) {
    document.forms[0].event.value = "<%=CommodityDealConstant.RELEASE%>"+"_"+"<%=FinanceAction.EVENT_PREPARE_UPDATE_SUB%>";
    document.forms[0].indexID.value = index;
...
<input type="hidden" name="event" value="<%=FinanceAction.EVENT_EDIT%>"/>
    ...
    <tr>
      ...
      <td valign="bottom"><table width="80"  border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="80" valign="baseline" align="center">&nbsp;</td>
            <td width="80" valign="baseline" align="center"><input name="Submit23" type="button" class="btnNormal" value="View / Edit Details" onclick="editPS()"/>
            </td>
          </tr>
      </table></td>
    </tr>
  ...
  <tr>
    ...
    <td valign="bottom" colspan="2" width="47%">
      <table width="80"  border="0" align="right" cellpadding="0" cellspacing="0">
        <tr>
          <td width="80">
            <input name="Submit5" type="button" class="btnNormal" value="View/Edit Hedged Details" onClick="editHedging()"/>
          </td>
        </tr>
      </table>
    </td>
      ...
      <table width="80"  border="0" align="right" cellpadding="2" cellspacing="0">
        <tr>
          <td width="80" valign="baseline" align="center">
            <input name="Submit2" type="button" class="btnNormal" value="Add New" onclick="addSettlement()"/>
          </td>
        </tr>
      </table>
    </td>
    ...
    <td colspan="2">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
        ...
        <tr class="<%=i%2==0?"odd":"even"%>">
          ...
          <td style="text-align:center" width="16%"><a href="javascript:editSettlement(<%=i%>)">View/Edit</a></td>
        </tr>
        <%
                }
            }
    ...
    <td valign="bottom">
      <table width="80"  border="0" align="right" cellpadding="2" cellspacing="0">
        ...
        %>
          ...
          <td width="80" valign="baseline" align="center">
            <input name="Submit2" type="button" class="btnNormal" value="Add New" onclick="addRelease()"/>
          </td>
        </tr>
      </table>
    </td>
    ...
    <td colspan="2">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
        ...
        <tr class="<%=i%2==0?"odd":"even"%>">
          ...
          <td style="text-align:center" width="13%"><a href="javascript:editRelease(<%=i%>)">View/Edit</a></td>
        </tr>
        <%
                }
            }
...
<!-- InstanceEndEditable -->
<form name="Form2" action="Finance.do">
	<input type="hidden" name="event" value="<%=FinanceAction.EVENT_PRINT_APPROVAL_SHEET%>"/>
</form>
</body>
<!-- InstanceEnd --></html>
