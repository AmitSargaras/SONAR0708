				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tbody>
						...
						<tr class="<%=style[count++%2] %>">
							...
							<td>
								<html:text property="offerDate" maxlength="11" size="12" readonly="true"></html:text>
								<img src="img/calendara.gif" name="cldr" border="0"
								onClick="return showCalendar('offerDate', 'dd/mm/y');" />		
								<html:errors property="offerDate"/>								
							</td>						
							<td class="fieldname">
						...
						<tr class="<%=style[count++%2] %>">
							...
							<td>
								<html:text property="primeReviewDate" maxlength="11" size="12" readonly="true"></html:text>
									<img src="img/calendara.gif" name="cldr" border="0"
										onClick="return showCalendar('primeReviewDate', 'dd/mm/y');" />		
								<html:errors property="primeReviewDate"/>								
							</td>		
						</tr>	
						<tr class="<%=style[count++%2] %>">
							<td class="fieldname">
							...
							<td>
								<html:text property="primeReviewTerm"/>
								<html:errors property="primeReviewTerm"/>
							</td>
							<td class="fieldname">
								<span class="stp"><bean:message key="label.facility.prime.review.term.code"/></span>
							</td>
							<td>
								<html:select property="primeReviewTermCode">
									<integro:common-code categoryCode="<%=CategoryCodeConstant.PRIME_REVIEW_TERM_CODE %>" />
								</html:select>
								<html:errors property="primeReviewTermCode"/>
							</td>							
						</tr>		
						<tr class="<%=style[count++%2] %>">
							<td class="fieldname">
							...
							<td>
								<html:select property="dealerNumber">
									<integro:common-code
										categoryCode="<%=CategoryCodeConstant.DEALER%>" descWithCode="true" />
								</html:select>
                            	<html:errors property="dealerNumber"/>
                            </td>	
                            <td class="fieldname">
                            	<span class="stp"><bean:message key="label.facility.date.send.decision.center"/></span>                            	
                            </td>					
                            <td>
								<html:text property="dateSendToDecisionCenter" maxlength="11" size="12" readonly="true"></html:text>
								<img src="img/calendara.gif" name="cldr" border="0"
								onClick="return showCalendar('dateSendToDecisionCenter', 'dd/mm/y');" />		
								<html:errors property="dateSendToDecisionCenter"/>	                            
                            </td>
						</tr>		
						<tr class="<%=style[count++%2] %>">
							<td class="fieldname">
							...
							<td>
								<html:text property="dateReceiveFromDecisionCenter" maxlength="11" size="12" readonly="true"></html:text>
								<img src="img/calendara.gif" name="cldr" border="0"
								onClick="return showCalendar('dateReceiveFromDecisionCenter', 'dd/mm/y');" />		
								<html:errors property="dateReceiveFromDecisionCenter"/>	      							
							</td>
							<td class="fieldname">
								<span class="stp"><bean:message key="label.facility.date.approved.by.cgc/bnm" /></span>
							</td>
							<td>
								<html:text property="dateApproveByCGCBNM" maxlength="11" size="12" readonly="true"></html:text>
									<img src="img/calendara.gif" name="cldr" border="0"
										onClick="return showCalendar('dateApproveByCGCBNM', 'dd/mm/y');" />		
								<html:errors property="dateApproveByCGCBNM"/>	    							
							</td>
						</tr>	
						<tr class="<%=style[count++%2] %>">
							<td class="fieldname">
