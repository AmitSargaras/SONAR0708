...
<%
	...
	System.out.println ( "record is null ? :  " + ( record == null ) ) ;
...
<html>
    ...
    <body >
        ...
        <html:form action="PreDeal.do" styleId="form" >
            <table width="70%" align="center" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
                <tbody>
                    ...
                    <tr class="even">
                        ...
                        <td colspan="3">
                            <html:select property="sourceSystem" >
                                <html:option value="" >
                                    Please Select
                                </html:option>
            ...
            <html:hidden property="earMarkGroupId" value="<%= String.valueOf ( record.getEarMarkGroupId () ) %>"/>
