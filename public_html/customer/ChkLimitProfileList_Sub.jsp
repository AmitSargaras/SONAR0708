...
<form name="ProcessCustomerDetailsForm" method="POST" action="/cms/CustomerProcess.do?event=resubmit">
      ...
      <td><table  width="100%" class="tblinfo" style="margin-top:0" border="0" cellspacing="0" cellpadding="0">
          ...
          <tbody>
             ...
             <tr class="odd">
              ...
              <td valign="top" width="5%"> <a href="CustomerProcess.do?event=resubmit&trxID=20030715000301" >View
                </a></td>
