<%@ page import="com.integrosys.base.techinfra.logger.DefaultLogger,
				...
				java.text.DateFormat,java.text.SimpleDateFormat,com.integrosys.cms.ui.collateral.CategoryCodeConstant,
...
<%
    ...
    else if(event.equals("prepare_maker_submit_remove"))
    {
     actionEvent="confirm_maker_submit_remove";
       ...
       if(event.equals("maker_edit_creditApproval")){
       // actionEvent="maker_add_edit_creditApproval_page";
        headingLabel="Edit";
    }
%>  
<%
...
function cancelPage(){	
    document.forms[0].action="credit_approval.do?event=prepare_list";
    document.forms[0].submit();
}
function submitPage() {
...
<%
    ...
    long creditApprovalId = oBCreditApproval.getId();
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="tblFormSection" align="center"><tr><td width="100%">      
      ...
      <table class="tblInput" id="backEdit1" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:0">      
        <tbody>   
          ...
          <br/>            </td></tr>
           <%if(event.equals(CreditApprovalAction.CHECKER_VIEW_CREDIT_APPROVAL)) {%>
            <tr>
 ...
 <tr>
  ...
  <%}else if(event.equals(CreditApprovalAction.EVENT_CLOSE_VIEW)){%>
    <td><a href="javascript:submitPage();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/close2a.gif',1)"><img src="img/close1a.gif" name="Image4411"  border="0" id="Image4411" /></a>&nbsp;&nbsp;&nbsp;
  ...
  <%}else if(event.equals(CreditApprovalAction.MAKER_VIEW_CREDIT_APPROVAL_READ)){%>
   <td><a href="credit_approval.do?event=maker_search_list_creditApproval&startIndex=<%=startIndex %>&approvalCode=<%=approvalCode %>&approvalName=<%=approvalName %>" onmouseout="MM_swapImgRestore()"onmouseover="MM_swapImage('Image4411','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4411" border="0" id="Image4411" /></a>
  <%}else if(event.equals(CreditApprovalAction.CHECKER_VIEW_CREDIT_APPROVAL_READ)){%>
   <td><a href="credit_approval.do?event=checker_search_list_creditApproval&startIndex=<%=startIndex %>&approvalCode=<%=approvalCode %>&approvalName=<%=approvalName %>" onmouseout="MM_swapImgRestore()"onmouseover="MM_swapImage('Image4411','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4411" border="0" id="Image4411" /></a>
  
  <%} else if(event.equals(CreditApprovalAction.MAKER_DELETE_READ)){%>
   <td><a href="javascript:submitPage();" onMouseOut="MM_swapImgRestore()"onMouseOver="MM_swapImage('Image3311','','img/submit2.gif',1)" onClick="submitPage('<%=creditApprovalId %>')"><img src="img/submit1.gif"name="Image3311" border="0" id="Image3311" /></a>
   </td><td><a href="javascript:cancelPage();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image1"border="0" id="Image1" /></a></td>
  <%}%>
