      ...
      <td><table  width="100%" class="tblinfo" style="margin-top:0" border="0" cellspacing="0" cellpadding="0">
          ...
          <tbody>
             <tr class="odd">
              ...
              <td valign="top" width="5%"> <a href="ViewLimits.do?event=chkLimitApRej&trxID=20030715000302" >View
                </a></td>
      ...
      <td><table  width="100%" border="0" cellpadding="0" cellspacing="0" class="tblinfo" style="margin-top:0">
          ...
          <tbody>
             ...
             <tr class="odd">
              ...
              <td valign="top"><a href="ViewLimits.do?event=chk_coborrower_approve_reject&limitID=20030710000038">View</td>
            </tr>
