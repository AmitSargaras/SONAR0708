...
<%
	...
	ICaseBranchTrxValue trxvalue = (ICaseBranchTrxValue)session.getAttribute("com.integrosys.cms.ui.caseBranch.MaintainCaseBranchAction.ICaseBranchTrxValue");
...
<%@page import="com.integrosys.cms.app.caseBranch.trx.ICaseBranchTrxValue"%>
...
function submitForm(event) {
		document.forms[0].action="caseBranch.do?event=maker_save_update";
	    document.forms[0].submit();
}
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
            ...
            <tr class="even">
              ...
              <td width="30%"><html:text property="coordinator1" maxlength="100" /><html:errors property="coordinator1Error"/>
              </td>
            ...
            <tr class="odd">
             ...
             <td class="fieldname" width="20%">Coordinater 2 <font color="red">*</font></td>
              <td width="30%"><html:text property="coordinator2" maxlength="100" /><html:errors property="coordinator2Error"/>
              </td>
            ...
            <%if(trxvalue.getCaseBranch()==null){ %> 
