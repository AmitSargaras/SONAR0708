...
<%
	...
	String rejectEvent;
	if (event.equals("checker_view_caseBranch")) {
		rejectEvent = "checker_list_caseBranch";
	} else {
		rejectEvent = "maker_list_caseBranch";
	}
	int sno = 0;
	 int startIndex = 0;
...
function cancelPage(){
    document.forms[0].action="caseBranch.do?event=<%=rejectEvent %>&go=N";
