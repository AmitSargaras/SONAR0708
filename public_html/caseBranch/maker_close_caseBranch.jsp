...
function submitPage(event) {
	...
	if(event=="maker_draft_close_process")
		...
		document.forms[0].action="caseBranch.do?event=maker_confirm_draft_close";
		
    }else{
      
    	document.forms[0].action="caseBranch.do?event=maker_confirm_close";
    }
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											<tr class="odd">
												...
												<td ><%=caseBranchForm.getBranchCode()%>&nbsp;
												</td>
...
<table width="130" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<a href="#" onmouseout="MM_swapImgRestore()"
				...
				<td colspan="2">
				<a
				href="#" onmouseout="MM_swapImgRestore()" onclick="cancelPage()"
