...
ISystemBankBranchTrxValue systemBankBranchTrx = (ISystemBankBranchTrxValue)session.getAttribute("com.integrosys.cms.ui.systemBankBranch.MaintainSystemBankBranchAction.ISystemBankBranchTrxValue");
	...
	System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ list of hub "+hubValueList);
...
function submitForm(event) {
	...
	if(event=="maker_update_save_process")
		{
		
		document.forms[0].action="systemBankBranch.do?event=maker_save_update";
		
    }else{
      
    	document.forms[0].action="systemBankBranch.do?event=maker_save_create";
    }
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
            ...
            <tr class="even">
              ...
              <td width="30%"><%=systemBankBranchForm.getSystemBankBranchCode()%>&nbsp;<html:errors property="systemBankBranchCodeError"/></td>
            ...
            <td class="fieldname" width="20%">Status&nbsp;</td>                            
               <% if(  systemBankBranchTrx.getFromState().equals("ACTIVE") ){ %>
            ...
            <tr class="odd">
              ...
              &nbsp;</br> <html:errors property="invalidHUBError"/></td>
            ...
            <tr class="even">
			 ...
			 <tr class="even">
				<td class="fieldname">City/Town <font color="red">*</font></td>
              	<td>
              		<html:select property="cityTown"  >
						<option value="">Please Select</option>
						<html:options collection="cityList" labelProperty="label" property="value" />
					</html:select>&nbsp;</br>  
					<html:errors property="systemBankBranchCityError"/>
				</td>

				<td class="fieldname">Pincode<font color="red">*</font> </td>
                <td>
                	<html:text property="pincode" styleId="pincode" onblur="validatePinCode()" value="<%=systemBankBranchForm.getPincode()%>"/>&nbsp;</br>
                  	<html:errors property="systemBankBranchPincodeError"/>
                </td>
             </tr>
             ...
             <tr class="even">
                ...
                <td>
                	<html:text property="contactNumber" value="<%=systemBankBranchForm.getContactNumber()%>"/>&nbsp;</br>
                	<html:errors property="systemBankBranchContactNumberError"/>
                </td>
             </tr>
             
			<tr class="odd">
              <td class="fieldname">Contact Mail </td>
              <td><html:text property="contactMail" value="<%=systemBankBranchForm.getContactMail()%>"/>&nbsp;</br><html:errors property="systemBankBranchContactMailError"/></td>
              <td class="fieldname">Fax Number</td>
							<td><html:text property="faxNumber" value="<%=systemBankBranchForm.getFaxNumber()%>"/>&nbsp;</br><html:errors property="systemBankBranchFaxNumberError"/></td>
...
<table width="130" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
   <%if(event.equals("maker_update_save_process")||event.equals("maker_save_update")){%>
                   <td colspan="2">
