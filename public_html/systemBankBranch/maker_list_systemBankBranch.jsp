...
<%
SearchResult sr = (SearchResult)request.getAttribute("systemBankBranchList");
...
<tr>
   <td valign="top">
                    ...
                    <%if((event.equals("checker_list_systemBankBranch"))||event.equals("checker_search_list_systemBankBranch")||event.equals("checker_list_pagination")||event.equals("checker_list_systemBank")){%>
                       ...
                       <% //String pageIndexUrl = "user.do?event=maker_list_user&"+form.getName()!=null&&form.getName().trim().equals("")?"name="+form.getName():""+"&startIndex=";%>
                        <%
                            String pageIndexUrl=null;
                                ...
                                pageIndexUrl = "systemBankBranch.do?event=maker_list_systemBankBranch&startIndex=";
