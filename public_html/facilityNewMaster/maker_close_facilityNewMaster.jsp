...
function submitPage(event) {
	...
	if(event=="maker_draft_close_process")
		...
		document.forms[0].action="facilityNewMaster.do?event=maker_confirm_draft_close";
		
    }else{
      
    	document.forms[0].action="facilityNewMaster.do?event=maker_confirm_close";
    }
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											...
											<tr class="even">
												...
												<td><integro:common-code-single categoryCode="<%=CategoryCodeConstant.FACILITY_CATEGORY %>" entryCode="<%=facilityNewMasterForm.getNewFacilityCategory()%>" display="true"/>&nbsp;
												</td>
												<td class="fieldname">
													Facility Type
												</td>
											...
											<tr class="even">
												...
												<td><integro:empty-if-null value="<%=facilityNewMasterForm.getWeightage()%>"/>&nbsp;
												</td>
...
<tr class="odd">
            ...
            <td class="fieldname">
												...
												<td><integro:common-code-single categoryCode="<%=CategoryCodeConstant.NPA_RULE_ID %>" entryCode="<%=facilityNewMasterForm.getRuleId()%>" display="true"/>&nbsp;
												</td>
              </tr>	
                                     <tr class="even">	 
                                     <td class="fieldname">
