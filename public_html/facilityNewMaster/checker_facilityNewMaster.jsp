...
function cancelPage(){
    document.forms[0].action="facilityNewMaster.do?event=maker_list_facilityNewMaster";
    
    document.forms[0].submit();
}
function approvePage() {
	
    document.forms[0].action="facilityNewMaster.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="facilityNewMaster.do?event=<%=rejectEvent%>";
    document.forms[0].submit();
}
function cancelPage(){
...
//-->
		...
		<body>
			...
			<table width="80%" border="0" align="center" cellpadding="0"
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											...
											<tr class="even">
												...
												<td>
												<integro:common-code-single categoryCode="<%=CategoryCodeConstant.FACILITY_CATEGORY %>" entryCode="<%=facilityNewMasterForm.getNewFacilityCategory()%>" display="true" descWithCode="false" />&nbsp;
												</td>
												<td class="fieldname">
													Facility Type
												</td>
											...
											<tr class="even">
												...
												if(facilityNewMasterForm.getWeightage()!=null){
													...
													System.out.print("---------------"+facilityNewMasterForm.getWeightage());
              ...
              <td class="fieldname">
												...
												<td>
												<integro:common-code-single categoryCode="<%=CategoryCodeConstant.NPA_RULE_ID %>" entryCode="<%=facilityNewMasterForm.getRuleId()%>" display="true" descWithCode="false" />&nbsp;
												</td>
              </tr>
                                        <tr class="even">	
                                        <td class="fieldname">
												...
												<td>
												<%=facilityNewMasterForm.getProductAllowed()%>&nbsp;
												</td>
												<td class="fieldname" >Currency Restriction&nbsp;</td>
              <td ><%if("Yes".trim().equalsIgnoreCase(facilityNewMasterForm.getCurrencyRestriction())){ %>Yes
              <% }else if("No".trim().equalsIgnoreCase(facilityNewMasterForm.getCurrencyRestriction())){ %>No
              <%}else{ %>-<%} %>&nbsp;</td>
              </tr>
                                        <tr class="even">	
              ...
              <%}else{ %>No<%} %>&nbsp;</td>
                                        <td class="fieldname">
												...
												<td>
												<%=facilityNewMasterForm.getLineCurrency()%>&nbsp;
												</td>
              ...
              <td ><%if("Yes".equalsIgnoreCase(facilityNewMasterForm.getScmFlag())){ %>Yes
              <%}else{ %>No<%} %>&nbsp;</td>
			 </tr>		
              ...
              <td ><%if(null !=facilityNewMasterForm.getAvailAndOptionApplicable()  && "on".equalsIgnoreCase(facilityNewMasterForm.getAvailAndOptionApplicable().trim() ) ){ %>
              
               <input type="checkbox" name="availAndOptionApplicable" property="availAndOptionApplicable" disabled="true"  checked="true" ></input>
              
              <%}else{ %>
             <input type="checkbox" name="availAndOptionApplicable" property="availAndOptionApplicable" disabled="true"   ></input>
              ...
              <%} %>&nbsp;</td>
               ...
               <tr class="odd">	
               <td class="fieldname" >Line Exclude from LOA Master&nbsp;</td>
              <td ><%if(null !=facilityNewMasterForm.getLineExcludeFromLoa()  && "Y".equalsIgnoreCase(facilityNewMasterForm.getLineExcludeFromLoa().trim() ) ){ %>
              
               <input type="checkbox" name="lineExcludeFromLoa" property="lineExcludeFromLoa" disabled="true"  checked="true" ></input>
              
              <%}else{ %>
             <input type="checkbox" name="lineExcludeFromLoa" property="lineExcludeFromLoa" disabled="true"   ></input>
              
              
              <%} %>&nbsp;</td>
              
               <td class="fieldname" >IDL Applicable&nbsp;</td>
              <td ><%if("Yes".equalsIgnoreCase(facilityNewMasterForm.getIdlApplicableFlag())){ %>Yes
              <%}else{ %>No<%} %>&nbsp;</td>
	...
	<html:hidden name="MaintainFacilityNewMasterForm" property="newFacilityCategory"/>
    ...
    <html:hidden name="MaintainFacilityNewMasterForm" property="ruleId"/>
    ...
    <html:hidden name="MaintainFacilityNewMasterForm" property="riskTypeNames"/>
