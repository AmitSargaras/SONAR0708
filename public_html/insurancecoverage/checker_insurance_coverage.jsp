...
<%@page import="com.integrosys.cms.app.insurancecoverage.trx.IInsuranceCoverageTrxValue"%><html>
	...
	<head>
		...
		function cancelPage(){
		    document.forms[0].action="InsuranceCoverage.do?event=view_relationship_mgr";
		    document.forms[0].submit();
		}
		function approvePage() {
		    document.forms[0].action="InsuranceCoverage.do?event=checker_approve_edit";
		    document.forms[0].submit();
		}
		function rejectPage() {
		    document.forms[0].action="InsuranceCoverage.do?event=checker_reject_edit";
		    document.forms[0].submit();
		}
		function cancelPage(){
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
						...
						<tr class="odd">
							...
							<td width="30%"><integro:empty-if-null value="<%=insuranceCoverageForm.getAddress()%>"/>&nbsp;
							</td>

							<td class="fieldname">Contact Number</td>
							<td><integro:empty-if-null value="<%=insuranceCoverageForm.getContactNumber()%>" />&nbsp;</td>
						</tr>
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tbody>
						...
						<tr>
							...
							<td class="odd"><%=insuranceCoverageTrx.getUserInfo()%>&nbsp;</td>
						</tr>
						<tr class="even">
