...
function submitForm() {
 	document.forms[0].action="InsuranceCoverage.do?event=maker_upload_insurance_coverage";
    document.forms[0].submit();
}
...
<html:form action="/InsuranceCoverage" enctype="multipart/form-data">
			...
			<table width="80%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<tr>
						<td align="center">
							<h3>
								Upload Insurance Coverage List
							</h3>
						</td>
					</tr>
					<tr>
