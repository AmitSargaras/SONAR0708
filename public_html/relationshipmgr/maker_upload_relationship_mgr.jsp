...
function submitForm() {
 	document.forms[0].action="RelationshipMgr.do?event=maker_upload_relationship_mgr";
    document.forms[0].submit();
}
...
<html:form action="/RelationshipMgr" enctype="multipart/form-data">
			...
			<table width="80%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<tr>
						<td align="center">
							<h3>
								Upload Relationship Manager List
							</h3>
						</td>
					</tr>
					<tr>
