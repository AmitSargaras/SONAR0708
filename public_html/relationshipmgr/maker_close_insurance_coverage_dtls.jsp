...
function submitPage () {
	document.forms[0].action="InsuranceCoverageDtls.do?event=maker_confirm_close";
    document.forms[0].submit();
}
			...
			<table width="80%" border="0" align="center" cellpadding="0"
				...
				<thead>
					<tr>
						...
						<br>
							<h3>
								Maintain Insurance Coverage Details:Close
							</h3>
						</td>
					</tr>
					<tr>
				...
				<tbody>
					...
					<tbody>
						...
						<tr class="even">
							...
							<td width="30%"><%=insuranceCoverageDtlsForm.getInsuranceCoverageCode()%>&nbsp;
							</td>
