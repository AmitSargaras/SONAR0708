				...
				<tbody>
					...
					<tbody>
						...
						<tr class="even">
							...
							<td width="30%">
							<html:text name="insuranceCoverageForm" property="insuranceCoverageCode" value="<%=insuranceCoverageForm.getInsuranceCoverageCode()%>"> &nbsp;  </html:text>
							...
							<td width="30%"><html:text name="insuranceCoverageForm"
								...
								value="<%=insuranceCoverageForm.getCompanyName()%>"></html:text>
						...
						<tr class="odd">	
							...
							<td><html:text name="insuranceCoverageForm"
								...
								value="<%=insuranceCoverageForm.getContactNumber()%>"></html:text></td>
						</tr>
					</tbody>
				</table>
						</td>
