...
function submitForm(event) {
	...
	if(event=="maker_prepare_resubmit_create")
    	...
    	document.forms[0].action="baselmaster.do?event=maker_edit_component";
    }
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <br>
  <tr>
                    <td><h3> Basel System Master</h3></td>
...
<%if(baselTrx.getBaselMaster()!=null){
if(baselTrx.getBaselMaster().getCreatedBy()!=null||!baselTrx.getBaselMaster().getCreatedBy().equals("")){ %>
<td ><%=baselTrx.getBaselMaster().getCreatedBy() %></td>
<%}}else{ %>
<td>- &nbsp;</td>
<%} %>
<td class="fieldname" width="20%">Last Approved By</td>
<%if(baselTrx.getBaselMaster()!=null){
if(baselTrx.getBaselMaster().getLastUpdatedBy()!=null){ %>
<td ><%=baselTrx.getBaselMaster().getLastUpdatedBy() %></td>
<%}}else{ %>
<td>- &nbsp;</td>
<%} %>
</tr>
...
<%if(baselTrx.getBaselMaster()!=null){
if(baselTrx.getBaselMaster().getCreatedOn()!=null){ %>
<td ><%=baselTrx.getBaselMaster().getCreatedOn() %></td>
<%}}else{ %>
<td>- &nbsp;</td>
<%} %>
...
<%if(baselTrx.getBaselMaster()!=null){
if(baselTrx.getBaselMaster().getLastUpdatedOn()!=null){ %>
<td ><%=baselTrx.getBaselMaster().getLastUpdatedOn() %></td>
<%}}else{ %>
<td>- &nbsp;</td>
<%} %>
