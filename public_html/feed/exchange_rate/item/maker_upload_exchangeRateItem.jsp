...
function cancelPage(){
    document.forms[0].action="feed_exchange_rate_list.do?event=prepare";
    document.forms[0].submit();
}
function submitForm() {
 	document.forms[0].action="feed_exchange_rate_item.do?event=maker_event_upload_exchangeRateItem";
    document.forms[0].submit();
}
...
<html:form action="/feed_exchange_rate_item" enctype="multipart/form-data">
