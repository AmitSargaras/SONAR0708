...
<%
    ...
    if (actionForm.getEvent().equals(StockIndexListAction.EVENT_SELECT) ||
            actionForm.getEvent().equals(StockIndexListAction.EVENT_READ) ||
            actionForm.getEvent().equals(StockIndexListAction.EVENT_READ_NOOP)) {
        event = StockIndexListAction.EVENT_READ;
    } else if (actionForm.getEvent().equals(StockIndexListAction.EVENT_SELECT_MAKER_EDIT)) {
        event = StockIndexListAction.EVENT_PREPARE;
    }
