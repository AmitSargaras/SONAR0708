...
function submitPage(event) {
	document.forms[0].action="feed_mutual_funds_item.do?event=maker_confirm_insert_close";
    document.forms[0].submit();
}
													...
													offset="<%=String.valueOf(startIndex)%>"
                               						length="<%=String.valueOf(10)%>"
														...
														<tr class="<%=rowClass%>">
															...
															<td style="text-align:center"><%=ob.getCurrentNAV()%>&nbsp;</td>
															</td>
