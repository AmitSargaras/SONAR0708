...
<%
    ...
    String event = null;
    if (actionForm.getEvent().equals(UnitTrustListAction.EVENT_SELECT) ||
            actionForm.getEvent().equals(UnitTrustListAction.EVENT_READ) ||
            actionForm.getEvent().equals(UnitTrustListAction.EVENT_READ_NOOP)) {
        event = UnitTrustListAction.EVENT_READ;
    } else if (actionForm.getEvent().equals(UnitTrustListAction.EVENT_SELECT_MAKER_EDIT)) {
        event = UnitTrustListAction.EVENT_PREPARE;
    }
