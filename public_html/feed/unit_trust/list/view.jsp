...
<%
    ...
    boolean forClose = event.equals(UnitTrustListAction.EVENT_READ_MAKER_CLOSE) ||
    					event.equals(UnitTrustListAction.EVENT_LIST_MAKER_CLOSE);
    					
    boolean forRead = UnitTrustListAction.EVENT_READ.equals(event) ||
    					UnitTrustListAction.EVENT_LIST_READ.equals(event);
...
function goPageIndex(targetOffset) {
	<% if (forClose) { %>
		document.forms[0].event.value = "<%=UnitTrustListAction.EVENT_LIST_MAKER_CLOSE%>";
	<% } else if (forRead) { %>
		document.forms[0].event.value = "<%=UnitTrustListAction.EVENT_LIST_READ%>";
	<% } else { %>
		document.forms[0].event.value = "<%=UnitTrustListAction.EVENT_LIST_VIEW%>";
	<% } %>
...
<tr>
	<td>
		...
		<thead>
		<tr>
			<td width="6%" rowspan="2">S/N</td>
			<td width="25%" rowspan="2">Name&nbsp;<font color="#00AAFF">* </font></td>
			<td width="6%" rowspan="2">ISIN Code</td>
			<td width="6%" rowspan="2">RIC/Stock Code&nbsp;<font color="#00AAFF">* </font></td>
			<td width="6%" rowspan="2">CCY&nbsp;<font color="#00AAFF">* </font></td>
			<td width="6%" rowspan="2">
			<p>Existing Pricing</p>
			</td>
			<td width="6%" rowspan="2">
			<p>Update Pricing&nbsp;<font color="#00AAFF">* </font></p>
			</td>
			<td width="10%" rowspan="2">Investment Product Code</td>
...
<tr>
	...
	<a href="feed_unit_trust_list.do?event=select" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4411"  border="0" id="Image4411" /></a>
	</a></td>
