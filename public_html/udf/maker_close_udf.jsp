...
<%
 ...
 UdfForm udfForm = (UdfForm) request.getAttribute("UdfForm");
...
function submitPage(event) {
	if(event=="maker_draft_close_process"){
		document.forms[0].action="udf.do?event=maker_confirm_draft_close";
    }else {
    	document.forms[0].action="udf.do?event=maker_confirm_close";
    }
    document.forms[0].submit();
}
</script>
	...
	<body>
		...
		<table width="80%" border="0" align="center" cellpadding="0"
			...
			<thead>
				...
				<tr>
					<td>
						<h3>Close User Defined Fields (UDFs)</h3>
					</td>
				</tr>
				<tr>
					<td>
