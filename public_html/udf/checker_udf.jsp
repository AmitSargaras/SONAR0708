...
function approvePage() {
    document.forms[0].action="udf.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="udf.do?event=<%=rejectEvent%>";
	document.forms[0].submit();
}
function cancelPage() {
	...
	<body>
		...
		<table width="80%" border="0" align="center" cellpadding="0"
			...
			<thead>
				...
				<tr>
					<td>
						<h3>User Defined Fields (UDFs)</h3>
					</td>
				</tr>
				<tr>
					<td>
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tbody>
								...
								<tr class="odd">
									...
									<td><%=udfTrx.getRemarks() != null ? udfTrx.getRemarks() : ""%>&nbsp;</td>
								</tr>
							</tbody>
						</table>
					</td>
