...
IFileUploadTrxValue trxValueOut=(IFileUploadTrxValue)session.getAttribute("com.integrosys.cms.ui.autoupdationlmtsupload.AutoupdationLmtsUploadAction.trxValueOut");
	...
	if(errorList!=null)
		...
		List<AutoupdationLmtsError> finalList=(ArrayList)session.getAttribute("com.integrosys.cms.ui.autoupdationlmtsupload.AutoupdationLmtsUploadAction.finalList");
...
<%@page import="com.integrosys.cms.ui.autoupdationlmtsupload.AutoupdationLmtsError"%><head>
...
function goBack(){
	document.forms[0].action = "AutoupdationLmtsupload.do?event=excelupload";		
	document.forms[0].submit(); 
}
...
<thead>
   <%if(finalList.size()>=1){ %>
<h3>Auto Updation of Limits Error</h3>
<%}else{ %>
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
                     ...
                     <logic:iterate id="ob"  offset="<%=String.valueOf(startIndex)%>"  indexId="counter"  name="finalList" type="com.integrosys.cms.ui.autoupdationlmtsupload.AutoupdationLmtsError" scope="page" length="100">
                     <%
					String rowClass = "";
					int i =0;
					if (rowCount % 2 != 0) {
      ...
      <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:15px">
        ...
        <tbody>
            <tr>
                <td>
                    <h3>
                  		Report has been generated successfully click here to <a href="#" onclick="downloadImage()">Download</a>
                  	</h3>
                </td>
            </tr>
            <tr>
