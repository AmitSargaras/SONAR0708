...
<%
     ...
     * $Header: /home/cms2/cvsroot/cms2/public_html/bfl/customer_accept_bfl.jsp,v 1.20 2006/10/27 08:10:27 hmbao Exp $
...
<body onload="MM_preloadImages('img/cancel2.gif')">
	<html:form  action="Bfl.do?event=confirm_customer_accept_bfl">
	...
	if(event_from.equals("customer_accept_bfl"))
		rs = (HashMap) request.getAttribute("infoMap");
	else
		rs = (HashMap) request.getAttribute("infoMap_customer_accept_bfl");
...
<!--	Pratheepa - the following block was not closed properly! commented it to fix display problem at View Issue Draft BFL-->
<!-- 	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:10px" dwcopytype="CopyTableRow">
		<thead>
			<tr>
				<td> 
					<h3><bean:message key="label.bfl.customer.accept.status"/><br /></h3>
				</td>
			</tr>
			<tr>
				<td><hr /></td>
...
%>
		...
		<h5 align="center">
			 <bean:message key="label.bfl.msg"/> <br> <bean:message key="label.bfl.customer.accept.status"/>
		</h5>
		...
		<table width="140" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td></td>
				<td><input type="button" name="Submit" value="Update Time Stamp" style="width:120px"  class="btnNormal" onclick="gotopage('Bfl.do?event=confirm_customer_accept_bfl')"/></td>
				<td>&nbsp;&nbsp;&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
