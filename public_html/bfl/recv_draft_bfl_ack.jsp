...
<%
     ...
     * $Header: /home/cms2/cvsroot/cms2/public_html/bfl/recv_draft_bfl_ack.jsp,v 1.21 2006/10/27 08:10:27 hmbao Exp $
...
<body onload="MM_preloadImages('img/cancel2.gif')">
	<html:form  action="Bfl.do?event=confirm_recv_draft_bfl_ack">
	...
	if(event_from.equals("recv_draft_bfl_ack"))
		rs = (HashMap) request.getAttribute("infoMap");
	else
		rs = (HashMap) request.getAttribute("infoMap_recv_draft_bfl_ack");
...
<!--	Pratheepa- the following block was not closed properly! commented it to fix display problem at View Recv Draft BFL-->
<!-- 	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:10px" dwcopytype="CopyTableRow">
		<thead>
			<tr>
				<td> 
					<h3><bean:message key="label.bfl.receive.draft.acknowledgement.status"/><br /></h3>
				</td>
			</tr>
			<tr>
				<td><hr /></td>
					...
					<table  width="100%" border="0" cellpadding="0" cellspacing="0" class="tblinfo" style="margin-top:0">
						<thead> 
							<tr> 
								...
								<td width="25%"><bean:message key="label.bfl.last.receive.draft.date"/></td>
...
%>
								<tr class="<%=rowClass%>">
									<td align="right" colspan="3">No Receive Draft BFL Acknowledgement found.</td>
								</tr>
<%							}
%>
						</tbody>
...
%>
		...
		<h5 align="center">
			<bean:message key="label.bfl.recieve.draft.ack.status.msg"/>
		</h5>
		...
		<table width="140" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td></td>
				<td><input type="button" name="Submit" value="Update Time Stamp" style="width:120px"  class="btnNormal" onclick="javascript:gotopage('Bfl.do?event=confirm_recv_draft_bfl_ack')"/></td>
				<td>&nbsp;&nbsp;&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
