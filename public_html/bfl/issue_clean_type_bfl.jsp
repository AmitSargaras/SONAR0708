...
<%
     ...
     * $Header: /home/cms2/cvsroot/cms2/public_html/bfl/issue_clean_type_bfl.jsp,v 1.21 2006/10/27 08:10:27 hmbao Exp $
...
<body onload="MM_preloadImages('img/cancel2.gif')">
	<html:form  action="Bfl.do?event=confirm_issue_clean_type_bfl">
	...
	if(event_from.equals("issue_clean_type_bfl"))
		rs = (HashMap) request.getAttribute("infoMap");
	else
		rs = (HashMap) request.getAttribute("infoMap_issue_clean_type_bfl");
...
<!--	Pratheepa- the following block was not closed properly! commented it to fix display problem at View Issue clean type BFL-->
<!-- 	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:10px" dwcopytype="CopyTableRow">
		<thead>
			<tr>
				<td> 
					<h3><bean:message key="label.bfl.issue.clean.type.status"/><br /></h3>
				</td>
			</tr>
			<tr>
				<td><hr /></td>
					...
					<table  width="100%" border="0" cellpadding="0" cellspacing="0" class="tblinfo" style="margin-top:0">
						<thead> 
							<tr> 
								...
								<td width="25%"><bean:message key="label.bfl.last.cust.accept.date"/></td>
...
%>
								<tr class="<%=rowClass%>">
									<td align="right" colspan="3"><bean:message key="label.bfl.none"/></td>
								</tr>
<%							}
%>
						</tbody>
...
%>
		...
		<h5 align="center">
			<bean:message key="label.bfl.msg"/> <br> <bean:message key="label.bfl.issue.clean.type.status"/>
		</h5>
		...
		<table width="140" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td></td>
				<td><input type="button" name="Submit" value="Update Time Stamp" style="width:120px"  class="btnNormal" onclick="gotopage('Bfl.do?event=confirm_issue_clean_type_bfl')"/></td>
				<td>&nbsp;&nbsp;&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
