...
<%@page import="com.integrosys.cms.app.pincodemapping.bus.IPincodeMapping"%><html>
...
function approvePage() {
    ...
    document.forms[0].action="StatePincodeMapping.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="StatePincodeMapping.do?event=<%=rejectEvent%>";
    document.forms[0].submit();
}
function cancelPage(){
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
						<tr class="odd">
							...
							<%
							if(pincodeMappingForm.getStateName()!=null) {
							%>
								<%= 
									pincodeMappingForm.getStateName()
								%>
							<%
							} else {
								if(pincodeMappingTrx!=null && pincodeMappingTrx.getStagingPincodeMapping()!=null && pincodeMappingTrx.getStagingPincodeMapping().getStateId()!=null){
							%>
								<%= 
										pincodeMappingTrx.getStagingPincodeMapping().getStateId().getStateName()
								%>
							<%
								}
							}
							...
							<td width="20%"><%=pincodeMappingForm.getPincode()%>&nbsp;</td>
						...
						<tr class="even" >
							...
							<td colspan="3" width="20%"><%=pincodeMappingTrx.getRemarks() != null ? pincodeMappingTrx
						.getRemarks() : ""%>&nbsp;</td>
						</tr>
