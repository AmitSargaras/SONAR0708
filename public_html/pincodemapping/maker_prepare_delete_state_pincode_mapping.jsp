...
PincodeMappingForm pincodeMappingForm = (PincodeMappingForm) request
	...
	pageContext.setAttribute("pincodeMappingList", pincodeMappingForm);
	int sno = 0;
	int startIndex = 0;
%>
<%
String actionStr1 = "com.integrosys.cms.ui.pincodemapping.PincodeMappingAction";
...
function submitPage() {
 	...
 	document.forms[0].action="StatePincodeMapping.do?event=maker_delete_state_pincode_mapping";
    document.forms[0].submit();
}
...
<td >&nbsp;</td>
	...
	<table width="95%" border="0" align="center" cellpadding="0"
		...
		<thead>
			...
			<br>
			<tr>
			<td  name="PincodeMappingForm" property="status">
					<h3>State Pincode Mapping : Delete</h3>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
						<tr class="odd">
							...
							<td width="30%"><%=pincodeMappingForm.getStateName()%>&nbsp;</td>
						
							<td class="fieldname">Pin Code<font color="red">*</font></td>
							<td><%=pincodeMappingForm.getPincode()%>&nbsp;</td>
						</tr>
