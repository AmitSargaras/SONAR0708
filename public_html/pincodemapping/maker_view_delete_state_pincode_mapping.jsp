...
<%
	...
	String rejectEvent;
	if (event.equals("checker_view_state_pincode_mapping")) {
		rejectEvent = "checker_list_state_pincode_mapping";
	} else {
		rejectEvent = "maker_list_state_pincode_mapping";
	}
	int sno = 0;
	int startIndex = 0;
%>
...
function cancelPage(){
    document.forms[0].action="StatePincodeMapping.do?event=<%=rejectEvent%>&startIndex=<%=request.getAttribute("startIndex")%>";
