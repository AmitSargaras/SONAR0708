...
function submitForm() {
 	document.forms[0].action="StatePincodeMapping.do?event=maker_create_state_pincode_mapping";
    document.forms[0].submit();
}

function saveForm() {

 	document.forms[0].action="StatePincodeMapping.do?event=maker_create_draft_state_pincode_mapping";
    document.forms[0].submit();
}
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
						<tr class="odd">
							...
							<td width="20%"><html:text property="pincode" size="30"
