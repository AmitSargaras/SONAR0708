...
<table class="tblFormSection" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3><bean:write name="DocFacilityMasterForm" property="secTypeDesc" /> (<bean:write name="DocFacilityMasterForm" property="subTypeDesc" />) - <% if(index.equals("")) {%>New<%}else{%>Edit<%}%></h3></td>
    </tr>
    <tr>
      <td><hr/></td>
    </tr>
    ...
    <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
		...
		<tr class="even">
          ...
          <td>
            &nbsp;<bean:write property="docCode" name="DocFacilityMasterForm" />
          </td>
        </tr>
		<% } %>
        <tr class="odd">
...
<table width="150"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td width="100" valign="baseline" align="center"> <a href="DocFacilityMaster.do?event=back" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image4411"  border="0" id="Image4411" /></a></td>
                      </tr>
                      <tr>
                        <td valign="baseline" align="center">&nbsp;</td>
                        <td valign="baseline" align="center">&nbsp;</td>
