...
<%
    int sno = 0;
    List sAddTemplateList = (List)session.getAttribute("com.integrosys.cms.ui.secmaster.SecurityMasterAction.sAddTemplateList");
...
<table class="tblFormSection" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3><bean:write name="SecurityMasterForm" property="secTypeDesc" /> (<bean:write name="SecurityMasterForm" property="subTypeDesc" />)
         </h3></td>
    </tr>
    <tr>
      <td><hr/></td>
