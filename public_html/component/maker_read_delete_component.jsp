...
function submitForm() {
 	document.forms[0].action="component.do?event=maker_delete_component";
    document.forms[0].submit();
}
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
									...
									<tr class="even">
										...
										<%	if (null!=componentForm.getComponentCategory()) {%>
											<td width="30%"><%=componentForm.getComponentCategory()%></td>
										<%}else{ %>	
											<td width="30%">-</td>
										<%} %>
									</tr>
									...
									<html:hidden name="MaintainComponentForm" property="status"
										value="DISABLE" />
									<html:hidden name="MaintainComponentForm" property="id" />
									<html:hidden name="MaintainComponentForm"
