...
<%  int row = 0;
    ...
    ICCCertificate cert = (ICCCertificate)request.getAttribute("cert");
    Amount bcaAmt = cert.getTotalApprovalAmount();
    if(cert!=null) {
    ...
    {
        bcaAmt = (Amount)session.getAttribute("com.integrosys.cms.ui.genccc.GenerateCCCAction.bcaAmt");
    }        
%>
...
<table width="97%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection"  >
  ...
  <tbody>
    <tr>
      <td class="header" align="center">Constitutional and Contractual Compliance
        Certificate</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    {%>
            ...
            <tr class="odd">
              ...
              <td>
                <%if(bcaAmt!=null)
                {%>
                    &nbsp;<integro:currency amount="<%=bcaAmt%>" /> <% } %>
              </td>
            </tr>
            <tr class="even">
...
<%
    if (custDetail.getNextReviewDate() != null)
    {
%>
