...
Locale locale = (Locale)session.getAttribute(ICommonEventConstant.GLOBAL_SCOPE+"."+com.integrosys.base.uiinfra.common.Constants.GLOBAL_LOCALE_KEY);
    ...
    System.out.println("form image id == "+itemOb.getFacImageTagUntagId());
    /* form.setFacImageTagUntagId(itemOb.getFacImageTagUntagId());
    form.setFacImageTagUntagImgName(itemOb.getFacImageTagUntagImgName());
    form.setFacImageTagUntagStatus(itemOb.getFacImageTagUntagStatus()); */
    
    
    
String secListImages = itemOb.getFacImageTagUntagImgName();
  ...
  if(",".equals(untagImagesNames.substring(untagImagesNames.length() - 1))){
    ...
    itemOb.setFacImageTagUntagId(tagImagesNames);
    //itemOb.setFacImageTagUntagImgName(secListImages);
    itemOb.setFacImageTagUntagStatus(untagImagesNames);
    
    form.setFacImageTagUntagId(tagImagesNames);
    form.setFacImageTagUntagImgName(secListImages);
 ...
 <table width="100%" height="100%" cellspacing="0" cellpadding="0"
	...
	<tr>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
             <%   if (previous != null && previous.equals("view")) { System.out.println(">>>>>>>>>>>>>>>>>>>>> IF");%>
