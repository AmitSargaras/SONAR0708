...
function saveForm() {
	document.forms["SecurityReceiptForm"].event.value="save_temp_uplift";
...
--%>        <tr class="even">
              <td class="fieldname">Date Temp Uplifted&nbsp;<font color="#0000FF">*</font></td>
              <td><html:text property="tempUpliftedDate" size="12" maxlength="12" readonly="true" />
                <img src="img/calendara.gif"  name="Image11a" border="0" id="Image1a" onclick="return showCalendar('tempUpliftedDate', 'dd/mm/y');" onmouseover="MM_swapImage('Image11a','','img/calendarb.gif',1)" /><html:errors property="tempUpliftedDate" />
