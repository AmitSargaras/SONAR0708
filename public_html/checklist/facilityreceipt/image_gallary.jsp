...
function showListing() {
	...
	{
		 document.forms[0].action="FacilityReceipt.do?event=view_image_page&category="+catg;
   ...
   // alert("imagePath is "+imagePath);
	...
	if(count<0){
	   alert("This is first Image.");
			...
			if('<%=event%>' == 'retrieveImageGallaryFacilityDoc'){
			 document.forms[0].action="FacilityReceipt.do?event=retrieveImageGallaryFacilityDoc&imageName="+imageName+"&status="+status+"&count="+count+"&pID="+imagePath+"&category"+categ;
				document.forms[0].submit();
			}
