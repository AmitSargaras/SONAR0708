...
String expiryDate=form.getDocExpDate();
    ...
    ICheckListItem checkListItem =(ICheckListItem)session.getAttribute("com.integrosys.cms.ui.checklist.facilityreceipt.FacilityReceiptAction.checkListItem");
    
    List deferCreditApproverList = (List)session.getAttribute("com.integrosys.cms.ui.checklist.facilityreceipt.FacilityReceiptAction.deferCreditApproverList");
...
function saveForm() {
	...
	//if(chkResult==true ){
		document.forms["FacilityReceiptForm"].event.value="save_defer";
...
/* moved validation into FacilityReceiptFormValidator.java
...
--%>
            <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="tblInput">
                ...
                <tr class="odd">
                    ...
                    <td><html:textarea name="FacilityReceiptForm" rows="5" cols="80" property="docRemarks" onkeyup="limitTextInput(this,1600,'Narration')"/><html:errors property="docRemarks" /></td>
                </tr>
                </tbody>
            </table>
             <table width="100%">
