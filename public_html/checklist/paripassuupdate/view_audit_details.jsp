...
List transactionHistoryList = (List) session.getAttribute("com.integrosys.cms.ui.checklist.paripassuupdate.UpdatePariPassuCheckListAction.transactionHistoryList");
