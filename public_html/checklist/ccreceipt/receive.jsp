...
function saveForm() {
	document.forms["CCReceiptForm"].event.value="save_receive";
...
function checkTextSize() {
	var text = document.forms[0].docRemarks.value;
	var maxLength = 16;
	if(text!=''){
		if(text.length>maxLength){
			document.all['warningRemarks'].innerHTML = '<font color="#FF0000" size="1"><br>Narration is too long. Please restrict to 1600 characters.</font>';
			document.forms[0].docRemarks.value = text.substring(0,maxLength);
		}else{
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
        ...
        <!--    <tr class="even">
            ...
            <tr class="odd">
             ...
             <tr class="even">
              <td class="fieldname">Receive Date&nbsp;<font color="#0000FF">*</font></td>
              <td><html:text property="receivedDate" size="12" maxlength="12" readonly="true"  />
                <img src="img/calendara.gif"  name="Image11" border="0" id="Image1" onclick="return showCalendar('receivedDate', 'dd/mm/y');" onmouseover="MM_swapImage('Image11','','img/calendarb.gif',1)" />
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="center" valign="middle">
                <a href="#" onmouseout="MM_swapImgRestore()" onclick="saveForm()" onmouseover="MM_swapImage('Image1','','img/ok2.gif',1)"><img src="img/ok1.gif" name="Image1"  border="0" id="Image1" /></a>
