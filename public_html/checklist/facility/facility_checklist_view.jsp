...
<%
    ...
    String limitId= (String)session.getAttribute("com.integrosys.cms.ui.checklist.facility.FacilityCheckListAction.limitID");
	String limitName= (String)session.getAttribute("com.integrosys.cms.ui.checklist.facility.FacilityCheckListAction.limitName");
	HashMap checkListIDMap = (HashMap)session.getAttribute("com.integrosys.cms.ui.checklist.facility.FacilityCheckListAction.checkListIDMap");
...
<%@page import="com.integrosys.cms.ui.checklist.facility.FacilityCheckListForm"%>
<%@page import="java.util.HashMap"%>
<%@page import="com.integrosys.cms.app.limit.bus.ILimit"%><html xmlns="http://www.w3.org/19009/xhtml"><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<!--                <td class="fieldname">FacilityName</td>-->
