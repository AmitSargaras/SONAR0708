...
<%@ page import="com.integrosys.base.techinfra.logger.DefaultLogger,
                 ...
                 com.integrosys.cms.ui.checklist.facility.FacilityCheckListForm,
...
<%
    ICheckListTrxValue checkListTrxVal = (ICheckListTrxValue) session.getAttribute("com.integrosys.cms.ui.checklist.facility.FacilityCheckListAction.checkListTrxVal");
    ICheckList checkList = (ICheckList) session.getAttribute("com.integrosys.cms.ui.checklist.facility.FacilityCheckListAction.checkList");
    String limitId = null;
    if(session.getAttribute("com.integrosys.cms.ui.checklist.facility.FacilityCheckListAction.limitID")!=null){
		limitId= String.valueOf(session.getAttribute("com.integrosys.cms.ui.checklist.facility.FacilityCheckListAction.limitID"));
    }
	String limitName= (String)session.getAttribute("com.integrosys.cms.ui.checklist.facility.FacilityCheckListAction.limitName");
    ...
    ILimit limit=null;
    if(limitId!=null && limitList!=null && limitList.length >0){
    ...
    ArrayList docIds = (ArrayList)session.getAttribute("com.integrosys.cms.ui.checklist.facility.FacilityCheckListAction.docNos");
...
//System.out.println("status ::::::::::::::::::"+checkList.getCheckListStatus());
    String remarks = "";
    String lastActionBy = "";
    if (checkList != null)
    ...
    String secType = "";
    String secSubType = "";
    FacilityCheckListForm aForm = (FacilityCheckListForm) request.getAttribute("FacilityCheckListForm");
...
<%@page import="com.integrosys.cms.ui.common.constant.IGlobalConstant"%><html xmlns="http://www.w3.org/19009/xhtml"><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<body>
<html:form action="FacilityCheckList">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
        ...
        <tbody>
           ...
           <tr class="even">
                ...
                <td><integro:empty-if-null value="<%=String.valueOf(limit.getLimitID()) %>" /></td>
                <td class="fieldname">Checklist Id</td>
                
                <td>
                <%if(checkList.getCheckListID()!=-999999999){ %>
...
//            " OB.getShared()=" +OB.getShared() + "OB.getViewable=" + OB.getViewable() );
    ...
    <% if (row == 0) {%>
    <tr class="odd">
        <td colspan="11">There are no facilities linked</td>
    </tr>
    <% }%>
    </tbody>
    </table>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <%} else {%>
            <td width="100" valign="baseline" align="center">
                <a href="FacilityCheckList.do?event=list" onmouseout="MM_swapImgRestore()"   onmouseover="MM_swapImage('Image2','','img/cancel2.gif',1)">
