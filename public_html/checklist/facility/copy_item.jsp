...
<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    ...
    <tr>
      <td width="78%"> <h3>Maintain Facility Checklist</h3></td>
      ...
      <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInput">
          <tbody>
            <tr class="even">
              ...
              <td><bean:write name="FacilityCheckListForm" property="docCode" /></td>
            </tr>
            <tr class="odd">
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="75" valign="baseline" align="center"><a href="#" onClick="goBack()" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image51','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image51" width="70" height="20" border="0" id="Image5" /></a></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
