...
<%
    int sno = 0;
    List ccAddCheckList = (List)session.getAttribute("com.integrosys.cms.ui.checklist.security.SecurityCheckListAction.ccAddCheckList");
...
<table class="tblFormSection" width="70%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3>Maintain Security Checklist - <%=secType%>/<%=secSubType%></h3></td>
    </tr>
    <tr>
      <td><hr/></td>
    </tr>
