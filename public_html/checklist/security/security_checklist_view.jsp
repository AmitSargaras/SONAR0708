...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:10px">
  <thead>
    ...
    %>
          <bean:message key="title.security.doc.checklist.delete"/>
    <%
    }else{
        //out.print("&nbsp;Maintain ");
        ...
        //out.print("Deleted ");
        %>
            <bean:message key="title.security.doc.checklist.deleted"/>
        <%
        }else{
        //out.print("Security Checklist");
        %>
          <bean:message key="title.security.doc.checklist.view"/>
        <%}
    }%>
    </h3></td>
    </tr>
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
          ...
          <tbody>
            ...
            %>
                <tr class="even">
                    <td class="fieldname"><bean:message key="label.security.docitem.source.securityID"/></td>
                    <td><bean:write name="SecurityCheckListForm" property="collateralID" /></td>
                    <td class="fieldname">
<!--                    <bean:message key="label.security.docitem.customercategory"/>-->
                    &nbsp;
                    </td>
                    <td>
                   <%-- <%=checkList.getCheckListOwner().getSubOwnerType()%> --%>
                    &nbsp;
                    </td>
                 </tr>
                 <tr class="odd">
            ...
            %>
                <tr class="even">
                    <td class="fieldname"><bean:message key="label.security.docitem.securityname"/></td>
                    <td>&nbsp;<%=secName%></td>
                    <td class="fieldname">
<!--                    <bean:message key="label.security.docitem.customercategory"/>--> &nbsp;
                    </td>
        ...
        <tr class="<%=rowClass%>">
          ...
          <td style="text-align:center">&nbsp;
           ...
           <td style="text-align:center">&nbsp;
            ...
            <input type="checkbox" name="check12" value="<%=row-1%>" <%if(mandatoryDisplay){%> checked <%} %> disabled />
            <%}%>
          </td>
 <%-- 
