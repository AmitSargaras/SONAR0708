...
<%@ page import="com.integrosys.cms.app.common.constant.ICMSConstant,
                 ...
                 com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptForm" %>
...
OtherReceiptForm aForm = (OtherReceiptForm)request.getAttribute("OtherReceiptForm");
	...
	Boolean isImageTagPending = (Boolean) session.getAttribute(OtherReceiptAction.class.getName()+"."+ ITagUntagImageConstant.IS_IMAGE_TAG_PENDING); 
	if(isImageTagPending == null){
		isImageTagPending = Boolean.FALSE;
	}
	
	String isSkipImgTag =(String)session.getAttribute("com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptAction.isSkipImgTag");
...
System.out.println("<<<<<<<<<<in Other Receipt isImageTagged>>>>>>>>>>"+request.getAttribute("isImageTagged"));
%>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function saveFormOnSkipDisable() {
        	...
        	if(isImageTagPending){
            	...
            	document.forms["OtherReceiptForm"].event.value = "save_receive";
...
function tagUntagImage(){
	document.forms["OtherReceiptForm"].event.value = "<%=OtherReceiptAction.EVENT_PREPARE_TAG_UNTAG_IMAGE%>";
    document.forms["OtherReceiptForm"].submit();
}
...
<%
	...
	ICheckList checkList = (ICheckList)session.getAttribute("com.integrosys.cms.ui.checklist.secreceipt.OtherReceiptAction.checkList");
...
<!--                    </tr>-->
                    ...
                    <tr class="odd">
                        ...
                        <td><html:text property="docDate" size="12" maxlength="12" readonly="true" value="<%=docDate %>" name="OtherReceiptForm"/>
              ...
              <td class="fieldname">Original Target Date &nbsp;</td>
               ...
               <td>&nbsp;-</td>
               <%} }else{%>
              <td><html:text property="originalTargetDate" size="12" maxlength="12" readonly="true" name="OtherReceiptForm"/>
                <img src="img/calendara.gif"  name="Image11" border="0" id="Image1" onclick="showCalendar('originalTargetDate', 'dd/mm/y');" 
                ...
                <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" class="tblInput">
                    <tbody>
                        <tr class="even">
                            ...
                            <td><html:textarea name="OtherReceiptForm" rows="5" cols="80" property="docRemarks"
