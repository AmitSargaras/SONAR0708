...
String event=(String)request.getAttribute("event");
    ...
    if(flag.equals("")){
      	 flag= (String)session.getAttribute("com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptAction.flag");
      }
      if(flag==null){
   	   flag="";
      }
   ...
   // System.out.println("::::::::::::::::"+aForm);
    ...
    if(!toTrack || "cancel_checklist_item".equals(event)||"search_other_doc_checker_close".equals(event)){
 	   searchEvent="search_other_doc_checker_close";
    }
    if("close_checklist_item".equals(event)){
    	searchEvent="search_other_doc_checker_close";
    }
    if("edit_staging_checklist_item".equals(event)){
    	searchEvent="search_other_doc_maker_close";
    }
    if(isUserCpcMaker && "view_return".equals(event) && !toTrack){
    	searchEvent="search_other_doc_checker_close";
    }
    if(!isUserCpcMaker && !toTrack ){
    	searchEvent="checker_search_other_doc";
    }
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td> <h3><%=("Cancel".equals(flag)?"Close":flag)%> Other Doc Receipt</h3>
...
--%>
              ...
              <%}else if("view_return".equals(event)||"close_checklist_item".equals(event)||"cancel_checklist_item".equals(event)||"search_other_doc_maker_close".equals(event)||"search_other_doc_checker_close".equals(event)){ %>
...
<% if(row==0){%>
            <tr class="odd">
              <td colspan="16">There are no others linked</td>
            </tr>
<% }%>
          </tbody>
        </table></td>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <%if((!toTrack && ("Close".equals(flag)||"Edit".equals(flag)))&& !checkListTrxVal.getStatus().equalsIgnoreCase("DRAFT")) { %>
    ...
    <td><a href="OtherReceipt.do?event=cancel" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','img/close2a.gif',1)"><img src="img/close1a.gif" name="Image4" width="70" height="20" border="0" id="Image4" /></a>&nbsp;&nbsp;&nbsp;<a href="ToDo.do" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image4411"  border="0" id="Image4411" /></a></td>
    <%}else{%>
    <td><a href="OtherReceipt.do?event=list" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4" width="70" height="20" border="0" id="Image4" /></a></a></td>
    <%} %>
  </tr>
  <tr>
    <td>&nbsp;</td>
