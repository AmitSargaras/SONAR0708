...
<table class="tblFormSection" width="70%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3><bean:message key="title.maintain.cov.condition.checklist.view"/></h3></td>
    </tr>
    <tr>
      <td><hr/></td>
    </tr>
...
<%--            <tr class="even">
              <td class="fieldname">Chaser / Reminder</td>
...
--%>			<%-- cr 26 --%><!-- -->
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
              ...
              <td>&nbsp;<bean:write name="RecurrentCheckListForm" property="covenantItemRemarks" /></td>
            </tr>
          </tbody>
        </table>
    </td>
...
<% } else { %>
    <td width="100" valign="baseline" align="center"> <a href="RecurrentCheckList.do?event=view_ok" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4411"  border="0" id="Image4411" /></a>
    </td>
<% } %>
      </tr>
  <tr> 
