...
<%
    ...
    ArrayList waiverCreditApproverList = (ArrayList)session.getAttribute("com.integrosys.cms.ui.checklist.recurrentDocreceipt.RecurrentDocReceiptAction.waiverCreditApproverList");
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td> <h3>Process Recurrent Doc Receipt</h3>
...
<!--			  	    </html:select>&nbsp;-->
<!--			  	  <%if(!ismandatory){%>-->
<!--			  	  <bean:write name="RecurrentDocReceiptForm" property="nonPanellawyerLegalFirm" />&nbsp;-->
<!--			  	  <%} %>-->
<!--				</td>-->
<!--		     </tr>-->
<!--		     <tr class="even">-->
<!--	            <td width="30%" class="fieldname">Lawyer Reference Number</td>-->
<!--	            <td><bean:write name="RecurrentDocReceiptForm" property="lawyerReferenceNumber" />&nbsp;</td>-->
<!--	          </tr>		-->
<!--            <tr class="odd">-->
<!--	            <td width="30%" class="fieldname">Person-In-Charge</td>-->
<!--	            <td><bean:write name="RecurrentDocReceiptForm" property="lawyerInCharge" />&nbsp;</td>-->
<!--            </tr>		-->
<!--            <tr class="even">-->
...
<!--				<td><bean:write name="RecurrentDocReceiptForm" property="lawFirmContactNumber" />&nbsp;</td>-->
<!--			</tr>	-->
<!--            <tr class="even">-->
<!--				<td width="30%" class="fieldname">Email</td>-->
<!--				<td><bean:write name="RecurrentDocReceiptForm" property="lawyerEmail" />&nbsp;</td>-->
<!--			</tr>		-->
<!--		    </tbody>-->
<!--		  </table>-->
<!--		 </td>-->
...
<!--		      <% 	
		    ...
		    //  		}
		      %>
<!--				<html:radio property="valuerFirmPanelFlag"  name="RecurrentDocReceiptForm" value="Y" disabled="true" />Yes &nbsp;-->
<!--                <html:radio property="valuerFirmPanelFlag"  name="RecurrentDocReceiptForm" value="N" disabled="true" /> No &nbsp;-->
<!--				<html:radio property="valuerFirmPanelFlag"  name="RecurrentDocReceiptForm" value="-"  disabled="true" /> N/A-->
<!--		      </td>-->
<!--		    </tr>-->
<!--		    </tbody>-->
<!--		  </table>-->
...
<!--				  	    </html:select>-->
<!--					<%//if(!bb){ %>-->
<!--						<bean:write name="RecurrentDocReceiptForm" property="nonPanelvaluerLegalFirm" />&nbsp;-->
<!--					<%//} %>-->
<!--					</td>-->
<!--			     </tr>-->
<!--			     <tr class="even">-->
<!--		            <td width="30%" class="fieldname">Valuer Reference Number</td>-->
<!--		            <td><bean:write name="RecurrentDocReceiptForm" property="valuerReferenceNumber" />&nbsp;</td>-->
<!--		          </tr>		-->
<!--	            <tr class="odd">-->
<!--		            <td width="30%" class="fieldname">Person-In-Charge</td>-->
<!--		            <td><bean:write name="RecurrentDocReceiptForm" property="valuerInCharge" />&nbsp;</td>-->
<!--	            </tr>		-->
<!--	            <tr class="even"> -->
<!--					<td width="30%" class="fieldname">Address-->
<!--					<%//if(bb){ %><font color="#0000FF" >*</font><%//} %></td>-->
...
<!--				<tr class="odd"> -->
<!--					<td width="30%" class="fieldname">Contact No</td>-->
<!--					<td><bean:write name="RecurrentDocReceiptForm" property="valuerFirmContactNumber" />&nbsp;</td>-->
<!--				</tr>	-->
<!--	            <tr class="even"> -->
<!--					<td width="30%" class="fieldname">Email</td>-->
<!--					<td><bean:write name="RecurrentDocReceiptForm" property="valuerEmail" />&nbsp;</td>-->
<!--				</tr>	-->
<!--		    </tbody>-->
<!--		  </table>-->
<!--		 </td>-->
...
<!--		      <td width="763">-->
		      <% 	
		      	...
		      	//	}
		      %>
<!--				<html:radio property="insurerFirmPanelFlag"  name="RecurrentDocReceiptForm" value="Y" disabled="true" />Yes &nbsp;-->
<!--                <html:radio property="insurerFirmPanelFlag"  name="RecurrentDocReceiptForm" value="N" disabled="true" /> No &nbsp;-->
<!--				<html:radio property="insurerFirmPanelFlag"  name="RecurrentDocReceiptForm" value="-"  disabled="true" /> N/A-->
<!--		      </td>-->
<!--		    </tr>-->
<!--		    </tbody>-->
<!--		  </table>-->
...
<!--				  	    </html:select>-->
<!--					<%//if(!cc){ %>-->
<!--						<bean:write name="RecurrentDocReceiptForm" property="nonPanelinsurerLegalFirm" />&nbsp;-->
<!--					<%//} %>-->
<!--					</td>-->
<!--			     </tr>-->
<!--			     <tr class="even">-->
<!--		            <td width="30%" class="fieldname">Insurer Reference Number</td>-->
<!--		            <td><bean:write name="RecurrentDocReceiptForm" property="insurerReferenceNumber" />&nbsp;</td>-->
<!--		          </tr>		-->
<!--	            <tr class="odd">-->
<!--		            <td width="30%" class="fieldname">Person-In-Charge</td>-->
<!--		            <td><bean:write name="RecurrentDocReceiptForm" property="insurerInCharge" />&nbsp;</td>-->
<!--	            </tr>		-->
<!--	            <tr class="even"> -->
<!--					<td width="30%" class="fieldname">Address-->
<!--					<%//if(cc){ %><font color="#0000FF" >*</font><%//} %></td>-->
...
<!--				<tr class="odd"> -->
<!--					<td width="30%" class="fieldname">Contact No</td>-->
<!--					<td><bean:write name="RecurrentDocReceiptForm" property="insurerFirmContactNumber" />&nbsp;</td>-->
<!--				</tr>	-->
<!--	            <tr class="even"> -->
<!--					<td width="30%" class="fieldname">Email</td>-->
<!--					<td><bean:write name="RecurrentDocReceiptForm" property="insurerEmail" />&nbsp;</td>-->
<!--				</tr>		-->
<!--		    </tbody>-->
<!--		  </table>-->
<!--		 </td>-->
...
<% if(row==0){%>
            <tr class="odd">
              <td colspan="12">There are no recurrent doc linked</td>
            </tr>
<% }%>
          </tbody>
        </table></td>
