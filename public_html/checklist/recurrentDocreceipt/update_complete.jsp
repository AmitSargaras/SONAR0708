...
<%
	...
	boolean isStatusReceived = "RECEIVED".equals(status);
	pageContext.setAttribute("isStatusReceived", isStatusReceived);
...
function saveFormOnSkipEnable(){
	...
	document.forms["RecurrentDocReceiptForm"].event.value="save_update";
...
function tagUntagImage(){
	document.forms["RecurrentDocReceiptForm"].event.value = "<%=RecurrentDocReceiptAction.EVENT_PREPARE_TAG_UNTAG_IMAGE_UPDATE%>";
    document.forms["RecurrentDocReceiptForm"].submit();
}
...
--%>
            ...
            <logic:equal name="isStatusReceived" value="true">
				<tr class="even">
...
--%>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
                 ...
                 <tr class="old">
                     ...
                     <td><html:textarea name="RecurrentDocReceiptForm" rows="5" style="width:97%"  property="docRemarks" onkeyup="limitTextInput(this,1600,'Narration')"/><html:errors property="docRemarks" /></td>
                    </tr>
                  </tbody>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
                 ...
                 <tr class="old">
                     ...
                     <td><html:textarea name="RecurrentDocReceiptForm" rows="5" style="width:97%"  property="docJustification" onkeyup="limitTextInput(this,2000,'Narration')"/><html:errors property="docJustification" /></td>
                    </tr>
                  </tbody>
            </table>
            ...
            <table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" valign="middle">
                          ...
                          <a href="#" onclick="saveFormOnSkipEnable()"  onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img/ok2.gif',1)"><img src="img/ok1.gif" name="Image1" border="0" id="Image1" /></a>
                          <%}else{ %>
                          <a href="#" onclick="saveFormOnSkipDisable()"  onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img/ok2.gif',1)"><img src="img/ok1.gif" name="Image1" border="0" id="Image1" /></a>
                           <%} %>
