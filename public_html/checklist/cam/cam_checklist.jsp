...
<%
    ...
    ArrayList docIds = (ArrayList)session.getAttribute("com.integrosys.cms.ui.checklist.cam.CAMCheckListAction.docNos");
        String docs[] = null;
        int length1=0 ;
  ...
  //  System.out.println("::::::::::::4:::::::::::::"+checkListItems );
    ...
    for (int i = 0; i < checkListItems.length; i++) {
      ...
      // System.out.println("::::::::::::5:::::::::::::"+itemRefLong );
...
%>
<%
String actionStr1 = "com.integrosys.cms.ui.checklist.cam.CAMCheckListAction";
...
<%@page import="com.integrosys.cms.ui.checklist.cam.CAMCheckListForm"%><html xmlns="http://www.w3.org/19009/xhtml"><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
//            " OB.getShared()=" +OB.getShared() + "OB.getViewable=" + OB.getViewable() );
    ...
    <% if (row == 0) {%>
    <tr class="odd">
        <td colspan="11">There are no CAM linked</td>
    </tr>
    <% }%>
    </tbody>
    </table>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <%} else {%>
             <td width="100" valign="baseline" align="center">
                <a href="CAMCheckList.do?event=list" onmouseout="MM_swapImgRestore()"   onmouseover="MM_swapImage('Image2','','img/cancel2.gif',1)">
