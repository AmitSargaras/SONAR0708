...
String  secSubType=(String)request.getAttribute("secSubType");
String  collateralID=(String)request.getAttribute("collateralID");
...
<input type="hidden"   name="secSubType"         value="<%=secSubType%>" >
