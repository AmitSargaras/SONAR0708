...
//	    alert('j'+j);
    ...
    if (num == 1) {
    	 document.forms[0].action="RecurrentCheckList.do?event=add_recurrent&selectedValues"+temp;
...
function addRecurrent() {
    ...
    document.forms[0].action="RecurrentCheckList.do?event=show_recurrent_master&type="+AppendedStatementType.value;
    document.forms[0].submit();
...
/*	
    ...
    //alert(type);
  		document.forms[0].action="RecurrentCheckList.do?event=show_recurrent_master&type="+type;
        document.forms[0].submit();
  */ 
...
<!--                                    </html:select>-->
<!--                                     <input type="button" value="GO" class="btnNormal" onclick="addRecurrent()"/>-->
<!--                                    </td>-->
<!--    </tr>-->
  ...
  <tr  >
										...
										<html:select  size="5" multiple="multiple" style="width:150" property="allStatementType" >					               
									        <integro:common-code pleaseSelect="false"	categoryCode="<%=CategoryCodeConstant.STATEMENT_TYPE%>" descWithCode="false" />
										</html:select> &nbsp; 
										</td>
								         	  <td>
										...
										<td rowspan="3" align="center" ><input type="button" value="GO" class="btnNormal" onclick="addRecurrent()"/> </td>
									</tr> 
									</tbody>
									</table></td></tr>
        <tr>
