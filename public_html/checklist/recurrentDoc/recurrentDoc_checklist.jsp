...
System.out.println("::::::::::::1:::::::::::::" );
    ...
    if(stockDocChkList ==null){
    	stockDocChkList = new HashMap();
    }
...
%>
<%
String actionStr1 = "com.integrosys.cms.ui.checklist.recurrentDoc.RecurrentDocCheckListAction";
...
--%>
    ...
    <logic:iterate id="OB" name="checkList" indexId="abcd"  property="checkListItemList" type="com.integrosys.cms.app.checklist.bus.ICheckListItem">
    <%
   
    index3++;
    System.out.println("::::::::::::::::::index3::NON DP::::"+abcd);
...
//            " OB.getShared()=" +OB.getShared() + "OB.getViewable=" + OB.getViewable() );
         ...
         %>
        <% 
        String id=String.valueOf(OB.getCheckListItemID());
        if(OB.getCheckListItemID()==-999999999){
        	id=String.valueOf(abcd);
        }
...
--%>
    ...
    <tbody>
    <logic:present name="checkList" property="checkListItemList">
    <logic:iterate id="OB" name="checkList" indexId="abc" property="checkListItemList" type="com.integrosys.cms.app.checklist.bus.ICheckListItem">
    <%	
    System.out.println("::::::::::::::::::index3:::DP:::"+abc);
    
    boolean isDP=false;
    	if(stockDocChkList.get(OB.getItemCode())!=null){
    		isDP=true;
    		if(OB.getCheckListItemID()==-999999999){
    			System.out.println("::::::::::::::::::index3:::DP in if :::"+abc);
    		++index3;
    		}
    	}
        String rowClass = "";
...
//            " OB.getShared()=" +OB.getShared() + "OB.getViewable=" + OB.getViewable() );
         ...
         %>
         <% 
        String id2=String.valueOf(OB.getCheckListItemID());
        if(OB.getCheckListItemID()==-999999999){
        	id2=String.valueOf(abc);
        }
        %>
            <input type="checkbox" name="check5" value="<%=id2%>"/>
            <% //}  %>
         <%--<% } %>--%>
        </td>
            <%--<td style="text-align:center" height="18" ><input name="removeID" type="checkbox" value="<%=(row-1)%>" /></td>--%>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <%} else {%>
            <td width="100" valign="baseline" align="center">
                <a href="RecurrentDocCheckList.do?event=list" onmouseout="MM_swapImgRestore()"   onmouseover="MM_swapImage('Image2','','img/cancel2.gif',1)">
