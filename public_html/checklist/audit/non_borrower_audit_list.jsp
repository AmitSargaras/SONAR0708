...
<table width="75" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td>        
        <a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img/print2.gif',1)"><img src="img/print2.gif" name="Image1" width="90" height="22" border="0" id="Image1" onclick="MM_openBrWindow('AuditCheckList.do?event=print_non_borrower_list','This_is_a_name','scrollbars=yes,toolbar=yes,menubar=yes,resizable=yes,width=760,height=400,left=5,top=5')"/></a>            
    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
