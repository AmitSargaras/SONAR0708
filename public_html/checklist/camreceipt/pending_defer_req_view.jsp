...
<%--  // cr 36
    ICheckListItem item = (ICheckListItem) session.getAttribute("com.integrosys.cms.ui.checklist.secreceipt.CAMReceiptAction.checkListItem");
...
<%@page import="com.integrosys.cms.ui.checklist.camreceipt.CAMReceiptForm"%><html><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<!--            </tr>-->
            <tr class="odd">
              <td class="fieldname">Defer to&nbsp;<font color="RED">* </font></td>
              <td>&nbsp;<bean:write name="CAMReceiptForm" property="deferDate" /></td>
            </tr>
            <%-- // cr 36 --%>
            <tr class="even">
              <td class="fieldname">Next Due Date</td>
              <td>&nbsp;<bean:write name="CAMReceiptForm" property="deferExtendedDate" /></td>
            </tr>
<%--            <tr class="odd">
