    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
            ...
            <% }else if(actionType.equals("RECEIVE")){ %>
            <tr class="even">
...
<table width="160" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
   <%
    ...
    <td width="100" valign="baseline" align="center"><a href="Annexure.do?event=edit_staging_checklist_item&custTypeTrxID=<%=custTypeTrxID %>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','img/cancel2.gif',0)"><img src="img/cancel1.gif" name="Image2"  border="0" id="Image2" /></a></td>
       <% } %>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
