...
<%
    ...
    List docList = (List) docsHeldMap.get(ICMSConstant.CHECKLIST_CO_BORROWER);
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblInfo">
  <tr class="odd"> 
    <td width="24%" class="fieldname">Co-Borrower Name</td>
    <td><integro:empty-if-null value="<%=docHeld.getLegalName()%>"/>&nbsp;</td>
  </tr>
  <tr class="even"> 
    <td class="fieldname"><bean:message key="label.customer.id"/></td>
    <td><%=docHeld.getLegalID()%></td>
  </tr>
</table>
<br>
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <tr> 
    <td> 
      <h3> Constitutional / Contractual Documents - Co-Borrower</h3>
    </td>
  </tr>
  <tr> 
    <td>
...
<%
	if (DocumentCheckListAction.EVENT_LIST_CO_BORROWER.equals(event)) {
%>
<table width="75" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td valign="top" ><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','img/print2.gif',1)" onclick="MM_openBrWindow('DocumentCheckList.do?event=print_co_borrower_list&checklist_id=<%=checkListIDStr%>','','scrollbars=yes,toolbar=yes,menubar=yes,resizable=yes,width=760,height=450,left=5,top=5')" ><img src="img/print1.gif" name="Image2" border="0" id="Image2" /></a></td>
  </tr>
  <tr> 
    <td valign="top" >&nbsp;</td>
  </tr>
