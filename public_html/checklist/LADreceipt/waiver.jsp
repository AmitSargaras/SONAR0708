...
<%
    ...
    List waiverCreditApproverList = (List)session.getAttribute("com.integrosys.cms.ui.checklist.LADreceipt.LADReceiptAction.waiverCreditApproverList");
...
function saveForm() {
	document.forms["LADReceiptForm"].event.value="save_waiver";
...
<html:hidden property="completedDate" />
