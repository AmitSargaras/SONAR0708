<%@ page import="com.integrosys.cms.app.limit.bus.ILimitProfile,
                 ...
                 java.util.*,
                 com.integrosys.cms.ui.checklist.secreceipt.OtherReceiptForm"%>
...
LADReceiptForm form = (LADReceiptForm)request.getAttribute("LADReceiptForm");
    ...
    ICheckListItem checkListItem =(ICheckListItem)session.getAttribute("com.integrosys.cms.ui.checklist.LADreceipt.LADReceiptAction.checkListItem");
    List deferCreditApproverList = (List)session.getAttribute("com.integrosys.cms.ui.checklist.LADreceipt.LADReceiptAction.deferCreditApproverList");
...
function saveForm() {
	document.forms["LADReceiptForm"].event.value="save_defer_req";
...
--%>
            <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="tblInput">
                ...
                <tr class="odd">
                    ...
                    <td><html:textarea name="LADReceiptForm" rows="5" cols="80" property="docRemarks" onkeyup="limitTextInput(this,1600,'Narration')"/><html:errors property="docRemarks" /></td>
                </tr>
                </tbody>
            </table>
