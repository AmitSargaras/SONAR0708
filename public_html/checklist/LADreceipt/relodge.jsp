...
function saveForm() {
	document.forms["SecurityReceiptForm"].event.value="save_relodge";
...
--%>
            ...
            <tr class="even">
                  <td class="fieldname">Date Lodged<font color="#0000FF">*</font></td>
                  <td><html:text property="lodgedDate" size="12" maxlength="12" readonly="true" />
                    <img src="img/calendara.gif"  name="Image11" border="0" id="Image1" onclick="return showCalendar('lodgedDate', 'dd/mm/y');" 
