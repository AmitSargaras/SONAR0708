...
function returnPage(num) {
    document.forms["LADReceiptForm"].event.value = "view_return";
...
--%>
            ...
            <tr class=<%=aa%> >
	            ...
	            <td>&nbsp;<bean:write name="LADReceiptForm" property="expectedReturnDate"/>
	            </td>
	            <% bb++; if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
	        </tr>
	         <tr class=<%=aa%>>
            ...
            <tr class=<%=aa%>>
              ...
              <% 	boolean isWaiver = false;
		        ...
		        <%if(isWaiver){ %>
		            ...
		            <td>&nbsp;<bean:write name="LADReceiptForm" property="waivedDate"/>
		            </td>
		            <% bb++; if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
		        </tr>
		        ...
		        <%if(isComplete){ %>
		            ...
		            <td>&nbsp;<bean:write name="LADReceiptForm" property="completedDate"/>
		            </td>
		            <% bb++; if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
		        </tr>
		        ...
		        <%if(received){ %>
		            ...
		            <td>&nbsp;<bean:write name="LADReceiptForm" property="receivedDate"/>
		            </td>
		            <% bb++; if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
		        </tr>	
		        <%} %>
        ...
        <% boolean tempUpliftedDate = false;
	        ...
	        <%if(tempUpliftedDate){ %>
	            ...
	            </td><td>&nbsp;<bean:write name="LADReceiptForm" property="tempUpliftedDate"/>
	            </td>
	            <% bb++; if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
	        </tr>	
	        <tr class=<%=aa%> >
	        ...
	        if (itemOb.getItemStatus().equals(ICMSConstant.STATE_PENDING_PERM_UPLIFT)||
		        ...
		        <%if(permUpliftedDate){ %>
		            ...
		            <td>&nbsp;<bean:write name="LADReceiptForm" property="permUpliftedDate"/> </td>
		            <% bb++; if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
		        </tr>
