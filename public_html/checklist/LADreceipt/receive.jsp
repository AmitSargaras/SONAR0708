<%@ page import="com.integrosys.cms.app.common.constant.ICMSConstant,
                 ...
                 com.integrosys.cms.ui.checklist.LADreceipt.LADReceiptForm" %>
...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function saveForm() {
            ...
            document.forms["LADReceiptForm"].event.value = "save_receive";
...
<%
	...
	ICheckList checkList = (ICheckList)session.getAttribute("com.integrosys.cms.ui.checklist.secreceipt.LADReceiptAction.checkList");
                ...
                <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" class="tblInput">
                    <tbody>
                        <tr class="even">
                            ...
                            <td><html:textarea name="LADReceiptForm" rows="5" cols="80" property="docRemarks"
