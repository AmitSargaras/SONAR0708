...
IFileUploadTrxValue trxValueOut=(IFileUploadTrxValue)session.getAttribute("com.integrosys.cms.ui.bulkudfupdateupload.BulkUDFUploadAction.trxValueOut");
	...
	if(errorList!=null)
		...
		List<BulkUDFError> finalList=(ArrayList)session.getAttribute("com.integrosys.cms.ui.bulkudfupdateupload.BulkUDFUploadAction.finalList");
...
<%@page import="com.integrosys.cms.ui.bulkudfupdateupload.BulkUDFError"%><head>
...
function goBack(){
	document.forms[0].action = "Bulkudfupload.do?event=csvupload";		
	document.forms[0].submit(); 
}
...
<thead>
   <%if(finalList.size()>=1){ %>
<h3>Bulk UDF Update Upload Error</h3>
<%}else{ %>
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
                     ...
                     <logic:iterate id="ob"  offset="<%=String.valueOf(startIndex)%>"  indexId="counter"  name="finalList" type="com.integrosys.cms.ui.bulkudfupdateupload.BulkUDFError" scope="page" length="100">
                     <%
					String rowClass = "";
					int i =0;
					if (rowCount % 2 != 0) {
