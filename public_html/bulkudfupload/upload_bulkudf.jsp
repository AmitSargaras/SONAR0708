...
<html>
	...
	<head>
		...
		function submitForm() {
 	document.forms[0].action="Bulkudfupload.do?event=bulkudfupload";
	...
	<html:form action="/Bulkudfupload" enctype="multipart/form-data">
		<body >
				...
				<tbody>
					<tr>
						<td valign="bottom" align="center">
							<html:file property="fileUpload" size="50"></html:file></br><html:errors property="bulkudfuploadError"/>
						</td>
					</tr>
					<%
