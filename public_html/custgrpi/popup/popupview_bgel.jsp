...
<table width="98%" border="0" cellpadding="0" cellspacing="0" class="tblInfo" align="center">
    <tbody>
        ...
        <tr class="odd">
            ...
            <td width="34%"><%=CustGrpIdentifierUIHelper.getCodeDesc(stagingObj.getGroupCurrency(), ICMSUIConstant.ISO_CUR)%>
                &nbsp;</td>
            <td class='fieldname'>
                <bean:message key="label.group.internal.limit"/><span class="mandatory"> * </span></td>
            <td><%=CustGrpIdentifierUIHelper.getCodeDesc(stagingObj.getInternalLmt(), ICMSUIConstant.INT_LMT_APPLY)%>
                &nbsp; </td>
        </tr>
        <tr class="even">
            <td class='fieldname'>
            ...
            <td>
                <% String lastReviewDt = UIUtil.mapOBDate_FormString(locale, stagingObj.getLastReviewDt()); %>
            ...
            <td>
                <%
                    ...
                    if (stagingObj.getGroupLmt() != null && stagingObj.getGroupLmt().getCurrencyCode() != null) {
                        groupLmt = UIUtil.formatNumber(stagingObj.getGroupLmt().getAmountAsBigDecimal(), 0, locale);
                    }
                %>
                <%=groupLmt%>&nbsp; </td>
        </tr>
