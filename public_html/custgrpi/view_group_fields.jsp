...
<html:hidden property="masterGroupInd" />
<html:hidden property="groupAccountMgrCode" />
<html:hidden property="groupTypeCD" />
<html:hidden property="countyCD" />
<html:hidden property="accountMgmtCD" />
...
<table width="98%" border="0" cellpadding="0" cellspacing="0" class="tblInfo" align="center">
        <tr class="odd">
            ...
            <td width="15%" class="fieldname"><bean:message key="label.group.name"/> <span class="mandatory"> * </span></td>
