...
List acknowledgmentList =(List) session.getAttribute("com.integrosys.cms.ui.acknowledgmentupload.AcknowledgmentUploadAction.List");
...
function submitPage(){
    ...
    document.forms[0].action="Acknowledgmentupload.do?event=maker_close_acknowledgment_file";
