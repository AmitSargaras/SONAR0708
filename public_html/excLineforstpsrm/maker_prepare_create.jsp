...
function cancelPage(){
    document.forms[0].action="ExcLineForSTPSRM.do?event=maker_list";
	document.forms[0].submit();
	newShowSilkScreen();
}

function submitForm() {
		document.forms[0].action = "ExcLineForSTPSRM.do?event=maker_create";
		document.forms[0].submit();
		newShowSilkScreen();
}

function saveForm() {
		document.forms[0].action = "ExcLineForSTPSRM.do?event=maker_draft";
		document.forms[0].submit();
		newShowSilkScreen();
}
</script>
...
<html:form action='ExcLineForSTPSRM.do'>
	...
	<body>
		<table width="70%" border="0" align="center" cellpadding="0"
			...
			<thead>
				<tr>
					<td>
						<h3>Add Exclusion line for STP of SRM</h3>
					</td>
				</tr>
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								<tr class="odd">
				                  ...
				                  <td width="20%">
				                  	<html:select property="lineCode">
										<html:option value="">Please Select</html:option>
										<html:options name="lineNoList"/>
									</html:select>
				                  	<br><html:errors property="lineCode"/>
				                  </td>
	...
	<script>
		<%if("Y".equals(isNew)){%>
			document.all.excluded.checked=true;
		<%}%>
	</script>
</html:form>
</html>