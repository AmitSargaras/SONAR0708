...
XRefDetailForm value = (XRefDetailForm) request.getAttribute("XRefDetailForm");
	...
	System.out.println("udf allowed "+value.getUdfAllowed());
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<jsp:include page="hidden_release_line_detail_edit.jsp"></jsp:include>
		<%if("edit_udf_2".equals(editTab)){%>
	<udf:udfDisplay2 module="4" action="add" refId="<%=value.getUdfAllowed_2()%>" refId2="<%=value.getUdfAllowed()%>"/>
	<%} else{ %>
	<udf:udfDisplay module="3" action="add" refId="<%=value.getUdfAllowed()%>" refId2="<%=value.getUdfAllowed_2()%>"/>
	<%} %>
</body>
