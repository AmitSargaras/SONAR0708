		...
		<tr>
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<tr align="left">
						<td width="25%" colspan="1"><input onclick="javascript : showDetail('close_summary_details')"
							name="AddNew12" type="button" id="AddNew12" value="Summary Details"
							class="btnNormal" />&nbsp;&nbsp;  
						<input onclick="javascript : showDetail('close_financial_details')"
							name="AddNew12" type="button" id="AddNew12" value="Financial Details"
							class="btnNormal" />&nbsp;&nbsp; 
						<input onclick="javascript : showDetail('close_cri_details')"
							name="AddNew12" type="button" id="AddNew12" value="CRI Details"
							class="btnNormal" />&nbsp;&nbsp; 
					<input onclick="javascript : showDetail('close_cibil_details')"
							name="AddNew12" type="button" id="AddNew12" value="CIBIL"
							class="btnNormal" />
						<input onclick="javascript : showDetail('close_udf_details')"
							name="AddNew12" type="button" id="AddNew12" value="User Defined Fields (UDF)"
							class="btnNormal" />
						<input onclick="javascript : showDetail('close_banking_method_details')"
					...
					<tr>
					<td>
						<% if(event.equals("close_financial_details") ){ %>		
						    <jsp:include page="close_financial_details.jsp"></jsp:include>
						<%} else if(event.equals("close_cri_details")){ %>
						    <jsp:include page="close_cri_details.jsp"></jsp:include>
						<%} else if(event.equals("close_cibil_details")){ %>
						    <jsp:include page="close_cibil_details.jsp"></jsp:include>	
						<%} else if(event.equals("close_udf_details")){ %>
						    <jsp:include page="close_udf_details.jsp"></jsp:include>	
						<%} else if(event.equals("close_banking_method_details") ){ %>		
					    <jsp:include page="close_banking_method_details.jsp"></jsp:include>
					<%} else { %>			
					    <jsp:include page="close_summary_details.jsp"></jsp:include>
					<%} %>
					</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
					<td align="center">
					<%if(event.equals("close_cibil_details")) {%>	
			<%if(trx.getToState().equals("DRAFT")) {%>
			<a href="javascript:submitForm('maker_close_draft_customer');"
				onmouseout="MM_swapImgRestore()"
				onmouseover="MM_swapImage('Image3311','','img/close2a.gif',1)">
			<img src="img/close1a.gif" name="Image3311" border="0" id="Image3311" />
			</a>&nbsp;
			<%}else { %>
			<a href="javascript:submitForm('close_page');"
				onmouseout="MM_swapImgRestore()"
				onmouseover="MM_swapImage('Image3311','','img/close2a.gif',1)">
			<img src="img/close1a.gif" name="Image3311" border="0" id="Image3311" />
			</a>&nbsp;
			...
			<%}else{ %>
					...
					&nbsp;
					<%if(event.equals("prepare_close_page")||event.equals("close_summary_details") || event.equals("maker_save_close")){ %>
					<a href="javascript:nextPage('close_financial_details');"
						onmouseout="MM_swapImgRestore()"
						onmouseover="MM_swapImage('Image4411','','img/next2.gif',1)"><img
						src="img/next1.gif" name="Image4411" border="0" id="Image4411" />
					</a>
					
					<%}else if(event.equals("close_financial_details") ){ %>
					<a href="javascript:nextPage('close_cri_details');"
						onmouseout="MM_swapImgRestore()"
						onmouseover="MM_swapImage('Image4411','','img/next2.gif',1)"><img
						src="img/next1.gif" name="Image4411" border="0" id="Image4411" />
					</a>
					...
					<%}else if(event.equals("close_cri_details")){ %>
					<a href="javascript:nextPage('close_cibil_details');"
						onmouseout="MM_swapImgRestore()"
						onmouseover="MM_swapImage('Image4411','','img/next2.gif',1)"><img
						src="img/next1.gif" name="Image4411" border="0" id="Image4411" />
					</a>
					...
					<%}else if(event.equals("close_udf_details")){ %>
					<a href="javascript:showDetail('close_banking_method_details');"
						onmouseout="MM_swapImgRestore()"
						onmouseover="MM_swapImage('Image4411','','img/next2.gif',1)"><img
						src="img/next1.gif" name="Image4411" border="0" id="Image4411" />
					</a>
