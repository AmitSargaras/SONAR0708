    ...
    <tr>
      <td width="100%" valign="bottom">
        <table width="100%"  border="0" align="right" cellpadding="0" cellspacing="0">
           <tr>
    <td width="100%">      
      <h3>delete Other / Relationship Details</h3>
      <hr />
                ...
                <tbody>
                  ...
                  <tr class="even">
                    ...
                    <td width="30%"><html:text property="directorPan" size="30"
											maxlength="20" value="<%=OB.getDirectorPan()%>"></html:text>&nbsp;</td>
                  ...
                  <tr class="odd">
                    ...
                    <td width="30%"><html:text property="businessEntityName" size="30"
											maxlength="20" value="<%=OB.getBusinessEntityName()%>"></html:text>&nbsp;</td>
                  ...
                  <tr class="odd">
                    ...
                    <td><html:text property="dirStdCodeTelex" size="3"
											maxlength="3" value="<%=OB.getDirStdCodeTelNo()%>"></html:text>
                     <html:text property="directorTelNo" size="30"
											maxlength="20" value="<%=OB.getDirectorTelNo()%>"></html:text>&nbsp;</td>
                    <td class="fieldname">Fax No.</td>
                    <td><html:text property="dirStdCodeTelex" size="3"
											maxlength="3" value="<%=OB.getDirStdCodeTelex()%>"></html:text>
                      <html:text property="directorFax" size="30"
											maxlength="20" value="<%=OB.getDirectorFax()%>"></html:text>&nbsp;</td>
                  </tr>
                  <tr class="even">
                    <td class="fieldname">Email</td>
                    <td><html:text property="directorEmail" size="30"
											maxlength="20" value="<%=OB.getDirectorEmail()%>"></html:text>&nbsp;</td>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <tr>    
   <%if(event.equals("delete_director")){ %>  
      <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/delete1.gif',1)">
     		<img src="img/delete1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:saveOtherSystem('confirm_delete_director')"/></a>
      	...
      	<%}else if(event.equals("delete_director_in_edit")){ %>
      	<td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/delete1.gif',1)">
     		<img src="img/delete1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:saveOtherSystem('confirm_delete_director_in_edit')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
     		<img src="img/cancel1.gif" name="ImageCancel" width="70" height="20" border="0" id="ImageCancel" onclick="returnPage('edit_summary_details')"/></a>	        	
      	 	...
      	 	<%}else if(event.equals("delete_director_in_resubmit")){ %>
      	<td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/delete1.gif',1)">
     		<img src="img/delete1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:saveOtherSystem('confirm_delete_director_in_resubmit')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
