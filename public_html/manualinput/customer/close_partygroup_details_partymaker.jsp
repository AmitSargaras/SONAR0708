			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<td>
					    ...
					    <jsp:include page="close_summary_details_partymaker.jsp"></jsp:include>
