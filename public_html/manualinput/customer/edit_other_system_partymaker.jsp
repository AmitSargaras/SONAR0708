...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <tr>      
      <%if(event.equals("edit_system_partymaker")){ %>
      
      <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/save1.gif',1)">
     		<img src="img/save1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:editOtherSystem('save_edited_system_partymaker')"/></a>
      ...
      <%}else if(event.equals("edit_system_in_edit_partymaker")){ %>
      <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/save1.gif',1)">
     		<img src="img/save1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:editOtherSystem('save_edited_system_in_edit_partymaker')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
      ...
      <%} else if(event.equals("edit_system_in_resubmit_partymaker")){ %>
      <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/save1.gif',1)">
     		<img src="img/save1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:editOtherSystem('save_edited_system_in_resubmit_partymaker')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
