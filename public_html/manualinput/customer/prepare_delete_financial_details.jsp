				...
				<table width="100%" height="100%" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<%if(value.getBankingMethod().equals("MULTIPLE") ||value.getBankingMethod().equals("CONSORTIUM")) {%>
							<br><html:errors property="nodalLeadError"/>
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
										...
										<logic:iterate id="ob" name="otherBankList"
											...
											if(value.getNodalLead()!=null && !value.getNodalLead().equals(""))
											{
			                                   ...
			                                   if (value.getNodalLead().startsWith("s") && Long.toString(ob.getBankId()).equals(bankId)) {%>
												<input type="radio"  id="nodalLead"  name="nodalLead" value="<%="s"+","+ob.getBankId()%>" checked="checked">
										<%}else{ %>
										<input type="radio"  id="nodalLead"  name="nodalLead" value="<%="s"+","+ob.getBankId()%>">
										<%} %>
											<%}else{ %>
											<input type="radio"  id="nodalLead"  name="nodalLead" value="<%="s"+","+ob.getBankId()%>">
											<%} %>
                                        ...
                                        <select id="actionDelete<%=no%>"
											...
											if(value.getNodalLead()!=null && !value.getNodalLead().equals(""))
											{
			                                   ...
			                                   if (value.getNodalLead().startsWith("o") && Long.toString(ob.getBankId()).equals(bankId)) {%>
												<input type="radio"  id="nodalLead"  name="nodalLead" value="<%="o"+","+ob.getBankId() %>" checked="checked">
												<%}else{ %>
													<input type="radio"  id="nodalLead"  name="nodalLead" value="<%="o"+","+ob.getBankId() %>">
												<%} %>
												<%}else{ %>
												<input type="radio"  id="nodalLead"  name="nodalLead" value="<%="o"+","+ob.getBankId() %>">
												<%} %>
