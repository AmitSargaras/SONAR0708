...
<html:form action="ManualInputCustomer.do?event=list_customers&legalSource=ARBS" >
<body>
        ...
        <table class="tblInput" id="custsearch" style="margin-top:25px" width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tbody>
           <tr class="odd">
              ...
              <td width="48%">
             <html:text property="customerNameShort" maxlength="100" />  &nbsp;
              <html:errors property="customerShortName"/>
              ...
              <tr class="even">
							...
							<td> <input onclick="submitPage(2)" name="AddNew" type="submit" id="AddNew" value="Go"
                ...
                <td width="48%">
                 <html:select property="systemName">
                           <integro:common-code
										 ...
										 <html:errors property="systemName"/>
              <br>
              <html:text property="systemId" maxlength="30" /> 
              	<html:errors property="systemId" />
              </td>
                <td rowspan="2">
              	<input onclick="submitPage(3)" name="AddNew" type="submit" id="AddNew" value="Go"  class="btnNormal" style="margin-right:5px;margin-left:10;width:50px" />
              </td> 
            </tr>
