...
function rejectForm() {
	...
	document.forms[0].event.value = "checker_reject_create_customer_brchecker";
    document.forms[0].submit();
...
function submitForm() {
	document.forms[0].action = "ManualInputCustomer.do";
	document.forms[0].event.value = "checker_approve_create_customer_brchecker";
    document.forms[0].submit();
}
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<td>
					    ...
					    <jsp:include page="create_checker_summary_details_brchecker.jsp"></jsp:include>
