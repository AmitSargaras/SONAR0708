...
function saveCustomerForm() {
	...
	document.forms[0].action="ManualInputCustomer.do?event=save_customer_in_edit_partymaker";
    document.forms[0].submit();
...
function submitForm() {
	document.forms[0].action="ManualInputCustomer.do?event=edit_customer_partymaker";
    document.forms[0].submit();
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<td>
					    ...
					    <jsp:include page="edit_summary_details_partymaker.jsp"></jsp:include>
