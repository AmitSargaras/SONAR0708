...
function deleteOtherSystem(name) 
{	
	document.forms[0].action = "ManualInputCustomer.do";
    document.forms[0].event.value = name;
    document.forms[0].submit();
        ...
        <tbody>   
          <tr>            
            ...
            <td><br />
              ...
              <td width="20%" class="fieldname" >System ID<span class="style11"></span></td>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <tr>  
    ...
    <%if(event.equals("delete_system_partymaker")){ %>    
      <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/delete1.gif',1)">
     		<img src="img/delete1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:deleteOtherSystem('system_deleted_partymaker')"/></a>
        ...
        <%}else if(event.equals("delete_system_in_edit_partymaker")){ %>
         <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/delete1.gif',1)">
     		<img src="img/delete1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:deleteOtherSystem('system_deleted_in_edit_partymaker')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
         ...
         <%} else if(event.equals("delete_system_in_resubmit_partymaker")){ %>
         <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/delete1.gif',1)">
     		<img src="img/delete1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:deleteOtherSystem('system_deleted_in_resubmit_partymaker')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
