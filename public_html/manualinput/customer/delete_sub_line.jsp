...
<%
	...
	if (partyGrpList != null) {
		...
		pageContext.setAttribute("partyList", partyGrpList);
	}
	else
...
function deletePartyGroup(name) 
{	
	document.forms[0].action = "ManualInputCustomer.do";
    document.forms[0].event.value = name;
    document.forms[0].submit();
		...
		<thead>
			<tr>
				...
				<table width="100%" border="0" align="right" cellpadding="0"
					...
					<tr>
						<td width="100%">
						<h3>Delete SubLine Details <%=event %></h3>
						<hr />
							...
							<tbody>
								<tr>
									...
									<table class="tblInput" id="backEdit2" width="100%" border="0"
										...
										<tbody>
											<tr class="even">
												<td width="20%" class="fieldname">Party Name</td>
												...
												<logic:present
													...
													<logic:iterate id="OB" name="partyList"
														...
														<input type="text" value="<%=OB.getPartyGroup().getCustomerName()%>"></input>
												...
												<td width="20%"><html:text property="amount"
													size="30" maxlength="30"></html:text>&nbsp;</td>
											</tr>
									</table>
									</td>
								</tr>
						...
						<table width="150" border="0" align="center" cellpadding="0"
							...
							<tr>
							 <%if(event.equals("delete_subline_party")){ %>
								<td align="center"><a href="#"
									onmouseout="MM_swapImgRestore()"
									onmouseover="MM_swapImage('ImageSave','','img/delete1.gif',1)">
								<img src="img/delete1.gif" name="ImageSave" width="70" height="20"
									border="0" id="ImageSave"
									onclick="javascript:deletePartyGroup('confirm_delete_party_group')" /></a> <a href="#"
									onmouseout="MM_swapImgRestore()"
								...
								<img src="img/cancel1.gif" name="ImageCancel" width="70"
								  ...
								  <%}else if(event.equals("delete_subline_party_in_edit")){ %>
								  <td align="center"><a href="#"
									onmouseout="MM_swapImgRestore()"
									onmouseover="MM_swapImage('ImageSave','','img/delete1.gif',1)">
								<img src="img/delete1.gif" name="ImageSave" width="70" height="20"
									border="0" id="ImageSave"
									onclick="javascript:deletePartyGroup('confirm_delete_party_group_in_edit')" /></a> <a href="#"
									onmouseout="MM_swapImgRestore()"
									onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
								<img src="img/cancel1.gif" name="ImageCancel" width="70"
									height="20" border="0" id="ImageCancel" onclick="returnPage('edit_financial_details')" /></a>
								</td>
								   <%}else if(event.equals("delete_subline_party_in_resubmit")){ %>
								  <td align="center"><a href="#"
									onmouseout="MM_swapImgRestore()"
									onmouseover="MM_swapImage('ImageSave','','img/delete1.gif',1)">
								<img src="img/delete1.gif" name="ImageSave" width="70" height="20"
									border="0" id="ImageSave"
									onclick="javascript:deletePartyGroup('confirm_delete_party_group_in_resubmit')" /></a> <a href="#"
									onmouseout="MM_swapImgRestore()"
									onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
								<img src="img/cancel1.gif" name="ImageCancel" width="70"
