...
<%@ page
	...
	com.integrosys.cms.app.customer.trx.ICMSCustomerTrxValue,com.integrosys.cms.app.common.constant.ICMSConstant,com.integrosys.base.uiinfra.common.ICommonEventConstant,com.integrosys.cms.ui.login.CMSGlobalSessionConstant,com.integrosys.cms.ui.bizstructure.MaintainTeamUtil,com.integrosys.component.user.app.bus.CommonUserSearchCriteria,java.util.List,java.util.Vector"%>
...
function addCriFacilityList(){
	document.forms[0].action="ManualInputCustomer.do?event=process_cri_fac_list";
...
function getActionFac(ind, value) {
	 ...
	 if(value =="Remove"){
		 alert(ind+" "+value);
		document.forms[0].action = "ManualInputCustomer.do?event=process_remove_cri_fac&index="+ind;		
   	document.forms[0].submit();
	}	   
}
//-->
...
<table width="100%" height="100%" cellspacing="0" cellpadding="0"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tbody>
							...
							<tr class="even">
								...
								<td width="30%"><html:text property="customerRamID" styleId="customerRamID" maxlength="20"  value="<%=formObj.getCustomerRamID()%>">
								</html:text><html:errors property="customerRamID"/></td>
							</tr>
							<tr class="odd">
								<td class="fieldname" width="20%">Customer APR Code</td>
								<td width="30%"><html:text property="customerAprCode" styleId="customerAprCode"
									 maxlength="10" value="<%=formObj.getCustomerAprCode()%>" ></html:text><html:errors property="customerAprCode"/></td>
								<td class="fieldname" width="20%">Customer External Rating</td>
								<td width="30%"><html:textarea property="customerExtRating" styleId="customerExtRating" rows="5" cols="50" ></html:textarea>
									<html:errors property="customerExtRatingLengthError"/>
								<html:errors property="customerExtRating"/>
							...
							<tr class="odd">
								...
								<td>
								<html:text property="customerFyClouser" value ="<%=yearEndPeriodValue%>" style="width:225" readonly="true">
							
								<html:hidden property="customerFyClouser"/>
								</html:text><html:errors property="customerFyClouserError"/></td>
								     <td></td>
									</tr>
							<tr class="even">
								<td class="fieldname">NBFC</td>
								<td><html:radio property="isNbfs" styleId="isNbfs" value="Yes" onclick="showHideNbfs();"/> Yes 
								<html:radio property="isNbfs" styleId="isNbfs" value="No" onclick="showHideNbfs();"/> No &nbsp;
								...
								<td>
								<p><html:select property="nbfsA" styleId="nbfsA" style="width:225" >
									<integro:common-code categoryCode="<%=CategoryCodeConstant.CommonCode_NBFC_A%>"
									descWithCode="false" />
								</html:select><html:errors property="nbfsA"/></p>
								<p><html:select property="nbfsB" styleId="nbfsB" style="width:225">
									<integro:common-code categoryCode="<%=CategoryCodeConstant.CommonCode_NBFC_B%>"
									descWithCode="false" />
								</html:select><html:errors property="nbfsB"/></p>
								</td>
							</tr>
							<tr class="odd">
								...
								<!--<html:text property="groupExposer" size="30" maxlength="23" ></html:text>
								--></td>
								<td class="fieldname">MSME Classification</td>
								<td><html:select property="msmeClassification" styleId="msmeClassification" style="width:225">
							...
							<tr class="even">
								...
								<p><html:select property="weakerSection" styleId="weakerSection"  style="width:225">
									<integro:common-code categoryCode="<%=CategoryCodeConstant.CommonCode_WEAKER_SEC%>"
									descWithCode="false" />
								</html:select><html:errors property="weakerSection"/></p>
								<p><html:text property="govtSchemeType" styleId="govtSchemeType" />
								<html:errors property="govtSchemeType"/></p>
								</td>
							</tr>
							...
							<tr class="odd">
								...
								<td>
								<p><html:radio property="isMinorityCommunity" styleId="isMinorityCommunity" value="Yes" onclick="showHideMinorityCommunity()"/> Yes 
								<html:radio property="isMinorityCommunity" styleId="isMinorityCommunity" value="No" onclick="showHideMinorityCommunity()" /> No  &nbsp;
							...
							<tr class="odd">
								...
								<td><html:radio property="isSensitive" styleId="isSensitive" value="Yes" onclick="showHideSensitive()" /> Yes 
								<html:radio property="isSensitive" styleId="isSensitive" value="No" onclick="showHideSensitive()" /> No  &nbsp;
							...
							<tr class="odd">
								...
								<td>
								<p>
								<html:radio property="psu" styleId="psu" value="State" onclick="showHidePsu();"/> State 
								<html:radio property="psu" styleId="psu" value="Central" onclick="showHidePsu();"/> Central 
								<html:radio property="psu" styleId="psu" value="No" onclick="showHidePsu();"/> No <html:errors property="psu"/>
								</p>
								</td>
							...
							<tr class="even">
								...
								<td><html:radio property="govtUnderTaking" styleId="govtUnderTaking" value="State" /> State 
								<html:radio property="govtUnderTaking" styleId="govtUnderTaking" value="Central" /> Central 
								<html:radio property="govtUnderTaking" styleId="govtUnderTaking" value="No" /> No 
							...
							<tr class="odd">
								...
								<td><html:radio property="isSemsGuideApplicable" styleId="isSemsGuideApplicable" value="Yes" /> Yes 
								<html:radio property="isSemsGuideApplicable" styleId="isSemsGuideApplicable" value="No" /> No 
								<html:errors property="isSemsGuideApplicable"/>
								</td>
								<td class="fieldname">Whether fails under IFC&rsquo;s
								Exclusion List</td>
								<td><html:radio property="isFailIfcExcluList" styleId="isFailIfcExcluList" value="Yes" /> Yes 
								<html:radio property="isFailIfcExcluList" styleId="isFailIfcExcluList" value="No" /> No 
							...
							<tr class="even">
								...
								<td>
								<html:radio property="isTufs" styleId="isTufs" value="Yes" onclick="changeSubsidy('Yes');"/> Yes 
								<html:radio property="isTufs" styleId="isTufs" value="No" onclick="changeSubsidy('No');"/> No 
							...
							<tr class="odd">
								...
								<html:text property="litigationBy" styleId="litigationBy" /><html:errors property="litigationBy"/>
								</td>
							...
							<tr class="even">
								...
								<td>
								<html:radio property="auditType" styleId="auditType" value="Internal Audit" /> Internal Audit 
								<html:radio property="auditType" styleId="auditType" value="External Audit" /> External Audit
								<html:radio property="auditType" styleId="auditType" value="RBI Audit" /> RBI Audit
							...
							<tr class="even">
								...
								<td><html:text property="industryExposer" styleId="industryExposer" maxlength="7"/><html:errors property="industryExposer"/></td>
							</tr>
							<tr class="odd">
							...
							<%if(!trx.getFromState().equals("PENDING_PERFECTION") && !trx.getFromState().equals("PENDING_CREATE")) {%>
							<tr class="odd">
							...
							<tr class="odd">
								<td class="fieldname">Infrastructure Finance</td>
								<td>
								<html:radio property="isInfrastructureFinanace" styleId="isInfrastructureFinanace" value="Yes" disabled="true"  onclick="showHideInfrastructureFinanace();showHideButtion();" /> Yes 
								<html:radio property="isInfrastructureFinanace" styleId="isInfrastructureFinanace" value="No" disabled="true"  onclick="showHideInfrastructureFinanace();showHideButtion();" /> No 
								<html:errors property="isInfrastructureFinanace"/>
								</td>
								<td class="fieldname">
								<p>Type</p>
							...
							<tr class="even">
								<td class="fieldname">Project Finance</td>
								<td>
								<html:radio property="isProjectFinance" styleId="isProjectFinance" value="Yes" disabled="true"  onclick="showHideButtion();" /> Yes 
								<html:radio property="isProjectFinance" styleId="isProjectFinance" value="No"  disabled="true" onclick="showHideButtion();" /> No 
								<html:errors property="isProjectFinance"/>
								</td>
								<td class="fieldname">Kisan Credit Card(KCC)</td>
								<td>
								<html:radio property="isKisanCreditCard" styleId="isKisanCreditCard" value="Yes" disabled="true"  onclick="showHideButtion();" /> Yes 
								<html:radio property="isKisanCreditCard" styleId="isKisanCreditCard" value="No" disabled="true"  onclick="showHideButtion();" /> No 
								<html:errors property="isKisanCreditCard"/>
								</td>
							</tr>
							<%} %>
							...
							<tr class="even">
								<td class="fieldname">Permanent SSI Cert</td>
								<td>
								<html:radio property="isPermenentSsiCert" styleId="isPermenentSsiCert" value="Yes"  disabled="true"  onclick="showHideButtion();" /> Yes 
								<html:radio property="isPermenentSsiCert" styleId="isPermenentSsiCert" value="No" disabled="true"  onclick="showHideButtion();" /> No 
								<html:errors property="isPermenentSsiCert"/>
								</td>
								<td class="fieldname">Backed by Govt. </td>
								<td>
								<html:radio property="isBackedByGovt" styleId="isBackedByGovt" value="State" disabled="true"   onclick="showHideButtion();" /> State 
								<html:radio property="isBackedByGovt" styleId="isBackedByGovt" value="Central" disabled="true"  onclick="showHideButtion();" /> Central 
								<html:radio property="isBackedByGovt" styleId="isBackedByGovt" value="No" disabled="true"  onclick="showHideButtion();" /> No 
								<html:errors property="isBackedByGovt"/>
								</td>
							</tr>
							<%} %>
							<%if(!trx.getFromState().equals("PENDING_PERFECTION") && !trx.getFromState().equals("PENDING_CREATE")) {%>
							<tr class="even">
								<td class="fieldname">Priority/Non priority Sector <%=trx.getFromState() %></td>
								<td>
							...
							<tr class="even">
								...
								<td>
								<html:radio property="isPrioritySector" styleId="isPrioritySector" value="Yes" disabled="true" onclick="showHideButtion();" /> Yes 
								<html:radio property="isPrioritySector" styleId="isPrioritySector" value="No" disabled="true" onclick="showHideButtion();" /> No 
								<html:errors property="isPrioritySector"/>
								</td>
								<td class="fieldname">Capital Market Exposure</td>
								<td>
								<html:radio property="isCapitalMarketExpos" styleId="isCapitalMarketExpos" value="Yes" disabled="true" onclick="showHideButtion();" /> Yes 
								<html:radio property="isCapitalMarketExpos" styleId="isCapitalMarketExpos" value="No" disabled="true"  onclick="showHideButtion();" /> No 
								<html:errors property="isCapitalMarketExpos"/>
								</td>
							</tr>
							<%} %>
							...
							<tr class="even">
								...
								<td class="fieldname">Real Estate Exposure</td>
								<td>
								<html:radio property="isRealEstateExpos" styleId="isRealEstateExpos" value="Yes" disabled="true"   onclick="showHideButtion();" /> Yes 
								<html:radio property="isRealEstateExpos" styleId="isRealEstateExpos" value="No" disabled="true"  onclick="showHideButtion();" /> No 
								<html:errors property="isRealEstateExpos"/>
								</td>
								<td class="fieldname">&nbsp; </td>
								<td>&nbsp;	</td>
							...
							<html:select name="ManualInputCustomerInfoForm"
											property="firstYear" styleId="firstYear" style="width:250px">
                  		...
                  		<html:select property="firstYearTurnoverCurr" value="INR" styleId="firstYearTurnoverCurr">
                  		<html:options collection="currencyList" property="value" labelProperty="label"/>
                    </html:select>
                  <%}else{ 
                  
                  %>
                  		<html:select property="firstYearTurnoverCurr" styleId="firstYearTurnoverCurr" value="<%=formObj.getFirstYearTurnoverCurr().trim()%>" >
                  		<html:options collection="currencyList" property="value" labelProperty="label"/>
                    </html:select>
                  <%} %>
                   ...
                   <br></br> <html:errors property="firstYearTurnover"/>
							...
							<html:select name="ManualInputCustomerInfoForm"
											property="secondYear" styleId="secondYear" style="width:250px">
											<integro:common-code descWithCode="false"
												categoryCode="<%=CategoryCodeConstant.CRI_TENURE_YEAR%>"
												refEntryCode='<%=request.getParameter("newCollateralMainType") %>' />
										</html:select>
	...
	<html:text property="secondYearTurnover" styleId="secondYearTurnover" onblur="javascript:formatAmountAsCommaSeparated(this)"/>&nbsp; 
                  		...
                  		<html:select property="secondYearTurnoverCurr" value="INR" styleId="secondYearTurnoverCurr">
                  		<html:options collection="currencyList" property="value" labelProperty="label"/>
                    </html:select>
                  <%}else{ 
                 
                  %>
                  		<html:select property="secondYearTurnoverCurr" styleId="secondYearTurnoverCurr" value="<%=formObj.getSecondYearTurnoverCurr().trim()%>" >
                  		<html:options collection="currencyList" property="value" labelProperty="label"/>
                    </html:select>
                  <%} %>
					 <br></br> <html:errors property="secondYearTurnover"/>
                  		...
                  		<html:select property="thirdYearTurnoverCurr" value="INR" styleId="thirdYearTurnoverCurr" >
                  		<html:options collection="currencyList" property="value" labelProperty="label"/>
                    </html:select>
                  <%}else{ 
                  
                  %>
                  		<html:select property="thirdYearTurnoverCurr" styleId="thirdYearTurnoverCurr" value="<%=formObj.getThirdYearTurnoverCurr().trim()%>" >
                  		<html:options collection="currencyList" property="value" labelProperty="label"/>
                    </html:select>
                  <%} %>
					<br></br>  <html:errors property="thirdYearTurnover"/>
									...
									<tr class="even">
										...
										<td><html:radio property="financeForAccquisition"    styleId="financeForAccquisition" value="Yes"
											onclick="enableTag('facilityApproved','facilityAmount','securityName','securityType','securityValue');" />
											Yes <html:radio property="financeForAccquisition"   styleId="financeForAccquisition"
										...
										<td><html:select property="facilityApproved"
											...
											<html:options collection="facNameList" labelProperty="label"
												...
												<p>Rs</p>
											</html:text>	<html:errors property="facilityAmount" /> </br> </br> </br> <html:select property="securityName" style="width:225"
												styleId="securityName" disabled="true"  onchange="refreshSubType(this);">
															 			<option value="">Please Select</option>
											...
											<integro:common-code categoryCode="<%=CategoryCodeConstant.COMMON_CODE_SECURITY_TYPE %>" descWithCode="false" />
												...
												<html:errors property="securityValue" />
											</td>
									...
									<tr class="even">
										...
										<td><html:radio property="ifBreachWithPrescriptions"
												...
												onclick="enableTag('comments');" /> Yes 
												<html:radio
												property="ifBreachWithPrescriptions"
												styleId="ifBreachWithPrescriptions" value="No"
												onclick="disableTag('comments');" /> No &nbsp; 
												<html:errors
												property="isWeakerSection" /></td>
										<td class="fieldname">
											<p>Please Provide details and comments there on</p>
										<td><html:textarea property="comments" rows="3" cols="50" styleId="comments"
												value="<%=formObj.getComments()%>">
											</html:textarea>
									...
									<tr class="odd">
										...
										<td><html:radio
												property="isInRestrictedList" value="Yes" styleId="isInRestrictedList"
												onclick="enableTag('restrictedFinancing');" /> Yes 
												
												<html:radio
												 property="isInRestrictedList" styleId="isInRestrictedList"
												value="No" onclick="disableTag('restrictedFinancing');" /> No &nbsp;
											<html:errors property="isWeakerSection" /> <html:select
												property="restrictedFinancing"  styleId="restrictedFinancing" value="<%=formObj.getRestrictedFinancing().trim()%>"	style="width:225" >
												<integro:common-code
										...
										<td>	<html:radio 
												property="restrictedIndustries" value="Yes" styleId="restrictedIndustries"
												onclick="enableTag('restrictedListIndustries');" /> Yes
												
												 	<html:radio
												property="restrictedIndustries"  styleId="restrictedIndustries"
												value="No" onclick="disableTag('restrictedListIndustries');" /> No &nbsp;
									...
									<tr class="odd">
										...
										<td><html:textarea property="rejectHistoryReason" styleId="rejectHistoryReason"
												rows="3" cols="50" value="<%=formObj.getRejectHistoryReason() %>">
											</html:textarea>
									...
									<tr class="even">
										...
										<td><html:select  property="facility" style="width:225" styleId="facility">
										
											 			<option value="">Please Select</option>
											<html:options collection="facNameList" labelProperty="label"
												property="value" /> 
											</html:select> </br> </br> </br> <html:text  property="limitAmount" maxlength="20" styleId="limitAmount">
									...
									<tr class="odd">
										...
										<td><html:radio property="conductOfAccountWithOtherBanks"
												styleId="conductOfAccountWithOtherBanks" value="Satisfactory"
												onclick="disableTag('crilicStatus','comment');" /> Satisfactory <html:radio
												property="conductOfAccountWithOtherBanks"
												styleId="conductOfAccountWithOtherBanks" value="classified"
												onclick="enableTag('crilicStatus');" /> Classified</td>
				...
				<tr>
					...
					<input onclick="javascript : addCriFacilityList()"
								...
								value="Attach Facility Details" class="btnNormal" />
					</td>
				</tr>
				<tr>
					<td colspan="2">
	...
	//A Shiv 230811 Commented By Dayananda Laishram For IE 11 Compatibility Changes-->
...
%>
	<%
	if (formObj.getIndirectCountryRiskExposure() == null || formObj.getIndirectCountryRiskExposure().equals("") || formObj.getIndirectCountryRiskExposure().equals("No") ) {
%>
<script language="javascript">
	document.all.indirectCountryRiskExposure[1].checked = true;
	document.getElementById('criCountryName').disabled = true;
...
<%if(formObj.getIsInRestrictedList() ==null || formObj.getIsInRestrictedList().equals("") ) {%>
<script language="javascript">
	document.all.isInRestrictedList[1].checked = true;
</script>
<%} %>
...
<% }%>
	<% if((formObj.getIsBackedByGovt() != null && (formObj.getIsBackedByGovt().equals("Central") || formObj.getIsBackedByGovt().equals("State")))
			...
			|| (formObj.getIsPrioritySector() != null && formObj.getIsPrioritySector().equals("Yes"))
			|| (formObj.getIsCapitalMarketExpos() != null && formObj.getIsCapitalMarketExpos().equals("Yes"))
			|| (formObj.getIsRealEstateExpos() != null && formObj.getIsRealEstateExpos().equals("Yes"))) { %>
			<script language="javascript">
			document.getElementById('btnCri').disabled = false;	
			</script>
	<% }else {%>
