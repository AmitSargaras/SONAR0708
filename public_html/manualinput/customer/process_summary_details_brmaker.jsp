								...
								<tbody>
									...
									<tr class="even">
										...
										<%if(trx.getFromState().equals("PENDING_PERFECTION") || trx.getFromState().equals("PENDING_CREATE")){ %>
											...
											<input type="radio" name="status" checked="checked" value="ACTIVE"  disabled="disabled" >Open</input>
										<%}else{ %>
										<%if( value.getStatus()==null){
											%>
						                  	<input type="radio" name="status" checked="checked" disabled="disabled"  value="ACTIVE"   onclick="javascript:checkboxStatusActive()">Open</input>
				                  		...
				                  		<%}else{%>
					                  		...
					                  		<input type="radio" name="status" checked="checked" value="INACTIVE" disabled="disabled"   onclick="javascript:checkboxStatusInactive()">Close</input>
				                  		<%} %>
				                  		<%} %>
