...
function submitForm(event) {
		...
		document.forms[0].action="MIPartyGroup.do?event=maker_save_update";
    document.forms[0].submit();
}
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
						...
						<tr class="odd">
							...
							<bean:write property="partyCode" name="MIPartyGroupForm" />&nbsp;
						
						<br>	<html:errors property="partyCodeError"/>
						<html:errors property="dupPartyCodeError"/>
							<html:errors property="partyCodeLengthError"/>
							</td>
						...
						<tr class="even">
							<td class="fieldname" width="30%">Group Exp Limit <font color="red">*</font></td>
							<td width="20%"><html:text property="groupExpLimit"
								size="30" maxlength="30" styleId="groupExpLimit" onblur="javascript:formatAmountAsCommaSeparated(this)"></html:text>&nbsp;
	...
	<table width="130" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td colspan="3"><a href="#" onmouseout="MM_swapImgRestore()"
				...
				onClick=" submitForm('MAKER_SAVE')"><img src="img/submit1.gif"
