...
function createPartyGroup() {
	...
	function searchParty()
	{
		...
		if(searchType == '' && searchText == '')
	    {
	        ...
	        document.forms[0].event.value       = "checker_list_party_group";
	        document.forms[0].submit();
	    }
	    else
	    {
									...
									<logic:iterate id="ob" name="partyGroupList"
										...
										<tr class="<%=rowClass%>">
											...
											<td><select name="menu1"
												...
												%>
												<option
													value='MIPartyGroup.do?event=checker_view_party_group&partyCode=<%=ob.getId()%>&startIndex=<%=startIndex%>'>View</option>
...
<td height="25">
 ...
 <%
                            String pageIndexUrl=null;
                                ...
                                pageIndexUrl = "MIPartyGroup.do?event=checker_list_pagination&startIndex=";
