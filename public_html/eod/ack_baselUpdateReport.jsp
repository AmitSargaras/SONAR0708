...
<html>
<head>
	<title>Basel report update Acknowledgement</title>
   		   ...
   		   <tr>
      			<td>
      				<table width="100%" border="0" cellpadding="10" cellspacing="0" class="tblInfo">
         				 ...
         				 <tbody>
            				<tr>
              					<td height="111" class="odd" style="text-align:left">Basel report update has been proceeded .<br></td>
           					</tr>
           					<tr>
