...
<%@ page import="com.integrosys.base.techinfra.logger.DefaultLogger,
                 ...
                 java.util.HashMap,
                 java.util.Locale,
                  com.integrosys.cms.app.collateralrocandinsurance.trx.ICollateralRocTrxValue,
                 java.util.Arrays"%>
...
CollateralRocForm collateralRocForm = (CollateralRocForm) request.getAttribute("CollateralRocForm");
	...
	ICollateralRocTrxValue trxvalue = (ICollateralRocTrxValue)session.getAttribute("com.integrosys.cms.ui.collateralrocandinsurance.CollateralRocAction.ICollateralRocTrxValue");
...
function submitForm () {
	document.forms[0].action="collateralrocandinsurance.do?event=maker_confirm_resubmit_delete";
    document.forms[0].submit();
}
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <tr>
   <%if((event.equals("maker_prepare_resubmit_create"))){%>
                    <td><h3>Collateral Roc & Insurance Mapping - Create </h3></td>
                    <%}else{ %>
                     <td><h3>Collateral Roc & Insurance Mapping - Edit </h3></td>
                     <%} %>
