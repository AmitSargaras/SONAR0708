...
<%@page import="com.integrosys.cms.app.collateralrocandinsurance.trx.ICollateralRocTrxValue"%><html><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
function submitForm(event) {
		document.forms[0].action="collateralrocandinsurance.do?event=maker_save_update";
	    document.forms[0].submit();
}
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <tr>
   <%if((event.equals("maker_prepare_resubmit_create"))){%>
                    <td><h3>Collateral Roc & Insurance Mapping</h3></td>
                    <%}else{ %>
