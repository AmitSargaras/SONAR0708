...
<%
	...
	if(null != propertyValuation3 && CommonCodeEntryConstant.SecurityOwnershipCodes.THIRD_PARTY.equals(propertyValuation3.getSecOwnership())){
		isThirdPartyOwnership = true; 
	}
	if(null != propertyValuation3 && null != propertyValuation3.getThirdPartyEntity() && null != mandatoryThirdPartyEntitiesStr && mandatoryThirdPartyEntitiesStr.contains(propertyValuation3.getThirdPartyEntity())){
		...
		<table width="98%" border="0" cellpadding="0" cellspacing="0" class="tblInfo" align="center">
			<tbody>
				<tr class="odd">
					...
					<td width="30%"> 
						<integro:common-code-single  categoryCode="<%= CategoryCodeConstant.COMMON_CODE_SECURITY_OWNERSHIP %>" 
							entryCode="<%=propertyValuation3.getSecOwnership() %>" display="true"  descWithCode="false"/>
					</td>
					...
					<td width="30%"> <integro:empty-if-null	value="<%=propertyValuation3.getOwnerOfProperty()%>" /> </td>
				</tr>
				...
				<tr class="odd">
					...
					<td width="30%">
						<integro:common-code-single  categoryCode="<%=CategoryCodeConstant.ENTITY%>" 
							entryCode="<%=propertyValuation3.getThirdPartyEntity() %>" display="true"  descWithCode="false"/>
					</td>
					<td class="fieldname" width="20%">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation3.getCinThirdParty()%>" /></td>
				</tr>
				...
				<tr class="odd">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation3.getCersaiTrxRefNo()%>" /></td>
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation3.getCersaiSecurityInterestId()%>" /></td>
				</tr>
				...
				<tr class="odd">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation3.getCersaiAssetId()%>" /></td>
					...
					<td width="30%"><integro:date object="<%=propertyValuation3.getCersaiRegDate()%>"/>&nbsp;</td>
				</tr>
				...
				<tr class="odd">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation3.getCersaiId()%>" /></td>
					...
					<td width="30%"><integro:date object="<%=propertyValuation3.getSaleDeedPurchaseDate()%>"/>&nbsp;</td>
				</tr>
				...
				<tr class="odd">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation3.getThirdPartyAddress()%>" /></td>
				...
				<tr class="odd">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation3.getThirdPartyPincode()%>" /></td>
				</tr>
				<tr class="odd">
					<td colspan="4">&nbsp;</td>
				</tr>
