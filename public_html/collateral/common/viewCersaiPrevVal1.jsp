...
<%
	...
	if(null != propertyValuation1 && CommonCodeEntryConstant.SecurityOwnershipCodes.THIRD_PARTY.equals(propertyValuation1.getSecOwnership())){
		isThirdPartyOwnership = true; 
	}
	if(null != propertyValuation1 && null != propertyValuation1.getThirdPartyEntity() && null != mandatoryThirdPartyEntitiesStr && mandatoryThirdPartyEntitiesStr.contains(propertyValuation1.getThirdPartyEntity())){
		...
		<table width="98%" border="0" cellpadding="0" cellspacing="0" class="tblInfo" align="center">
			<tbody>
				<tr class="odd">
					...
					<td width="30%"> 
						<integro:common-code-single  categoryCode="<%= CategoryCodeConstant.COMMON_CODE_SECURITY_OWNERSHIP %>" 
							entryCode="<%=propertyValuation1.getSecOwnership() %>" display="true"  descWithCode="false"/>
					</td>
					...
					<td width="30%"> <integro:empty-if-null	value="<%=propertyValuation1.getOwnerOfProperty()%>" /> </td>
				</tr>
				...
				<tr class="odd">
					...
					<td width="30%">
						<integro:common-code-single  categoryCode="<%=CategoryCodeConstant.ENTITY%>" 
							entryCode="<%=propertyValuation1.getThirdPartyEntity() %>" display="true"  descWithCode="false"/>
					</td>
					<td class="fieldname" width="20%">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation1.getCinThirdParty()%>" /></td>
				</tr>
				...
				<tr class="odd">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation1.getCersaiTrxRefNo()%>" /></td>
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation1.getCersaiSecurityInterestId()%>" /></td>
				</tr>
				...
				<tr class="odd">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation1.getCersaiAssetId()%>" /></td>
					...
					<td width="30%"><integro:date object="<%=propertyValuation1.getCersaiRegDate()%>"/>&nbsp;</td>
				</tr>
				...
				<tr class="odd">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation1.getCersaiId()%>" /></td>
					...
					<td width="30%"><integro:date object="<%=propertyValuation1.getSaleDeedPurchaseDate()%>"/>&nbsp;</td>
				</tr>
				...
				<tr class="odd">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation1.getThirdPartyAddress()%>" /></td>
				...
				<tr class="odd">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation1.getThirdPartyPincode()%>" /></td>
				</tr>
				<tr class="odd">
					<td colspan="4">&nbsp;</td>
				</tr>
