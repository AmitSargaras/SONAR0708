...
function submitForm() {
	...
	if(insuranceStatusRadio == ""){
		...
		if(insuranceStatusRadio == 'Pending'){
			document.forms[0].action="<%=actionNameStr%>?event=maker_create_insurance_pending&insuranceStatusRadio="+insuranceStatusRadio;
			document.forms[0].submit();
		}
		 else if(insuranceStatusRadio == 'Deferred'){
			document.forms[0].action="<%=actionNameStr%>?event=maker_create_insurance_deferred&insuranceStatusRadio="+insuranceStatusRadio;
   			document.forms[0].submit();
		}else if(insuranceStatusRadio == 'Received'){
			document.forms[0].action="<%=actionNameStr%>?event=maker_create_insurance_received&insuranceStatusRadio="+insuranceStatusRadio;
   			document.forms[0].submit();
		} else if(insuranceStatusRadio == 'Waived'){
			document.forms[0].action="<%=actionNameStr%>?event=maker_create_insurance_waived&insuranceStatusRadio="+insuranceStatusRadio;
   			document.forms[0].submit();
		} 
	}
}
