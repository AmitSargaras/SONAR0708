...
<%
    ...
    if ("-1".equals(request.getParameter("apportionIndexID"))) {
...
<tr class="odd">
    ...
    <td colspan="3">
        <bean:write name="SecurityApportionmentDtlForm" property="fsvCurrency"/>&nbsp;
        <html:hidden property="fsvCurrency"/>
        <html:text property="priorityRankingAmt"/>
        &nbsp;<span id="id_prAmt">&nbsp;</span>
    </td>
</tr>
<tr class="even">
    <td class="fieldname" width="20%">LE ID&nbsp;<font color="#0000FF">*</font></td>
    <td width="30%">
        <logic:equal parameter="apportionIndexID" value="-1">
...
<tr class="odd">
    <td class="fieldname" width="20%"><bean:message key="label.customer.subprofile.id"/>&nbsp;<font color="#0000FF">*</font></td>
    <td width="30%">
        <logic:equal parameter="apportionIndexID" value="-1">
            <html:select property="subProfileId" style="width:100" onchange="javascript:stateChange(3)">
...
<tr class="even">
    ...
    <td>
        ...
        <html:radio property="percAmtInd" onclick="javascript:byAmountCheckChanged()" value="<%= ICMSConstant.SEC_APPORTION_AMT %>"/>&nbsp;&nbsp;<bean:message key="label.security.absolute.amt"/>
    </td>
    <td>
...
<tr class="odd">
    ...
    <td>
        ...
        <html:radio property="minPercAmtInd" onclick="javascript:minAmountCheckChanged()"  value="<%= ICMSConstant.SEC_APPORTION_AMT %>"/>&nbsp;&nbsp;<bean:message key="label.security.absolute.amt"/>
    </td>
    <td>
...
<tr class="even">
    ...
    <td>
        ...
        <html:radio property="maxPercAmtInd" onclick="javascritp:maxAmountCheckChanged()"  value="<%= ICMSConstant.SEC_APPORTION_AMT %>"/>&nbsp;&nbsp;<bean:message key="label.security.absolute.amt"/>
    </td>
    <td>
