...
<% ICollateralTrxValue itrxValue = (ICollateralTrxValue) session.getAttribute("com.integrosys.cms.ui.collateral.document.DocumentAction.serviceColObj");
    IPledge iCol = (IPledge) itrxValue.getStagingCollateral();
    ...
    DocPledgeForm colForm = (DocPledgeForm) request.getAttribute(formName);
    String prefix = "Doc";
...
<html:form action="DocPledgeCollateral.do">
<input type="hidden" name="event"/>
<input type="hidden" name="indexID"/>
<input type="hidden" name="itemType"/>
<input type="hidden" name="subtype" value="DocPledge"/>
    ...
    <td colspan="2">
        ...
        <tbody>
			...
			<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
			    ...
			    <td width="30%">
			        <html:text property="awardedDate" readonly="true"/>
			        <img src="img/calendara.gif" name="Image724" border="0" id="Image724" onclick="return showCalendar('awardedDate', 'dd/mm/y');"
			             onmouseover="MM_swapImage('Image724','','img/calendarb.gif',1)" onmouseout="MM_swapImgRestore()"/>
			        <html:errors property="awardedDate"/> </td>
			    <td class="fieldname"><bean:message key="label.security.negative.pledge.date"/>&nbsp;
			    	<span class="mandatory">*</span></td>
			...
			<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
			    <td width="20%" class="fieldname"><bean:message key="label.security.irr.loi"/>&nbsp;</td>
			    <td width="30%">
			        <html:radio property="isLetterInstruct" value="Y"><bean:message key="label.common.yes"/></html:radio>
			    ...
			    <td width="20%" class="fieldname"><bean:message key="label.security.lou"/>&nbsp;</td>
			    <td width="30%">
			        <html:radio property="isLetterUndertake" value="Y"><bean:message key="label.common.yes"/></html:radio>
			        <html:radio property="isLetterUndertake" value="N"><bean:message key="label.common.no"/></html:radio>
			        <html:errors property="isLetterUndertake"/>
			    </td>
			</tr>

			<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
			    <td width="20%" class="fieldname"><bean:message key="label.security.prj.name"/>&nbsp;</td>
			    <td width="30%">
			        <html:text property="projectName" size="30" maxlength="30"/>
