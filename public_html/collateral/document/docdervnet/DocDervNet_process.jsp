...
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/document/docdervnet/DocDervNet_process.jsp,v 1.17 2007/02/28 11:31:45 Jerlin Exp $
*
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td colspan="2"><h3><bean:message key="label.security.documentation.title.process"/></h3></td>
    </tr>
  </thead>
</table>
...
<%@ include file="DocDervNet_read_helper.jsp" %>
