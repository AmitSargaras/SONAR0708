<%@ page import="com.integrosys.base.techinfra.diff.CompareOBUtil,
                 ...
                 com.integrosys.cms.ui.collateral.document.docdervnet.DocDervNetForm,
                 com.integrosys.base.businfra.currency.Amount,
                 com.integrosys.cms.ui.common.CountryList,
                 com.integrosys.cms.app.collateral.bus.ILimitCharge,
                 com.integrosys.cms.app.collateral.bus.type.document.subtype.fxnetting.IFXNetting,
...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/document/docdervnet/DocDervNet_read_helper.jsp,v 1.41 2007/03/15 16:35:15 Jerlin Exp $
    *
    * Purpose: Helper page for read and process of the Collateral
    * Description: Type - Document, Subtype - FX-Derivative-Netting Agreement
    *
    * @author $Author: Jerlin $<br>
    * @version $Revision: 1.41 $
    * Date: $Date: 2007/03/15 04:35:15 $
    * Tag: $Name:  $
    */
%>
<%
    IFXNetting oldCollateral = (IFXNetting)itrxValue.getCollateral();
    IFXNetting newCollateral = (IFXNetting)itrxValue.getStagingCollateral();
    String action = "docdervnet.DocDervNetAction";
    String formName = "DocDervNetForm";
    DocDervNetForm aForm = (DocDervNetForm)request.getAttribute(formName);
    String prefix = "Doc";
    String subtype = "DocDervNet";
...
<%
			...
			<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				<td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"documentDate")?"fieldname":"fieldnamediff"):"fieldname"%>">
					<bean:message key="label.security.net.agree.date"/>&nbsp;
                  	<span class="mandatory">*</span></td>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				...
				<td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral.getDocumentAmount(),((oldCollateral==null)?null:oldCollateral.getDocumentAmount()),"amount")?"fieldname":"fieldnamediff"):"fieldname"%>">
	                <bean:message key="label.security.doc.amt"/>&nbsp;
                  	<span class="mandatory">*</span></td>
				<td><bean:write name="DocDervNetForm" property="amountLetter"/>&nbsp;</td>
            </tr>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				...
				<td><bean:write name="DocDervNetForm" property="minAmount"/>&nbsp;</td>
				...
				<td><bean:write name="DocDervNetForm" property="maxAmount"/>&nbsp;</td>
            </tr>
