...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/document/docdervnet/DocDervNet_update.jsp,v 1.61 2007/03/15 16:40:15 Jerlin Exp $
    *
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.document.DocumentAction.serviceColObj");
    IFXNetting iCol = (IFXNetting) itrxValue.getStagingCollateral();
    ...
    DocDervNetForm colForm = (DocDervNetForm) request.getAttribute(formName);
    String prefix = "Doc";
...
<html:form action="DocDervNetCollateral.do">
<input type="hidden" name="event"/>
<input type="hidden" name="indexID" />
<input type="hidden" name="itemType"/>
<input type="hidden" name="subtype" value="DocDervNet"/>
...
<tr>
    <td colspan="2">
        ...
        <tbody>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				<td class="fieldname"><bean:message key="label.security.net.agree.date"/>&nbsp;
					<span class="mandatory">*</span></td>
