...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/document/doclou/DocLoU_update.jsp,v 1.59 2007/03/15 17:05:45 Jerlin Exp $
    *
...
<%
    ...
    IUndertaking iCol = (IUndertaking) itrxValue.getStagingCollateral();

    String subtypeCode = null;

    String action = "doclou.DocLoUAction";
    String formName = "DocLoUForm";
    DocLoUForm colForm = (DocLoUForm) request.getAttribute(formName);
    String prefix = "Doc";
...
<html:form action="DocLoUCollateral.do">
<input type="hidden" name="event"/>
<input type="hidden" name="indexID" />
<input type="hidden" name="itemType"/>
<input type="hidden" name="subtype" value="DocLoU"/>
    ...
    <td colspan="2">
        ...
        <tbody>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				...
				<td class="fieldname"><bean:message key="label.security.letter.undertaking.date"/>&nbsp;
					<span class="mandatory">*</span></td>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				<td class="fieldname"><bean:message key="label.security.spec.undertaking"/></td>
				<td colspan="3">
