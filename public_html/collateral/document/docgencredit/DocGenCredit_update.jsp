...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/document/docgencredit/DocGenCredit_update.jsp,v 1.60 2007/03/15 16:52:45 Jerlin Exp $
    *
...
<%    ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.document.DocumentAction.serviceColObj");
    ...
    ICreditAgreement iCol = (ICreditAgreement) itrxValue.getStagingCollateral();
    ...
    DocGenCreditForm colForm = (DocGenCreditForm) request.getAttribute(formName);
    String prefix = "Doc";
...
<html:form action="DocGenCreditCollateral.do">
<input type="hidden" name="event"/>
<input type="hidden" name="indexID" />
<input type="hidden" name="itemType"/>
<input type="hidden" name="subtype" value="DocGenCredit"/>
...
<tr>
    <td colspan="2">
        ...
        <tbody>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				<td class="fieldname"><bean:message key="label.security.credit.agree.date"/>&nbsp;
					<span class="mandatory">*</span>&nbsp;<span class="mandatoryPerfection">*</span></td>
