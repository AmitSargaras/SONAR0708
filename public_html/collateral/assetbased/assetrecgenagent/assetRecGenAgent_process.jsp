...
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/assetbased/assetrecgenagent/assetRecGenAgent_process.jsp,v 1.13 2006/10/27 08:24:57 hmbao Exp $
*
* Purpose: Process to approve Collateral
* @author $Author: hmbao $<br>
* @version $Revision: 1.13 $
* Date: $Date: 2006/10/27 08:24:57 $
* Tag: $Name:  $
*/
%>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td colspan="2"><h3><bean:message key="label.security.title.process.assetbased.receiveable.assign.invoice"/></h3></td>
    </tr>
  </thead>
</table>
...
<%@ include file="assetRecGenAgent_read_helper.jsp" %>
