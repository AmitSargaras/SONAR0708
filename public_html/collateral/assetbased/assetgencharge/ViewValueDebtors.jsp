...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <%if(event!=null && event.equalsIgnoreCase("view_value_debtors_close")){ %>
        <td width="100" valign="baseline" align="center">
         ...
         <%}else if(event!=null && event.equalsIgnoreCase("view_value_debtors_check")){ %>
        <td width="100" valign="baseline" align="center">
