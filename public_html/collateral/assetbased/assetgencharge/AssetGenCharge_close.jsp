...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/assetbased/assetgencharge/AssetGenCharge_close.jsp,v 1.11 2006/10/27 08:23:41 hmbao Exp $
    *
...
String parentPageFromSession=(String)session.getAttribute("com.integrosys.cms.ui.collateral.assetbased.AssetBasedAction.parentPageFrom");
    ...
    if (forward_page.equals("track") || forward_page.equals("track_return")||"ASSET_CLOSE_TRACK".equals(parentPageFromSession)) {
        from_event = "track";
        isTrack = true;
    }
...
<input type="hidden" name="event" value="<%=AssetGenChargeAction.EVENT_CLOSE%>">
...
<%
String parentPageFrom = "ASSET_CLOSE"; 
if(isTrack){
	parentPageFrom = "ASSET_CLOSE_TRACK";
}
%>
