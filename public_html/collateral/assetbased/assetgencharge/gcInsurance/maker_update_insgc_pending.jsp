...
pageContext.setAttribute("MaintainInsuranceGCForm", insuranceObj);
...
List<LabelValue> oldPolicyNoList = (List<LabelValue>) request.getAttribute("oldPolicyNoList");
pageContext.setAttribute("oldPolicyNoList", oldPolicyNoList);
...
System.out.println("insuranceStatusRadio:"+insuranceStatusRadio+" insuranceObj:"+insuranceObj);
%>
...
function submitForm() {
	...
	document.forms[0].action='AssetInsuranceCollateral.do?event=maker_update_inspending_list&collateralID=<%=itrxValue.getReferenceID()%>&insuranceCode=<%=insuranceObj.getInsuranceCode()%>';
    document.forms[0].submit();
}
function cancleForm() {

	
 	document.forms[0].action='AssetInsuranceCollateral.do?event=maker_edit_cancle_insstatus&collateralID=<%=itrxValue.getReferenceID()%>';
    document.forms[0].submit();
}
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <tr>
      <td><h3>Edit Insurance - Pending </h3></td>
  </tr>
  <tr>
    <td><hr/></td>
  </tr>
          ...
          <tbody>
              ...
              <img src="img/calendara.gif" alt="calender" name="Image723" border="0" id="Image725"
                ...
                <td class="fieldname" width="20%">
                	<bean:message bundle="message-collateral" key="label.insurance.linked.old.policy.no" />
                	<font color="#FF0000">*</font>
                </td>
                <td width="30%">
					<html:select name="MaintainInsuranceGCForm" property="oldPolicyNo">
						<html:option value="">Please Select</html:option>
						<logic:present name="oldPolicyNoList">
			            	<html:options collection="oldPolicyNoList" labelProperty="label" property="value"/>
			            </logic:present>
			        </html:select>                
                </td>
              </tr>
