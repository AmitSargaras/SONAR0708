...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/cash/cashcash/CashCash_process.jsp,v 1.19 2006/10/27 08:26:42 Naveen Exp $
    *
    * Purpose: Process to approve Collateral
    * Description: Type - Cash, Subtype - deposit cash
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td colspan="2"><h3><bean:message key="label.security.title.deposit.process"/></h3></td>
    </tr>
  </thead>
</table>
