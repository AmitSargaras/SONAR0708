<%@ page import="com.integrosys.cms.ui.collateral.*,
                 ...
                 com.integrosys.cms.app.collateral.bus.type.cash.subtype.cashcash.*,
                 com.integrosys.base.techinfra.util.DateUtil,
                 com.integrosys.cms.app.collateral.trx.ICollateralTrxValue,
                 com.integrosys.base.businfra.currency.Amount,
                 java.util.Collection,
                 com.integrosys.cms.ui.dataprotection.DataProtectionUtil,
                 com.integrosys.cms.ui.collateral.cash.cashcash.CashCashForm,
                 java.util.HashMap,
                 java.util.Iterator,
...
<%
     ...
     * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/cash/cashcash/CashCash_update.jsp,v 1.66 2006/11/23 02:49:57 Naveen Exp $
     *
     * Purpose: Update -- Submit or Save Collateral
     * Description: Type - Cash, Subtype - Cash
     *
     * @author $Author: Naveen $<br>
     * @version $Revision: 1.66 $
     * Date: $Date: 2007/02/213 02:49:57 $
...
<% ICollateralTrxValue itrxValue = (ICollateralTrxValue) session.getAttribute("com.integrosys.cms.ui.collateral.cash.CashAction.serviceColObj");
    ...
    ICashCash iCol = (ICashCash) itrxValue.getStagingCollateral();
    ...
    String prefix = "Cash";
    String subtype = "CashCash";
    String formName = subtype + "Form";
    String from_event = "prepare_update";
    String formActionName = subtype + "Collateral.do";

    CashCashForm colForm = (CashCashForm) request.getAttribute(formName);
	...
	function submitPage(num, index) {
	   ...
	   // selectLists();
        ...
        function addDeposit(){
            ...
            window.location.href="CashDeposit.do?event=prepare&indexID=-1&subtype=CashCash";
...
<html:form action="CashCashCollateral.do">
    ...
    <td colspan="2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
            <tbody>
                ...
                <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                    <td class="fieldname" width="20%"><bean:message key="label.security.internet.capitalisation"/>&nbsp;<bean:message key="label.mandatory"/></td>
                    <td width="30%">
                        <html:radio property="interest" value="true"/><bean:message key="label.common.yes"/>
                        &nbsp;&nbsp;
                        <html:radio property="interest" value="false"/><bean:message key="label.common.no"/>
                        <html:errors property="interest"/></td>
                    <td class="fieldname" width="20%"><bean:message key="label.security.nature.charge"/>&nbsp;
