...
<%
	  ...
	  IGovernment oldCollateral = (IGovernment) itrxValue.getCollateral();
	    IGovernment newCollateral = (IGovernment) itrxValue.getStagingCollateral();
	    String prefix = "Gte";
...
<tr>
    <td colspan="2">
        ...
        <tbody>
                ...
                <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>"></tr>
                ...
                %>
	         	...
	         	<td class="<%=isProcess?(UIUtil.isAmountUnChanged(stagingAmt, actualAmt)?"fieldname":"fieldnamediff"):"fieldname"%>" width="20%">
	         ...
	         <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
			     ...
			     <td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"country")?"fieldname":"fieldnamediff"):"fieldname"%>"> 
			      	...
			      	<td>
			      		...
			      		&nbsp;<html:hidden name="GteGovtForm" property="country"/></td>	
			      	...
			      	<td>
			      		...
			      		<html:hidden name="GteGovtForm" property="region"/></td>		      
			 ...
			 <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
			 		...
			 		<td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"state")?"fieldname":"fieldnamediff"):"fieldname"%>"> 
			      	...
			      	<td>
			      		...
			      		<html:hidden name="GteGovtForm" property="state"/> </td>
			      ...
			      <td>
			      	...
			      	<html:hidden name="GteGovtForm" property="city"/></td>
