...
ICollateralTrxValue itrxValue = (ICollateralTrxValue) session.getAttribute("com.integrosys.cms.ui.collateral.guarantees.GuaranteesAction.serviceColObj");
	IPersonal iCol = (IPersonal) itrxValue.getStagingCollateral();
     pageContext.setAttribute("obj", iCol);
    String subtypeCode = iCol.getCollateralSubType().getSubTypeCode();
   GteIndivForm colForm = (GteIndivForm) request.getAttribute("GteIndivForm");
    String prefix = "Gte";
    String subtype = "GteIndiv";
...
<%@page import="com.integrosys.cms.app.collateral.bus.type.guarantee.subtype.personal.IPersonal"%>
<%@page import="com.integrosys.cms.ui.collateral.guarantees.gteindiv.GteIndivForm"%><html>
<head>
...
<link href="<%=context%>css/smartlender-print.css" media="print"
    ...
    <script language="JavaScript" type="text/JavaScript">
	    ...
	    function refreshRegionId(dropdown)
		{
		 ...
		 var dep = 'region';
		 var url = '/cms/GteIndivCollateral.do?event=refresh_region_id&countryId='+curSel;
		...
		function refreshStateId(dropdown)
		{
		 ...
		 var dep = 'state';
		 var url = '/cms/GteIndivCollateral.do?event=refresh_state_id&regionId='+curSel;
		 sendLoadDropdownReq(dep, url);
		}
		...
		function refreshCityId(dropdown)
		{
		 ...
		 var dep = 'city';
		 var url = '/cms/GteIndivCollateral.do?event=refresh_city_id&stateId='+curSel;
		 sendLoadDropdownReq(dep, url);
		}
		 ...
		 function refreshCurrency(dropdown)
			{
				...
				var cur=document.getElementById('collateralCurrency').value;
				 ...
				 var urlc = '/cms/GteIndivCollateral.do?event=refresh_currency&currencyId='+curSel;
...
<html:form action="GteIndivCollateral.do">
<input type="hidden" name="event"/>
<input type="hidden" name="indexID"/>
<input type="hidden" name="itemType"/>
<input type="hidden" name="subtype" value="GteIndiv"/>
...
<tr>
    <td colspan="2">
        ...
        <td class="fieldname"><bean:message key="label.security.net.worth.date"/></td>
				...
				<td class="fieldname"><bean:message key="label.security.address.line1"/>
        ...
        <td class="fieldname">Guarantor Type 
	         ...
	         <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
		         <td class="fieldname"><bean:message key="label.security.guaranters.name.prefix"/>
                <span class="mandatoryPerfection"> * </span></td>
			    ...
			    <td class="fieldname"><bean:message key="label.security.guaranters.full.name"/>
                   <span class="mandatoryPerfection"> * </span></td>
	         ...
	         <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">	         
			      ...
			      <td class="fieldname"> <bean:message key="label.security.country"/>&nbsp;
	            	<span class="mandatoryPerfection">*</span>&nbsp;</td>          
			      <td><html:select name="GteIndivForm" property="country" onchange="javascript:refreshRegionId(this)">
	                ...
	                <td class="fieldname"> <bean:message key="label.security.region"/>&nbsp;
			      	...
			      	<td><html:select name="GteIndivForm" property="region"  onchange="javascript:refreshStateId(this)">
                  			<option value=""><bean:message key="label.please.select"/></option>
			 ...
			 <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
			 		...
			 		<td class="fieldname"> <bean:message key="label.security.state"/>&nbsp;
			      	...
			      	<td><html:select name="GteIndivForm" property="state"  onchange="javascript:refreshCityId(this)">
                  			<option value=""><bean:message key="label.please.select"/></option>
	                ...
	                <td class="fieldname"> <bean:message key="label.security.city"/>&nbsp;
			      	...
			      	<td><html:select name="GteIndivForm" property="city"  >
	                  		<option value=""><bean:message key="label.please.select"/></option>
