...
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/guarantees/gteindem/GteIndem_close.jsp,v 1.11 2006/10/27 08:33:17 hmbao Exp $
*
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.guarantees.GuaranteesAction.serviceColObj");
    ...
    IGteinwardLC iCol = (IGteinwardLC) itrxValue.getStagingCollateral();
        // IGteinwardLC iCol = (IGteinwardLC) itrxValue.getStagingCollateral();
    //todo:jitu  should be  getStagingCollateral
...
<%@ include file="GteInwardLC_read_helper.jsp" %>
