<%@ page import="com.integrosys.base.techinfra.diff.CompareOBUtil,
                 ...
                 com.integrosys.cms.app.collateral.bus.type.guarantee.subtype.sblcsameccy.ISBLCSameCurrency,
...
<%
    ISBLCSameCurrency oldCollateral = (ISBLCSameCurrency) itrxValue.getCollateral();
    ISBLCSameCurrency newCollateral = (ISBLCSameCurrency) itrxValue.getStagingCollateral();
    String prefix = "Gte";
...
<%@page import="com.integrosys.cms.app.collateral.bus.type.guarantee.subtype.sblcsameccy.ISBLCSameCurrency"%><tbody>
<tr>
    <td colspan="2">
        ...
        <tbody>
	        ...
	        <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
		          	<td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"followUpDate")?"fieldname":"fieldnamediff"):"fieldname"%>">
                       <bean:message key="label.security.follow.up.date"/></td>
