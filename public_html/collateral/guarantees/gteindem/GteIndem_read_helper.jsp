...
<%
     ...
     * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/guarantees/gteindem/GteIndem_read_helper.jsp,v 1.48 2006/07/27 01:54:03 jzhan Exp $
     *
     ...
     * Date: $Date: 2006/07/27 01:54:03 $
     */
%>

<%
    IInterBranchIndemnity oldCollateral = (IInterBranchIndemnity) itrxValue.getCollateral();
    IInterBranchIndemnity newCollateral = (IInterBranchIndemnity) itrxValue.getStagingCollateral();
    String prefix = "Gte";
...
<!--                <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				...
				<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                    ...
                    <td><bean:write name="GteIndemForm" property="amtGuarantee"/>&nbsp;</td>
                </tr>
