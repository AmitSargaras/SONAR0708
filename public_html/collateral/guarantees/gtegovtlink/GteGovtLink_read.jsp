...
<%
     ...
     * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/guarantees/gtegovtlink/GteGovtLink_read.jsp,v 1.18 2006/10/27 08:33:17 hmbao Exp $
     *
     * Purpose: Read Collateral
     * Description: Type - Guarantee, Subtype - GOVT LINK
     *
...
<% 
    ...
    IGteGovtLink iCol = (IGteGovtLink) itrxValue.getCollateral();
