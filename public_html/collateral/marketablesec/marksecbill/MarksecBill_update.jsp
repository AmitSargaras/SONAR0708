...
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/marketablesec/marksecbill/MarksecBill_update.jsp,v 1.66 2006/11/23 02:56:24 jzhan Exp $
*
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.marketablesec.MarketableSecAction.serviceColObj");
	...
	IGovtLocal iCol = (IGovtLocal) itrxValue.getStagingCollateral();
    ...
    MarksecBillForm colForm = (MarksecBillForm) request.getAttribute(formName);
...
function submitPage(num, index) {
    ...
    if (num == 4) {
        document.forms[0].event.value="marksecbill_prepare";
        document.forms[0].indexID.value="-1";
        document.forms[0].itemType.value="PORTITEM";
    }
    if (num == 5) {
        document.forms[0].event.value="marksecbill_prepare_update_sub";
...
<html:form action="MarksecBillCollateral.do">
<input type="hidden" name="event">
<input type="hidden" name="subtype" value="MarksecBill"/>
    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
            <%
				...
				%>
                     <tr class="<%=classtype%>">
                     <td colspan="6">There is no security detail.</td>
                     </tr>
