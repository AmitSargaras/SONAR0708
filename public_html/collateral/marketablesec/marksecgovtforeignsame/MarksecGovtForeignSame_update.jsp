...
<%@ page import="com.integrosys.cms.ui.collateral.marketablesec.marksecgovtforeignsame.MarksecGovtForeignSameForm"%>

<%
/**
* Copyright Integro Technologies Pte Ltd
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/marketablesec/marksecgovtforeignsame/MarksecGovtForeignSame_update.jsp,v 1.59 2006/11/23 02:57:57 jzhan Exp $
*
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.marketablesec.MarketableSecAction.serviceColObj");
	...
	IGovtForeignSameCurrency iCol = (IGovtForeignSameCurrency) itrxValue.getStagingCollateral();
    ...
    MarksecGovtForeignSameForm colForm = (MarksecGovtForeignSameForm) request.getAttribute(formName);
...
function submitPage(num, index) {
    ...
    if (num == 4) {
        document.forms[0].event.value="marksecgovtforeignsame_prepare";
        document.forms[0].indexID.value="-1";
        document.forms[0].itemType.value="PORTITEM";
    }
    if (num == 5) {
        document.forms[0].event.value="marksecgovtforeignsame_prepare_update_sub";
...
<html:form action="MarksecGovtForeignSameCollateral.do">
<input type="hidden" name="event">
<input type="hidden" name="subtype" value="MarksecGovtForeignSame"/>
      ...
      <td colspan="2"> <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
          <tbody>
				...
				<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
					...
					<td><html:radio property="borrowerDependency" value="<%=ICMSConstant.TRUE_VALUE%>">Yes </html:radio> &nbsp; 
						<html:radio property="borrowerDependency" value="<%=ICMSConstant.FALSE_VALUE%>">No </html:radio> &nbsp;  </td>
				</tr>
