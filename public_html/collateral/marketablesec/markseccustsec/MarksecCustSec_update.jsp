...
<%@ page import="com.integrosys.cms.ui.collateral.marketablesec.markseccustsec.MarksecCustSecForm"%>

<%
/**
* Copyright Integro Technologies Pte Ltd
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/marketablesec/markseccustsec/MarksecCustSec_update.jsp,v 1.59 2006/11/23 02:57:19 jzhan Exp $
*
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.marketablesec.MarketableSecAction.serviceColObj");
   ...
   MarksecCustSecForm colForm = (MarksecCustSecForm) request.getAttribute(formName);
...
function submitPage(num, index) {
    ...
    if (num == 4) {
        document.forms[0].event.value="markseccustsec_prepare";
        document.forms[0].indexID.value="-1";
        document.forms[0].itemType.value="PORTITEM";
    }
    if (num == 5) {
        document.forms[0].event.value="markseccustsec_prepare_update_sub";
