...
<%
IFileUploadTrxValue trxValueOut=(IFileUploadTrxValue)session.getAttribute(BondDetailsUploadAction.class.getName() + "." + IBondDetailsUploadConstants.SESSION_TRX_VALUE_OUT);
	...
	<head>
		<script type="text/javascript">
			...
			function approvePage() {
				...
				if (x) {
					document.forms[0].action="BondDetailsUpload.do?event=checker_approve";
			...
			function rejectPage() {
			    document.forms[0].action="BondDetailsUpload.do?event=checker_reject";
			    document.forms[0].submit();
			}
