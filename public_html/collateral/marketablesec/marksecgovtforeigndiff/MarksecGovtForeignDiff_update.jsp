<%@ page import="com.integrosys.cms.ui.collateral.*,
                 ...
                 com.integrosys.cms.app.collateral.bus.type.marketable.subtype.govtforeigndiffccy.IGovtForeignDiffCurrency"%>
<%@ page import="com.integrosys.cms.ui.collateral.marketablesec.marksecgovtforeigndiff.MarksecGovtForeignDiffForm"%>

<%
/**
* Copyright Integro Technologies Pte Ltd
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/marketablesec/marksecgovtforeigndiff/MarksecGovtForeignDiff_update.jsp,v 1.58 2006/11/23 02:57:38 jzhan Exp $
*
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.marketablesec.MarketableSecAction.serviceColObj");
	...
	IGovtForeignDiffCurrency iCol = (IGovtForeignDiffCurrency) itrxValue.getStagingCollateral();

    String subtypeCode = iCol.getCollateralSubType().getSubTypeCode();
    String formName = "MarksecGovtForeignDiffForm";
    String prefix = "Mark";
    String subtype = "MarksecGovtForeignDiff";
    String from_event = "prepare_update";
    String formActionName = subtype + "Collateral.do";
	String event = itrxValue.getCollateral()==null ? "create" : "update";
    MarksecGovtForeignDiffForm colForm = (MarksecGovtForeignDiffForm) request.getAttribute(formName);
...
function submitPage(num, index) {
    ...
    if (num == 4) {
        document.forms[0].event.value="marksecgovtforeigndiff_prepare";
        document.forms[0].indexID.value="-1";
        document.forms[0].itemType.value="PORTITEM";
    }
    if (num == 5) {
        document.forms[0].event.value="marksecgovtforeigndiff_prepare_update_sub";
...
<html:form action="MarksecGovtForeignDiffCollateral.do">
<input type="hidden" name="event">
<input type="hidden" name="subtype" value="MarksecGovtForeignDiff"/>
...
<%@ include file="/collateral/common/update_basic_security_fields.jsp" %>
		...
		<td width="20%"  class="fieldname"><bean:message key="label.security.legal.enforceability.date"/>&nbsp;<font color="#FF0000">* </font><font color="#0000FF"><span id="span11">&nbsp;</span></font></td>
		<td width="30%">
        ...
        <%@ include file="../common_update_marketable.jsp" %>
          </tbody>
        </table></td>
    </tr>
