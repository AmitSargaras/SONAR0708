...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/marketablesec/marksecgovtforeigndiff/MarksecGovtForeignDiff_read.jsp,v 1.14 2006/10/27 08:35:26 hmbao Exp $
    *
...
<%	
    ...
    IGovtForeignDiffCurrency iCol = (IGovtForeignDiffCurrency) itrxValue.getCollateral();
