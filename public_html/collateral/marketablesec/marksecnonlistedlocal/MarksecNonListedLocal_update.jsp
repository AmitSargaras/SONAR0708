...
<%@ page import="com.integrosys.cms.ui.collateral.marketablesec.marksecnonlistedlocal.MarksecNonListedLocalForm"%>

<%
/**
* Copyright Integro Technologies Pte Ltd
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/marketablesec/marksecnonlistedlocal/MarksecNonListedLocal_update.jsp,v 1.61 2006/11/23 02:58:53 jzhan Exp $
*
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.marketablesec.MarketableSecAction.serviceColObj");
	...
	INonListedLocal iCol = (INonListedLocal) itrxValue.getStagingCollateral();
    ...
    MarksecNonListedLocalForm colForm = (MarksecNonListedLocalForm) request.getAttribute(formName);
...
function submitPage(num, index) {
    ...
    if (num == 4) {
        document.forms[0].event.value="marksecnonlistedlocal_prepare";
        document.forms[0].indexID.value="-1";
        document.forms[0].itemType.value="PORTITEM";
    }
    if (num == 5) {
        document.forms[0].event.value="marksecnonlistedlocal_prepare_update_sub";
...
<html:form action="MarksecNonListedLocalCollateral.do">
<input type="hidden" name="event">
<input type="hidden" name="subtype" value="MarksecNonListedLocal"/>
