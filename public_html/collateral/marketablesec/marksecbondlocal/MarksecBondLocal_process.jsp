...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/marketablesec/marksecbondlocal/MarksecBondLocal_process.jsp,v 1.14 2006/10/27 08:35:11 hmbao Exp $
    *
       ...
       <td><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblInfo">
           <tbody>
             ...
             <tr class="odd">
               ...
               <td><integro:wrapper value="<%=itrxValue.getRemarks()%>"/>&nbsp;             
               </td>
             </tr>
           </tbody>
         </table></td>
