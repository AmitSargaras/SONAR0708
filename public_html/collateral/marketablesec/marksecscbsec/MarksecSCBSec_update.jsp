...
<%@ page import="com.integrosys.cms.ui.collateral.marketablesec.marksecscbsec.MarksecSCBSecForm"%>

<%
/**
* Copyright Integro Technologies Pte Ltd
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/marketablesec/marksecscbsec/MarksecSCBSec_update.jsp,v 1.59 2006/11/23 02:59:58 jzhan Exp $
*
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.marketablesec.MarketableSecAction.serviceColObj");
	...
	IPortfolioOwn iCol = (IPortfolioOwn) itrxValue.getStagingCollateral();
    ...
    MarksecSCBSecForm colForm = (MarksecSCBSecForm) request.getAttribute(formName);
...
function submitPage(num, index) {
    ...
    if (num == 4) {
        document.forms[0].event.value="marksecscbsec_prepare";
        document.forms[0].indexID.value="-1";
        document.forms[0].itemType.value="PORTITEM";
    }
    if (num == 5) {
        document.forms[0].event.value="marksecscbsec_prepare_update_sub";
...
<html:form action="MarksecSCBSecCollateral.do">
<input type="hidden" name="event">
<input type="hidden" name="subtype" value="MarksecSCBSec"/>
            ...
            <%
				...
				<% } for (int counter = 0; counter < equity.length; counter++) { %>
                    ...
                    <tr class="<%=classtype%>">
                      ...
                      <%=equity[counter].getUnitPrice().getCurrencyCode()%>&nbsp;<%=equity[counter].getUnitPrice().getAmount()%>
                       <% } %>
                       &nbsp;</td>
                      <td width="13%">
