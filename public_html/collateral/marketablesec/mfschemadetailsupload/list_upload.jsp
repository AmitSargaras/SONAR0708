...
<%@page import="com.integrosys.cms.ui.mf.schemadetailsupload.ISchemaDetailsUploadConstants"%>
<%@page import="com.integrosys.cms.ui.mf.schemadetailsupload.SchemaDetailsUploadAction"%>
<%@page import="com.integrosys.cms.app.fileUpload.trx.IFileUploadTrxValue"%>
<%@ taglib uri="/WEB-INF/struts-html.tld" prefix="html" %>
<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"%>
<%@ taglib uri="/WEB-INF/struts-logic.tld" prefix="logic"%>
<%
	//IFileUploadTrxValue trxValueOut=(IFileUploadTrxValue)session.getAttribute(SchemaDetailsUploadAction.class.getName() + "." + ISchemaDetailsUploadConstants.SESSION_TRX_VALUE_OUT);
	List totalUploadedList = (List)session.getAttribute(SchemaDetailsUploadAction.class.getName() + "." + ISchemaDetailsUploadConstants.SESSION_TOTAL_UPLOADED_LIST);
	List totalFailedList = (List)session.getAttribute(SchemaDetailsUploadAction.class.getName() + "." + ISchemaDetailsUploadConstants.SESSION_TOTAL_FAILED_LIST);
...
<head>
	<script type="text/javascript">
		...
		function downloadImage(){ //v3.0
			var aLocation = "MFSchemaDetailsUpload.do?event=download_report";
			window.location.href = aLocation ;
		}

		function cancelPage(action){
			if(action == 0)
		...
		function submitPage(){
		    document.forms[0].action="MFSchemaDetailsUpload.do?event=maker_close";
		    document.forms[0].submit();
		}
...
<body>
	<table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0">
		<tr>
			<td valign="top">
				<html:form action="MFSchemaDetailsUpload.do" >
								...
								<td>
									<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
										<thead>
											<tr>
												<td>
													<h3><bean:message key="menu.uploads.mfschemaDetailsUpload.name"/></h3>
												</td>
											</tr>
											<tr>
												<td>&nbsp;</td>
					...
					<table width="130" border="0" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
							<logic:equal name="enableClose" value="true">
								...
								<td>
								 	<center>
								 		<a href="javascript:cancelPage(0)" onmouseout="MM_swapImgRestore()"
							 ...
							 <logic:equal name="enableClose" value="false">
							 	 <td colspan="4">
							 	 	<center>
								 		<a href="javascript:cancelPage(1)" onmouseout="MM_swapImgRestore()"
									onmouseover="MM_swapImage('Image4411','','img/cancel1.gif',1)"><img
										src="img/cancel1.gif" name="Image4411" border="0" id="Image4411" />
										</a>
								 	</center>&nbsp;
