<%@ page import="com.integrosys.cms.ui.collateral.*,
                 ...
                 com.integrosys.cms.app.collateral.bus.type.marketable.subtype.mainindexforeign.IMainIndexForeign,
                 com.integrosys.cms.app.common.constant.ICMSConstant"%>
<%@ page import="com.integrosys.cms.ui.collateral.marketablesec.marksecmainforeign.MarksecMainForeignForm"%>

<%
/**
* Copyright Integro Technologies Pte Ltd
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/marketablesec/marksecmainforeign/MarksecMainForeign_update.jsp,v 1.58 2006/11/23 02:58:15 jzhan Exp $
*
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.marketablesec.MarketableSecAction.serviceColObj");
	...
	IMainIndexForeign iCol = (IMainIndexForeign) itrxValue.getStagingCollateral();

    String subtypeCode = iCol.getCollateralSubType().getSubTypeCode();
    String formName = "MarksecMainForeignForm";
    String prefix = "Mark";
    String subtype = "MarksecMainForeign";
    String from_event = "prepare_update";
    String formActionName = subtype + "Collateral.do";
	String event = itrxValue.getCollateral()==null ? "create" : "update";
    MarksecMainForeignForm colForm = (MarksecMainForeignForm) request.getAttribute(formName);
...
function submitPage(num, index) {
    ...
    if (num == 4) {
        document.forms[0].event.value="marksecmainforeign_prepare";
        document.forms[0].indexID.value="-1";
        document.forms[0].itemType.value="PORTITEM";
    }
    if (num == 5) {
        document.forms[0].event.value="marksecmainforeign_prepare_update_sub";
...
<html:form action="MarksecMainForeignCollateral.do">
<input type="hidden" name="event">
<input type="hidden" name="subtype" value="MarksecMainForeign"/>
