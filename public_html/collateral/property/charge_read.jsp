<%@ page import="com.integrosys.cms.ui.collateral.property.*,
...
<thead>
    <tr>
        <td><h3><bean:message key="label.security.charge.infor"/> - <bean:message key="label.view"/></h3></td>
    </tr>
    <tr>
        <td><hr/></td>
    </tr>
      ...
      <tbody>
            <tr class="even">
                ...
                <td colspan="2" valign="middle" style="border-left:0;border-right:0;text-align:center">
                    <input name="Button" type="button" disabled="true" class="btnNormal" style="width:80"
                           onclick="moveDualList(limitMapID,limitID, false )" value="Add&gt;&gt;"/>
                    <br/> <br/>
                    <input name="Button" type="button" disabled="true" class="btnNormal" style="width:80"
                                       onclick="moveDualList(limitID,limitMapID,false )" value="&lt;&lt;Remove"/>
                </td>

                <td style="border-left:0;border-right:0"><bean:message key="label.security.selected.limit.ids"/><br/>
                    <%
                        id = aForm.getLimitID();
                        style = "";
                        if (id == null || id.length == 0) {
            ...
            <tr class="odd">
				...
				%>
					<bean:write name="ChargeForm" property="securityID"/>
				<%	} %>
				</td>
            ...
            <tr class="even">
                ...
                <td class="<%=isProcess?(unchanged?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.security.charge.amount"/>&nbsp;
                	<span class="mandatory">*</span>&nbsp;<span class="mandatoryPerfection">*</span></td>
                <td><bean:write name="ChargeForm" property="chargeAmount"/>&nbsp;</td>
            </tr>
            ...
            <tr class="odd">
                ...
                <td colspan="2"><bean:write name="ChargeForm" property="dateLegalCharge"/>&nbsp;</td>
            ...
            <tr class="even">
                <td width="20%"
                    class="<%=isProcess?(CompareOBUtil.compOB(stagingOB,originOB, "priorChargeChargee")?"fieldname":"fieldnamediff"):"fieldname"%>">
                    	<bean:message key="label.security.charge.prior.charge"/>&nbsp;</td>
                <td width="30%" colspan="2"><bean:write name="ChargeForm" property="chargeePriorCharge"/>&nbsp;</td>
            ...
            <tr class="odd">
                ...
                %>
                <td width="20%" class="<%=isProcess?(unchanged?"fieldname":"fieldnamediff"):"fieldname"%>">Prior Charge Amount</td>
                <td width="30%" colspan="2"><bean:write name="ChargeForm" property="priorChargeAmount"/>&nbsp;</td>
                <td width="20%"
                    class="<%=isProcess?(CompareOBUtil.compOB(stagingOB,originOB, "priorChargeType")?"fieldname":"fieldnamediff"):"fieldname"%>">
    ...
    <td>
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
		...
		<tr class="even">
			...
			<td width="20%" class="<%=isProcess?(CompareOBUtil.compOB(stagingOB,originOB, "caveatReferenceNo")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.charge.prop.caveat.presentation.no"/>&nbsp;
					<%if(aa.equals("N")){ %>
					<font color="#0000FF">*</font>
					<% }%>
					</td>
			<td>
			<bean:write name="ChargeForm" property="caveatReferenceNo"/>&nbsp;	
			</td>
			
		</tr>
		<tr class="odd">
			<td class="<%=isProcess?(CompareOBUtil.compOB(stagingOB,originOB, "expiryDate")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.charge.prop.caveat.expiry.date"/>
			<%if(aa.equals("N")){ %>
					<font color="#0000FF">*</font>
			<% }%>
			</td>
			<td><bean:write name="ChargeForm" property="expiryDate"/>&nbsp;</td>
			<td class="<%=isProcess?(CompareOBUtil.compOB(stagingOB,originOB, "presentationNo")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.charge.prop.presentation.no"/></td>
			<td><bean:write name="ChargeForm" property="presentationNo"/>&nbsp;</td>
		</tr>
		<tr class="even">
			<td class="<%=isProcess?(CompareOBUtil.compOB(stagingOB,originOB, "presentationDate")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.charge.prop.presentation.date"/></td>
			<td><bean:write name="ChargeForm" property="presentationDate"/>&nbsp;</td>
			<td class="<%=isProcess?(CompareOBUtil.compOB(stagingOB,originOB, "lodgedDate")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.charge.prop.registered.date"/></td>
			<td><bean:write name="ChargeForm" property="lodgedDate"/>&nbsp;</td>			
		</tr>
		<tr class="odd">
			...
			<td><bean:write name="ChargeForm" property="solicitorName"/>&nbsp;</td>
			<td class="fieldname">&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
		<tr class="even">
			...
			<td><bean:write name="ChargeForm" property="folio"/>&nbsp;</td>
			...
			<td><bean:write name="ChargeForm" property="jilid"/>&nbsp;</td>
		</tr>
		<tr class="odd">
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td colspan="2" width="100" valign="baseline" align="center">
            <a  href="PropertyCharge.do?event=read_return&from_event=<%=request.getParameter("from_event")%>&subtype=<%=request.getParameter("subtype")%>"
