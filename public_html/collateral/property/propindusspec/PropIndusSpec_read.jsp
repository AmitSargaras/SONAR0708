<%@ page import="com.integrosys.cms.app.collateral.trx.ICollateralTrxValue,                 
                 ...
                 com.integrosys.cms.app.collateral.bus.type.property.subtype.industrialspecial.IIndustrialSpecial"%>

<%
    /**
    * Copyright Integro Technologies Pte Ltd
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/property/propindus/PropIndus_read.jsp,v 1.22 2006/10/27 08:37:22 hmbao Exp $
    *
...
<%		
    ...
    IIndustrialSpecial iCol = (IIndustrialSpecial) itrxValue.getCollateral();
...
<input type="hidden" name="subtype" value="PropIndusSpec"/>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
	...
	<%@ include file="PropIndusSpec_read_helper.jsp" %>
  </tbody>
</table>
