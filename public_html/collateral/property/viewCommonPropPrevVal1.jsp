...
%>
    ...
    <tr>
		...
		<table width="98%" border="0" cellpadding="0" cellspacing="0" class="tblInfo" align="center">
			<tbody> 
			<%@ include file="/collateral/common/viewBasicSecPrevVal1.jsp" %>
			</tbody>
        </table></td>
	</tr>
...
<tr>
    <td colspan="2">
		<table width="98%" border="0" cellpadding="0" cellspacing="0" class="tblInfo" >
        <tbody>
             <%@ include file="/collateral/viewCommonSecurityPrevVal1.jsp" %>
        </tbody>
        </table>
    </td>
</tr>
...
%>
 ...
 <%@ include file="/collateral/common/viewCersaiPrevVal1.jsp" %>

<jsp:include page="/collateral/property/viewPropValComPrevVal1.jsp" >
...
<jsp:include page="/collateral/property/viewPropValUncomPrevVal1.jsp" >
	<jsp:param name="rowIdxInteger" value="<%=rowIdx %>" />
	<jsp:param name="isProcess" value="<%=isProcessStr %>" />
	<jsp:param name="subtype" value="<%=subtype%>" />
	<jsp:param name="fromEvent" value="<%=from_event %>"/>
