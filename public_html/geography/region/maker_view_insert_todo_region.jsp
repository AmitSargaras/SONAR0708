...
<%@page import="com.integrosys.cms.ui.geography.region.RegionForm"%><html>
									...
									<td colspan="4">
										<table width="100%" border="0" cellspacing="0" cellpadding="0"
											...
											<tbody>
													...
													offset="<%=String.valueOf(startIndex)%>"
                               						length="<%=String.valueOf(10)%>"
														...
														<tr class="<%=rowClass%>">
															...
															<td><integro:empty-if-null value="<%=ob.getRegionCode()%>" />&nbsp;
															</td>
															<td><integro:empty-if-null value="<%=ob.getRegionName()%>" />
															</td>
															<td><integro:empty-if-null value="<%=ob.getCountryId().getCountryName()%>" />
															</td>																														
														</tr>
													</logic:iterate>
													<%
												...
												<logic:notPresent name="regionList">
													<tr class="odd">
														<td colspan="10">
															<bean:message key="label.global.not.found" />
														</td>
							...
							<table id="generalPurposeBar" width="100%" border="0"
								...
								<tr>
									...
									<%
										...
										pageIndexUrl = "Region.do?event=maker_rejected_delete_read&TrxId="+transId+"&startIndex=";									
									%>
