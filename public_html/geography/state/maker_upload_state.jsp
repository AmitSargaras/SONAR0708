...
function cancelPage(){
    document.forms[0].action="State.do?event=view_list_state";
    document.forms[0].submit();
}
function submitForm() {
 	document.forms[0].action="State.do?event=maker_upload_state";
    document.forms[0].submit();
}
...
<html:form action="/State" enctype="multipart/form-data">
