...
<%
	...
	ICityTrxValue CityTrxValue = (ICityTrxValue)session.getAttribute("com.integrosys.cms.ui.geography.city.CityAction.ICityTrxValue");
	...
	if (sr != null) {
		...
		pageContext.setAttribute("cityList",
				searchList);
	}
...
<%@page import="com.integrosys.cms.app.geography.city.trx.ICityTrxValue"%><html>
...
function cancelPage(){
    document.forms[0].action="City.do?event=checker_view_list_city";
    
    document.forms[0].submit();
}
function approvePage() {
	
    document.forms[0].action="City.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="City.do?event=<%=rejectEvent%>";
    document.forms[0].submit();
}
function cancelPage(){
									...
									<td colspan="4">
										<table width="100%" border="0" cellspacing="0" cellpadding="0"
											...
											<tbody>
													...
													offset="<%=String.valueOf(startIndex)%>"
                               						length="<%=String.valueOf(10)%>"
														...
														<tr class="<%=rowClass%>">
															...
															<td><integro:empty-if-null value="<%=ob.getCityCode()%>" />&nbsp;
															</td>
															<td><integro:empty-if-null value="<%=ob.getCityName()%>" />
															</td>
															<td><integro:empty-if-null value="<%=ob.getStateId().getStateName()%>" />
															</td>																														
														</tr>
													</logic:iterate>
													<%
												...
												<logic:notPresent name="cityList">
													<tr class="odd">
														<td colspan="10">
															<bean:message key="label.global.not.found" />
														</td>
														...
														<table width="100%" border="0" align="center"
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="even"><%=CityTrxValue.getUserInfo()%>&nbsp;
																	</td>
																</tr>
																<tr class="odd">
																	<td class="fieldname">
																	...
																	<td><%=CityTrxValue.getRemarks() != null ? CityTrxValue.getRemarks() : ""%>&nbsp;
																	</td>
																</tr>
															</tbody>
														</table>
															...
															<tr>
																...
																<%
																	String pageIndexUrl = null;
																			...
																			pageIndexUrl = "City.do?event=checker_process_create_insert&TrxId="+transId+"&startIndex=";
																%>
