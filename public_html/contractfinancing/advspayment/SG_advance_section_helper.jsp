...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblInfo">
    ...
    <tbody>
        ...
        <tr class="odd">
            <td class="fieldname"><bean:message key="label.advancepayment.claim.amount"/></td>
        ...
        <tr class="odd">
            <td class="fieldname"><bean:message key="label.advancepayment.actual.advanced.amount"/></td>
            <td><integro:amount param="all" amount="<%=obAdvance.getActualAdvanceAmount()%>"/>&nbsp;</td>
        </tr>
        <tr class="odd">
