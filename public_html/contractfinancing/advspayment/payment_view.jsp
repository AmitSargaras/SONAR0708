...
<tbody>
    ...
    <tr class="odd">
        <td class="fieldname"><bean:message key="label.advancepayment.distributed.account"/></td>
        <td colspan="2">
...
<tr>
    <td>
        ...
        if (initAdvEvent != null && initAdvEvent.equals("view")) {
            %><a href="javascript:gotoPage('CF_AdvsPayment.do','view')" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image51','','img/cancel2.gif',1)"><img src="img/return1.gif" name="Image3311" border="0" id="Image3311"/></a><%
        } else {
            %><a href="javascript:gotoPage('CF_AdvsPayment.do','maker_prepare_update')" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image51','','img/cancel2.gif',1)"><img src="img/return1.gif" name="Image3311" border="0" id="Image3311"/></a><%
        }
        %>
    </td>
</tr>
