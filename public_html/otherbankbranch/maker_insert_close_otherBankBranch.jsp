...
function submitPage() {
	document.forms[0].action="OtherBranch.do?event=maker_confirm_insert_close";
    document.forms[0].submit();
}
            ...
            <tr>
             ...
             <%
                            String pageIndexUrl=null;
                                ...
                                pageIndexUrl = "OtherBranch.do?event=list_pagination&startIndex=";
                           
                        %>
                <td valign="middle">
                    <integro:pageindex
                            pageIndex="<%=new PageIndex(startIndex,10,0)%>"
                            url="OtherBranch.do?event=list_pagination&startIndex=" />
                </td>
            </tr>
        </table>
