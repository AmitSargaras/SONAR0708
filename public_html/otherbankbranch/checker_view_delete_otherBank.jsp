							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											...
											<tr class="even">
												...
												<td><%=otherBankForm.getAddress()%>&nbsp;
												</td>
												<td class="fieldname">
													City/Town
												</td>
												<td><%=otherBankForm.getCity()%>&nbsp;
												</td>
											</tr>
											<tr class="odd">
												<td class="fieldname">
												...
												<td><%=otherBankForm.getState()%>&nbsp;
												</td>
												<td class="fieldname">
													Region
												</td>
												<td><%=otherBankForm.getRegion()%>&nbsp;
												</td>
											</tr>
											<tr class="even">
												...
												<td><%=otherBankForm.getCountry()%>&nbsp;
												</td>
												<td class="fieldname">
													Contact Number
												</td>
												<td><%=otherBankForm.getContactNo()%>&nbsp;
												</td>
											</tr>
											<tr class="odd">
												<td class="fieldname">
												...
												<td><%=otherBankForm.getContactMailId()%>&nbsp;
												</td>
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tbody>
						...
						<tr class="odd">
							...
							<td><%=otherBankTrx.getRemarks() != null ? otherBankTrx
						.getRemarks() : ""%>&nbsp;</td>
						</tr>
					</tbody>
				</table>
