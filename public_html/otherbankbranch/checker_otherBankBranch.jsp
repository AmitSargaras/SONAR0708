...
<html>
	...
	<head>
		...
		function cancelPage(){
		    document.forms[0].action="OtherBranch.do?event=view_other_bank";
		    document.forms[0].submit();
		}
		function approvePage() {
		    document.forms[0].action="OtherBranch.do?event=checker_approve_edit";
		    document.forms[0].submit();
		}
		function rejectPage() {
		    document.forms[0].action="OtherBranch.do?event=checker_reject_edit";
		    document.forms[0].submit();
		}
		function cancelPage(){
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
						...
						<tr class="odd">
							...
							<td width="30%"><%=otherBankForm.getOtherBranchCode()%>&nbsp;
							<html:errors property="otherBranchCodeError"/>
							</td>
							<td class="fieldname" width="20%">Branch Name</td>
							<td width="30%"><%=otherBankForm.getOtherBranchName()%>&nbsp;
							<html:errors property="otherBranchNameError"/>
							</td>
						</tr>
						...
						<tr class="odd">
							...
							<td width="30%"><%=otherBankForm.getBranchRbiCode()%>&nbsp;
							<html:errors property="branchRbiCodeError"/>
							</td>
