...
<%@page import="com.integrosys.cms.ui.otherdoc.OtherGlobalForm"%><html><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<html:hidden name="OtherGlobalForm"  property="itemCode" />
<html:hidden name="OtherGlobalForm"  property="itemDesc" />
<html:hidden name="OtherGlobalForm"  property="expDate" />
<html:hidden name="OtherGlobalForm"  property="tenureCount" />
<html:hidden name="OtherGlobalForm"  property="status" />
<html:hidden name="OtherGlobalForm"  property="tenureType" />
<html:hidden name="OtherGlobalForm"  property="deprecated" value="Y" />
  ...
  <tr>
    <td width="100" valign="baseline" align="center"><a href="#"
			...
			<td width="100" valign="baseline" align="center">
			 ...
			 <a href="OtherGlobal.do?event=global_list&type=O&go=N&startIndex=<%=startIndex %>"
				onmouseout="MM_swapImgRestore()"
