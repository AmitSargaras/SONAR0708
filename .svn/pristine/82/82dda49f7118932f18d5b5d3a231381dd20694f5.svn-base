...
<%
	...
	if(null != propertyValuation2 && CommonCodeEntryConstant.SecurityOwnershipCodes.THIRD_PARTY.equals(propertyValuation2.getSecOwnership())){
		isThirdPartyOwnership = true; 
	}
	if(null != propertyValuation2 && null != propertyValuation2.getThirdPartyEntity() && null != mandatoryThirdPartyEntitiesStr && mandatoryThirdPartyEntitiesStr.contains(propertyValuation2.getThirdPartyEntity())){
	...
	<tbody>
		<table width="98%" border="0" cellpadding="0" cellspacing="0" class="tblInfo" align="center">
			<tbody>
				<tr class="odd">
					...
					<td width="30%"> 
						<integro:common-code-single  categoryCode="<%= CategoryCodeConstant.COMMON_CODE_SECURITY_OWNERSHIP %>" 
							entryCode="<%=propertyValuation2.getSecOwnership() %>" display="true"  descWithCode="false"/>
					</td>
					...
					<td width="30%"> <integro:empty-if-null	value="<%=propertyValuation2.getOwnerOfProperty()%>" /> </td>
				</tr>
				...
				<tr class="odd">
					...
					<td width="30%">
						<integro:common-code-single  categoryCode="<%=CategoryCodeConstant.ENTITY%>" 
							entryCode="<%=propertyValuation2.getThirdPartyEntity() %>" display="true"  descWithCode="false"/>
					</td>
					<td class="fieldname" width="20%">
					...
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation2.getCinThirdParty()%>" /></td>
				</tr>
				
				<tr class="odd">
					<td class="fieldname" width="20%"><bean:message key="label.cersai.transaction.reference" /> &nbsp;
						<span id="spanTrxRef" style="visibility:hidden">&nbsp;</span>
					</td>
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation2.getCersaiTrxRefNo()%>" /></td>
					<td class="fieldname" width="20%" ><bean:message key="label.cersai.security.interest" /> &nbsp;
						<span id="spanSecurityInterest" style="visibility:hidden">&nbsp;</span>
					</td>
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation2.getCersaiSecurityInterestId()%>" /></td>
				</tr>
				
				<tr class="odd">
					<td class="fieldname" width="20%"><bean:message key="label.cersai.asset.id" /> &nbsp;
						<span id="spanAssetId" style="visibility:hidden">&nbsp;</span>
					</td>
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation2.getCersaiAssetId()%>" /></td>
					<td class="fieldname" width="20%"><bean:message key="label.cersai.registration.date" /> &nbsp;
						<span id="spanRegDate" style="visibility:hidden">&nbsp;</span>
					</td>
					<td width="30%"><integro:date object="<%=propertyValuation2.getCersaiRegDate()%>"/>&nbsp;</td>
				</tr>
				
				<tr class="odd">
					<td class="fieldname" width="20%"><bean:message key="label.cersai.id" /> &nbsp;
						<span id="spanCersaiId" style="visibility:hidden">&nbsp;</span>
					</td>
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation2.getCersaiId()%>" /></td>
					<td class="fieldname" width="20%"><bean:message key="label.cersai.sale.purchase.agreement.date" /> &nbsp;
						<span id="spanCersaiSaleDate" style="visibility:hidden">&nbsp;<bean:message key="label.perfection" /></span>
					</td>
					<td width="30%"><integro:date object="<%=propertyValuation2.getSaleDeedPurchaseDate()%>"/>&nbsp;</td>
				</tr>
				
				<tr class="odd">
					<td class="fieldname" width="20%"><bean:message key="label.cersai.third.party.address" /> &nbsp;
						<span id="spanAddress" style="visibility:hidden">&nbsp;<bean:message key="label.perfection" /></span>
					</td>
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation2.getThirdPartyAddress()%>" /></td>
					<td class="fieldname" width="20%"><bean:message key="label.cersai.third.party.state" /> &nbsp;
				...
				<tr class="odd">
					<td class="fieldname" width="20%" ><bean:message key="label.cersai.third.party.city" /> &nbsp;
					...
					<td class="fieldname" width="20%"><bean:message key="label.cersai.third.party.pincode" /> &nbsp;
						<span id="spanPincode" style="visibility:hidden">&nbsp;<bean:message key="label.perfection" /></span>
					</td>
					<td width="30%"><integro:empty-if-null value="<%=propertyValuation2.getThirdPartyPincode()%>" /></td>
				</tr>
				<tr class="odd">
					<td colspan="4">&nbsp;</td>
				</tr>
