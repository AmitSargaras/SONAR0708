...
<input type="hidden" name="event" value="<%=ConcReportNewAction.EVENT_GENERATE%>"/>
            ...
            <table width="150" border="0" align="right" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="100" valign="baseline" align="center">
                        <a href="#"  onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image33111','','img/generate2.gif',1)"></a>
                    </td>
                    <td width="100" valign="baseline" align="center">
    ...
    <td colspan="2">
            ...
            <thead>
                <tr>
                    ...
                    <td ><bean:message key="label.report.type" /></td>
                    <td width="15%"><bean:message key="label.report.scope" /></td>
            ...
            <tr class="<%=rowColor(index)%>">
                ...
                <td><b><bean:message key="label.report.CON013.title" /></b></td>
                <td><bean:message key="label.report.country.malaysia" /></td>
                <td rowspan="1">
                    <input type="checkbox" name="checks" value="CON013,MY"/>
                </td>
            </tr>
            <%}%>

            <%if (StringUtils.indexOfAny("SG", countrys) > -1) { %>
            <tr class="<%=rowColor(index)%>">
                <td class="index"><%=++index%></td>
                <td><b><bean:message key="label.report.CON013.title" /></b></td>
                <td><bean:message key="label.report.country.singapore"/> </td>
                <td rowspan="1">
                    <input type="checkbox" name="checks" value="CON013,SG"/>
                </td>
            </tr>
            <%}%>
            ...
            <tr class="<%=rowColor(index)%>">
                <td class="index"><%=++index%></td>
                <td><b><bean:message key="label.report.CON014.title"/></b></td>
                <td><bean:message key="label.report.country.malaysia" /></td>
                <td rowspan="1">
                    <input type="checkbox" name="checks" value="CON014,MY"/>
                </td>
            </tr>
            ...
            <tr class="<%=rowColor(index)%>">
                ...
                <td><bean:message key="label.report.country.singapore"/> </td>
                <td rowspan="1">
                    <input type="checkbox" name="checks" value="CON014,SG"/>
                </td>
            </tr>
            <%}%>
            ...
            <tr class="<%=rowColor(index)%>">
                <td class="index"><%=++index%></td>
                <td><b><bean:message key="label.report.CON015.title" /></b></td>
                <td><bean:message key="label.report.country.malaysia" /></td>
                <td rowspan="1">
                    <input type="checkbox" name="checks" value="CON015,MY"/>
                </td>
            </tr>
            <%}%>
			--%>
            ...
            <tr class="<%=rowColor(index)%>">
                <td class="index"><%=++index%></td>
                <td><b><bean:message key="label.report.CON016.title" /></b></td>
                <td><bean:message key="label.report.country.malaysia" /></td>
                <td rowspan="1">
                <input type="checkbox" name="checks" value="CON016,MY"/>
                </td>
            </tr>
            <%}%>
            ...
            <tr class="<%=rowColor(index)%>">
                ...
                <td><bean:message key="label.report.country.singapore"/> </td>
                <td rowspan="1">
                <input type="checkbox" name="checks" value="CON016,SG"/>
                </td>
            </tr>
            <%}%>
            ...
            <tr class="<%=rowColor(index)%>">
                <td class="index"><%=++index%></td>
                <td><b><bean:message key="label.report.CON017.title" /></b></td>
                <td><bean:message key="label.report.country.malaysia" /></td>
                <td rowspan="1">
                <input type="checkbox" name="checks" value="CON017,MY"/>
                </td>
            </tr>
            <%}%>
            ...
            <tr class="<%=rowColor(index)%>">
                ...
                <td><bean:message key="label.report.country.singapore"/> </td>
                <td rowspan="1">
                    <input type="checkbox" name="checks" value="CON017,SG"/>
                </td>
            </tr>
            <%}%>
            ...
            <tr class="<%=rowColor(index)%>">
                <td class="index"><%=++index%></td>
                <td><b><bean:message key="label.report.CON018.title" /> </b></td>
                <td><bean:message key="label.report.country.malaysia" /></td>
                <td rowspan="1">
                    <input type="checkbox" name="checks" value="CON018,MY"/>
                </td>
            </tr>
            <%}%>
