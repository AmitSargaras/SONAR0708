...
String event=(String)request.getAttribute("event");
    ...
    ArrayList docIds = (ArrayList)session.getAttribute("com.integrosys.cms.ui.checklist.camreceipt.CAMReceiptAction.docNos");
...
%>
<%
String actionStr1 = "com.integrosys.cms.ui.checklist.camreceipt.CAMReceiptAction";
    ...
    if(temp=="") {
        return false;
	      ...
	      (selObj.options[selObj.selectedIndex].value == 'ALLOW_PERM_UPLIFT' ||
	       ...
	       alert("The document must de-link linkage to CAM before deleting/perm-uplifting");
...
function searchDoc(){
	...
	document.forms[0].action      	= "CAMReceipt.do?list="+list+"&searchType="+searchType+"&search="+search;
 	document.forms[0].event.value 	= "search_cam_doc";
 	document.forms[0].submit();
}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td> <h3>Update CAM Doc Receipt</h3>
...
<!--			      <td width="763">-->
<!--			         <html:radio property="valuerFirmPanelFlag"  name="CAMReceiptForm" value="Y" onclick="getlag()" />Yes &nbsp;-->
<!--	                 <html:radio property="valuerFirmPanelFlag"  name="CAMReceiptForm" value="N" onclick="getlag()" /> No &nbsp;-->
<!--					<html:radio property="valuerFirmPanelFlag"  name="CAMReceiptForm" value="-" onclick="getlag()" /> N/A-->
...
<!--			      <td width="763">-->
<!--			         <html:radio property="insurerFirmPanelFlag"  name="CAMReceiptForm" value="Y" onclick="getlag()" />Yes &nbsp;-->
<!--	                 <html:radio property="insurerFirmPanelFlag"  name="CAMReceiptForm" value="N" onclick="getlag()" /> No &nbsp;-->
<!--					<html:radio property="insurerFirmPanelFlag"  name="CAMReceiptForm" value="-" onclick="getlag()" /> N/A-->
...
<% if(row==0){%>
            <tr class="odd">
              <td colspan="15">There are no cam linked</td>
            </tr>
<% }%>
          </tbody>
        </table></td>
...
<td><a href="CAMReceipt.do?event=search_cam_no&camNo=<%=camNo %>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4" width="70" height="20" border="0" id="Image4" /></a></td>
<%}--%>
