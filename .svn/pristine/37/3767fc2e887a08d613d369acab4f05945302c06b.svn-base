...
<%
    ...
    FacilityGlobalForm secGlobalForm = (FacilityGlobalForm)request.getAttribute("FacilityGlobalForm");
      ...
      <td> <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
          ...
          <% if(isDocCodePresent) { %>
            <tr class="even">
              ...
              <td>&nbsp;<bean:write name="FacilityGlobalForm" scope="request" property="itemCode" />
