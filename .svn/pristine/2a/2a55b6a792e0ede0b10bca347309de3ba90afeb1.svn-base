...
function cancelPage(){
    document.forms[0].action="Region.do?event=view_list_region";
    document.forms[0].submit();
}
function submitForm() {
 	document.forms[0].action="Region.do?event=maker_upload_region";
    document.forms[0].submit();
}
...
<html:form action="/Region" enctype="multipart/form-data">
