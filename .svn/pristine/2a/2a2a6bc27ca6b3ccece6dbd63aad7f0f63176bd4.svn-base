...
<%
	...
	IFileUploadTrxValue itrxValue = (IFileUploadTrxValue) session.getAttribute("com.integrosys.cms.ui.releaselinedetailsupload.ReleaselinedetailsUploadAction.IFileUploadTrxValue");
	List releaselinedetailsList = (List) session.getAttribute("com.integrosys.cms.ui.releaselinedetailsupload.ReleaselinedetailsUploadAction.releaselinedetailsList");
	
	if (releaselinedetailsList != null) {
		pageContext.setAttribute("releaselinedetailsList", releaselinedetailsList);
	}
	...
	DefaultLogger.debug(this,"releaselinedetailsList size : "+ releaselinedetailsList.size());
	
	int sno = 0;
	String heading = "Release Line Details Upload";
	String approve_event = "checker_approve_create_releaselinedetails";
...
<%@page import="com.integrosys.cms.app.common.util.CommonUtil"%><html:form
	action='Releaselinedetailsupload.do?'>
	<head>
...
function downloadImage(){ //v3.0
		var aLocation = "Releaselinedetailsupload.do?event=downloadReport&system=";
...
function approvePage() {
	...
	//	if (x == 'Y') {
		if (x == true) {
		    document.forms[0].action="Releaselinedetailsupload.do?event="+'<%=approve_event%>';
...
function rejectPage() {
    document.forms[0].action="Releaselinedetailsupload.do?event=checker_reject_create_releaselinedetails";
    document.forms[0].submit();
}
function cancelPage(){
