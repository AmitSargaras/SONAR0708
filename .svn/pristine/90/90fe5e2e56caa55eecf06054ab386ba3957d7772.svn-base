...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function submitPage(num) {
            ...
            if (num == 1) {
               document.forms[0].event.value="process";
            }
            if (num == 2) {
...
<% int index = 2;
    ...
    if ("view_chequeDetail".equals(request.getParameter("event"))||"view_list".equals(request.getParameter("event") )) {
        index = 3;
    }
...
<tr>
      ...
      <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
	          ...
	          <td width="20%" class="fieldname">Branch Name</td>
               ...
               <%if(obj1.getSystemBankBranch()!=null  && "S".equalsIgnoreCase(obj1.getDraweeBank())){ %>
                     <td width="30%"><integro:empty-if-null value="<%=obj1.getSystemBankBranch().getSystemBankBranchName()%>"/>
                  <%}else if(obj1.getOtherbranch()!=null  && "O".equalsIgnoreCase(obj1.getDraweeBank())){ %>
	...
	<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
            ...
            <td width="30%"><integro:empty-if-null value="<%= dtr.format(obj1.getExpiryDate())%>"/></td>
            <%}else{ %>
              <td width="30%">&nbsp;</td>
                <%} %>
...
<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
              ...
              <td width="30%"><integro:empty-if-null value="<%= obj1.getRamId() %>"/>
                </td>
		...
		<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
            ...
            <td><integro:empty-if-null value="<%=dtr.format(obj1.getReturnDate()) %>"/></td>
            <%}else{ %>
              <td>&nbsp;</td>
                <%} %>
