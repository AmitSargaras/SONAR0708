...
<%@page import="com.integrosys.cms.app.udf.bus.IUdf"%>
...
function submitFormDisable() {
 	...
 	document.forms[0].action="udf.do?event=maker_delete_udf";
    document.forms[0].submit();
}
function submitFormEnable() {
	
 	document.forms[0].action="udf.do?event=maker_activate_udf";
    document.forms[0].submit();
}
function cancelPage() {
	...
	<body>
		...
		<table width="80%" border="0" align="center" cellpadding="0"
			...
			<thead>
				...
				<br>
				<tr>
					<td><logic:equal name="UdfForm" property="status" value="ACTIVE">
					<h3>Disable User Defined Fields (UDFs)</h3>

				</logic:equal> <logic:notEqual name="UdfForm" property="status" value="ACTIVE">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
							   ...
							   <tr class="odd">
								...
								<logic:equal name="UdfForm" property="status" value="ACTIVE">
								<html:hidden name="UdfForm" property="deprecated" value="Y" />
								<html:hidden name="UdfForm" property="status" value="INACTIVE" />
								</logic:equal>
								
								<logic:equal name="UdfForm" property="status" value="INACTIVE">
								<html:hidden name="UdfForm" property="deprecated" value="N" />
								<html:hidden name="UdfForm" property="status" value="ACTIVE" />
								</logic:equal>
							</tbody>
						</table>
					</td>
		...
		<table width="130" border="0" align="center" cellpadding="0"
			...
			<tr>
			<logic:equal name="UdfForm" property="status" value="ACTIVE">
				<td><a href="javascript:submitFormDisable();"
					onmouseout="MM_swapImgRestore()"
					onmouseover="MM_swapImage('Image8','','img/submit2.gif',1)"><img
						src="img/submit1.gif" name="Image8" width="80" height="20"
						border="0" id="Image8" /></a></td>
						</logic:equal>		
			<logic:notEqual name="UdfForm" property="status" value="ACTIVE">
				<td colspan="2"><a href="javascript:submitFormEnable();"
					onmouseout="MM_swapImgRestore()"
					onmouseover="MM_swapImage('Image8','','img/submit2.gif',1)"><img
						src="img/submit1.gif" name="Image8" width="80" height="20"
						border="0" id="Image8" /></a></td>
