...
function saveForm(currentStatus) {
	...
	document.forms["OtherReceiptForm"].event.value="save_complete";
    document.forms["OtherReceiptForm"].status.value=currentStatus;
...
<!--                </tr>-->
              ...
              <td><html:text property="docAmt" size="22" maxlength="23"  />
                <html:errors property="docAmt" />
              </td>
            </tr>
             <tr class="odd">
              <td class="fieldname">HDFC Amount &nbsp;</td>
              <td><html:text property="hdfcAmt" size="22" maxlength="23" />
...
--%>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
                  ...
                  <tr class="even">
                      ...
                      <td><html:textarea name="OtherReceiptForm" rows="10" style="width:97%"  property="docRemarks" onkeyup="limitTextInput(this,1600,'Narration')"/><html:errors property="docRemarks" /></td>
                  </tr>
                 </tbody>
          </table> --%>
 <%-- End here  for cr-17 --%>
