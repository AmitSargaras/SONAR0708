		...
		function MM_swapImgRestore() { //v3.0
			...
			function submitPage(event) {
				...
				if(event=="maker_draft_close_process")
					...
					document.forms[0].action="fccBranch.do?event=maker_confirm_draft_close";
					
			    }else{
			      
			    	document.forms[0].action="fccBranch.do?event=maker_confirm_close";
			    }
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											<tr class="odd">
												...
												<td ><%=fccBranchForm.getBranchCode()%>&nbsp;
												</td>
												...
												<td ><%=fccBranchForm.getAliasBranchCode()%>&nbsp;
												</td>
