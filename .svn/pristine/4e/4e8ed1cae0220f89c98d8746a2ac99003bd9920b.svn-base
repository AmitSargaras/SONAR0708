...
<%@ page import="com.integrosys.cms.ui.recurrentMaster.RecurrentGlobalForm" %>
<%
/**
...
<table class="tblFormSection" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3>Global Recurrent Document Template - View</h3></td>
    </tr>
    <tr>
      <td><hr/></td>
    </tr>
  ...
  <tbody>
    <tr>
      ...
      <%--      <tr class="even">
             <td class="fieldname" >Document Frequency&nbsp;</td>
            <td>
...
<table width="100"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <%if(!toTrack && close) { %>
    <a href="RecurrentGlobal.do?event=close_doc_item" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/close2a.gif',1)"><img src="img/close1a.gif" name="Image4411"  border="0" id="Image4411" /></a>&nbsp;&nbsp;&nbsp;<a href="ToDo.do" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image4411"  border="0" id="Image4411" /></a>
    <%}else if(toTrack){%>
    ...
    <%}else{
    	if(viewOnly){
        	%>
            <a href="RecurrentGlobal.do?event=global_list&view=view&type=REC&go=N&startIndex=<%=startIndex %>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4411"  border="0" id="Image4411" /></a>
        <%
        		}else{
        		%>
        <a href="RecurrentGlobal.do?event=global_list&type=REC&go=N&startIndex=<%=startIndex %>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4411"  border="0" id="Image4411" /></a>
    <%}
    }%>
    </td>
  </tr>
