...
<%@page import="com.integrosys.cms.app.holiday.bus.IHoliday"%><html>
					...
					<tbody>
						<tr>
							...
							<td class="odd"><textarea name="remarks" rows="4"
								style="width: 90%"></textarea></br><html:errors property="holidayRemarksError"/></td>
						</tr>
						<tr>
