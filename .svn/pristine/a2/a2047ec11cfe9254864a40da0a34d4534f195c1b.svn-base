function openpic(picurl, title, winwidth, winheight, nid) {
	...
	newWindow.document.write('<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><html><head><title>'+title+'</title><script type="text/javascript" src="scripts/disablerightclk.js"></script></head><body background="images/screenshots/'+picurl+'"></body></html>');
	newWindow.focus(); }
