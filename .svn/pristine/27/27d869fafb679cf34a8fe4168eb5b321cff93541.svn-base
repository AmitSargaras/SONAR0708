		...
		<tr>
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<tr align="left">
						<td width="25%" colspan="1"><input onclick="javascript : showDetail('reopen_released_line_details_rejected','<%=sessionCriteria%>')"
							name="AddNew12" type="button" id="AddNew12" value="Released Line Details"
							class="btnNormal" />&nbsp;&nbsp;  
						<input onclick="javascript : showDetail('reopen_udf_rejected','<%=sessionCriteria%>')"
					...
					<tr>
					<td>
						<% if(event.equals("reopen_udf_rejected") || fromPage.equals("reopen_udf_rejected") ){ %>		
						    <jsp:include page="reopen_udf_rejected.jsp"></jsp:include>
						<%} else { %>			
					    <jsp:include page="reopen_released_line_details_rejected.jsp"></jsp:include>
					<%} %>
				...
				<tr><td>&nbsp;</td></tr>
					...
					<td align="center">
					<% if(event.equals("reopen_udf_rejected") || fromPage.equals("reopen_udf_rejected")){ %>
				<a href="javascript:nextPage('reopen_released_line_details_rejected','<%=sessionCriteria%>');"
