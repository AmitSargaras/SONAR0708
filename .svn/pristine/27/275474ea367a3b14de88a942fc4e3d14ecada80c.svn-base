...
<%
	String formStr = "PropertyAddtionalDocumentFacilityDetailsForm";
	String actionNameStr = "PropertyAddtionalDocumentFacilityDetails.do";
...
%>
<%@ include file="/collateral/addtionalDocumentFacilityDetails/maker_update_additionalDocFacilityDetails.jsp"%>
