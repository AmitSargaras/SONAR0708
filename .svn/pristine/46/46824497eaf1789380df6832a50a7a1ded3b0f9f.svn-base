...
<%
    int sno = 0;
    List ccAddCheckList = (List)session.getAttribute("com.integrosys.cms.ui.checklist.facility.FacilityCheckListAction.ccAddCheckList");
...
<table class="tblFormSection" width="70%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3>Maintain Facility Checklist </h3></td>
    </tr>
    <tr>
      <td><hr/></td>
    </tr>
