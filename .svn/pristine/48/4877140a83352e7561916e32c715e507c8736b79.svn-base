...
function showListing() {
	...
	{
		 document.forms[0].action="LADReceipt.do?event=view_attach_image_reject&category="+catg;
		   document.forms[0].event.value="view_attach_image_reject";
   ...
   // alert("imagePath is "+imagePath);
	...
	if(count<0){
	   alert("This is first Image.");
			...
			if('<%=event%>' == 'retrieveImageGallaryLADDoc'){
			 document.forms[0].action="LADReceipt.do?event=retrieveImageGallaryLADDoc&imageName="+imageName+"&status="+status+"&count="+count+"&pID="+imagePath+"&category"+categ;
				document.forms[0].submit();
			}
			if('<%=event%>' == 'chk_view_reject_img'){
				 document.forms[0].action="LADReceipt.do?event=chk_view_reject_img&imageName="+imageName+"&status="+status+"&count="+count+"&pID="+imagePath+"&category"+categ;
					document.forms[0].submit();
				}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%}else if(isCputUserChecker) {%>
&nbsp;&nbsp;&nbsp;
		<a href="javascript:showChkListing();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','img/return2.gif',1)">
	<img src="img/return1.gif" name="Image2" width="70" height="20" border="0" id="Image2" align="middle"/>
</a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%} %>
