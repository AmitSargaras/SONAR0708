...
<%@page import="com.integrosys.cms.app.otherbank.trx.IOtherBankTrxValue"%>
<%@page import="com.integrosys.cms.ui.otherbankbranch.OtherBankForm"%><html>
...
function cancelPage(){
    document.forms[0].action="OtherBank.do?event=maker_list_valuationAgency";
    
    document.forms[0].submit();
}
function approvePage() {
	
    document.forms[0].action= "OtherBank.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {

    document.forms[0].action= "OtherBank.do?event=<%=rejectEvent%>";
    document.forms[0].submit();
}
function cancelPage(){
