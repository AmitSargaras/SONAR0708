...
<script language="JavaScript" type="text/JavaScript">
    ...
    function submitPage() {
        if (checkFeeTrigger()) {
            document.forms[0].event.value = "add_covenant";
...
<table class="tblFormSection" width="70%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
    <thead>
        <tr>
            <td><h3><bean:message key="title.maintain.cov.condition.checklist.new"/></h3></td>
        </tr>
        <tr>
            <td><hr/></td>
        </tr>
                    ...
                    <tbody>
			            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                            ...
                            <td><html:radio property="isParameterizedDesc" value="true" onclick="javascript:chooseFirstCovenant();"/>
								<html:select property="covenantSelect" >
								...
								<html:text  property="covenantItemDesc" size="50" maxlength="100" /><br/>
								<html:errors property="recurrentItemDesc" />
                            </td>
                        </tr>
                            <%-- cr 26 --%>
			            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                            <td class="fieldname"><bean:message key="label.checklist.one.off"/></td>
                            <td><html:radio property="oneOff" value="true" onclick="changeFrequency(this)"/>Yes
                                &nbsp;&nbsp;
                                <html:radio property="oneOff" value="false" onclick="changeFrequency(this)"/>No
                            </td>
                        </tr>
			            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                            <td class="fieldname"><bean:message key="label.checklist.risk.trigger"/></td>
                            <td><html:radio property="riskTrigger" value="true"/>Yes
                                &nbsp;&nbsp;
			            ...
			            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                            ...
                            <td><html:radio property="fee" value="true"/>Yes
                                &nbsp;&nbsp;
			            ...
			            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                            ...
                            <td><html:text property="frequency" size="3" maxlength="3" disabled="<%=isOneOff%>"/>&nbsp;&nbsp;
			            ...
			            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                            ...
                            <td><html:text property="dueDate" size="12" maxlength="12" readonly="true"/>
                                <img src="img/calendara.gif" name="dueDateCal" border="0" id="dueDateCal" 
                                     onclick="return showCalendar('dueDate', 'dd/mm/y');"
			            ...
			            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                            ...
                            <td><html:text property="docEndDate" size="12" maxlength="12" readonly="true"/>
                                <img src="img/calendara.gif" name="Image32" border="0" id="Image32"
                                     onclick="return showCalendarWithCustomHandling('docEndDate', 'dd/mm/y', setDueDate);"
                                     onmouseover="MM_swapImage('Image32','','img/calendarb.gif',1)"/>
			            ...
			            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                            ...
                            <td><html:text property="gracePeriod" size="3" maxlength="3" onchange="setDueDate('','')"/> &nbsp;&nbsp;
			            ...
			            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                            ...
                            <td><html:text property="lastDocEntryDate" size="12" maxlength="12" readonly="true"/>
                                <img src="img/calendara.gif" name="lastDocEntryDateCal" border="0" id="lastDocEntryDateCal"
                                     onclick="return showCalendarWithCustomHandling('lastDocEntryDate', 'dd/mm/y', setDueDate);"
                                     onmouseover="MM_swapImage('Image32','','img/calendarb.gif',1)"/>
			            ...
			            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                            ...
                            <td><html:textarea property="covenantItemRemarks" rows="4" cols="65"  onkeyup="limitTextInput(this.form.covenantItemRemarks,2000, 'Remarks');"/>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td width="100" valign="baseline" align="center">
            <a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3311','','img/ok2.gif',1)" onclick="submitPage()">
                <img src="img/ok1.gif" name="Image3311"  border="0" id="Image3311" /></a>
        </td>
        <td width="100" valign="baseline" align="center">
            <a href="RecurrentCheckList.do?event=view_ok" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)">
...
<script language="JavaScript" type="text/JavaScript">
	if(document.forms[0].isParameterizedDesc[0].checked){
		chooseFirstCovenant();
		}else{
		chooseSecondCovenant();
	}
