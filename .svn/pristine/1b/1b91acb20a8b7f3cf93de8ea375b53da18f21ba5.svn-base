...
String dafaultDeferDate= df.format(new Date());
...
<head>
    ...
    <script type="text/javascript" src="js/ajaxListDiscrepancy.js"></script>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function saveForm() {
        	...
        	document.forms["DiscrepencyForm"].action = "Discrepency.do?event=maker_edit_discrepency_defer&searchstatus=<%=searchstatus%>&discType=<%=discType %>";
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
                ...
                <tr class="even">
                    ...
                    <tr class="even">
                        ...
                        <html:text property="deferDate" size="12" maxlength="12" readonly="true" value="<%=dafaultDeferDate %>"  />
                        <%}else{ %>
               ...
               originalDeferedDaysCal();
                   ...
                   <tr class="even">
											...
											int defCount=0;
												if(form!=null && form.getDeferedCounter()!=null && !form.getDeferedCounter().trim().equals("")){
													defCount=Integer.parseInt(form.getDeferedCounter()); 
												}
												defCount=defCount+1;
											
											%>
											<integro:empty-if-null value="<%=String.valueOf(defCount) %>"/>
								            </td>
