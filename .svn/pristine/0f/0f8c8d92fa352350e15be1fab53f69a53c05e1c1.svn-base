            ...
            <table width="70%" align="center" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
                <tbody>
					...
					<tr class="odd">
						...
						<!--% Concentration Holdings for Bank Group [1+2+3 / Listed Shares (Quantity)]-->
						<td class="fieldname">
						...
						<!--% Concentration Holdings for Entity [1+2+3 / Listed Shares (Quantity)]-->
						<td class="fieldname">
							<bean:message key="label.predeal.concentration.holdings" />
						</td>
						<td>
                    ...
                    <tr class="odd">
                        ...
                        <td colspan="3">
                            <bean:write name="PreDealForm" property="branchName" />
                        </td>
                    </tr>
                    ...
                    <tr class="even">
                        ...
                        <td colspan="3">
                            <bean:write name="PreDealForm" property="branchCode" />
                        </td>
                    </tr>
                    ...
                    <tr class="odd">
                        ...
                        <td colspan="3">
                            <bean:write name="PreDealForm" property="cifNumber" />
                        </td>
                    </tr>
                    ...
                    <tr class="even">
                        ...
                        <td colspan="3">
                            <bean:write name="PreDealForm" property="accountNo" />
                        </td>
                    </tr>
