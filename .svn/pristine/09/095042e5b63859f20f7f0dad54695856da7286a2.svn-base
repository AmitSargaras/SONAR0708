...
function cancelPage(){
    document.forms[0].action="OtherBank.do?event=checker_list_otherBank";
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											...
											<tr class="even">
												...
												<td><%=otherBankForm.getBranchAddress()%>&nbsp;
												</td>
												<td class="fieldname">
													City/Town
												</td>
												<td><%=otherBankForm.getBranchCity()%>&nbsp;
												</td>
											</tr>
											<tr class="odd">
												<td class="fieldname">
												...
												<td><%=otherBankForm.getBranchState()%>&nbsp;
												</td>
												<td class="fieldname">
													Region
												</td>
												<td><%=otherBankForm.getBranchRegion()%>&nbsp;
												</td>
											</tr>
											<tr class="even">
												...
												<td><%=otherBankForm.getBranchCountry()%>&nbsp;
												</td>
												<td class="fieldname">
													Contact Number
												</td>
												<td><%=otherBankForm.getBranchContactNo()%>&nbsp;
												</td>
											</tr>
											<tr class="odd">
												<td class="fieldname">
												...
												<td><%=otherBankForm.getBranchContactMailId()%>&nbsp;
												</td>
