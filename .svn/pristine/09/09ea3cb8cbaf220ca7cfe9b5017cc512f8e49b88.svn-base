...
function saveForm() {
 	...
 	document.forms[0].action="collateralrocandinsurance.do?event=maker_update_draft_collateral_roc";
    document.forms[0].submit();
}
function submitForm(event) {
	...
	if(event=="maker_prepare_resubmit_create")
		...
		document.forms[0].action="collateralrocandinsurance.do?event=maker_confirm_resubmit_create";
		
    }else{
      
    	document.forms[0].action="collateralrocandinsurance.do?event=maker_edit_collateral_roc";
    }
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <tr>
   <%if((event.equals("maker_prepare_resubmit_create"))){%>
                    <td><h3>Create Collateral Roc & Insurance Mapping</h3></td>
                    <%}else{ %>
                     <td><h3>Edit Collateral Roc & Insurance Mapping</h3></td>
                     <%} %>
          ...
          <tbody>
							...
							<td class="fieldname">Collateral Category<font color="red">*</font>
								...
								<tr class="odd">
									...
									<td width="30%" ><%=collateralRocForm.getCollateralRocCode()%>&nbsp;<br/>
									<html:errors property="collateralRocCodeError" />
									</td>

									<td class="fieldname">Collateral Description</td>
									<td><%=collateralRocForm.getCollateralRocDescription()%>&nbsp;<br/>
								...
								<tr class="even">
									...
									<td><html:radio property="insuranceApplicable" styleId="insuranceApplicable" value="Applicable" /> Applicable
								<html:radio property="insuranceApplicable" styleId="insuranceApplicable" value="Not Applicable" /> Not Applicable &nbsp;
						         </td>
						     </tr>
			    ...
			    <html:hidden name="CollateralRocForm" property="deprecated" />
  ...
  <%if((event.equals("maker_prepare_resubmit_create"))){%>
                   <td colspan="2">
                    ...
                    <td colspan="2">
						<a href="#" onmouseout="MM_swapImgRestore()"
							onmouseover="MM_swapImage('Image3311','','img/submit2.gif',1)"
							onClick=" submitForm('maker_edit_collateral_roc')"><img src="img/submit1.gif"
								name="Image3311" border="0" id="Image3311" />
						</a>&nbsp;&nbsp;
					</td>
                     <%} %>
...
<%	if(collateralRocForm.getInsuranceApplicable() == null || collateralRocForm.getInsuranceApplicable().equals("") || collateralRocForm.getInsuranceApplicable().equals("Not Applicable")) { %>
				<script language="javascript">
				document.all.insuranceApplicable[1].checked=true;
				</script>
		<%	}else {%>
		<%if(collateralRocForm.getInsuranceApplicable().equals("Applicable")) { %>
				<script language="javascript">
				document.all.insuranceApplicable[0].checked=true;
				</script>
		<% }else{ %>
				<script language="javascript">
				document.all.insuranceApplicable[1].checked=true;
