<%@ page import="com.integrosys.base.techinfra.diff.CompareOBUtil,
                 ...
                 com.integrosys.cms.ui.collateral.document.docloi.DocLoIForm,
...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/document/docloi/docloi_read_helper.jsp,v 1.2 2007/03/15 17:03:45 Jerlin Exp $
    *
    ...
    * Date: $Date: 2007/03/15 17:03:45 $
    * Tag: $Name:  $
    */
%>

<%
    ILetterIndemnity oldCollateral = (ILetterIndemnity)itrxValue.getCollateral();
    ILetterIndemnity newCollateral = (ILetterIndemnity)itrxValue.getStagingCollateral();
    String action = "docloi.DocLoIAction";
    String formName = "DocLoIForm";
    DocLoIForm aForm = (DocLoIForm)request.getAttribute(formName);
    String prefix = "Doc";
    String subtype = "DocLoI";
        ...
        <tbody>
			...
			<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				...
				<td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"documentDate")?"fieldname":"fieldnamediff"):"fieldname"%>">
					<bean:message key="label.security.indemnitiy.date"/>&nbsp;
                  	<span class="mandatory">*</span></td>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
              ...
              <td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral.getDocumentAmount(),((oldCollateral==null)?null:oldCollateral.getDocumentAmount()),"amount")?"fieldname":"fieldnamediff"):"fieldname"%>">
                  <bean:message key="label.security.doc.amt"/>&nbsp;
                  	<span class="mandatory">*</span></td>
              <td><bean:write name="DocLoIForm" property="amountLetter"/>&nbsp;</td>
            </tr>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
              ...
              <td><bean:write name="DocLoIForm" property="minAmount"/>&nbsp;</td>
              ...
              <td><bean:write name="DocLoIForm" property="maxAmount"/>&nbsp;</td>
            </tr>
