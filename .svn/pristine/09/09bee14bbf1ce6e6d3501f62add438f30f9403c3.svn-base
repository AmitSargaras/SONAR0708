 ...
 * @since Oct 1, 2009
 */
public class StpFacIslamicSecDepositDeletionCmdTest extends TestCase implements IStpConstants, IStpTransType {
    StpFacIslamicSecDepositDeletionCmd cmd;
    ...
    protected void setUp() throws Exception {
        ...
        cmd = new StpFacIslamicSecDepositDeletionCmd();
    ...
    public void testSecDepositMsgDelete() throws Exception {
