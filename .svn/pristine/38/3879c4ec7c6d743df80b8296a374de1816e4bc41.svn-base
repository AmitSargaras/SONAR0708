...
function getFacList(){
	...
	document.forms[0].action="facilityNewMaster.do?event=maker_list_facilityNewMaster&go=Y&facCode="+code+"&facName="+name+"&facCategory="+category+"&facType="+type+"&facSystem="+system+"&facLine="+line;
...
function createFacilityNewMaster() {

 	document.forms[0].action="facilityNewMaster.do?event=maker_prepare_create_facilityNewMaster";
    document.forms[0].submit();
}
   ...
   <td valign="top">
                    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
                      <thead>
                        ...
                        <tr><td>&nbsp;</td></tr>
                        <tr><td colspan="3">
                        <table width="100%" class="tblinfo" border="0" cellpadding="0" cellspacing="0">
                        <THEAD>
                      <TR><TD colSpan=4 width="100%">Please enter search criteria</TD></TR></THEAD>
                        <tr><td class="fieldname">Facility Code</td>
                        <td>
                        <html:text value="<%= code %>" property="newFacilityCodeSearch" styleId='facCode'/>
                        <html:errors property="newFacilityCodeError"/>
                        </td>
                        <td class="fieldname" >Facility Name</td>
                        <td>
                        <html:text value="<%= name %>" property="newFacilityNameSearch" styleId='facName'/>
                        <html:errors property="newFacilityNameError"/>
                        </td></tr>
...
<html:option value=""> Please Select </html:option>
					 ...
					 <html:option value=""> Please Select </html:option>
                        ...
                        <td><html:text property="lineNumberSearch" maxlength="20" styleId='facLine' value="<%= line %>"/>
                        <html:errors property="newFacilityLineError"/>
                        </td></tr>
                        <tr>
                        <td colspan="4"><center><input class=btnNormal style="margin-left: 60px;height:30px; WIDTH: 70px;"  type="button" value="Go" onclick='getFacList()'></center></td>
                        </tr>
                        </table></td>
                        </tr><tr><td>&nbsp;</td></tr>
                         <tr>
...
<!--                    Search Text: <input type="text"  id="searchText" /> -->
                    <%if((event.equals("checker_list_facilityNewMaster"))||event.equals("checker_search_list_facilityNewMaster")||event.equals("checker_list_pagination")||event.equals("checker_list_facilityNewMaster")){%>
...
<!--                    <input class="btnNormal" type="button" value="GO" onclick="javascript:searchBranch();"/>-->
                    ...
                    <td  valign="bottom" align="right">
											<input type="button" name="Submit" value="Add New" class="btnNormal" onclick="createFacilityNewMaster()"/>
										</td>
                     <%} %>
                                ...
                                <tr class="<%=rowClass%>">
                                  <td class="index"><%=counter.intValue()+1%></td>
                                   <td><%=ob.getNewFacilityCode()%></td>
                                    <td style="white-space:pre"><%=ob.getNewFacilityName()%></td>                                    
              ...
              <tr>
                <td height="25">
                    ...
                    <table  width="100%" border="0" cellspacing="0" cellpadding="0">
                         ...
                         <% if(sr != null) {
                        	 if((event.equals("checker_list_facilityNewMaster"))
                        			 ||event.equals("checker_search_list_facilityNewMaster")
					            ...
					            <tr>
					                <td valign="middle">
					                    <integro:pageindex
					                            ...
					                            url="facilityNewMaster.do?event=checker_list_facilityNewMaster&startIndex=&go=Y"/>
					                </td>
					            </tr>
					        </table>
					    </td>
					        ...
					        <table id="generalPurposeBar" width="100%" border="0" cellspacing="0" cellpadding="5" align="center">
					            <tr>
					                <td valign="middle">
					                    <integro:pageindex
					                            pageIndex="<%=new PageIndex(startIndex, 10, sr.getResultList().size())%>"
					                            url="facilityNewMaster.do?event=list_pagination&startIndex="/>
					                </td>
					            </tr>
					        </table>
					    </td>
