...
<%@page import="com.integrosys.cms.ui.collateral.SecurityCoverageForm,
...
String actionForm = "CollateralForm";
if (mapping != null) {        
	actionForm = mapping.getName();
}

CollateralForm form = (CollateralForm) request.getAttribute(actionForm);
