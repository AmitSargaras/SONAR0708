...
Locale locale = (Locale)session.getAttribute(ICommonEventConstant.GLOBAL_SCOPE+"."+com.integrosys.base.uiinfra.common.Constants.GLOBAL_LOCALE_KEY);
    ...
    if(stageOb!=null){
    System.out.println("form image id === "+stageOb.getSecImageTagUntagId());
    /* form.setSecImageTagUntagId(stageOb.getSecImageTagUntagId());
    form.setSecImageTagUntagImgName(stageOb.getSecImageTagUntagImgName());
    form.setSecImageTagUntagStatus(stageOb.getSecImageTagUntagStatus()); */
...
function submitInactive() {
	var index=<%=index%>;
	//alert("index "+index);
	document.forms["SecurityReceiptForm"].event.value="conform_inactive";
	document.forms["SecurityReceiptForm"].submit();
}
</script>
