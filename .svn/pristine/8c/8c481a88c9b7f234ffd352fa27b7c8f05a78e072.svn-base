		...
		<tr>
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<tr align="left">
						<td width="25%" colspan="1"><input onclick="javascript : showDetail('to_track_summary_details')"
							name="AddNew12" type="button" id="AddNew12" value="Summary Details"
							class="btnNormal" />&nbsp;&nbsp;  
						<input onclick="javascript : showDetail('to_track_financial_details')"
							name="AddNew12" type="button" id="AddNew12" value="Financial Details"
							class="btnNormal" />&nbsp;&nbsp; 
						<input onclick="javascript : showDetail('to_track_cri_details')"
							name="AddNew12" type="button" id="AddNew12" value="CRI Details"
							class="btnNormal" />&nbsp;&nbsp; 
					<input onclick="javascript : showDetail('to_track_cibil_details')"
							name="AddNew12" type="button" id="AddNew12" value="CIBIL"
							class="btnNormal" />
							<input onclick="javascript : showDetail('to_track_udf_details')"
					...
					<tr>
					<td>
						<% if(event.equals("to_track_financial_details") ){ %>		
						    <jsp:include page="to_track_financial_details.jsp"></jsp:include>
						<%} else if(event.equals("to_track_cri_details")){ %>
						    <jsp:include page="to_track_cri_details.jsp"></jsp:include>
						<%} else if(event.equals("to_track_cibil_details")){ %>
						    <jsp:include page="to_track_cibil_details.jsp"></jsp:include>	
						  <%} else if(event.equals("to_track_udf_details")){ %>
						    <jsp:include page="to_track_udf_details.jsp"></jsp:include>	
						<%} else { %>			
					    <jsp:include page="to_track_summary_details.jsp"></jsp:include>
					<%} %>
					</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
					<td align="center">
					<%if(event.equals("to_track_cibil_details")) {%>	
			
			<a href="javascript:returnPage();"
			...
			<%}else{ %>
					...
					&nbsp;
					<%if(event.equals("totrack_maker")||event.equals("to_track_summary_details") || event.equals("totrack_checker")){ %>
					<a href="javascript:nextPage('to_track_financial_details');"
						onmouseout="MM_swapImgRestore()"
						onmouseover="MM_swapImage('Image4411','','img/next2.gif',1)"><img
						src="img/next1.gif" name="Image4411" border="0" id="Image4411" />
					</a>
					&nbsp;
					<%}else if(event.equals("to_track_financial_details") ){ %>
					<a href="javascript:nextPage('to_track_cri_details');"
						onmouseout="MM_swapImgRestore()"
						onmouseover="MM_swapImage('Image4411','','img/next2.gif',1)"><img
						src="img/next1.gif" name="Image4411" border="0" id="Image4411" />
					</a>
					&nbsp;
					<%}else if(event.equals("to_track_cri_details")){ %>
					<a href="javascript:nextPage('to_track_cibil_details');"
						onmouseout="MM_swapImgRestore()"
						onmouseover="MM_swapImage('Image4411','','img/next2.gif',1)"><img
						src="img/next1.gif" name="Image4411" border="0" id="Image4411" />
					</a>
