...
<%@page import="com.integrosys.cms.app.insurancecoverage.trx.IInsuranceCoverageTrxValue"%>
<%@page import="com.integrosys.cms.ui.geography.country.CountryForm"%>
<%@page import="com.integrosys.cms.app.geography.country.trx.ICountryTrxValue"%><html>
							...
							<table id="generalPurposeBar" width="100%" border="0"
								...
								<tr>
									...
									<%
										...
										pageIndexUrl = "Country.do?event=maker_rejected_delete_read&TrxId="+transId+"&startIndex=";												
									%>												
