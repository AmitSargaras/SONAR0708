...
<script language="JavaScript" type="text/javascript">
	...
	function activateCity(){
		var flag = <%=flg %>
		if( flag == true )
			alert('Please Enable the STATE for this CITY !!!');
		else
		{
			var ans = window.confirm('Are You Sure to Enable the CITY ');
			if( ans == true )
			{
				document.forms[0].action		=	"City.do";
				document.forms[0].event.value	=	"maker_activate_city";
				document.forms[0].submit();
			}
		}	 
	}
		...
		<body>
			...
			<table width="130" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="2">
						<center>
							<a href="javascript:activateCity()" onmouseout="MM_swapImgRestore()"
