              ...
              <td class="even" style="text-align:center" valign="middle"> 
                <table width="350" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
                  <tr class="even"> 
                      ...
                      <td style="border:none" width="200"><strong><font size="2">Facility is pending</font></strong></td>
                    </tr>
                    <tr class="even"> 
                      
                    <td colspan="2" style="border:none;text-align:center"><br />
                      Facility is pending in draft or for approval/rejection/resubmit. 
                      Please submit or approve/reject/resubmit facility first. <br /> 
		    		</td>
                    </tr>
                </table> </td>
            </tr>
