...
<script language="JavaScript" type="text/JavaScript">		
		function submitForm() {
 	document.forms[0].action="Createfacilitylineupload.do?event=createFacilitylineupload";
				...
				<tbody>
					<tr>
						<td valign="bottom" align="center">
							<html:file property="fileUpload" size="50"></html:file></br><html:errors property="createfacilitylineuploadError"/>
						</td>
					</tr>
					<%
