...
<%	
    ...
    IReceivableGeneralAgent iCol = (IReceivableGeneralAgent) itrxValue.getCollateral();
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td width="50%" colspan="2"><h3><bean:message key="label.security.title.view.assetbased.receiveable.assign.invoice"/></h3></td>
