...
<tbody>
    <tr class="odd">
        <td width="20%" class="<%=CompareOBUtil.compOB(obPayment,obActualPayment,"distributeDate")?"fieldname":"fieldnamediff"%>"><bean:message key="label.advancepayment.date.retention.distributed"/></td>
    ...
    <tr class="even">
        ...
        %>
        <td class="<%=UIUtil.isAmountUnChanged(stagingAmt,actualAmt,true)?"fieldname":"fieldnamediff"%>"><bean:message key="label.advancepayment.retention.amount"/></td>
    ...
    <tr class="odd">
        ...
        %>
        <td class="<%=isUnChanged?"fieldname":"fieldnamediff"%>"><bean:message key="label.advancepayment.retained.to"/></td>
        <td colspan="2">
