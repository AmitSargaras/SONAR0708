<%@ page import="com.integrosys.cms.app.customer.bus.ICreditGrade,
                 com.integrosys.cms.app.customer.bus.OBCreditGrade,
...
//                            DefaultLogger.debug(this, "creditGradeArray[cdIdx].getCGType() : " + creditGradeArray[cdIdx].getCGType() );
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
                ...
                <tbody>
                    <tr class="odd">
                        <td class="fieldname" width="20%"><%=typeMap.get(key)%>&nbsp;</td>
                        <td width="30%"><integro:empty-if-null value="<%=CommonDataSingleton.getCodeCategoryLabelByValue( CategoryCodeConstant.CREDIT_GRADE_VALUE,creditGradeArrayDisp.getCGCode())%>"/>&nbsp;
                        </td>
