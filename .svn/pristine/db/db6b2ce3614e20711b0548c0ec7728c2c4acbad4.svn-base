...
System.out.println("::::::::::::::::::::::::::::::::ilads:::::::::::::::::::"+ilads);
%>
...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td><h3>LAD Generated But Not Received listing </br></br></h3></td>
    </tr>
    ...
    <tr >
						...
						<td>
						 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
                            <thead>
                             <td width="5%">S/N</td>
                                                        <td width="50%">LAD Name</td>
                                                        <td width="21%">LAD Generation Date</td>
                            ...
                            if(ilads!=null){
                            	if(ilads.size()!=0){
                                   ...
                                   <tr class="<%=rowClass%>">
                                                            ...
                                                            <td><%=ilad.getLad_name()%>&nbsp;</td>
                                                             <td><integro:date object="<%=ilad.getGeneration_date()%>"/>&nbsp;</td>
                                   <td> <select name="menu1" onchange="MM_jumpMenu('self',this,0)" >
                                   <option value="">--Please Select--</option>
                                   <%if(isUserCpcMaker){ %>
                                    <option value='GenerateLAD.do?event=prepare_update_lad&id=<%=ilad.getId()%>'>Update</option>
                                    <option value='GenerateLAD.do?event=prepare_view_lad&operation=LADGBNR&id=<%=ilad.getId()%>'>View</option>
                                    <%}else{ %>
                                    <option value='GenerateLAD.do?event=prepare_view_lad_view&operation=LADGBNR&id=<%=ilad.getId()%>'>View</option>
                                    <%} %>   
                                      </select></td>                      
                                                        </tr>
                                                        <%
