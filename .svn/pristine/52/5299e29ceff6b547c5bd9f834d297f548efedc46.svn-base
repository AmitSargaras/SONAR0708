drop procedure MIG_RUN_AB103
@

CREATE PROCEDURE MIG_RUN_AB103
	LANGUAGE SQL
BEGIN
	CALL "MIG_LOG_PROC_TIME"('MIG_RUN_AB103', 'MIG', 1);			
	...
	env_risky_status, env_risky_date, env_risky_remark, asset_description, phy_inspection_freq_unit, type_of_asset)
	...
	CALL "MIG_LOG_PROC_TIME"('MIG_RUN_AB103', 'MIG', 0);
