...
<%
    int sno = 0;
    List ccAddCheckList = (List)session.getAttribute("com.integrosys.cms.ui.checklist.other.OtherCheckListAction.ccAddCheckList");
...
<%@page import="com.integrosys.cms.ui.checklist.other.OtherCheckListForm"%>
...
<table class="tblFormSection" width="70%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3>Maintain Other Checklist </h3></td>
    </tr>
    <tr>
      <td><hr/></td>
    </tr>
...
<% if(sno==0){%>
            <tr class="odd">
              <td colspan="9">There are no other documents </td>
            </tr>
<% }%>        </tbody>
      </table>
    </td>
