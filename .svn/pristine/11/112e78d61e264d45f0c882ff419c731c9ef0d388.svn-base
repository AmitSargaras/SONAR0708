...
function cancelPage(){
    document.forms[0].action="State.do?event=checker_view_list_state";
    
    document.forms[0].submit();
}
function approvePage() {
	
    document.forms[0].action="State.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="State.do?event=<%=rejectEvent%>";
    document.forms[0].submit();
}
function cancelPage(){
														...
														<table width="100%" border="0" align="center"
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="even"><%=StateTrxValue.getUserInfo()%>&nbsp;
																	</td>
																</tr>
																<tr class="odd">
																	<td class="fieldname">
																	...
																	<td><%=StateTrxValue.getRemarks() != null ? StateTrxValue.getRemarks() : ""%>&nbsp;
																	</td>
																</tr>
															</tbody>
														</table>
															...
															<tr>
																...
																<%
																	String pageIndexUrl = null;
																			...
																			pageIndexUrl = "State.do?event=checker_process_create_insert&TrxId="+transId+"&startIndex=";
																%>
