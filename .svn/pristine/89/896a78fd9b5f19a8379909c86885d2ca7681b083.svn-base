...
function closePage() {
	document.forms[0].action="LADReceipt.do?event=view_ok&&limitBkgLoc=IN&&orgCode=000&&checkListID=<%=checklistId %>&&secType=LAD&&secSubType=LAD";
	document.forms[0].submit();
}
function returnPage() {
	document.forms[0].action="LADReceipt.do?event=view_return&&limitBkgLoc=IN&&orgCode=000&&checkListID=<%=checklistId %>&&secType=LAD&&secSubType=LAD";
	document.forms[0].submit();
}
...
<input type="hidden" name="viewFlag" value="<%=viewFlag%>"/>
                                                    ...
                                                    for (int z = 0; z < listLADSubItem.size(); z++) {
                                                       ...
                                                       String rowClass = "";
                                                        ...
                                                        <tr class="<%=rowClass%>">
                                                            ...
                                                            <td width="10%"><a href="LADReceipt.do?event=view_attach_image&id=<%=String.valueOf(item.getChklistDocId())%>&docType=<%=docType %>&docIdLAD=<%=String.valueOf(item.getChklistDocItemId()) %>&checklistId=<%=checklistId + urlForView%>">View Images &nbsp;</a></td>
                                                        </tr>
                                                        <%
                                                    }
                                }
