...
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/assetbased/assetgencharge/drawingpower/drawingpower_view.jsp,v 1.24 2006/10/27 08:24:00 hmbao Exp $
*
...
<%
	...
	if (from_page.equals(DrawingPowerAction.EVENT_READ)) {
	...
	<tr>
	  <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
        ...
        %>
            ...
            <%
            	...
            	if (colAllocation != null)  {
	            	for (int i = 0; i < colAllocation.length; i++) {
	            		...
	            		if (limitCol.getSCISecurityID() != iCol.getSCISecurityID()) {		            		
            %>
          ...
          <td class="total" style="text-align:right "><bean:write name="AssetDrawingPowerForm" property="totalApprovedLimit"/>&nbsp;</td>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr align="center">
      <%
      	if (from_page != null && from_page.equals(DrawingPowerAction.EVENT_TRACK)) {
      %>
	  ...
	  <% 
	  	} else if (from_page != null & from_page.equals(DrawingPowerAction.EVENT_PREPARE_CLOSE)) { 
	  %>
