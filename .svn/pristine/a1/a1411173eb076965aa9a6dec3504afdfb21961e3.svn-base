...
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/marketablesec/markseccustsec/MarksecCustSec_read_helper.jsp,v 1.45 2006/07/27 02:02:54 jzhan Exp $
*
...
* Date: $Date: 2006/07/27 02:02:54 $
* Tag: $Name:  $
*/
%>

<%
    IPortfolioOthers oldCollateral = (IPortfolioOthers) itrxValue.getCollateral();
    IPortfolioOthers newCollateral = (IPortfolioOthers) itrxValue.getStagingCollateral();
	String formName = "MarksecCustSecForm";
    String prefix = "Mark";
    String subtype = "MarksecCustSec";
           ...
           %>
                    ...
                    <tr class="<%=classtype%>">
                      ...
                      <integro:empty-if-null value="<%=marketEquity.getUnitPrice().getCurrencyCode()%>"/>&nbsp;<%=marketEquity.getUnitPrice().getAmount()%>
                       <% } %>
                       &nbsp;</td>
                      <td width="11%"><a href="MarketPortItem.do?event=markseccustsec_read&indexID=<%=marketEquity.getRefID()%>&subtype=MarksecCustSec&from_event=<%=from_event%>">View</a>
                      </td>
                    </tr>
...
%>
                    ...
                    <tr class="<%=classtype%>">
                      ...
                      <integro:empty-if-null value="<%=equity[counter].getUnitPriceCcyCode()%>"/>&nbsp;<%=equity[counter].getUnitPrice().getAmount()%>
                       <% } %>
                       &nbsp;</td>
                      <td width="11%"><a href="MarketPortItem.do?event=markseccustsec_read&indexID=<%=equity[counter].getRefID()%>&subtype=MarksecCustSec&from_event=<%=from_event%>">View</a>
                      </td>
