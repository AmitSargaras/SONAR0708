<%@ page import="com.integrosys.cms.app.collateral.trx.ICollateralTrxValue,
                 ...
                 com.integrosys.cms.ui.collateral.property.proplandurban.PropLandUrbanForm"%>
<%@ page import="com.integrosys.cms.ui.collateral.CollateralAction" %>

<%
    /**
    * Copyright Integro Technologies Pte Ltd
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/property/proplandurban/PropLandUrban_update.jsp,v 1.85 2006/11/23 03:02:10 jzhan Exp $
    *
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.property.PropertyAction.serviceColObj");
    ...
    ILandUrban iCol = (ILandUrban) itrxValue.getStagingCollateral();
    ...
    PropLandUrbanForm colForm = (PropLandUrbanForm) request.getAttribute(formName);
...
<html:form action="PropLandUrbanCollateral.do">
<input type="hidden" name="event">
<input type="hidden" name="itemType"/>
<input type="hidden" name="indexID" />
<input type="hidden" name="subtype" value="PropLandUrban"/>
