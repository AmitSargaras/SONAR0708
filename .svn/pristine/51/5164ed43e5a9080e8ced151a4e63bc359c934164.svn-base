...
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/insprotection/insswap/InsSwap_read.jsp,v 1.17 2006/10/27 08:34:25 hmbao Exp $
*
...
<%	
    ...
    ICreditDefaultSwaps iCol = (ICreditDefaultSwaps) itrxValue.getCollateral();
...
<%@ include file="InsSwap_read_helper.jsp" %>
