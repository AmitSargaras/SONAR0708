 ...
 * @since Oct 1, 2009
 */
public class StpFacIncrementReductionDeletionCmdTest extends TestCase implements IStpConstants, IStpTransType {
    StpFacIncrementReductionDeletionCmd cmd;
    ...
    protected void setUp() throws Exception {
        ...
        obFacilityTrxValue.setStatus(ICMSConstant.STATE_LOADING_DELETE);
        ...
        cmd = new StpFacIncrementReductionDeletionCmd();
    ...
    public void testIncrementMsgDelete() throws Exception {
