...
function saveCustomerForm() {
	...
	document.forms[0].action="ManualInputCustomer.do?event=save_customer_brmaker";
...
function submitForm() {
 	document.forms[0].action="ManualInputCustomer.do?event=create_customer_brmaker";
    document.forms[0].submit();
}
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<td>
					    ...
					    <jsp:include page="create_summary_details_brmaker.jsp"></jsp:include>
