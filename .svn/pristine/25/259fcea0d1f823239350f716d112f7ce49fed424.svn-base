														...
														<table width="100%" border="0" align="center"
															...
															<tbody>
																...
																<tr class="odd">
																	...
																	<td><%=systemBankBranchTrx.getRemarks() != null ? systemBankBranchTrx.getRemarks() : ""%>&nbsp;
																	</td>
																</tr>
															</tbody>
														</table>
															...
															<tr>
																...
																<%
																	String pageIndexUrl = null;
																			...
																			pageIndexUrl = "systemBankBranch.do?event=checker_process_create_insert&TrxId="
											+ transId + "&startIndex=";
																%>
