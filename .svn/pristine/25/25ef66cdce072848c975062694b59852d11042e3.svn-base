...
<%
	...
	double con = 0;
	if( record.getListedShareQuantity () > 0 ){
	    con = ( record.getTotalUnits () + record.getCmsActualHolding () + record.getEarmarkHolding () +record.getEarmarkCurrent () ) * 100 / (double)record.getListedShareQuantity () ;
	}
	
	DecimalFormat df = new DecimalFormat ( "#0.00" ) ;
	
	pageContext.setAttribute ( PreDealConstants.PRE_DEAL_SOURCE_LABELS , request.getAttribute ( PreDealConstants.PRE_DEAL_SOURCE_LABELS ) ) ;
	pageContext.setAttribute ( PreDealConstants.PRE_DEAL_SOURCE_VALUES, request.getAttribute ( PreDealConstants.PRE_DEAL_SOURCE_VALUES ) ) ;
...
<html>
    ...
    <head>
		...
		<!--
			function submit ()
			{
				...
				form.event.value  = '<%= PreDealConstants.EVENT_MAKER_PRESUBMIT_UPDATE_REJECT %>' ;
				form.submit () ;
			}
			...
			{
				var form = document.getElementById( 'form' ) ;
				form.event.value  = '<%= PreDealConstants.EVENT_MAKER_CALCULATE_REJECT %>' ;
				form.submit () ;
			}
			...
			{
				var form = document.getElementById( 'form' ) ;
				form.event.value  = '<%= PreDealConstants.EVENT_MAKER_SOURCE_SYSTEM_REJECT %>' ;
				form.submit () ;			
			}
		//-->
        </script>
    ...
    <body >
        ...
        <html:form action="PreDeal.do" styleId="form" >
            <table width="70%" align="center" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
                <tbody>
                    <tr class="odd">
                        <!--Counter Name-->
                    ...
                    <tr class="even">
                        <!--Branch Name-->
                        <td class="fieldname">
                            <bean:message key="label.predeal.branch.name"/>
                            <span class="style1">* </span>
                        </td>
                        <td colspan="3">
                    ...
                    <tr class="even">
                        ...
                        <td colspan="3">
                            <html:text property="cifNumber" />
                            <html:errors property="cifNumber" />
                        </td>
                    </tr>
                    ...
                    <tr class="even">
                        <!--Account No.-->
                        <td class="fieldname">
                            <bean:message key="label.predeal.account.no"/>
                        </td>
                    ...
                    <tr class="odd">
                        ...
                        <td width="60%" colspan="3">
                            ...
                            <html:errors property="earMarkUnits" />
