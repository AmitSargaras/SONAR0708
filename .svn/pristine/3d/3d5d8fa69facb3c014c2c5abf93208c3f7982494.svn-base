<%@page 	import="java.util.*,com.integrosys.cms.ui.collateral.CategoryCodeConstant,java.util.List,java.util.ArrayList,com.integrosys.base.techinfra.util.DateUtil,com.integrosys.cms.ui.common.CommonCodeList,com.integrosys.cms.app.chktemplate.trx.OBDocumentItemTrxValue,com.integrosys.cms.app.common.constant.ICMSConstant,com.integrosys.cms.ui.facglobal.FacilityGlobalForm"%>
<%
/**
...
function savePage () {
	document.forms[0].action="FacilityGlobal.do?event=draft_doc_item";
...
<!--				-->
<!--				</td>-->
                        <td width="100" valign="baseline" align="center"> <a href="FacilityGlobal.do?event=global_list&type=F&go=N" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image4411"  border="0" id="Image4411" /></a>
                        </td>
                      </tr>
                      <tr>
                        <td valign="baseline" align="center">&nbsp;</td>
