...
if(ICMSConstant.CHECKLIST_CAM.equals(checkListType)){
	...
	cancelEvent = CAMReceiptAction.EVENT_PREPARE_TAG_UNTAG_IMAGE_FROM_RETRIEVE;
}
	...
	cancelEvent = OtherReceiptAction.EVENT_PREPARE_TAG_UNTAG_IMAGE_FROM_RETRIEVE;
	...
	cancelEvent = FacilityReceiptAction.EVENT_PREPARE_TAG_UNTAG_IMAGE_FROM_RETRIEVE;
	...
	cancelEvent = SecurityReceiptAction.EVENT_PREPARE_TAG_UNTAG_IMAGE_FROM_RETRIEVE;
}
...
String documentName = "";
		if(currentIndex != null){
			if(selectedOBImageUpload != null){
				...
				System.out.println("selectedOBImageUpload.getTypeOfDocument() old checklist_image_gallery.jsp =>"+selectedOBImageUpload.getTypeOfDocument());
