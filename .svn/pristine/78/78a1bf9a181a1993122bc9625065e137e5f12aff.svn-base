...
<table width="75" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
   <td> 
    ...
    <td valign="top" ><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','img/print2.gif',1)" onclick="MM_openBrWindow('AuditCheckList.do?event=print_co_borrower_list&checklist_id=<%=checkListIDStr%>&co_borrower_legal_id=<%=coBorrowerLegalID%>&co_borrower_name=<%=encodedCoBorrowerName%>','','scrollbars=yes,toolbar=yes,menubar=yes,resizable=yes,width=760,height=450,left=5,top=5')" ><img src="img/print1.gif" name="Image2" border="0" id="Image2" /></a></td>
  </tr>
  <tr> 
    <td valign="top" >&nbsp;</td>
  </tr>
