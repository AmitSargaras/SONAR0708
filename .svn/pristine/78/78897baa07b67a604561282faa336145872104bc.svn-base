...
function submitPage(event) {
	if(event=="maker_draft_close_process"){
		document.forms[0].action="LimitsOfAuthorityMaster.do?event=maker_confirm_draft_close";
    }else {
    	document.forms[0].action="LimitsOfAuthorityMaster.do?event=maker_confirm_close";
    }
    document.forms[0].submit();
}
</script>
	...
	<body>
		<table width="70%" border="0" align="center" cellpadding="0"
			...
			<thead>
				<tr>
					<td>
						<h3>Close Limits of Authority (LOA) Master</h3>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						...
						<tr class="odd">
							...
							<td width="20%">
								...
								<%=ICMSConstant.YES.equals(loaMasterForm.getFacilityCamCovenant())?"Yes":"No"%>
								<logic:empty name="LimitsOfAuthorityMasterForm" property="facilityCamCovenant">-</logic:empty>
								&nbsp;
