...
'CUST-ALLOC-0012', 'Biopolis Research Lab', 'Biopolis Research Lab', 
'56', 'C', 'MY', 'CUST-ALLOC-0012-BUS', 'ARBS');
...
from sci_le_main_profile where lmp_le_id = 'CUST-ALLOC-0012';
...
lsp_le_id, lsp_id, '80000012', 'ALLOC-AA-0012', cms_le_sub_profile_id, 'ACTIVE', 
'MY', '2', 'ARBS', 'N', 'BANKING', 'Y', 'Y', 'CO', 'CON'
from sci_le_sub_profile where lsp_le_id = 'CUST-ALLOC-0012';
...
where llp_le_id = 'CUST-ALLOC-0012';
...
cms_lsp_lmt_profile_id, '700000023', '27', 'HP',
'25', 'OUTER', 40000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 40000000, '210', 1, 'FAC-ALLOC-0023', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0012';
...
account_type, lmt_bca_ref_num, los_bca_ref_num)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for limit_seq), 2)) AS bigint), 
cms_lsp_lmt_profile_id, '700000024', '27', 'HP',
'25', 'OUTER', 20000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 20000000, '210', 1, 'FAC-ALLOC-0024', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0012';
...
account_type, lmt_bca_ref_num, los_bca_ref_num)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for limit_seq), 2)) AS bigint), 
cms_lsp_lmt_profile_id, '700000025', '27', 'HP',
'25', 'OUTER', 60000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 60000000, '210', 1, 'FAC-ALLOC-0025', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0012';
...
where los_lmt_id in ('FAC-ALLOC-0023','FAC-ALLOC-0024','FAC-ALLOC-0025') ;
...
'--', '--', '--', '-999999999', -999999999, -999999999
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0023','FAC-ALLOC-0024','FAC-ALLOC-0025');
...
cmv, cmv_currency, fsv, fsv_currency, NET_REALIZABLE_VALUE, RESERVE_PRICE)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for collateral_seq), 2)) AS bigint), 
'PT704', 'PT704-ALLOC-0003', 'PT704-ALLOC-0003', 'MY', subtype_name, security_type_name, 
'PT704', 'PT', 'MYR', 'ACTIVE', 'MYR', '12', 'ARBS', 'Y',
120000000, 'MYR', 90000000, 'MYR', 90000000, 80000000
...
where sci_security_dtl_id in ('PT704-ALLOC-0003');	
...
cmv, cmv_currency, fsv, fsv_currency, NET_REALIZABLE_VALUE, RESERVE_PRICE)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for collateral_seq), 2)) AS bigint), 
'MS600', 'MS600-ALLOC-0002', 'MS600-ALLOC-0002', 'MY', subtype_name, security_type_name, 
'MS600', 'MS', 'MYR', 'ACTIVE', 'MYR', '12', 'ARBS', 'Y',
100000000, 'MYR', 8000000, 'MYR',70000000, 60000000
from cms_security_sub_type where security_sub_type_id = 'MS600';

insert into cms_marketable_sec (cms_collateral_id)
select cms_collateral_id from cms_security 
where sci_security_dtl_id in ('MS600-ALLOC-0002');	
...
cmv, cmv_currency, fsv, fsv_currency, NET_REALIZABLE_VALUE, RESERVE_PRICE)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for collateral_seq), 2)) AS bigint), 
'CS202', 'CS202-ALLOC-0002', 'CS202-ALLOC-0002', 'MY', subtype_name, security_type_name, 
'CS202', 'CS', 'MYR', 'ACTIVE', 'MYR', '12', 'ARBS', 'Y',
50000000, 'MYR', 40000000, 'MYR', 30000000, 30000000
from cms_security_sub_type where security_sub_type_id = 'CS202';

insert into cms_cash (cms_collateral_id)
select cms_collateral_id from cms_security 
where sci_security_dtl_id in ('CS202-ALLOC-0002');	
...
cmv, cmv_currency, fsv, fsv_currency, NET_REALIZABLE_VALUE, RESERVE_PRICE
from cms_security 
where sci_security_dtl_id in ('PT704-ALLOC-0003', 'MS600-ALLOC-0002', 'CS202-ALLOC-0002');	
...
and s.sci_security_dtl_id in ('PT704-ALLOC-0003');
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'MS600-ALLOC-0002'), 'MS600-ALLOC-0002',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp , 'I'
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0023', 'FAC-ALLOC-0024');	

insert into cms_limit_security_map
(charge_id, cms_collateral_id, sci_las_sec_id, cms_lsp_appr_lmts_id, sci_las_lmt_id, cms_lsp_lmt_profile_id, 
customer_category,create_date, update_status_ind)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'CS202-ALLOC-0002'), 'CS202-ALLOC-0002',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp , 'I'
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0024', 'FAC-ALLOC-0025');	

insert into cms_limit_security_map
(charge_id, cms_collateral_id, sci_las_sec_id, cms_lsp_appr_lmts_id, sci_las_lmt_id, cms_lsp_lmt_profile_id, 
customer_category,create_date, update_status_ind)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'PT704-ALLOC-0003'), 'PT704-ALLOC-0003',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp , 'I'
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0023', 'FAC-ALLOC-0025');	
...
and s.sci_security_dtl_id in ('PT704-ALLOC-0003', 'MS600-ALLOC-0002', 'CS202-ALLOC-0002');
...
and lmts.los_lmt_id in ('FAC-ALLOC-0023', 'FAC-ALLOC-0025');
...
'MYR', (current timestamp - 5 days), 'V9999', 100000000, 80000000, s.cms_collateral_id, 'S', 'ARBS'
from cms_security s
where s.sci_security_dtl_id in ('MS600-ALLOC-0002');

insert into cms_valuation
(valuation_id, valuation_currency, valuation_date, valuer, cmv, fsv, cms_collateral_id, source_type, source_id)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for VALUATION_SEQ), 2)) AS bigint), 
'MYR', (current timestamp - 5 days), 'V9999', 50000000, 400000000, s.cms_collateral_id, 'S', 'ARBS'
from cms_security s
where s.sci_security_dtl_id in ('CS202-ALLOC-0002');

insert into cms_valuation
(valuation_id, valuation_currency, valuation_date, valuer, cmv, fsv, cms_collateral_id, source_type, source_id)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for VALUATION_SEQ), 2)) AS bigint), 
'MYR', (current timestamp - 5 days), 'V9999', 120000000, 90000000, s.cms_collateral_id, 'S', 'ARBS'
from cms_security s
where s.sci_security_dtl_id in ('PT704-ALLOC-0003');
...
'37', 'ARBS', 'SIBS-ACT-0029', 'MY', 'N', 'A', 'L', 1, 40000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0030', 'MY', 'N', 'A', 'L', 1, 20000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0031', 'MY', 'N', 'A', 'L', 1, 60000000, 'I');

-- npl account
insert into cms_npl
(cms_npl_id, account_number ,source_id, account_status, status)
values
(CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for NPL_SEQ), 2)) AS bigint), 
	'SIBS-ACT-0030', 'ARBS', 'A', 'Y');
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	...
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0029'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0023';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0030'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0024';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0031'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0025';
