...
function saveForm()
{
	...
	document.forms["CCReceiptForm"].event.value="save_update_renewal";
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td><h3>Update CC Doc Receipt </h3></td>
    </tr>
    <tr>
...
--%>
         <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" class="tblInput">
            <tbody>
           <tr class="odd">
