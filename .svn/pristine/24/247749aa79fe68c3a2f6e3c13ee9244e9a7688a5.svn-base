...
<%
    ...
    ICashCash oldCollateral = (ICashCash) itrxValue.getCollateral();
    ICashCash newCollateral = (ICashCash) itrxValue.getStagingCollateral();
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
            <tbody>
                ...
                <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                    ...
                    <td><% if (!isLimitNull) { %>
	                        <bean:write name="CashCashForm" property="amtCharge"/>
                        <% } %> &nbsp;</td>
