drop procedure dc_validate_ab102
@

create procedure dc_validate_ab102 
	language sql
begin
	...
	set v_update_ind = 'update dc_ab102'
		' set VALID_IND = ''N'' '||
	...
	set v_insert_ind = 'insert into dc_error_log '||
		...
		'select current_timestamp, ''DC-ARBS'', ''DC_AB102-''||REGION, CMS_COLLATERAL_ID, '||
