...
<%
	...
	String pageIndexUrl = "directorMaster.do?event=checker_list_pagination&searchBy="+srcBy+"&searchText="+srcText+"&startIndex=";
%>
...
function cancel()
{
 ...
 {	
	    ...
	    if(document.getElementById("searchText").value==""||document.getElementById("searchText").value==null||document.getElementById("searchByCriteria").value=="")
		    {
	    	 document.forms[0].action="directorMaster.do?event=checker_list_directorMaster";
			 document.forms[0].submit();
		    }	
	    else
		{    
                         ...
                         <%}else{ %>Disable<%}%></td>   
                             ...
                             <td> <select name="menu1" onchange="MM_jumpMenu('self',this,0)" style="width:110">
                                  <option value="#" selected>Please Select</option>                                      
                                   ...
                                   <option value='directorMaster.do?event=checker_view_directorMaster&branchCode=<%=ob.getId()%>'>View</option>
