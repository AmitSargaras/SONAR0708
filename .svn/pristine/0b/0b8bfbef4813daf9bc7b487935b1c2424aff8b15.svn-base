...
function submitForm() {
		document.forms[0].action = "npaTraqCodeMaster.do?event=maker_edit_npa_traq_code_master";
		document.getElementById("propertyTypeCodeDesc").disabled=false;
		document.forms[0].submit();
	}

function saveForm() {
		document.forms[0].action = "npaTraqCodeMaster.do?event=maker_update_draft_npa_traq_code_master";
		document.getElementById("propertyTypeCodeDesc").disabled=false;
		document.forms[0].submit();
	}
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								...
								<tr class="odd">
				                  ...
				                  <td width="20%">
				                  	<html:select styleId="securitySubType" property="securitySubType"  disabled="false">
