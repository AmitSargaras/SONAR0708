package com.integrosys.simulator.host.stp;

import com.integrosys.simulator.host.base.castor.IMessage;
...
public class STPMessage implements Serializable, IMessage {
	...
	private com.integrosys.simulator.host.stp.STPBody msgBody;
	 ...
	 */
	public STPMessage(STPHeader header, com.integrosys.simulator.host.stp.STPBody body) {
	 ...
	 * @param body message body
	 */
	public STPMessage(String correlationId, STPHeader header, com.integrosys.simulator.host.stp.STPBody body) {
	...
	public com.integrosys.simulator.host.stp.STPBody getMsgBody() {
		return msgBody;
	}
	...
	public void setMsgBody(com.integrosys.simulator.host.stp.STPBody msgBody) {
