<%@ page import="com.integrosys.cms.ui.custgrpi.groupotrlimit.GroupOtrLimitForm" %>
...
<%
    ...
    GroupOtrLimitForm aForm = (GroupOtrLimitForm) request.getAttribute("GroupOtrLimitForm");
...
<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
    <thead>
        <tr>
            <td><h3><bean:message key="label.group.other.limit"/> - Update </h3></td>
        ...
        <tr>
            <td colspan="2">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
                    <tbody>
                        <tr class="even">
                            <td width="38%" class="fieldname"><bean:message key="label.group.other.limit.type"/> <span
