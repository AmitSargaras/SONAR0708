...
function submitPage(event) {
	...
	if(event=="maker_draft_close_process")
		...
		document.forms[0].action="MIPartyGroup.do?event=maker_confirm_draft_close";
		
    }else{
      
    	document.forms[0].action="MIPartyGroup.do?event=maker_confirm_close";
    }
