...
<%@ page import="com.integrosys.base.techinfra.logger.DefaultLogger,com.integrosys.base.businfra.search.SearchResult,
	com.integrosys.base.uiinfra.tag.PageIndex,com.integrosys.cms.ui.user.MaintainUserForm,com.integrosys.cms.app.common.constant.ICMSConstant,
	com.integrosys.base.uiinfra.common.ICommonEventConstant,com.integrosys.cms.ui.login.CMSGlobalSessionConstant,
	com.integrosys.cms.ui.bizstructure.MaintainTeamUtil,com.integrosys.component.user.app.bus.CommonUserSearchCriteria,
	com.integrosys.component.commondata.app.CommonDataSingleton,
	java.util.List,java.util.Vector,
	com.integrosys.cms.app.customer.bus.ICMSCustomer,
	com.integrosys.cms.app.customer.bus.OBCMSCustomer,
	com.integrosys.cms.app.customer.bus.OBCriFac,
	com.integrosys.cms.app.customer.bus.ICriFac"%>
<%@page
...
<%@page import="java.util.*"%><script type="text/javascript"
...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
 	//session.removeAttribute("com.integrosys.cms.ui.manualinput.customer.ManualInputCustomerAction.facList");
	...
	List facList = (ArrayList) session
	...
	List partyGroupList = (List) session.getAttribute(
			"com.integrosys.cms.ui.manualinput.customer.ManualInputCustomerAction.partyGroupList");
	...
	List securityNameList = (List) session.getAttribute(
			"com.integrosys.cms.ui.manualinput.customer.ManualInputCustomerAction.securityNameList");
	...
	if (!(securityNameList == null)) {
	  ...
	  List securityCodeAndTypeList = (List) session.getAttribute(
				"com.integrosys.cms.ui.manualinput.customer.ManualInputCustomerAction.securityCodeAndTypeList");
			
	  if (null!= securityCodeAndTypeList) 
		{
			pageContext.setAttribute("securityCodeAndTypeList", securityCodeAndTypeList);
	  		System.out.println("securityCodeAndTypeList::::"+securityCodeAndTypeList.size());
		}
...
<!--
	...
	<%-- alert('hhhiii');
	var revised = '<%=revisedArr22%>';
	revisedArrs
	//alert(revised);
	var lengt = <%=len%>;
	 for(var i=0;i<lengt;i++){
		var revisedArrs = '<%=revisedArr22.get(cnt)%>';
		//alert(revisedArrs);
		 <%=cnt++%>
	}  --%>
	//document.getElementById("revisedEmailIdsArrayId").value = revisedArrs; 
	<%--  var revisedArrs = <%=revisedArr%>;
		//alert(revisedArrs);
		document.getElementById("revisedEmailIdsArrayId").value = revisedArrs;  --%>
}
...
<table width="100%" height="100%" cellspacing="0" cellpadding="0"
						...
						<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
									...
									<tr class="even">
										...
										<td width="30%"><html:text property="customerRamID"
												styleId="customerRamID" maxlength="20">
									...
									<tr class="odd">
										...
										<td width="30%"><html:text property="customerAprCode"
												styleId="customerAprCode" maxlength="10"></html:text> <html:errors
												property="customerAprCode" /></td>
									...
									<tr class="even">
										...
										<td><html:radio property="isNbfs" value="Yes"
												styleId="isNbfs" onclick="showHideNbfs();" /> Yes <html:radio
												property="isNbfs" value="No" styleId="isNbfs"
												...
												<logic:iterate id="ob" name="partyGroupList"
													...
													<%
														if (formObj.getPartyGroupName() != null
																		&& formObj.getPartyGroupName().equals(String.valueOf(ob.getId()))) {
													%>
													<html:text property="groupExposer" styleId="groupExposer"
														value="<%=String.valueOf(ob.getGroupExpLimit().getAmountAsBigDecimal())%>"
								...
								--></td>
										...
										<td><html:select property="msmeClassification"
												styleId="msmeClassification" style="width:225">
												<integro:common-code
													categoryCode="<%=CategoryCodeConstant.CommonCode_MSME_CLASSIC%>"
													descWithCode="false" />
											</html:select>
									...
									<tr class="even">
										...
										<td>
											<p>
												<html:radio property="isWeakerSection"
													styleId="isWeakerSection" value="Yes"
													onclick="showHideWeakerSection();" />
												Yes
											<p>
												<html:radio property="isWeakerSection"
													styleId="isWeakerSection" value="No"
													onclick="showHideWeakerSection();" />
												No &nbsp;
										...
										<td>
											<p>
												<html:select property="weakerSection"
													styleId="weakerSection" style="width:225">
													<integro:common-code
														categoryCode="<%=CategoryCodeConstant.CommonCode_WEAKER_SEC%>"
														descWithCode="false" />
												</html:select>
												<html:errors property="weakerSection" />
											</p>
											<p>
												<html:text property="govtSchemeType"
													styleId="govtSchemeType" />
											</p> <html:errors property="govtSchemeType" />
											</p>
										</td>
									</tr>
									...
									<tr class="odd">
										...
										<td>
											<p>
												<html:radio property="isMinorityCommunity"
													styleId="isMinorityCommunity" value="Yes"
													onclick="showHideMinorityCommunity()" />
												Yes
												<html:radio property="isMinorityCommunity"
													styleId="isMinorityCommunity" value="No"
													onclick="showHideMinorityCommunity()" />
												No &nbsp;
												<html:errors property="isMinorityCommunity" />
											<p>
												<html:select property="minorityCommunity"
													styleId="minorityCommunity">
													<integro:common-code
														categoryCode="<%=CategoryCodeConstant.CommonCode_MINORITY_COMMU%>"
														descWithCode="false" />
												</html:select>
												<html:errors property="minorityCommunity" />
											</p>
										</td>
									...
									<tr class="even">
										...
										<td><html:radio property="isCommoditiesExposer"
												styleId="isCommoditiesExposer" value="Yes"
												onclick="showHideCommoditiesExposer()" /> Yes <html:radio
												property="isCommoditiesExposer"
												styleId="isCommoditiesExposer" value="No"
												onclick="showHideCommoditiesExposer()" /> No &nbsp; <html:errors
												property="isCommoditiesExposer" /></td>
									</tr>
									<tr class="odd">
										<td class="fieldname">Sensitive</td>
										<td><html:radio property="isSensitive"
												styleId="isSensitive" value="Yes"
												onclick="showHideSensitive()" /> Yes <html:radio
												property="isSensitive" styleId="isSensitive" value="No"
												onclick="showHideSensitive()" /> No &nbsp; <html:errors
												property="isSensitive" /></td>
										<td class="fieldname">Commodity Name</td>
										<td><html:select property="commoditiesName"
												styleId="commoditiesName" style="width:225">
												<integro:common-code
									...
									<tr class="even">
										<td class="fieldname">Gross Investment (In plant and
											machinery) (INR)</td>
										<td>Rs.<html:text property="grossInvsInPM" maxlength="23"
												styleId="grossInvsInPM"
												onblur="javascript:formatAmountAsCommaSeparated(this)" />&nbsp;
											millions <html:errors property="msmeGrossInvsInPM" /> <html:errors
												property="grossInvsInPM" /></td>
										<td class="fieldname">Gross Investment (In equipment)
											(INR)</td>
										<td>Rs.<html:text property="grossInvsInEquip"
												maxlength="23" styleId="grossInvsInEquip"
												onblur="javascript:formatAmountAsCommaSeparated(this)" />&nbsp;
											millions <html:errors property="grossInvsInEquip" /> <html:errors
												property="msmeGrossInvsInEquip" />
										</td>
									</tr>
									<tr class="odd">
										...
										<td>
											<p>
												<html:radio property="psu" styleId="psu" value="State"
													onclick="showHidePsu();" />
												State
												<html:radio property="psu" styleId="psu" value="Central"
													onclick="showHidePsu();" />
												Central
												<html:radio property="psu" styleId="psu" value="No"
													onclick="showHidePsu();" />
												No
										...
										<td>
											<p>
												<html:text property="psuPercentage" styleId="psuPercentage"
													maxlength="5" />
												<html:errors property="psuPercentage" />
											</p>
										</td>
									</tr>
									<tr class="even">
										<td class="fieldname">Govt. Undertaking</td>
										<td><html:radio property="govtUnderTaking"
												styleId="govtUnderTaking" value="State" /> State <html:radio
												property="govtUnderTaking" styleId="govtUnderTaking"
												value="Central" /> Central <html:radio
												property="govtUnderTaking" styleId="govtUnderTaking"
												value="No" /> No <html:errors property="govtUnderTaking" />
										</td>
									...
									<tr class="odd">
										...
										<td><html:radio property="isSemsGuideApplicable"
												styleId="isSemsGuideApplicable" value="Yes" /> Yes <html:radio
												property="isSemsGuideApplicable"
												styleId="isSemsGuideApplicable" value="No" /> No <html:errors
												property="isSemsGuideApplicable" /></td>
										<td class="fieldname">Whether fails under IFC&rsquo;s
											Exclusion List</td>
										<td><html:radio property="isFailIfcExcluList"
												styleId="isFailIfcExcluList" value="Yes" /> Yes <html:radio
												property="isFailIfcExcluList" styleId="isFailIfcExcluList"
												value="No" /> No <html:errors property="isFailIfcExcluList" />
										</td>
									</tr>
									<tr class="even">
										<td class="fieldname">TUFS</td>
										<td><html:radio property="isTufs" styleId="isTufs" value="Yes"  onclick="changeSubsidy('Yes');"/> Yes <html:radio
												property="isTufs" styleId="isTufs" value="No" onclick="changeSubsidy('No');"/> No <html:errors
												property="isTufs" /></td>
										<td class="fieldname">RBI Defaulter&rsquo;s list /
											Caution List</td>
										<td>
											<p>
												<html:radio property="isRbiDefaulter"
													styleId="isRbiDefaulter" value="Yes"
													onclick="showHideRbiDefaulter();" />
												Yes
												<html:radio property="isRbiDefaulter"
													styleId="isRbiDefaulter" value="No"
													onclick="showHideRbiDefaulter();" />
												No
											...
											<p>
												...
												%>
												<input type="radio" name="rbiDefaulter" id="rbiDefaulter"
													value="Company" checked="checked" /> Company <input
													type="radio" name="rbiDefaulter" id="rbiDefaulter"
													value="Directors" /> Directors <input type="radio"
													name="rbiDefaulter" id="rbiDefaulter"
													value="Group Companies" /> Group Companies
												<%
													}
												%>
												<%
												...
												%>
												<input type="radio" name="rbiDefaulter" id="rbiDefaulter"
													value="Company" /> Company <input type="radio"
													name="rbiDefaulter" id="rbiDefaulter" value="Directors"
													checked="checked" /> Directors <input type="radio"
													name="rbiDefaulter" id="rbiDefaulter"
													value="Group Companies" />Group Companies
												<%
													}
												...
												<input type="radio" name="rbiDefaulter" id="rbiDefaulter"
													value="Company" /> Company <input type="radio"
													name="rbiDefaulter" id="rbiDefaulter" value="Directors" />
												Directors <input type="radio" name="rbiDefaulter"
													id="rbiDefaulter" value="Group Companies" checked="checked" />
												Group Companies
												<%
													}
												%>
												...
												<input type="radio" name="rbiDefaulter" id="rbiDefaulter"
													...
													name="rbiDefaulter" id="rbiDefaulter" value="Directors" />
												Directors <input type="radio" name="rbiDefaulter"
													id="rbiDefaulter" value="Group Companies" /> Group
												Companies
												<%
													}
												%>
												...
												%>
												<html:radio property="rbiDefaulter" styleId="rbiDefaulter"
													value="Company" disabled="true" />
												Company
												<html:radio property="rbiDefaulter" styleId="rbiDefaulter"
													value="Directors" disabled="true" />
												Directors
												<html:radio property="rbiDefaulter" styleId="rbiDefaulter"
													value="Group Companies" disabled="true" />
												Group Companies
									...
									<tr class="odd">
										<td class="fieldname">Litigations Pending / contemplated
											by Banks / Financiers</td>
										<td><html:radio property="isLitigation"
												styleId="isLitigation" value="Yes"
												onclick="showHideLitigation();" /> Yes <html:radio
												property="isLitigation" styleId="isLitigation" value="No"
												onclick="showHideLitigation();" /> No <html:errors
												property="isLitigation" /> <html:text
												property="litigationBy" styleId="litigationBy" />
											<html:errors property="litigationBy" /></td>
										<td class="fieldname">Interest of Directors / Senior
											officers / (Credit approvers) of the bank</td>
										<td><html:radio property="isInterestOfBank"
												styleId="isInterestOfBank" value="Yes"
												onclick="showHideInterestOfBank();" /> Yes <html:radio
												property="isInterestOfBank" styleId="isInterestOfBank"
												value="No" onclick="showHideInterestOfBank();" /> No <html:errors
												property="isInterestOfBank" /> <html:text
												property="interestOfBank" styleId="interestOfBank" />
											<html:errors property="interestOfBank" /></td>
									</tr>
									<tr class="even">
										<td class="fieldname">Adverse Remark (if Any)</td>
										<td><html:radio property="isAdverseRemark"
												styleId="isAdverseRemark" value="Yes"
												onclick="showHideAdverseRemark(1);" /> Yes <html:radio
												property="isAdverseRemark" styleId="isAdverseRemark"
												value="No" onclick="showHideAdverseRemark(2);" /> No <html:errors
												property="isAdverseRemark" /> <html:text
												property="adverseRemark" styleId="adverseRemark" /> <html:errors
												property="adverseRemark" /></td>
 ...
 %> <font
											id="astrick" color="red" style="display: none;">*</font> <%
 	}
 %>

										</td>
										<td><html:radio property="auditType" styleId="auditType"
												value="Internal Audit" /> Internal Audit <html:radio
												property="auditType" styleId="auditType"
												value="External Audit" /> External Audit <html:radio
												property="auditType" styleId="auditType" value="RBI Audit" />
											RBI Audit <html:errors property="auditType" /></td>
									</tr>
									<tr class="odd">
										<td class="fieldname">Average Annual turnover (In Million
											INR)</td>
										<td><html:text property="avgAnnualTurnover"
												maxlength="23" styleId="avgAnnualTurnover"
												onblur="javascript:formatAmountAsCommaSeparated(this)" />
											<html:errors property="avgAnnualTurnover" /></td>
										<td class="fieldname">RBI Industry Code</td>
										<td><%=("".equals(value.getRbiIndustryCode()) || value.getRbiIndustryCode() == null)
					? "-"
					: value.getRbiIndustryCode() + "-"%>
											<integro:common-code descWithCode="false"
												categoryCode="<%=CategoryCodeConstant.HDFC_RBI_CODE%>"
												entryCode="<%=value.getRbiIndustryCode()%>" display="true" /></td>
									</tr>
									<tr class="even">
										...
										<td><html:text property="industryExposer"
												styleId="industryExposer" maxlength="7" />
											<html:errors property="industryExposer" /></td>
									</tr>

									<tr class="odd">
										<td class="fieldname">Is the borrower a director
											(including the chairman/ Managing Director) of other banks</td>
										<td><html:radio property="isDirecOtherBank"
												styleId="isDirecOtherBank" value="Yes"
												onclick="showHideDirecOtherBank();" /> Yes <html:radio
												property="isDirecOtherBank" styleId="isDirecOtherBank"
												value="No" onclick="showHideDirecOtherBank();" /> No <html:errors
												property="isDirecOtherBank" /> <html:text
												property="direcOtherBank" styleId="direcOtherBank" />
											<html:errors property="direcOtherBank" /></td>
										<td class="fieldname">Is the partner / guarantor of the
											borrowing firm a director of other banks</td>
										<td><html:radio property="isPartnerOtherBank"
												styleId="isPartnerOtherBank" value="Yes"
												onclick="showHidePartnerOtherBank();" /> Yes <html:radio
												property="isPartnerOtherBank" styleId="isPartnerOtherBank"
												value="No" onclick="showHidePartnerOtherBank();" /> No <html:errors
												property="isPartnerOtherBank" /> <html:text
												property="partnerOtherBank" styleId="partnerOtherBank" />
											<html:errors property="partnerOtherBank" /></td>
									</tr>
									<tr class="even">
										...
										<td><html:radio property="isSubstantialOtherBank"
												styleId="isSubstantialOtherBank" value="Yes"
												onclick="showHideSubstantialOtherBank();" /> Yes <html:radio
												property="isSubstantialOtherBank"
												styleId="isSubstantialOtherBank" value="No"
												onclick="showHideSubstantialOtherBank();" /> No <html:errors
												property="isSubstantialOtherBank" /> <html:text
												property="substantialOtherBank"
												styleId="substantialOtherBank" />
											<html:errors property="substantialOtherBank" /></td>
										<td class="fieldname">Is the borrower a relative of HDFC
											Bank&rsquo;s Chairman / Managing directors or other directors</td>
										<td><html:radio property="isHdfcDirecRltv"
												styleId="isHdfcDirecRltv" value="Yes"
												onclick="showHideHdfcDirecRltv();" /> Yes <html:radio
												property="isHdfcDirecRltv" styleId="isHdfcDirecRltv"
												value="No" onclick="showHideHdfcDirecRltv();" /> No <html:errors
												property="isHdfcDirecRltv" /> <html:text
												property="hdfcDirecRltv" styleId="hdfcDirecRltv" />
											<html:errors property="hdfcDirecRltv" /></td>
									</tr>
									<tr class="odd">
										<td class="fieldname">Is the borrower a relative of the
											Chairman / Managing Directors / or other directors of other
											banks</td>
										<td><html:radio property="isObkDirecRltv"
												styleId="isObkDirecRltv" value="Yes"
												onclick="showHideObkDirecRltv();" /> Yes <html:radio
												property="isObkDirecRltv" styleId="isObkDirecRltv"
												value="No" onclick="showHideObkDirecRltv();" /> No <html:errors
												property="isObkDirecRltv" /> <html:text
												property="obkDirecRltv" styleId="obkDirecRltv" />
											<html:errors property="obkDirecRltv" /></td>
										<td class="fieldname">Is the partner/ guarantor / of the
											borrowing firm a relative of the Chairman / Managing Director
											or other directors of HDFC Bank or other Banks</td>
										<td><html:radio property="isPartnerDirecRltv"
												styleId="isPartnerDirecRltv" value="Yes"
												onclick="showHidePartnerDirecRltv();" /> Yes <html:radio
												property="isPartnerDirecRltv" styleId="isPartnerDirecRltv"
												value="No" onclick="showHidePartnerDirecRltv();" /> No <html:errors
												property="isPartnerDirecRltv" /> <html:text
												property="partnerDirecRltv" styleId="partnerDirecRltv" />
											<html:errors property="partnerDirecRltv" /></td>
									</tr>
									<tr class="even">
										<td class="fieldname">Is the &ldquo;substantial&rdquo;
											shareholder / director / guarantor of the borrowing company a
											relative of the Chairman / Managing directors or other
											directors of HDFC Bank or other Banks</td>
										<td><html:radio property="isSubstantialRltvHdfcOther"
												styleId="isSubstantialRltvHdfcOther" value="Yes"
												onclick="showHideSubstantialRltvHdfcOther();" /> Yes <html:radio
												property="isSubstantialRltvHdfcOther"
												styleId="isSubstantialRltvHdfcOther" value="No"
												onclick="showHideSubstantialRltvHdfcOther();" /> No <html:errors
												property="isSubstantialRltvHdfcOther" /> <html:text
												property="substantialRltvHdfcOther"
												styleId="substantialRltvHdfcOther" />
											<html:errors property="substantialRltvHdfcOther" /></td>
										<td class="fieldname">&nbsp;</td>
										<td>&nbsp;</td>
									</tr>
									<tr class="odd">
										<td class="fieldname">Infrastructure Finance</td>
										<td><html:radio property="isInfrastructureFinanace"
												styleId="isInfrastructureFinanace" value="Yes"
												onclick="showHideInfrastructureFinanace();"
												onclick="showHideButtion();" disabled="true" /> Yes <html:radio
												property="isInfrastructureFinanace"
												styleId="isInfrastructureFinanace" value="No"
												onclick="showHideInfrastructureFinanace();"
												onclick="showHideButtion();" disabled="true" /> No <html:errors
												property="isInfrastructureFinanace" /></td>
										<td class="fieldname">
											<p>Type</p>
										</td>
										<td><html:select property="infrastructureFinanaceType"
												styleId="infrastructureFinanaceType" style="width:350">
												<integro:common-code
													categoryCode="<%=CategoryCodeConstant.CommonCode_INFRA_FINANACE_TYPE%>"
													descWithCode="false" />
											</html:select>
											<html:errors property="infrastructureFinanaceType" /></td>
									</tr>
									<tr class="even">
										<td class="fieldname">Project Finance</td>
										<td><html:radio property="isProjectFinance"
												styleId="isProjectFinance" value="Yes"
												onclick="showHideButtion();" disabled="true" /> Yes <html:radio
												property="isProjectFinance" styleId="isProjectFinance"
												value="No" onclick="showHideButtion();" disabled="true" />
											No <html:errors property="isProjectFinance" /></td>
										<td class="fieldname">Kisan Credit Card(KCC)</td>
										<td><html:radio property="isKisanCreditCard"
												styleId="isKisanCreditCard" value="Yes"
												onclick="showHideButtion();" disabled="true" /> Yes <html:radio
												property="isKisanCreditCard" styleId="isKisanCreditCard"
												value="No" onclick="showHideButtion();" disabled="true" />
											No <html:errors property="isKisanCreditCard" /></td>
									</tr>
									<tr class="odd">
										<td class="fieldname">Permanent SSI Cert</td>
										<td><html:radio property="isPermenentSsiCert"
												styleId="isPermenentSsiCert" value="Yes"
												onclick="showHideButtion();" disabled="true" /> Yes <html:radio
												property="isPermenentSsiCert" styleId="isPermenentSsiCert"
												value="No" onclick="showHideButtion();" disabled="true" />
											No <html:errors property="isPermenentSsiCert" /></td>
										<td class="fieldname">Backed by Govt.</td>
										<td><html:radio property="isBackedByGovt"
												styleId="isBackedByGovt" value="State"
												onclick="showHideButtion();" disabled="true" /> State <html:radio
												property="isBackedByGovt" styleId="isBackedByGovt"
												value="Central" onclick="showHideButtion();" disabled="true" />
											Central <html:radio property="isBackedByGovt"
												styleId="isBackedByGovt" value="No"
												onclick="showHideButtion();" disabled="true" /> No <html:errors
												property="isBackedByGovt" /></td>
									</tr>
									<tr class="even">
										<td class="fieldname">Priority/Non priority Sector</td>
										<td><html:radio property="isPrioritySector"
												styleId="isPrioritySector" value="Yes"
												onclick="showHideButtion();" disabled="true" /> Yes <html:radio
												property="isPrioritySector" styleId="isPrioritySector"
												value="No" onclick="showHideButtion();" disabled="true" />
											No <html:errors property="isPrioritySector" /></td>
										<td class="fieldname">Capital Market Exposure</td>
										<td><html:radio property="isCapitalMarketExpos"
												styleId="isCapitalMarketExpos" value="Yes"
												onclick="showHideButtion();" disabled="true" /> Yes <html:radio
												property="isCapitalMarketExpos"
												styleId="isCapitalMarketExpos" value="No"
												onclick="showHideButtion();" disabled="true" /> No <html:errors
												property="isCapitalMarketExpos" /></td>
									</tr>
									<tr class="odd">
										<td class="fieldname">Real Estate Exposure</td>
										<td><html:radio property="isRealEstateExpos"
												styleId="isRealEstateExpos" value="Yes"
												onclick="showHideButtion();" disabled="true" /> Yes <html:radio
												property="isRealEstateExpos" styleId="isRealEstateExpos"
												value="No" onclick="showHideButtion();" disabled="true" />
											No <html:errors property="isRealEstateExpos" /></td>
										<td class="fieldname">&nbsp;</td>
										<td>&nbsp;</td>
									</tr>
									<tr class="even">
										...
										<td><html:select name="ManualInputCustomerInfoForm"
												styleId="firstYear" property="firstYear" style="width:250px">
												<integro:common-code descWithCode="false"
													categoryCode="<%=CategoryCodeConstant.CRI_TENURE_YEAR%>"
													refEntryCode='<%=request.getParameter("newCollateralMainType")%>' />
											</html:select> <br></br>
										<html:errors property="firstYear" /></td>
										<td class="fieldname">1st year Turnover</td>
										<td><html:text property="firstYearTurnover"
												styleId="firstYearTurnover"
												onblur="javascript:formatAmountAsCommaSeparated(this)" />&nbsp;
											<%
											...
											<html:select property="firstYearTurnoverCurr" value="INR"
												styleId="firstYearTurnoverCurr">
												<html:options collection="currencyList" property="value"
													labelProperty="label" />
											</html:select> <%
 	} else {
 %> <html:select property="firstYearTurnoverCurr"
												styleId="firstYearTurnoverCurr"
												value="<%=formObj.getFirstYearTurnoverCurr().trim()%>">
												<html:options collection="currencyList" property="value"
													labelProperty="label" />
											</html:select> <%
 	}
 %> <br></br> <html:errors property="firstYearTurnover" />
									...
									<tr class="odd">
										...
										<td><html:select name="ManualInputCustomerInfoForm"
												styleId="secondYear" property="secondYear"
												style="width:250px">
												<integro:common-code descWithCode="false"
													categoryCode="<%=CategoryCodeConstant.CRI_TENURE_YEAR%>"
													refEntryCode='<%=request.getParameter("newCollateralMainType")%>' />
											</html:select> <br></br> <html:errors property="secondYear" /></td>
										<td class="fieldname">2nd year Turnover</td>
										<td><html:text property="secondYearTurnover"
												styleId="secondYearTurnover"
												onblur="javascript:formatAmountAsCommaSeparated(this)" />&nbsp;

											<%
												if (formObj.getSecondYearTurnoverCurr() == null || formObj.getSecondYearTurnoverCurr().trim().equals("")) {
											%>
											<html:select property="secondYearTurnoverCurr"
												styleId="secondYearTurnoverCurr" value="INR">
												<html:options collection="currencyList" property="value"
													labelProperty="label" />
											</html:select> <%
 	} else {
 %> <html:select property="secondYearTurnoverCurr"
												styleId="secondYearTurnoverCurr"
												value="<%=formObj.getSecondYearTurnoverCurr().trim()%>">
												<html:options collection="currencyList" property="value"
													labelProperty="label" />
											</html:select> <%
 	}
 %> <br></br> <html:errors property="secondYearTurnover" />
									...
									<tr class="even">
										...
										<td><html:select name="ManualInputCustomerInfoForm"
												property="thirdYear" styleId="thirdYear" style="width:250px">
												<integro:common-code descWithCode="false"
													categoryCode="<%=CategoryCodeConstant.CRI_TENURE_YEAR%>"
													refEntryCode='<%=request.getParameter("newCollateralMainType")%>' />
											</html:select> <br></br> <html:errors property="thirdYear" /></td>
										<td class="fieldname">3rd year Turnover</td>
										<td><html:text property="thirdYearTurnover"
												styleId="thirdYearTurnover"
												onblur="javascript:formatAmountAsCommaSeparated(this)" />&nbsp;

											<%
												if (formObj.getThirdYearTurnoverCurr() == null || formObj.getThirdYearTurnoverCurr().trim().equals("")) {
											%>
											<html:select property="thirdYearTurnoverCurr"
												styleId="thirdYearTurnoverCurr" value="INR">
												<html:options collection="currencyList" property="value"
													labelProperty="label" />
											</html:select> <%
 	} else {
 %> <html:select property="thirdYearTurnoverCurr"
												styleId="thirdYearTurnoverCurr"
												value="<%=formObj.getThirdYearTurnoverCurr().trim()%>">
												<html:options collection="currencyList" property="value"
													labelProperty="label" />
											</html:select> <%
 	}
 %> <br></br> <html:errors property="thirdYearTurnover" />
									...
									<tr class="odd">
										...
										<td><html:select property="entityType" style="width:250px">
												<integro:common-code
									...
									<tr class="even">
										...
										<td><input type="radio"
											...
											onclick="enableTag('criCountryName','salesPercentage');" />
											Yes <input type="radio" name="indirectCountryRiskExposure"
											onclick="disableTag('criCountryName','salesPercentage');"
											checked="checked" value="No" /> No &nbsp; <html:errors
										...
										<td><html:select property="criCountryName"
												style="width:225" styleId="criCountryName" disabled="true">

												<option value="">Please Select</option>
												<html:options collection="countryList" labelProperty="label"
													property="value" />
											</html:select> <html:errors property="criCountryNameError" /> 
											</br> </br> </br> <html:text property="salesPercentage" maxlength="20"
									...
									<tr class="even">
										<td class="fieldname">Financing for Acquisition of
										...
										<td><html:radio property="financeForAccquisition"
											...
											Yes <html:radio property="financeForAccquisition"
												...
												onclick="disableTag('facilityApproved','facilityAmount','securityName','securityType','securityValue');"
										...
										<td><html:select property="facilityApproved"
											...
											<html:errors property="facilityAmount" /> </br> </br> </br> <html:select
											...
											<html:errors property="securityValue" /></td>
									...
									<tr class="odd">
										...
										<td><html:textarea property="landHolding" rows="3"
												cols="50" value="<%=formObj.getLandHolding()%>"
												styleId="landHolding" />
									...
									<%		if (  null != formObj.getRestrictedListIndustries() ){ %>
										<td><html:radio property="restrictedIndustries"
												...
												onclick="disableTag('restrictedListIndustries')" /> No
											&nbsp; <html:errors property="isWeakerSection" /> <html:select
												property="restrictedListIndustries"
												styleId="restrictedListIndustries" style="width:225"
												value="<%=formObj.getRestrictedListIndustries()%>">
												<integro:common-code
									...
									<tr class="odd">
										...
										<td><html:textarea property="rejectHistoryReason" styleId="rejectHistoryReason"
												rows="3" cols="50"
									...
									<tr class="even">
										...
										<td><html:select property="facility" style="width:225"
												styleId="facility">
											...
											<html:errors property="limitAmount" /></td>
									</tr>
									...
									<tr class="odd">
										...
										<td><html:radio property="cautionList"
											...
											onmouseout="MM_swapImgRestore()" /> <html:errors
												property="dateOfCautionListError" /> </br> </br> </br> <html:text
												...
												style="width:250" styleId="groupCompanies" maxlength="100"
										...
										<td><html:radio property="defaultersList"
											...
											onmouseout="MM_swapImgRestore()" /> <html:errors
												property="aaApprovalDate" /> <html:errors
												property="rbiDateOfCautionListError" /> </br> </br> </br> <html:text
					...
					<tr>
						<td align="right">
							...
							onclick="javascript : addCriFacilityList()" name="AddNew12"
							type="button" id="AddNew12" value="Attach Facility Details"
							class="btnNormal" disabled="disabled" />
						</td>
					</tr>
					<tr>
						<td colspan="2">
									...
									<logic:present name="facList">
										<logic:iterate id="ob" name="facList"
											...
											<tr class="<%=rowClass%>">
												...
												<td>
													<center>
														<integro:empty-if-null value="<%=ob.getSerialNo()%>" />
														&nbsp;
													</center>
												</td>
												<%
												...
												<td>
													<center><%=ob.getFacilityName()%>&nbsp;
													</center>
												</td>
												<td>
													<!--  <center><%=ob.getFacilityAmount()%>&nbsp;</center>-->
													<center>
														<integro:amount param="amount" decimal="2"
															amount="<%=UIUtil.convertToAmount(locale, CommonUtil.getBaseCurrency(), ob.getFacilityAmount())%>" />
														&nbsp;
													</center>
												</td>
												<td><integro:empty-if-null
														value="<%=ob.getEstateType()%>" /> / <integro:empty-if-null
														value="<%=CommonDataSingleton.getCodeCategoryLabelByValue(
							CategoryCodeConstant.CommonCode_COMMERCIAL_REAL_ESTATE, ob.getCommRealEstateType())%>" />
												</td>
												<td><integro:empty-if-null
														value="<%=CommonDataSingleton.getCodeCategoryLabelByValue(
							CategoryCodeConstant.CommonCode_PRIORITY_SECTOR_Y, ob.getPrioritySector())%>" />
												</td>
												<td>
													<center>
														<select id="actionType<%=no%>"
...
<%
	if (formObj.getIsSPVFunding() == null || formObj.getIsSPVFunding().equals("")
...
<%
	if (formObj.getIndirectRealEstate() == null || formObj.getIndirectRealEstate().equals("")
...
<%
	if (formObj.getResidentialRealEstate() == null || formObj.getResidentialRealEstate().equals("")
...
<%
	if (formObj.getCommericialRealEstateResidentialHousing() == null
			|| formObj.getCommericialRealEstateResidentialHousing().equals("")
			|| formObj.getCommericialRealEstateResidentialHousing().equals("No")) {
%>
<script language="javascript">
	document.all.commericialRealEstateResidentialHousing[1].checked = true;
</script>
...
<%
	if (formObj.getCommericialRealEstate() == null || formObj.getCommericialRealEstate().equals("")
...
<%
	if (formObj.getDefaultersList() == null || formObj.getDefaultersList().equals("")
...
<!-- <script language="javascript"> // commented by Dayananda Laishram for IE 11 compatibility changes || Starts
	//A Shiv 230811 -->
<%
	if (formObj.getCautionList() == null || formObj.getCautionList().equals("")
...
<%
	if (formObj.getIfBreachWithPrescriptions() == null || formObj.getIfBreachWithPrescriptions().equals("")
			|| formObj.getIfBreachWithPrescriptions().equals("No")) {
%>
<script language="javascript">
	//alert("no:::"+document.all.ifBreachWithPrescriptions[2].value);
	//alert("no:::"+document.all.ifBreachWithPrescriptions[2].value);
...
<%
	if (formObj.getIsCommodityFinanceCustomer() == null || formObj.getIsCommodityFinanceCustomer().equals("")
...
<%
	if (formObj.getObjectFinance() == null || formObj.getObjectFinance().equals("")
...
<%
	} else if (formObj.getObjectFinance() == null || formObj.getObjectFinance().equals("")
...
<%-- <%
	if (formObj.getOdfdCategory() == null || formObj.getOdfdCategory().equals("")
...
<%
	} else if (formObj.getOdfdCategory() == null || formObj.getOdfdCategory().equals("")
...
<%
	if (formObj.getIsBorrowerInRejectDatabase() == null || formObj.getIsBorrowerInRejectDatabase().equals("")
...
<%
	if (formObj.getIsQualifyingNotesPresent() == null || formObj.getIsQualifyingNotesPresent().equals("")
...
<%
	if (formObj.getIsIPRE() == null || formObj.getIsIPRE().equals("") || formObj.getIsIPRE().equals("No")) {
%>
<script language="javascript">
...
<%
	if (formObj.getIsCGTMSE() == null || formObj.getIsCGTMSE().equals("")
...
<%
	if (null == formObj.getCrilicStatus() || "".equals(formObj.getCrilicStatus())) {
%>
<script language="javascript">
	document.getElementById('comment').disabled = true;
</script>
...
<%
	if (null == formObj.getIsInRestrictedList() || "".equals(formObj.getIsInRestrictedList())
			|| "No".equals(formObj.getRestrictedIndustries())) {
%>
<script language="javascript">
...
<%
	if (formObj.getRestrictedIndustries() == null || formObj.getRestrictedIndustries().equals("")
			|| formObj.getRestrictedIndustries().equals("No")) {
%>
<script language="javascript">
...
<%
	if (formObj.getIsAffordableHousingFinance() == null || formObj.getIsAffordableHousingFinance().equals("")) {
%>
<script language="javascript">
...
%>
<%
	if (formObj.getIsCapitalMarketExpos() == null || formObj.getIsCapitalMarketExpos().equals("")) {
%>
<script language="javascript">
...
%>
<%
	if (formObj.getIsRealEstateExpos() == null || formObj.getIsRealEstateExpos().equals("")) {
%>
<script language="javascript">
...
<%
	if (formObj.getIndirectCountryRiskExposure() == null || formObj.getIndirectCountryRiskExposure().equals("")
