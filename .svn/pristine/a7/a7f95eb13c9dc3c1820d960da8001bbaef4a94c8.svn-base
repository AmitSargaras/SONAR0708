						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
									...
									<tr class="even">
										<td class="fieldname" width="20%">CIN/LLPIN</td>
										<td width="30%"><integro:empty-if-null value="<%=form.getCinLlpin()%>"/></td>
										<td class="fieldname" width="20%">Date of Birth/Incorporation</td>
									...
									<tr class="odd">
										...
										<td><integro:empty-if-null value="<%=form.getForm6061Checked()%>"/>
									...
									<tr class="odd">
										...
										<td><integro:empty-if-null value="<%=form.getDeferLEI()%>"/>
										</tr>
									<tr class="even">
