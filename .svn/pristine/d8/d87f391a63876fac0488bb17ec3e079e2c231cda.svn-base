...
<%  } %>
    ...
    <tr>
      <td nowrap="nowrap" valign="top">-</td>
      <td height="18" nowrap="nowrap"><a href="CCColTask.do?event=list" title="View C/C Collaboration Task">View
...
%>
    <tr>
      <td nowrap valign="top">-</td>
      <td height="18" nowrap wrap ><a href="SecurityColTask.do?event=list" title="View Security Collaboration Task">View
