...
<%
String transactionHistoryListStr = "";
if(prefix.equals("Other"))
{
	transactionHistoryListStr = "com.integrosys.cms.ui.collateral.others.OthersAction.transactionHistoryList";	
	  
}
else if(prefix.equals("Asset"))
{
	transactionHistoryListStr = "com.integrosys.cms.ui.collateral.assetbased.AssetBasedAction.transactionHistoryList"; 
}
else if(prefix.equals("Ins"))
{
	transactionHistoryListStr = "com.integrosys.cms.ui.collateral.insprotection.InsProtectionAction.transactionHistoryList"; 
}
else if(prefix.equals("Mark"))
{
	transactionHistoryListStr = "com.integrosys.cms.ui.collateral.marketablesec.MarketableSecAction.transactionHistoryList"; 
}
else if(prefix.equals("Cash"))
{
	transactionHistoryListStr = "com.integrosys.cms.ui.collateral.cash.CashAction.transactionHistoryList"; 
}
else if(prefix.equals("Gte"))
{
	transactionHistoryListStr = "com.integrosys.cms.ui.collateral.guarantees.GuaranteesAction.transactionHistoryList"; 
}
else if(prefix.equals("NoCollateral"))
{
	transactionHistoryListStr = "com.integrosys.cms.ui.collateral.nocollateral.NoCollateralAction.transactionHistoryList"; 
}
else if(prefix.equals("Property"))
{
	transactionHistoryListStr = "com.integrosys.cms.ui.collateral.property.PropertyAction.transactionHistoryList"; 
}


//List transactionHistoryList = (List) session.getAttribute("com.integrosys.cms.ui.collateral.cash.CashAction.transactionHistoryList");
List transactionHistoryList = (List) session.getAttribute(transactionHistoryListStr);
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
										...
										<%}else if((firstRecord[2].equals("DELETED")  && secondRecord[2].equals("PENDING_DELETE")))
													{ %>
										<td class="fieldname" width="20%">Deleted By </td>
										<%}else{ %>
									...
									<%if(firstRecord[2].equals("DRAFT") || (firstRecord[2].equals("ACTIVE")  && secondRecord[2].equals("DRAFT"))){ %>
										...
										<%}else if(firstRecord[2].equals("DELETED")  && secondRecord[2].equals("PENDING_DELETE")){ %>
									<td class="fieldname" width="20%">Deleted On</td>
										<%}else{ %>
