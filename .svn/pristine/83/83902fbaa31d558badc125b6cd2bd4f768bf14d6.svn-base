...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/property/propcommgeneral/PropCommGeneral_process.jsp,v 1.16 2006/10/27 08:37:06 hmbao Exp $
    *
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.property.PropertyAction.serviceColObj");
    ...
    System.out.println("/collateral/property/propcommgeneral/PropCommGeneral_process.jsp=>otherChecklistCountPartyName======>>>>>"+otherChecklistCountPartyName);
%>
...
<%@ include file="PropCommGeneral_read_helperVal.jsp" %>
