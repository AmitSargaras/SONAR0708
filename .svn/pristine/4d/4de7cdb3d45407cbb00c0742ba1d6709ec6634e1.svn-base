...
<%
	...
	//List hubValueList = (List)request.getAttribute("hubValueList");		
...
function submitForm() {
 	...
 	document.forms[0].action="fccBranch.do?event=maker_create_fccBranch";
    document.forms[0].submit();
}

function saveForm() {

 	document.forms[0].action="fccBranch.do?event=maker_draft_fccBranch";
    document.forms[0].submit();
}
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
  <tr>
      <td><h3>Add FCC Branch Master</h3></td>
  </tr>
  <tr>
    <td><hr/></td>
  </tr>
            ...
            <tr class="odd">
              <td class="fieldname">Branch Code<font color="red">*</font></td>
               ...
               <td class="fieldname">Alias Branch Code<font color="red">*</font></td>
                  ...
                  <html:errors property="aliasBranchCodeError"/>
                  <html:errors property="fccBranchCombinationDuplicateError"/></td>
...
<html:hidden name="FCCBranchForm" property="deprecated" value="N"/>
