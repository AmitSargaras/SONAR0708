...
<%
	...
	IInsuranceCoverageTrxValue insuranceCoverageTrx = (IInsuranceCoverageTrxValue) session
...
function submitPage () {
	document.forms[0].action="InsuranceCoverage.do?event=maker_confirm_close";
    document.forms[0].submit();
}
			...
			<table width="80%" border="0" align="center" cellpadding="0"
				...
				<thead>
					<tr>
						...
						<br>
							<h3>
								Maintain Insurance Coverage:Close
							</h3>
						</td>
					</tr>
					<tr>
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tbody>
						<tr>
							...
							<td class="even"><%=insuranceCoverageTrx.getUserInfo()%>&nbsp;</td>
						</tr>
						<tr class="odd">
