...
//List directorMasterList = (List) session
              ...
              <table class="tblInput" id="backEdit2" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:0">     
                <tbody>
                   <tr class="odd">
                    ...
                    <td width="30%"><html:text property="dinNo" size="15" styleId="dinNo"
                    ...
                    <td width="20%" class="even"><html:select property="relatedType">
                  ...
                  <tr class="even">
                    ...
                    <td width="20%" class="even"><html:select property="relationship">
                           <integro:common-code descWithCode="false"
                  ...
                  <tr class="even">
                    ...
                    <td><html:text property="directorPostCode" size="10"
											...
											<html:errors property="directorPostcodeError"/>
					</td>
                  </tr>
                  <tr class="odd">
                    <td class="fieldname">Country<font color="red">*</font></td>
										<td><html:select property="directorCountry"
											...
											onchange="javascript:refreshDirectorRegionId(this)">
                   ...
                   <td class="fieldname">Region<font color="red">*</font></td>
										<td><html:select property="directorRegion"
											name="ManualInputCustomerInfoForm"
											onchange="javascript:refreshDirectorStateId(this)">
											<option value="">-Select-</option>
                  ...
                  <tr class="even">
                   <td class="fieldname">State<font color="red">*</font></td>
										<td><html:select property="directorState"
											name="ManualInputCustomerInfoForm"
											onchange="javascript:refreshDirectorCityId(this)">
											<option value="">-Select-</option>
                  ...
                  <tr class="even">
                    ...
                    <td class="fieldname">AADHAR Number</td>
										<td><html:text property="directorAadhar" size="30" maxlength="75"></html:text>&nbsp;
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <tr>    
   <%if(event.equals("add_director")){ %>  
      <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/save1.gif',1)">
     		<img src="img/save1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:saveOtherSystem('save_director')"/></a>
      	...
      	<%}else if(event.equals("add_director_in_edit")){ %>
      	<td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/save1.gif',1)">
     		<img src="img/save1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:saveOtherSystem('save_director_in_edit')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
     		<img src="img/cancel1.gif" name="ImageCancel" width="70" height="20" border="0" id="ImageCancel" onclick="returnPage('edit_cibil_details')"/></a>	        	
      </td>
      	
      	 	<%}else if(event.equals("add_director_in_resubmit")){ %>
      	<td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/save1.gif',1)">
     		<img src="img/save1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:saveOtherSystem('save_director_in_resubmit')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
     		<img src="img/cancel1.gif" name="ImageCancel" width="70" height="20" border="0" id="ImageCancel" onclick="returnPage('process_cibil_details')"/></a>	        	
      </td>
