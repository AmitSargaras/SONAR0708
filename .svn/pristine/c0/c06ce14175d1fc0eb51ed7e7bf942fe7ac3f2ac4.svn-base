drop procedure dc_validate_ab103
@

create procedure dc_validate_ab103 
	language sql
begin
	...
	set v_update_ind = 'update dc_ab103'
		' set VALID_IND = ''N'' '||
	...
	set v_insert_ind = 'insert into dc_error_log '||
		...
		'select current_timestamp, ''DC-ARBS'', ''DC_AB103-''||REGION, CMS_COLLATERAL_ID, '||
