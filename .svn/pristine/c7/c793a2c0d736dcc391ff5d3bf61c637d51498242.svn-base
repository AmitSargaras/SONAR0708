...
function saveForm(currentStatus) {
	...
	document.forms["CAMReceiptForm"].event.value="save_complete";
    document.forms["CAMReceiptForm"].status.value=currentStatus;
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td><h3>Update CAM gyjhyjh Doc Receipt </h3></td>
    </tr>
    <tr>
...
--%>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
                  ...
                  <tr class="even">
                      ...
                      <td><html:textarea name="CAMReceiptForm" rows="10" style="width:97%"  property="docRemarks" onkeyup="limitTextInput(this,1600,'Narration')"/><html:errors property="docRemarks" /></td>
                  </tr>
                 </tbody>
          </table> --%>
 <%-- End here  for cr-17 --%>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
                <tbody>
                    <tr class="even">
                        ...
                        <td><html:textarea name="CAMReceiptForm" rows="5" style="width:97%"  property="docRemarks" onkeyup="limitTextInput(this,1600,'Narration')"/><html:errors property="docRemarks" /></td>
                    </tr>
                </tbody>
        </table>
         <%}%>
