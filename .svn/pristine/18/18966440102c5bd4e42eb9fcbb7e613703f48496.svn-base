...
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/insprotection/inscrdtderiv/InsCrdtDeriv_read.jsp,v 1.16 2006/10/27 08:34:09 hmbao Exp $
*
...
<%	
    ...
    ICreditDerivative iCol = (ICreditDerivative) itrxValue.getCollateral();
...
<%@ include file="InsCrdtDeriv_read_helper.jsp" %>
