...
System.out.println("liabilityFixedMarginValue======== "+liabilityFixedMarginValue+ "  &&& liabilityMarginType===="+liabilityMarginType);
   ...
   // AssetGenChargeForm colForm = (AssetGenChargeForm) request.getAttribute("AssetGenChargeForm");
	...
	System.out.println("????????<<<<<<prepare cuurent liability update: "+dpCalculateManually);
    //end Santosh
...
<!--
  ...
  function submitPage(num) {
            ...
            if (num == 1) {
                document.forms[0].event.value="create_current_liabilities";
            }
            if (num == 2) {
                document.forms[0].event.value="edit_current_liabilities";
            }
            if (num == 3) {
...
<tr class="odd">
	...
	<%}else{ %>
		<%=liabilityMarginType %>
	<%} %> 
		<%-- <html:text name="AssetGenChargeStockDetailsForm" property="marginType" value="FIXED"/> --%>
	
	<%-- <html:hidden property="marginType" value="FIXED"/> --%>
 	<%if("FIXED".equals(liabilityMarginType)) {%>
	<html:hidden property="marginType" value="FIXED"/>
	<%}else if("VARIABLE".equals(liabilityMarginType)) { %>
...
<%-- 	<html:hidden property="marginType"/> --%>
	...
	<td>
	 ...
	 <%if("FIXED".equals(liabilityMarginType) || null==liabilityMarginType || "".equals(liabilityMarginType)) {%>
	<html:text name="AssetGenChargeStockDetailsForm" property="margin" value="<%=liabilityFixedMarginValue%>" readonly="true" onkeyup="javascript:calculateLonable()" />
	<%}else{ %>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <%if(evnt!=null && "edit_prepare_current_liabilities".equals(evnt) ) {%>
