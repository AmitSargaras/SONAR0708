...
<%
    ...
    ArrayList waiverCreditApproverList = (ArrayList)session.getAttribute("com.integrosys.cms.ui.checklist.camreceipt.CAMReceiptAction.waiverCreditApproverList");
...
function searchDoc(){
	...
	document.forms[0].action      	= "CAMReceipt.do?list="+list+"&searchType="+searchType+"&search="+search;
 	document.forms[0].event.value 	= "search_cam_doc_checker";
 	document.forms[0].submit();
}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td> <h3>Process CAM Doc Receipt</h3>
...
<!--			  	    </html:select>&nbsp;-->
<!--			  	  <%if(!ismandatory){%>-->
<!--			  	  <bean:write name="CAMReceiptForm" property="nonPanellawyerLegalFirm" />&nbsp;-->
<!--			  	  <%} %>-->
<!--				</td>-->
<!--		     </tr>-->
<!--		     <tr class="even">-->
<!--	            <td width="30%" class="fieldname">Lawyer Reference Number</td>-->
<!--	            <td><bean:write name="CAMReceiptForm" property="lawyerReferenceNumber" />&nbsp;</td>-->
<!--	          </tr>		-->
<!--            <tr class="odd">-->
<!--	            <td width="30%" class="fieldname">Person-In-Charge</td>-->
<!--	            <td><bean:write name="CAMReceiptForm" property="lawyerInCharge" />&nbsp;</td>-->
<!--            </tr>		-->
<!--            <tr class="even">-->
...
<!--				<td><bean:write name="CAMReceiptForm" property="lawFirmContactNumber" />&nbsp;</td>-->
<!--			</tr>	-->
<!--            <tr class="even">-->
<!--				<td width="30%" class="fieldname">Email</td>-->
<!--				<td><bean:write name="CAMReceiptForm" property="lawyerEmail" />&nbsp;</td>-->
<!--			</tr>		-->
<!--		    </tbody>-->
<!--		  </table>-->
<!--		 </td>-->
...
<!--		      <% 	
		    ...
		    //  		}
		      %>
<!--				<html:radio property="valuerFirmPanelFlag"  name="CAMReceiptForm" value="Y" disabled="true" />Yes &nbsp;-->
<!--                <html:radio property="valuerFirmPanelFlag"  name="CAMReceiptForm" value="N" disabled="true" /> No &nbsp;-->
<!--				<html:radio property="valuerFirmPanelFlag"  name="CAMReceiptForm" value="-"  disabled="true" /> N/A-->
<!--		      </td>-->
<!--		    </tr>-->
<!--		    </tbody>-->
<!--		  </table>-->
...
<!--				  	    </html:select>-->
<!--					<%//if(!bb){ %>-->
<!--						<bean:write name="CAMReceiptForm" property="nonPanelvaluerLegalFirm" />&nbsp;-->
<!--					<%//} %>-->
<!--					</td>-->
<!--			     </tr>-->
<!--			     <tr class="even">-->
<!--		            <td width="30%" class="fieldname">Valuer Reference Number</td>-->
<!--		            <td><bean:write name="CAMReceiptForm" property="valuerReferenceNumber" />&nbsp;</td>-->
<!--		          </tr>		-->
<!--	            <tr class="odd">-->
<!--		            <td width="30%" class="fieldname">Person-In-Charge</td>-->
<!--		            <td><bean:write name="CAMReceiptForm" property="valuerInCharge" />&nbsp;</td>-->
<!--	            </tr>		-->
<!--	            <tr class="even"> -->
<!--					<td width="30%" class="fieldname">Address-->
<!--					<%//if(bb){ %><font color="#0000FF" >*</font><%//} %></td>-->
...
<!--				<tr class="odd"> -->
<!--					<td width="30%" class="fieldname">Contact No</td>-->
<!--					<td><bean:write name="CAMReceiptForm" property="valuerFirmContactNumber" />&nbsp;</td>-->
<!--				</tr>	-->
<!--	            <tr class="even"> -->
<!--					<td width="30%" class="fieldname">Email</td>-->
<!--					<td><bean:write name="CAMReceiptForm" property="valuerEmail" />&nbsp;</td>-->
<!--				</tr>	-->
<!--		    </tbody>-->
<!--		  </table>-->
<!--		 </td>-->
...
<!--		      <td width="763">-->
		      <% 	
		      	...
		      	//	}
		      %>
<!--				<html:radio property="insurerFirmPanelFlag"  name="CAMReceiptForm" value="Y" disabled="true" />Yes &nbsp;-->
<!--                <html:radio property="insurerFirmPanelFlag"  name="CAMReceiptForm" value="N" disabled="true" /> No &nbsp;-->
<!--				<html:radio property="insurerFirmPanelFlag"  name="CAMReceiptForm" value="-"  disabled="true" /> N/A-->
<!--		      </td>-->
<!--		    </tr>-->
<!--		    </tbody>-->
<!--		  </table>-->
...
<!--				  	    </html:select>-->
<!--					<%//if(!cc){ %>-->
<!--						<bean:write name="CAMReceiptForm" property="nonPanelinsurerLegalFirm" />&nbsp;-->
<!--					<%//} %>-->
<!--					</td>-->
<!--			     </tr>-->
<!--			     <tr class="even">-->
<!--		            <td width="30%" class="fieldname">Insurer Reference Number</td>-->
<!--		            <td><bean:write name="CAMReceiptForm" property="insurerReferenceNumber" />&nbsp;</td>-->
<!--		          </tr>		-->
<!--	            <tr class="odd">-->
<!--		            <td width="30%" class="fieldname">Person-In-Charge</td>-->
<!--		            <td><bean:write name="CAMReceiptForm" property="insurerInCharge" />&nbsp;</td>-->
<!--	            </tr>		-->
<!--	            <tr class="even"> -->
<!--					<td width="30%" class="fieldname">Address-->
<!--					<%//if(cc){ %><font color="#0000FF" >*</font><%//} %></td>-->
...
<!--				<tr class="odd"> -->
<!--					<td width="30%" class="fieldname">Contact No</td>-->
<!--					<td><bean:write name="CAMReceiptForm" property="insurerFirmContactNumber" />&nbsp;</td>-->
<!--				</tr>	-->
<!--	            <tr class="even"> -->
<!--					<td width="30%" class="fieldname">Email</td>-->
<!--					<td><bean:write name="CAMReceiptForm" property="insurerEmail" />&nbsp;</td>-->
<!--				</tr>		-->
<!--		    </tbody>-->
<!--		  </table>-->
<!--		 </td>-->
...
<% if(row==0){%>
            <tr class="odd">
              <td colspan="12">There are no cam linked</td>
            </tr>
<% }%>
          </tbody>
        </table></td>
