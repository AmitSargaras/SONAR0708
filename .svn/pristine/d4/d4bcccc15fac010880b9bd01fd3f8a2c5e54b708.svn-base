...
<%
	...
	if(event.equals("VIEW_PENDING_PERM_UPLIFT")||
			event.equals("VIEW_PERM_UPLIFTED")){
		isViewUplift = true ;
		}
%>
...
function saveForm() {
	document.forms["CCReceiptForm"].event.value="save_perm_uplift";
...
--%>
            ...
            <tr class="odd">
              <td class="fieldname">Date Pemp Uplifted
              <%if(!isViewUplift){ %>&nbsp;<font color="#0000FF">*</font><%} %></td>
              <%if(!isViewUplift){ %>
              <td><html:text property="permUpliftedDate" size="12" maxlength="10" readonly="true" />
                <img src="img/calendara.gif"  name="Image11" border="0" id="Image1" 
                onclick="return showCalendar('permUpliftedDate', 'dd/mm/y');" 
