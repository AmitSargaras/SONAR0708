								...
								Error Page City
													...
													<%
														...
														if(transDenied.equals("true")){
															...
															if(noOfRecords>=1000){
																System.out.println("no Of uploaded Records-are "+noOfRecords+" which exceed the max limit of 1000 records so showing validation of max limit exceed");	
																%>
																<tr class="odd">
																	<td colspan="10">
																		<bean:message key="label.global.file.maxlimit" />
																	</td>
																</tr>
																<%
																} 
