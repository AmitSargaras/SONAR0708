...
function submitForm() {
	...
	document.forms[0].action='<%=actionNameStr%>?event=maker_submit_insurance_received';
          ...
          <tbody>
              ...
              <tr class="even"">
                ...
                <html:select property="insPolicyCurrency" value="INR">
                   ...
                   <%}else{ %>                        
                    <html:select property="insPolicyCurrency" value="<%=insuranceObj.getInsPolicyCurrency() %>">
                 	  <option value="">Please Select </option>
                      <html:options collection="currencyList" property="value" labelProperty="label" />	
                                     </html:select>&nbsp;
                    <%} %>                 
                ...
                <td width="30%">
                 ...
                 if(insuranceObj!= null){
                     ...
                     if(insuranceObj.getEffectiveDateIns()!=null && (!"".equals(insuranceObj.getEffectiveDateIns()))){
                          effectiveDate=df.format(insuranceObj.getEffectiveDateIns());
                	    }
                     if(insuranceObj.getExpiryDateIns()!=null && (!"".equals(insuranceObj.getExpiryDateIns()))){
                          expiryDate=df.format(insuranceObj.getExpiryDateIns());
                        }
              }%>
                  <% if(insuranceObj== null){%>
