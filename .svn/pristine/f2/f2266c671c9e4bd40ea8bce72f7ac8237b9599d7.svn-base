...
# Limit booking update status to expired Batch job(UpdateStatusExpiredMain) is changed to be executed via RunEventMonitor interface. No notification is generated.
"$JAVA_HOME"/bin/java $JAVA_OPTS  com.integrosys.cms.ui.eventmonitor.EventMonitorClient UpdateStatusExpiredMainBatchJob;
