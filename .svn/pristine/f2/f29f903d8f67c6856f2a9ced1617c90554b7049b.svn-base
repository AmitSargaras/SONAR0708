...
function submitForm() {
		document.forms[0].action = "leiDateValidation.do?event=maker_confirm_resubmit_delete";
		document.forms[0].submit();
	}
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<tbody>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								<tr class="odd">
				                  ...
				                  <td width="20%">
				                  	<html:text property="partyName"  maxlength="30"/>
				                  	<html:errors property="partyName"/>
				                  	<html:errors property="partyNameLengthError" /> 
				                  	<html:errors property="partyNameError" /> 
				                   </td>
				                   
									<td class="fieldname" width="30%">Party ID<font
										color="red">*</font></td>
									<td width="20%"><html:text property="partyID"
											size="50" maxlength="100"></html:text>&nbsp; <br>
											<html:errors property="partyID" />
											<html:errors property="partyIDLengthError" /> 
				                  			<html:errors property="partyIDError" /> 
											</td>
								</tr>
								<tr class="odd">
									<td class="fieldname" >LEI Date Validation Period(In Months)<font color="red">*</font></td>
				                  <td width="20%">
				                  	<html:text property="leiDateValidationPeriod" onkeypress="return isNumber(event);" maxlength="3"/>
				                  	<html:errors property="leiDateValidationPeriod"/>
				                  	<html:errors property="leiDateValidationPeriodLengthError" /> 
				                  	<html:errors property="leiDateValidationPeriodError" /> 
				                   </td>
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tbody>
						<tr>
							<td class="fieldname" width="40%">Remarks</td>
							<td class="odd" width="60%"><textarea name="remarks" rows="4"
						...
						<tr class="odd">
							...
							<td><%=leiDateValidationTrx.getRemarks() != null
						? leiDateValidationTrx.getRemarks()
						: ""%>&nbsp;</td>
						</tr>
					</tbody>
				</table>
