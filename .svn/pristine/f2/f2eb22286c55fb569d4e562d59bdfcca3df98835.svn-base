...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/property/propindus/PropIndus_process.jsp,v 1.17 2006/10/27 08:37:22 hmbao Exp $
    *
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.property.PropertyAction.serviceColObj");
    IIndustrial iCol = (IIndustrial) itrxValue.getStagingCollateral();
...
<html:form action="PropIndusCollateral.do">
<input type="hidden" name="event">
<input type="hidden" name="indexID" />
<input type="hidden" name="subtype" value="PropIndus"/>
...
<%@ include file="PropIndus_read_helper.jsp" %>
