...
'CUST-ALLOC-0009', 'Powerful Footwear Co.', 'Powerful Footwear Co.', 
'56', 'C', 'MY', 'CUST-ALLOC-0009-BUS', 'ARBS');
...
from sci_le_main_profile where lmp_le_id = 'CUST-ALLOC-0009';
...
from sci_le_sub_profile where lsp_le_id = 'CUST-ALLOC-0009';
...
where llp_le_id = 'CUST-ALLOC-0009';
...
cms_lsp_lmt_profile_id, '700000016', '27', 'HP',
'25', 'OUTER', 180000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 180000000, '210', 1, 'FAC-ALLOC-0016', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0009';
...
where los_lmt_id in ('FAC-ALLOC-0016') ;
...
'--', '--', '--', '-999999999', -999999999, -999999999
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0016');
...
'AB102', 'AB102-ALLOC-0005', 'AB102-ALLOC-0005', 'MY', subtype_name, security_type_name, 
'AB102', 'AB', 'MYR', 'ACTIVE', 'MYR', '12', 'ARBS', 'Y',
40000000, 'MYR', 32000000, 'MYR'
...
where sci_security_dtl_id in ('AB102-ALLOC-0005');	
...
cmv, cmv_currency, fsv, fsv_currency)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for collateral_seq), 2)) AS bigint), 
'PT704', 'PT704-ALLOC-0001', 'PT704-ALLOC-0005', 'MY', subtype_name, security_type_name, 
'PT704', 'PT', 'MYR', 'ACTIVE', 'MYR', '12', 'ARBS', 'Y',
160000000, 'MYR', 150000000, 'MYR'
from cms_security_sub_type where security_sub_type_id = 'PT704';

insert into cms_property (cms_collateral_id)
select cms_collateral_id from cms_security 
where sci_security_dtl_id in ('PT704-ALLOC-0001');	
...
cmv, cmv_currency, fsv, fsv_currency)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for collateral_seq), 2)) AS bigint), 
'AB103', 'AB103-ALLOC-0001', 'AB103-ALLOC-0001', 'MY', subtype_name, security_type_name, 
'AB103', 'AB', 'MYR', 'ACTIVE', 'MYR', '12', 'ARBS', 'Y',
100000000, 'MYR', 85000000, 'MYR'
from cms_security_sub_type where security_sub_type_id = 'AB103';

insert into cms_asset (cms_collateral_id)
select cms_collateral_id from cms_security 
where sci_security_dtl_id in ('AB103-ALLOC-0001');	
...
cmv, cmv_currency, fsv, fsv_currency
from cms_security 
where sci_security_dtl_id in ('AB102-ALLOC-0005', 'PT704-ALLOC-0001', 'AB103-ALLOC-0001');	
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint), 
	...
	'ACTIVE', 'O', 'ARBS', 'N', 'Y'
from cms_security s where sci_security_dtl_id = 'AB102-ALLOC-0005';
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint), 
	...
	CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint),
	'ACTIVE', 'O', 'ARBS', 'N', 'Y'
from cms_security s where sci_security_dtl_id = 'PT704-ALLOC-0001';
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint), 
	...
	CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint),
	'ACTIVE', 'O', 'ARBS', 'N', 'Y'
from cms_security s where sci_security_dtl_id = 'AB103-ALLOC-0001';
...
and s.sci_security_dtl_id in ('AB102-ALLOC-0005', 'PT704-ALLOC-0001', 'AB103-ALLOC-0001');
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB102-ALLOC-0005'), 'AB102-ALLOC-0005',
...
customer_category,create_date, update_status_ind)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'PT704-ALLOC-0001'), 'PT704-ALLOC-0001',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp , 'I'
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0016');	
...
customer_category,create_date, update_status_ind)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB103-ALLOC-0001'), 'AB103-ALLOC-0001',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp , 'I'
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0016');	
...
and lmts.los_lmt_id in ('FAC-ALLOC-0016');
...
'MYR', (current timestamp - 5 days), 'V9999', 40000000, 32000000, s.cms_collateral_id, 'S', 'ARBS'
from cms_security s
where s.sci_security_dtl_id in ('AB102-ALLOC-0005');

insert into cms_valuation
(valuation_id, valuation_currency, valuation_date, valuer, cmv, fsv, cms_collateral_id, source_type, source_id)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for VALUATION_SEQ), 2)) AS bigint), 
'MYR', (current timestamp - 5 days), 'V9999', 160000000, 150000000, s.cms_collateral_id, 'S', 'ARBS'
from cms_security s
where s.sci_security_dtl_id in ('AB102-ALLOC-0003');
...
'37', 'ARBS', 'SIBS-ACT-0022', 'MY', 'N', 'A', 'L', 1, 180000000, 'I');
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	...
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0022'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0016';
