...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/document/docloi/docloi_update.jsp,v 1.2 2007/03/15 17:00:45 Jerlin Exp $
    *
...
<%
    ...
    ILetterIndemnity iCol = (ILetterIndemnity) itrxValue.getStagingCollateral();
    
    String subtypeCode = iCol.getCollateralSubType().getSubTypeCode();

    String action = "docloi.DocLoIAction";
    String formName = "DocLoIForm";
    DocLoIForm colForm = (DocLoIForm) request.getAttribute(formName);
    String prefix = "Doc";
...
<html:form action="DocLoICollateral.do">
<input type="hidden" name="event"/>
<input type="hidden" name="indexID" />
<input type="hidden" name="itemType"/>
<input type="hidden" name="subtype" value="DocLoI"/>
    ...
    <td colspan="2">
        ...
        <tbody>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				...
				<td class="fieldname"><bean:message key="label.security.indemnitiy.date"/>&nbsp;
					<span class="mandatory">*</span></td>
