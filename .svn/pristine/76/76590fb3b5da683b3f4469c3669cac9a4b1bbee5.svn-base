...
<%
   ...
   pageContext.setAttribute("cifId", customerCifId); */
	...
	//List currencyList = (List) session
...
//	pageContext.setAttribute("currencyList", currencyList);
	...
	System.out.println("value new:"+value.getIsRBIWilfulDefaultersList());
	...
	if(value != null){
		if(value.getRevisedEmailIdsArray() != null){
			...
			revisedArr = new String[len - 1];
			for(int i=0; i<value.getRevisedEmailIdsArray().length - 1;i++){
...
<%@page import="com.integrosys.cms.app.systemBankBranch.bus.OBSystemBankBranch"%><script type="text/javascript" src="js/calendar.js"></script>
...
function getAction(ind) {
	...
	var type = document.getElementById("actionType"+ind).value;
	 ...
	 if(type =="Edit"){
    	...
    	document.forms[0].event.value = "edit_director";
    	document.forms[0].submit();
	}
	else if( type == "Delete"){					
		document.forms[0].action = "ManualInputCustomer.do?index="+ind;		
    	document.forms[0].event.value = "delete_director";
    	document.forms[0].submit();
	}	    
}
...
function copyValue()
{
	...
	document.getElementById("regOffice").value= "Y";
	 document.forms[0].action="ManualInputCustomer.do?event=copy_office_to_reg";
	 document.forms[0].submit();
	}
	else
	{
...
function enableDirectorName(){
	if(document.all.isDirectorMoreThanOne[0].checked){
		document.getElementById('nameOfDirector').disabled=false;
	}
	else{
		document.getElementById('nameOfDirector').value='';
		document.getElementById('nameOfDirector').disabled=true;
	}	
}
function enableDefaultAndCompWriteoff(){
	if(document.all.isBorrDefaulterWithBank[0].checked){
...
function enableDtailsOfCleanCibil(){
	if(document.all.isCibilStatusClean[0].checked){
		document.getElementById('detailsOfCleanCibil').value='';
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<tbody>
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tbody>
							...
							<tr class="even">
								<td class="fieldname" >Customer Name<font color="red">*</font></td>
								<td >
								<textarea id="customerNameShort" readonly="readonly" style="width: 300px; height: 30px;" ><%=value.getCustomerNameShort()%></textarea>&nbsp;
							...
							<tr class="odd">
								<td class="fieldname" >Copy previous address as
							...
							<tr class="even">
								...
								<td><html:text property="regOfficeAddress2" styleId="regOfficeAddress2" size="30"
									maxlength="75"></html:text>&nbsp;
									<br><html:errors property="regOfficeAddress2Error"/>
							...
							<tr class="odd">
								...
								<td><html:text property="regOfficeAddress3" styleId="regOfficeAddress3" size="30"
									maxlength="75"></html:text>&nbsp;
									<br><html:errors property="regOfficeAddress3Error"/>
							...
							<tr class="even">
								...
								<td><html:text property="regOfficePostCode" styleId="regOfficePostCode" size="10"
									...
									<html:errors property="specialCharacterRegOfficePostCodeError"/>
							...
							<tr class="even">
								...
								<html:text property="stdCodeOfficeTelNo" styleId="stdCodeOfficeTelNo" size="5"
								...
								<html:text property="stdCodeOfficeTelex" styleId="stdCodeOfficeTelex" size="5"
											maxlength="5"></html:text>
								<html:text
						...
						<tbody>
							<tr class="odd">
								...
								<td width="30%"><html:select
									property="willfulDefaultStatus" styleId="willfulDefaultStatus" style="width:250px" onchange="willfulDftSts(this.value)">
									...
									<br></br><html:errors property="willfulDefaultStatusError"/>
								</td>
								<td class="fieldname" width="20%">Date classified as
								willful default</td>
								<td width="30%"><html:text property="dateWillfulDefault" styleId="dateWillfulDefault" 
									size="30" maxlength="20" readonly="true"></html:text><br></br><html:errors property="dateWillfulDefault" />
							...
							<tr class="even">
								...
								<td width="30%"><html:select property="suitFilledStatus" styleId="suitFilledStatus"  style="width:250px">
								...
								<td width="30%"><html:text property="suitReferenceNo" styleId="suitReferenceNo"
									size="15" maxlength="10"></html:text>
										...
										<td><html:textarea property="detailsOfDefault"
											...
											<br />
											 ...
											 <html:textarea property="extOfCompromiseAndWriteoff"
												...
												<html:errors property="extOfCompromiseAndWriteoffLengthError" /></td>
									</tr>
				...
				<tr>
					...
					<input onclick="javascript : addDirector('add_director')"
...
<logic:present name="revisedArr">
    ...
    <html:hidden name="ManualInputCustomerInfoForm" property="cifId" />   
 	<%-- <input type="text" id='cifId' value='<%=customerCifId%>'/>  --%>
...
<input type="hidden" name="revisedEmailIdsArray"  id="revisedEmailIdsArrayId" >
<%-- <html:hidden name="ManualInputCustomerInfoForm" property="revisedEmailIdsArray"   id="revisedEmailIdsArrayId" /> --%>
