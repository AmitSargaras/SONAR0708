...
<body>
  <html:form action="<%= pageAction %>">
    ...
    <p class="required"><font color="#FF0000">*</font> <bean:message key="label.security.mandatory.for.scc"/></p><br>
    <p class="required"><font color="#0000FF">*</font> <bean:message key="label.security.mandatory.for.submission"/>&nbsp;&nbsp;&nbsp;&nbsp;</p>
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
      <thead>
        <tr> 
          <td width="81%" ><h3><bean:message key="label.security.title.view.apportionment"/></h3></td>
          ...
          <td colspan="2">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
              <tbody>
                ...
                <tr class="odd">
                  <td class="<%= priorityRankingAmtStyle %>"><bean:message key="label.security.updateaptmnt.pri.rank.amt"/>&nbsp;<font color="#0000FF">*</font></td>
                  <td colspan="3">
                    <bean:write name="SecurityApportionmentDtlForm" property="fsvCurrency" />&nbsp;
                ...
                <tr class="even">
                  <td class="fieldname" width="20%"><bean:message key="label.security.le.id"/>&nbsp;<font color="#0000FF">*</font></td>
                  <td width="30%">
                ...
                <tr class="even">
                  <td class="<%= byAmountStyle %>" width="20%"><bean:message key="label.security.updateaptmnt.amt"/>&nbsp;<font color="#0000FF">*</font></td>
                  <td colspan="3">
