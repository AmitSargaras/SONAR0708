...
<%@page import="com.integrosys.cms.ui.facglobal.FacilityGlobalForm"%><html><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<body >
<html:form action="FacilityGlobal.do">
<input type="hidden" name="event" />
<html:hidden name="FacilityGlobalForm"  property="itemCode" />
<html:hidden name="FacilityGlobalForm"  property="itemDesc" />
<html:hidden name="FacilityGlobalForm"  property="expDate" />
<html:hidden name="FacilityGlobalForm"  property="tenureCount" />
<html:hidden name="FacilityGlobalForm"  property="status" />
<html:hidden name="FacilityGlobalForm"  property="tenureType" />
<html:hidden name="FacilityGlobalForm"  property="deprecated" value="Y" />
  ...
  <tr>
    <td width="100" valign="baseline" align="center"><a href="#"
			...
			<td width="100" valign="baseline" align="center">
			 ...
			 <a href="FacilityGlobal.do?event=global_list&type=F&go=N&startIndex=<%=startIndex %>"
				onmouseout="MM_swapImgRestore()"
