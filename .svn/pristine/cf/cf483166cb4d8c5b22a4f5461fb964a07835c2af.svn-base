...
function cancelPage(){
    document.forms[0].action="riskType.do?event=maker_list_risk_type&go=N";
	document.forms[0].submit();
	}
function submitForm() {
		document.forms[0].action = "riskType.do?event=maker_create_risk_type";
		document.forms[0].submit();
	}

function saveForm() {
		document.forms[0].action = "riskType.do?event=maker_draft_risk_type";
		document.forms[0].submit();
	}
							...
							<tbody>
								<tr class="even">
								  <td class="fieldname" >Risk Type Name<font color="red">*</font></td>
				                   ...
				                   <td width="20%"><html:text property="riskTypeName" style='width: 250px;' maxlength="100" styleId="riskTypeName">
				                   	</html:text>&nbsp; 
								  ...
								  <td width="20%" style="width: 200px;">
								  	...
								  	<html:errors property="riskTypeCode" />
								  </td>
								</tr>
				...
				<td>
					<center>
						<a href="javascript:cancelPage();"
							...
							<img
							src="img/cancel1.gif" name="ImageCancel" border="0" id="ImageCancel" />
						</a>
					</center> &nbsp;
				</td>
			</tr>
