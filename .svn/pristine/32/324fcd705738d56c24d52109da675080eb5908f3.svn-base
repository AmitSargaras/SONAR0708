          ...
          <tr>            
            ...
            <td><br />
              ...
              <table class="tblInput" id="backEdit2" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:0">     
                <tbody>
                  <tr class="even" >
                    <td width="20%" class="fieldname" >System<font color="red">*</font></td>
                  <td width="20%" class="even"><html:select property="system">
                           <integro:common-code
												categoryCode="<%=CategoryCodeConstant.SYSTEM%>"
												refEntryCode='<%=request.getParameter("newCollateralMainType") %>' />
										</html:select>
										<br><html:errors property="systemError"/>
										<html:errors property="bankingMethodEmptyError"/>
										</td>
                  
              <td width="20%" class="fieldname" >System ID<font color="red">*</font><span class="style11"></span></td>
                  <td width="20%"><html:text property="systemCustomerId" size="16"
								maxlength="16"></html:text>&nbsp;
								<br><html:errors property="systemCustomerIdError"/>
								<html:errors property="systemCustomerIdLengthError"/>
									<html:errors property="specialCharacterSystemCustomerIdError"/>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <tr>    
   <%if(event.equals("add_other_system_partymaker")){ %>  
      <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/save1.gif',1)">
     		<img src="img/save1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:saveOtherSystem('save_other_system_partymaker')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
     		<img src="img/cancel1.gif" name="ImageCancel" width="70" height="20" border="0" id="ImageCancel" onclick="returnPage('display_summary_details_partymaker')"/></a>	        	
      </td>
      	<%}else if(event.equals("add_other_system_in_edit_partymaker")){ %>
      	<td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/save1.gif',1)">
     		<img src="img/save1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:saveOtherSystem('save_other_system_in_edit_partymaker')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
     		<img src="img/cancel1.gif" name="ImageCancel" width="70" height="20" border="0" id="ImageCancel" onclick="returnPage('edit_summary_details_partymaker')"/></a>	        	
      </td>
      	
      	 	<%}else if(event.equals("add_other_system_in_resubmit_partymaker")){ %>
      	<td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/save1.gif',1)">
     		<img src="img/save1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:saveOtherSystem('save_other_system_in_resubmit_partymaker')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
     		<img src="img/cancel1.gif" name="ImageCancel" width="70" height="20" border="0" id="ImageCancel" onclick="returnPage('process_summary_details_partymaker')"/></a>	        	
      </td>
