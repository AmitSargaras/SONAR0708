<%@ page import="com.integrosys.base.techinfra.diff.CompareOBUtil,
                 ...
                 com.integrosys.cms.ui.collateral.document.docgencredit.DocGenCreditForm,
...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/document/docgencredit/DocGenCredit_read_helper.jsp,v 1.41 2007/03/15 16:57:45 Jerlin Exp $
    *
    * Purpose: Helper page to read and process of the Collateral
    * Description: Type - Document, Subtype - Gen Credit Agreement
    *
    * @author $Author: Jerlin $<br>
    * @version $Revision: 1.41 $
    * Date: $Date: 2007/03/15 16:57:45 $
    * Tag: $Name:  $
    */
%>
<%
    ICreditAgreement oldCollateral = (ICreditAgreement)itrxValue.getCollateral();
    ICreditAgreement newCollateral = (ICreditAgreement)itrxValue.getStagingCollateral();
    String action = "docgencredit.DocGenCreditAction";
    String formName = "DocGenCreditForm";
    DocGenCreditForm aForm = (DocGenCreditForm)request.getAttribute(formName);
    String prefix = "Doc";
    String subtype = "DocGenCredit"; 
        ...
        <tbody>
			...
			<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				...
				<td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"perfectionDate")?"fieldname":"fieldnamediff"):"fieldname"%>">
					<bean:message key="label.security.perfection.date"/>&nbsp;<span class="mandatory">*</span>&nbsp;<span class="mandatoryPerfection">*</span></td>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
              ...
              <td><bean:write name="DocGenCreditForm" property="amountLetter"/>&nbsp;</td>
            </tr>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
              ...
              <td><bean:write name="DocGenCreditForm" property="minAmount"/>&nbsp;</td>
              ...
              <td><bean:write name="DocGenCreditForm" property="maxAmount"/>&nbsp;</td>
            </tr>
			...
			<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				<td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"documentDate")?"fieldname":"fieldnamediff"):"fieldname"%>">
					<bean:message key="label.security.credit.agree.date"/>&nbsp;
                  	<span class="mandatory">*</span></td>
				<td><integro:date object="<%=iCol.getDocumentDate()%>" />&nbsp;</td>
				<td class="fieldnmame">&nbsp;</td>
				<td>&nbsp;</td>
            </tr>

            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
              <td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"documentDesc")?"fieldname":"fieldnamediff"):"fieldname"%>">
