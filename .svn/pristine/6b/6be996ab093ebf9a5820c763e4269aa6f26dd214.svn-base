...
AddtionalDocumentFacilityDetailsForm docFacDetObj = (AddtionalDocumentFacilityDetailsForm) request.getAttribute(formStr);
...
function submitForm() {
	...
	document.forms[0].action='<%=actionNameStr%>?event=maker_update_add_fac_doc_det_list';
    document.forms[0].submit();
}
...
<html:hidden property="addFacDocStatus"  value="PENDING_UPDATE"/>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
    <thead>
                        <tr>
                          <td><h3>Edit Document Facility Details</h3></td>
							...
							<tbody>
								<tr class="even">
								  <td class="fieldname" >Document Facility Category<font color="red">*</font></td>
				                   ...
				                   <td width="20%">
									 <html:select property="docFacilityCategory" style='width: 270px;' styleId="criteriais">
