...
function submitPage(num) {
    ...
    if (num == 1) {
    	document.forms[0].event.value="marksecbondforeign_create";
    }
	if (num == 2) {
    	document.forms[0].event.value="marksecbondforeign_update";
    }
    if (num == 3) {
...
if ("marksecbondforeign_prepare".equals(request.getParameter("event")) 
		|| "marksecbondforeign_create".equals(request.getParameter("event"))){
	index = 1;
}
      ...
      <td colspan="2"> <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
	      ...
	      <html:text property="secMaturityDate" readonly="true" size="15" maxlength="11" />
            ...
            <tr class="odd">
              ...
              <td>
              <html:text property="isserIdentType" maxlength="30"/>&nbsp;
            ...
            <tr class="even">
              ...
              <td>
              <html:text property="leadMgr" maxlength="50"/>&nbsp;
              <html:errors property="leadMgr"/>
              </td>
              <td class="fieldname"><bean:message key="label.security.bond.market.country"/></td>
              <td>
              <html:select property="countryBondMarket">
	                <option value="" ><bean:message key="label.please.select"/> </option>
            ...
            <tr class="odd">
              ...
              <td >
             <html:select property="settleOrg">
	                <option value="" ><bean:message key="label.please.select"/> </option>
              ...
              <td>
			  <html:text property="bondIssueDate" disabled="<%=!isUpdate%>" readonly="true" size="15" maxlength="11" />
              ...
              <html:errors property="bondIssueDate"/>
              </td>
            </tr>
            <tr class="even">
              <td class="fieldname"><bean:message key="label.security.bond.maturity.date"/></td>

           <td>
		<html:text property="bondMatDate" disabled="<%=!isUpdate%>" readonly="true" size="15" maxlength="11" />
              ...
              <html:errors property="bondMatDate"/>
              </td>
              <td class="fieldname"><bean:message key="label.security.bond.market"/></td>
              <td>
              <html:select property="bondMarket">
	                <option value="" ><bean:message key="label.please.select"/> </option>
	                <html:options name="stockMarketID" labelName="stockMarketValue"/>
                    </html:select>
              <html:errors property="bondMarket"/>
              </td>
            </tr>
            <tr class="odd">
              ...
              <td>
              <html:select property="bondType">
	                <option value="" ><bean:message key="label.please.select"/> </option>
	                <html:options name="bondTypeID" labelName="bondTypeValue"/>
                    </html:select>
              	<html:errors property="bondType"/>
              </td>
            ...
            <tr class="even">
				...
				<td><html:text property="ric" maxlength="30"/>&nbsp;
					<html:errors property="ric"/></td>
				<td class="fieldname">
					<bean:message key="label.security.exchange.ctr.app"/>&nbsp;</td>
				<td><html:select property="xchangeCtrlObtained">
						<option value="" ><bean:message key="label.please.select"/> </option>
