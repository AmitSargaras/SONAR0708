...
<table width="25%" border="0" align="left" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:10px">
  ...
  <tbody>
    ...
    <tr>
      ...
      <bean:message key="title.leftframe.view.customer"/></a></td>
    </tr>
    ...
    <tr>
      ...
      <td height="18">
          <a href="MaintainSecurityEnvelope.do?event=checker_view_sec_envelope&customerID=<%=limitprofile.getCustomerID()%>&lspLmtProfileId=<%=limitprofile.getLimitProfileID()%>">
