...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/property/propagri/PropAgri_process.jsp,v 1.16 2006/10/27 08:36:58 hmbao Exp $
    *
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.property.PropertyAction.serviceColObj");
    ...
    System.out.println("****from_ page:::"+from_event );
