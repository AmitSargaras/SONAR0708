...
<%
    ...
    ArrayList docIds = (ArrayList)session.getAttribute("com.integrosys.cms.ui.checklist.other.OtherCheckListAction.docNos");
        String docs[] = null;
        int length1=0 ;
...
<%
String actionStr1 = "com.integrosys.cms.ui.checklist.other.OtherCheckListAction";
...
//            " OB.getShared()=" +OB.getShared() + "OB.getViewable=" + OB.getViewable() );
    ...
    <% if (row == 0) {%>
    <tr class="odd">
        <td colspan="11">There are no Other linked</td>
    </tr>
    <% }%>
    </tbody>
    </table>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <%} else {%>
             <td width="100" valign="baseline" align="center">
                <a href="OtherCheckList.do?event=list" onmouseout="MM_swapImgRestore()"   onmouseover="MM_swapImage('Image2','','img/cancel2.gif',1)">
