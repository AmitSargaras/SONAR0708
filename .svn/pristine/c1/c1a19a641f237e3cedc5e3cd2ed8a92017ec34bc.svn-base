...
<%
	DefaultLogger.debug(this, ">>>>Entity Limit view.jsp start page");
	...
	boolean forRead = EntityLimitListAction.EVENT_READ.equals(event) ||
						EntityLimitListAction.EVENT_LIST_READ.equals(event);
	
    // Get the entity limit from session.
    ...
    String remarks = entityLimitTrxValue.getRemarks();
