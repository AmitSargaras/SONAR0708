...
<%@page import="com.integrosys.cms.app.fccBranch.bus.IFCCBranch"%>
...
function approvePage() {
    ...
    document.forms[0].action="fccBranch.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="fccBranch.do?event=<%=rejectEvent%>";
    document.forms[0].submit();
}
function cancelPage(){
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											<tr class="odd">
												...
												<td width="30%"><%=fccBranchForm.getBranchCode()%>&nbsp;
												<html:errors property="fccBranchDuplicateError"/>
												</td>
												...
												<td width="30%"><%=fccBranchForm.getAliasBranchCode()%>&nbsp;
												<html:errors property="fccBranchCombinationDuplicateError"/>
												</td>
											...
											<tr class="even">
												...
												<td><%=(fccBranchForm.getBranchName())%>&nbsp;
												</td>
												
											
											 <td class="fieldname" >Status&nbsp;</td>
              <td ><%if(fccBranchForm.getStatus().trim().equalsIgnoreCase("ACTIVE")){ %>Enable
              <%}else{ %>Disable<%} %>&nbsp;</td></tr>		
 
 <html:hidden name="FCCBranchForm" property="status"  />
					...
					<tbody>
						<tr>
							...
							<td class="odd"><textarea name="remarks" rows="4"
								style="width: 90%"></textarea></br><html:errors property="fccBranchRemarksError"/></td>
						</tr>
						<tr>
							<td class="fieldname">Last Action By</td>
							<td class="even"><%=fccBranchTrx.getUserInfo()%>&nbsp;</td>
						</tr>
						<tr class="odd">
							<td class="fieldname">Last Remarks Made</td>
							<td><%=fccBranchTrx.getRemarks() != null
						? fccBranchTrx.getRemarks()
						: ""%>&nbsp;</td>
						</tr>
					</tbody>
				</table>
