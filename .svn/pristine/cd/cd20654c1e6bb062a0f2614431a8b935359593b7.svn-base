            ...
            <td class="fieldname">
			  ...
			  <td >
									 ...
									 <option value="">Please Select </option>	
                                       ...
                                       <html:errors property="currencyRestrictionError"/>&nbsp;</td>									                    
                                       </tr>
               ...
               <tr class="even">
                  <td class="fieldname">Availability & Option Applicable</td>
                 	...
                 	<td>	 <input type="checkbox" id ="AvailAndOptionApplicable" name="availAndOptionApplicable" property="availAndOptionApplicable"  onclick="javascript:checkAvailAndOptionApplicable()"  disabled="true" checked="true" ></input>
                 	</td>
					 <html:hidden property="availAndOptionApplicable" styleId="availAndOptionApplicable"/>
					<% }else {%> 
					<td><input type="checkbox" id ="AvailAndOptionApplicable"  name="availAndOptionApplicable" property="availAndOptionApplicable" onclick="javascript:checkAvailAndOptionApplicable()" ></input></td>
								<html:hidden property="availAndOptionApplicable" styleId="availAndOptionApplicable"/>
								<%} %>
  ...
  <%if((event.equals("maker_prepare_resubmit_create"))){%>
                   <td colspan="2">
                    ...
                    <td colspan="2">
						<a href="#" onmouseout="MM_swapImgRestore()"
							onmouseover="MM_swapImage('Image3311','','img/submit2.gif',1)"
							onClick=" submitForm('maker_edit_facilityNewMaster')"><img src="img/submit1.gif"
								name="Image3311" border="0" id="Image3311" />
						</a>&nbsp;&nbsp;
					</td>
                     <%} %>
