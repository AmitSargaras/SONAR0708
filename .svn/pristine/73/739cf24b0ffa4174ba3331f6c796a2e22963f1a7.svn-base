...
<%
    ...
    DefaultLogger.debug("\\paripassuupdate\\complete.jsp", status + "|");
...
function saveForm(currentStatus) {
	if(document.forms["UpdatePariPassuCheckListForm"].isPolicy.value == "true"){
		if(document.forms["UpdatePariPassuCheckListForm"].docEffDate.value != document.forms["UpdatePariPassuCheckListForm"].docOldEffDate.value){
			document.forms["UpdatePariPassuCheckListForm"].isEffDateChanged.value="true";
		}
	}
	document.forms["UpdatePariPassuCheckListForm"].event.value="save_complete";
    document.forms["UpdatePariPassuCheckListForm"].status.value=currentStatus;
...
--%>
 ...
 <%--
            <tr class="even">
              ...
              <td>&nbsp;<bean:write name="UpdatePariPassuCheckListForm" property="docRef" /></td>
            </tr>
--%>
            <tr class="even">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
                <tbody>
                    <tr class="even">
                        ...
                        <td><html:textarea name="UpdatePariPassuCheckListForm" rows="5" style="width:97%"  property="docRemarks" onkeyup="limitTextInput(this,1600,'Narration')"/><html:errors property="docRemarks" /></td>
                    </tr>
                </tbody>
        </table>
         <%}%>
