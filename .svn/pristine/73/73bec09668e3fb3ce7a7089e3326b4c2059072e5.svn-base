...
function cancelPage(){
    document.forms[0].action="Country.do?event=view_list_country";
    document.forms[0].submit();
}
function submitForm() {
 	document.forms[0].action="Country.do?event=maker_upload_country";
    document.forms[0].submit();
}
...
<html:form action="/Country" enctype="multipart/form-data">
