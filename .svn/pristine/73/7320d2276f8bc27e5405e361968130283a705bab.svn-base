...
System.out.println("maker_create_insgc_received.jsp   stockdocMonth:"+stockdocMonth+"  stockdocYear:"+stockdocYear);
...
function submitForm() {
	...
	document.forms[0].action='AssetInsuranceCollateral.do?event=maker_submit_insurance_received&collateralID=<%=itrxValue.getReferenceID()%>&calculatedDP=<%=dp%>&dpCalculateManually=<%=dpCalculateManually%>';
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <tr>
      <td><h3>Add Insurance - Received </h3></td>
  </tr>
  <tr>
    <td><hr/></td>
  </tr>
          ...
          <tbody>
              ...
              <tr class="even"">
                ...
                <td width="30%">
                  ...
                  <% if(insuranceObj== null){%> 
                <html:select property="insuranceCurrency" value="INR">
