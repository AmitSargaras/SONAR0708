...
<%
	...
	String list=(String)session.getAttribute("com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptAction.session.list");
if(list==null)
	list="";
String searchType=(String)session.getAttribute("com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptAction.session.searchType");
if(searchType==null)
	searchType="";
String search=(String)session.getAttribute("com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptAction.session.search");
if(search==null)
	search="";
    ICheckListTrxValue checkListTrxVal =(ICheckListTrxValue)session.getAttribute("com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptAction.checkListTrxVal");
    ICheckList checkList = (ICheckList)session.getAttribute("com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptAction.checkList");
    ArrayList deferCreditApproverList = (ArrayList)session.getAttribute("com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptAction.deferCreditApproverList");
    
    ArrayList waiverCreditApproverList = (ArrayList)session.getAttribute("com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptAction.waiverCreditApproverList");
    ArrayList allCreditApproverList = (ArrayList)session.getAttribute("com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptAction.allCreditApproverList");
...
function searchDoc(){
	...
	document.forms[0].action      	= "OtherReceipt.do?list="+list+"&searchType="+searchType+"&search="+search;
 	document.forms[0].event.value 	= "search_other_doc_checker";
 	document.forms[0].submit();
}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td> <h3>Process Other Doc Receipt</h3>
...
<html:hidden property="lawFirmPanelFlag"  name="OtherReceiptForm" value="-" />
		    </tbody>
		  </table>
		 </td>
	  </tr>
...
<!--			  	    </html:select>&nbsp;-->
<!--			  	  <%if(!ismandatory){%>-->
<!--			  	  <bean:write name="OtherReceiptForm" property="nonPanellawyerLegalFirm" />&nbsp;-->
<!--			  	  <%} %>-->
<!--				</td>-->
<!--		     </tr>-->
<!--		     <tr class="even">-->
<!--	            <td width="30%" class="fieldname">Lawyer Reference Number</td>-->
<!--	            <td><bean:write name="OtherReceiptForm" property="lawyerReferenceNumber" />&nbsp;</td>-->
<!--	          </tr>		-->
<!--            <tr class="odd">-->
<!--	            <td width="30%" class="fieldname">Person-In-Charge</td>-->
<!--	            <td><bean:write name="OtherReceiptForm" property="lawyerInCharge" />&nbsp;</td>-->
<!--            </tr>		-->
<!--            <tr class="even">-->
...
<!--				<td><bean:write name="OtherReceiptForm" property="lawFirmContactNumber" />&nbsp;</td>-->
<!--			</tr>	-->
<!--            <tr class="even">-->
<!--				<td width="30%" class="fieldname">Email</td>-->
<!--				<td><bean:write name="OtherReceiptForm" property="lawyerEmail" />&nbsp;</td>-->
<!--			</tr>		-->
<!--		    </tbody>-->
<!--		  </table>-->
<!--		 </td>-->
...
<!--		      <% 	
		    ...
		    //  		}
		      %>
<!--				<html:radio property="valuerFirmPanelFlag"  name="OtherReceiptForm" value="Y" disabled="true" />Yes &nbsp;-->
<!--                <html:radio property="valuerFirmPanelFlag"  name="OtherReceiptForm" value="N" disabled="true" /> No &nbsp;-->
<!--				<html:radio property="valuerFirmPanelFlag"  name="OtherReceiptForm" value="-"  disabled="true" /> N/A-->
<!--		      </td>-->
<!--		    </tr>-->
<!--		    </tbody>-->
<!--		  </table>-->
...
<!--				  	    </html:select>-->
<!--					<%//if(!bb){ %>-->
<!--						<bean:write name="OtherReceiptForm" property="nonPanelvaluerLegalFirm" />&nbsp;-->
<!--					<%//} %>-->
<!--					</td>-->
<!--			     </tr>-->
<!--			     <tr class="even">-->
<!--		            <td width="30%" class="fieldname">Valuer Reference Number</td>-->
<!--		            <td><bean:write name="OtherReceiptForm" property="valuerReferenceNumber" />&nbsp;</td>-->
<!--		          </tr>		-->
<!--	            <tr class="odd">-->
<!--		            <td width="30%" class="fieldname">Person-In-Charge</td>-->
<!--		            <td><bean:write name="OtherReceiptForm" property="valuerInCharge" />&nbsp;</td>-->
<!--	            </tr>		-->
<!--	            <tr class="even"> -->
<!--					<td width="30%" class="fieldname">Address-->
<!--					<%//if(bb){ %><font color="#0000FF" >*</font><%//} %></td>-->
...
<!--				<tr class="odd"> -->
<!--					<td width="30%" class="fieldname">Contact No</td>-->
<!--					<td><bean:write name="OtherReceiptForm" property="valuerFirmContactNumber" />&nbsp;</td>-->
<!--				</tr>	-->
<!--	            <tr class="even"> -->
<!--					<td width="30%" class="fieldname">Email</td>-->
<!--					<td><bean:write name="OtherReceiptForm" property="valuerEmail" />&nbsp;</td>-->
<!--				</tr>	-->
<!--		    </tbody>-->
<!--		  </table>-->
<!--		 </td>-->
...
<!--		      <td width="763">-->
		      <% 	
		      	...
		      	//	}
		      %>
<!--				<html:radio property="insurerFirmPanelFlag"  name="OtherReceiptForm" value="Y" disabled="true" />Yes &nbsp;-->
<!--                <html:radio property="insurerFirmPanelFlag"  name="OtherReceiptForm" value="N" disabled="true" /> No &nbsp;-->
<!--				<html:radio property="insurerFirmPanelFlag"  name="OtherReceiptForm" value="-"  disabled="true" /> N/A-->
<!--		      </td>-->
<!--		    </tr>-->
<!--		    </tbody>-->
<!--		  </table>-->
...
<!--				  	    </html:select>-->
<!--					<%//if(!cc){ %>-->
<!--						<bean:write name="OtherReceiptForm" property="nonPanelinsurerLegalFirm" />&nbsp;-->
<!--					<%//} %>-->
<!--					</td>-->
<!--			     </tr>-->
<!--			     <tr class="even">-->
<!--		            <td width="30%" class="fieldname">Insurer Reference Number</td>-->
<!--		            <td><bean:write name="OtherReceiptForm" property="insurerReferenceNumber" />&nbsp;</td>-->
<!--		          </tr>		-->
<!--	            <tr class="odd">-->
<!--		            <td width="30%" class="fieldname">Person-In-Charge</td>-->
<!--		            <td><bean:write name="OtherReceiptForm" property="insurerInCharge" />&nbsp;</td>-->
<!--	            </tr>		-->
<!--	            <tr class="even"> -->
<!--					<td width="30%" class="fieldname">Address-->
<!--					<%//if(cc){ %><font color="#0000FF" >*</font><%//} %></td>-->
...
<!--				<tr class="odd"> -->
<!--					<td width="30%" class="fieldname">Contact No</td>-->
<!--					<td><bean:write name="OtherReceiptForm" property="insurerFirmContactNumber" />&nbsp;</td>-->
<!--				</tr>	-->
<!--	            <tr class="even"> -->
<!--					<td width="30%" class="fieldname">Email</td>-->
<!--					<td><bean:write name="OtherReceiptForm" property="insurerEmail" />&nbsp;</td>-->
<!--				</tr>		-->
<!--		    </tbody>-->
<!--		  </table>-->
<!--		 </td>-->
