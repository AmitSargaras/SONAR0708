...
<%  String party= "";
	...
	DefaultLogger.debug(this,"************************************ "+ context);
	
	//DefaultLogger.debug(this,"*************cif id is*********************** "+ customerCifId);
								...
								<tbody>
									<tr class="odd">
										...
										<td width="30%"><html:text property="customerNameShort" onchange="javascript : makeUppercase()"
											size="40" maxlength="100"></html:text>&nbsp;
									...
									<tr class="even">
										...
										<%if( value.getStatus()==null || value.getStatus()==""){
											%>
						                  	<input type="radio" name="status" checked="checked" value="ACTIVE" >Open</input>
