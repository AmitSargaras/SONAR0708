package com.integrosys.simulator.host.stp.trade;
 ...
 * @author KC Chin
 */
public class TradeResponseHeader extends STPHeader implements java.io.Serializable {
	...
	public TradeResponseHeader() {
	}

	public TradeResponseHeader(TradeResponseHeader another) {
