...
function approvePage() {
    document.forms[0].action="leiDateValidation.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="leiDateValidation.do?event=<%=rejectEvent%>";
	document.forms[0].submit();
}
function cancelPage() {
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								<tr class="odd">
									...
									<td class="fieldname" >Party Name<font
										color="red">*</font></td>
									<td ><%=leiDateValidationForm.getPartyName()%> &nbsp;<%--  <html:errors property="dupStateIdError" /> --%></td>

									<td class="fieldname" >Party ID<font
										color="red">*</font></td>
								...
								<tr class="odd">
									...
									<td class="fieldname" >LEI Date Validation Period(In Months)<font
										color="red">*</font></td>
									<td ><%=leiDateValidationForm.getLeiDateValidationPeriod()%> &nbsp;<%--  <html:errors property="dupStateIdError" /> --%></td>
								...
								<tr class="odd">
									...
									<td>
										<%
											if (leiDateValidationForm.getStatus().trim().equalsIgnoreCase("ACTIVE")) {
										%>Enable
										<%
											} else {
										%>Disable<%
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tbody>
								...
								<tr>
									...
									<td class="even"><%=leiDateValidationTrx.getUserInfo()%>&nbsp;</td>
								</tr>
								<tr class="odd">
									<td class="fieldname">Last Remarks Made</td>
									<td><%=leiDateValidationTrx.getRemarks() != null ? leiDateValidationTrx.getRemarks() : ""%>&nbsp;</td>
								</tr>
							</tbody>
						</table>
					</td>
