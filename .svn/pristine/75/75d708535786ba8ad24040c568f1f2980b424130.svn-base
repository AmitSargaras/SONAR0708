...
Locale locale = (Locale)session.getAttribute(ICommonEventConstant.GLOBAL_SCOPE+"."+com.integrosys.base.uiinfra.common.Constants.GLOBAL_LOCALE_KEY);
    ...
    ICheckListItem item = (ICheckListItem) session.getAttribute("com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptAction.checkListItem");
...
function submitInactive() {
	var index=<%=index%>;
	//alert("index "+index);
	document.forms["OtherReceiptForm"].event.value="conform_inactive";
	document.forms["OtherReceiptForm"].submit();
}
</script>
...
--%>
            <tr class="even">
             ...
             <tr class="even">
              ...
              <td>&nbsp;<bean:write name="OtherReceiptForm" property="receivedDate" /></td>
            </tr>
