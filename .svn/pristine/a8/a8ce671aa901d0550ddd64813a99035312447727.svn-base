                    ...
                    <td colspan="2">
                        ...
                        <tbody>
	                            <tr class="even">	                           
				                  ...
				                  <td class="fieldname" >Insurance Company Code </td>				                 				                  	
				                  	  <td><html:text name="insuranceCoverageForm" property="insuranceCoverageCode" styleId="insuranceCoverageCode" maxlength="30" size="30" style="background:#B4CFEC" disabled="true"/>
				                  ...
				                  <td>
				                  	<html:text name="insuranceCoverageForm" property="companyName" maxlength="75"  size="30"/>
				                ...
				                <tr class="odd">  
				                  ...
				                  <td>
				                  	<html:textarea name="insuranceCoverageForm" property="address" rows="5" cols="40" onkeypress="setMaxLenght(this,'200')"/>
				                  	  <html:errors property="addressError"/></td>
				                  </td>
				                  
				                  <td class="fieldname" width="15%">Contact Number </td>
				                  <td>
				                  	<html:text name="insuranceCoverageForm" property="contactNumber" maxlength="15" size="30" ></html:text>
