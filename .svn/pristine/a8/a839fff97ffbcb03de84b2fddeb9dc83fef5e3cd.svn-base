...
UpdatePariPassuCheckListForm form = (UpdatePariPassuCheckListForm)request.getAttribute("UpdatePariPassuCheckListForm");
    String lableDocDate = "Doc Expiry Date";
        ...
        ICheckListItem checkListItem =(ICheckListItem)session.getAttribute("com.integrosys.cms.ui.checklist.paripassuupdate.UpdatePariPassuCheckListAction.checkListItem");
    List deferCreditApproverList = (List)session.getAttribute("com.integrosys.cms.ui.checklist.paripassuupdate.UpdatePariPassuCheckListAction.deferCreditApproverList");
...
function saveForm() {
	...
	//if(chkResult==true ){
		document.forms["UpdatePariPassuCheckListForm"].event.value="save_defer";
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td><h3>Update Pari Passu CheckList </h3></td>
    </tr>
    <tr>
