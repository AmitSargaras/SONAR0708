					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tbody>
							...
							<tr class="odd">
								...
								<tr class="even">
										<td class="fieldname" width="20%">Is it in RBI wilful
											Defaulters List?</td>
										<td width="30%">
										...
										<td class="fieldname" width="20%">
											...
											<p>2)If any director name appears more than once</p> <br />
											<p>3)Name of the director</p>
										</td>
										<td><html:select property="nameOfBank"
												styleId="nameOfBank" disabled="true" disabled="true" value="<%=form.getNameOfBank()%>" >
											...
											<br /> <br /> <br /> <html:text
												...
												styleId="nameOfDirectorsAndCompany" size="15" maxlength="10"
												readonly="true" value="<%=form.getNameOfDirectorsAndCompany()%>"></html:text></td>
									</tr>
...
<%}%>										 
										...
										<td><html:text property="detailsOfDefault" readonly="true"
												styleId="detailsOfDefault" size="15" maxlength="10" value="<%=form.getDetailsOfDefault()%>"></html:text>
											<br />
													<br />
															<br />
											 <html:text property="extOfCompromiseAndWriteoff"
												styleId="extOfCompromiseAndWriteoff" size="15" readonly="true"
												maxlength="10"  value="<%=form.getExtOfCompromiseAndWriteoff()%>"></html:text></td>
									</tr>
...
<%}%>
										...
										<td><html:text property="detailsOfCleanCibil"  readonly="true"
												styleId="detailsOfCleanCibil" size="15" maxlength="10" value="<%=form.getDetailsOfCleanCibil()%>"></html:text>
