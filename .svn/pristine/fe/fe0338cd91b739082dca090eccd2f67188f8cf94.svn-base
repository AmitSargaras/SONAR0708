Alter Table SCI_LSP_APPR_LMTS Add (IS_DP_REQUIRED Char(1));
Alter Table STAGE_LIMIT Add (IS_DP_REQUIRED Char(1));
...
COMMIT;
  ...
  --DELETE FROM CMS_BASEL_MONTHLY_P2 WHERE length(N_F_LINE_SERIAL) > 2;
  --COMMIT;
