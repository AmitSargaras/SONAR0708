...
ISegmentWiseEmailTrxValue segmentWiseEmailTrx = (ISegmentWiseEmailTrxValue) session
	...
	List oldEmailList = null;
	oldEmailList = (ArrayList) request.getAttribute("emailList");
	pageContext.setAttribute("oldEmailList", oldEmailList);
%>
...
<script language="JavaScript" type="text/JavaScript">
	...
	function submitForm() {
		document.forms[0].action = "segmentWiseEmail.do?event=maker_edit_segment_wise_email";
				...
				<tr>
					<td align="center">
						<table width="60%" id="listTable" border="1px" cellspacing="0" cellpadding="0" class="tblInput">
							<%-- 	<logic:present name="oldEmailList">
	                    			<logic:iterate id="OB" name="oldEmailList" type="com.integrosys.cms.app.segmentWiseEmail.bus.ISegmentWiseEmail" scope="page" >
											<tr>
												<td><%=OB.getEmail()%></td>
												<script language="JavaScript" type="text/JavaScript">
													addedEmailList.push('<%=OB.getEmail()%>');
												</script>
