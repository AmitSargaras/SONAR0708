														...
														<table width="100%" border="0" align="center"
															...
															<%if(!event.equals("maker_rejected_delete_read")){ %>
																...
																<tr class="odd">
																	...
																	<td><%=forexFeedGroupTrxValue.getRemarks() != null ? forexFeedGroupTrxValue
								.getRemarks()
								: ""%>&nbsp;
																	</td>
																</tr>
								...
								<tr>
									...
									<%
										...
										String alphaIndexUrl = null;
												...
												alphaIndexUrl = "feed_exchange_rate_item.do?event=maker_rejected_delete_read&TrxId="+transId+"&loginId=";
