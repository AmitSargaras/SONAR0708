...
<%
    ...
    System.out.println("::::::::::::::::getStatus>>>"+checkListTrxVal.getStatus());
    int itemIndex = 0;
...
if("REJECTED".equals(checkListTrxVal.getStatus())){
	flag="Close";
}
System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> flag>"+flag);
   ...
   // System.out.println("::::::::::::::::"+aForm);
    ...
    if("to_track".equals(previous)||"maker_return_to_track".equals(previous)||"checker_return_to_track".equals(previous)){//OFFICE
        toTrack = true;
    }
...
function callSubmit6(ind,docNo) {
	formObj = document.forms["LADReceiptForm"];
...
function callSubmit3(ind,docNo) {
	formObj = document.forms["LADReceiptForm"];
	 ...
	 formObj.event.value="maker_totrack_view_image";
	      //  alert(selObj.options[selObj.selectedIndex].value);
			formObj.index.value = ind;
	      			formObj.submit();
	  	    }

function callSubmit4(ind,docNo) {
	formObj = document.forms["LADReceiptForm"];
	  
	 formObj.event.value="checker_totrack_view_image";
	      //  alert(selObj.options[selObj.selectedIndex].value);
			formObj.index.value = ind;
	      			formObj.submit();
	  	    }
function callSubmit5(ind,docNo) {
	
	formObj = document.forms["LADReceiptForm"];
	  
	 formObj.event.value="close_draft_view_image";
	      //  alert(selObj.options[selObj.selectedIndex].value);
			formObj.index.value = ind;
	      			formObj.submit();
	  	    }
...
<input type="hidden" name="viewFlag" value="Y"/>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td> <h3><%=("Cancel".equals(flag)?"Close":flag)%> LAD Doc Receipt</h3>
...
--%>
              ...
              %>
               <center> <a href="#" onClick="goView('<%=OB.getCheckListItemRef()%>', '<%=checkListID%>')">View</a></center>
              <% } else { %>
                <center><a href="#" onClick="view('<%=OB.getCheckListItemRef()%>')">View</a></center>
              <%-- } } else { --%>
                &nbsp;
              <% } %>
              </td>
              <%if(checkListTrxVal.getStatus().equals("REJECTED") && !toTrack){ %>
                <% String tempScr2 = "callSubmit1('"+(itemIndex-1)+"','"+docNo+"')"; %>
                <td><center><a href="#" onClick="<%=tempScr2%>">View Images</a></center></td>
                <%}else if(checkListTrxVal.getStatus().equals("REJECTED") && toTrack){ %>
                <% String tempScr4 = "callSubmit4('"+(itemIndex-1)+"','"+docNo+"')"; %>
                <td><center><a href="#" onClick="<%=tempScr4%>">View Images</a></center></td>
                <%}else if(checkListTrxVal.getStatus().equals("ACTIVE")&& toTrack){ %>
                <% String tempScr3 = "callSubmit3('"+(itemIndex-1)+"','"+docNo+"')"; %>
                <td><center><a href="#" onClick="<%=tempScr3%>">View Images</a></center></td>
                <%}else if(checkListTrxVal.getStatus().equals("DRAFT")){ %>
                <% String tempScr5 = "callSubmit5('"+(itemIndex-1)+"','"+docNo+"')"; %>
                <td><center><a href="#" onClick="<%=tempScr5%>">View Images</a></center></td>
                <%}else if(!checkListTrxVal.getStatus().equals("ACTIVE")&& toTrack){
                	String tempScr5 = "callSubmit3('"+(itemIndex-1)+"','"+docNo+"')";%>
                	 <td><center><a href="#" onClick="<%=tempScr5%>">View Images</a></center></td>
                <%}else{ %>
                 <% String tempScr2 = "callSubmit2('"+(itemIndex-1)+"','"+docNo+"')"; %>
                <td><center><a href="#" onClick="<%=tempScr2%>">View Images</a></center></td>
                <%} %>
                <%if(checkListTrxVal.getStatus().equals("REJECTED")&& !toTrack){ %>
                <td>
              <center>
              <a href="LADReceipt.do?event=prepare_checker_view_lad&operation=LADREC&id=<%=OB.getCheckListItemID()%>&custTypeTrxID=<%=custTypeTrxID %>&viewFlag=Y" >View&nbsp;</a>
           </center>
              &nbsp;
              </td>
              <%}else if(checkListTrxVal.getStatus().equals("REJECTED")&& toTrack){ %>
              <td>
              <center>
              <a href="LADReceipt.do?event=checker_totrack_view_lad&operation=LADREC&id=<%=OB.getCheckListItemID()%>&custTypeTrxID=<%=custTypeTrxID %>&viewFlag=Y" >View&nbsp;</a>
           </center>
              &nbsp;
              </td>
              <%}else if(checkListTrxVal.getStatus().equals("DRAFT")){ %>
              <td>
              <center>
              <a href="LADReceipt.do?event=draft_close_view_lad&operation=LADREC&id=<%=OB.getCheckListItemID()%>&custTypeTrxID=<%=custTypeTrxID %>&viewFlag=Y" >View&nbsp;</a>
           </center>
              &nbsp;
              </td>
              <%}else if("PENDING_UPDATE".equals(checkListTrxVal.getStatus())&& !toTrack){ %>
              <td>
              <center>
              <a href="LADReceipt.do?event=checker_totrack_view_lad&operation=LADREC&id=<%=OB.getCheckListItemID()%>&custTypeTrxID=<%=custTypeTrxID %>&viewFlag=Y" >View&nbsp;</a>
           </center>
              &nbsp;
               ...
               <%}else if((checkListTrxVal.getStatus().equals("ACTIVE")&& toTrack)||(checkListTrxVal.getStatus().equals("PENDING_UPDATE")&& toTrack)){ %>
               <td>
              <center>
              <a href="LADReceipt.do?event=prepare_totrack_view_lad&operation=LADREC&id=<%=OB.getCheckListItemID()%>&custTypeTrxID=<%=custTypeTrxID %>&viewFlag=Y" >View&nbsp;</a>
           </center>
              &nbsp;
              </td>
                <%}else{ %>
              <td>
              <center>
              <a href="LADReceipt.do?event=prepare_view_lad_doc&operation=LADREC&id=<%=OB.getCheckListItemID()%>&checklistId=<%=checkList.getCheckListID() %>&viewFlag=Y" >View&nbsp;</a>
           </center>
              &nbsp;
              </td>
              <%} %>
...
<% if(row==0){%>
            <tr class="odd">
              <td colspan="11">There are no LAD linked</td>
            </tr>
<% }%>
          </tbody>
        </table></td>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <%if(!toTrack && "Close".equals(flag)) { %>
    ...
    <%}else{%>
    <td><a href="LADReceipt.do?event=list" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4" width="70" height="20" border="0" id="Image4" /></a></a></td>
    <%} %>
  </tr>
  <tr>
    <td>&nbsp;</td>
