...
window.onload = function(e){ 
	<%
	System.out.println("Drop down Entity validator"+form.getEntity());
			...
			<tbody>
				<tr id="customerdetails">
					...
					<table width="100%" height="100%" cellspacing="0" cellpadding="0"
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
									...
									<td class="fieldname">RBI Industry Code<font color="red">*</font></td>
										...
										<td><integro:empty-if-null value="<%=form.getCycle()%>"/></td>
									</tr>
									<tr class="even">
										<td class="fieldname"></td>
										<td></td>
										<td class="fieldname">Party name as per PAN</td>
										<td><integro:empty-if-null value="<%=form.getPartyNameAsPerPan()%>"/></td>
									</tr>
									<tr class="odd">
										...
										<td><integro:empty-if-null value="<%=form.getPan()%>"/>
										<%if(null!= form.getIsPanValidated() && 'Y' == form.getIsPanValidated()){%>
									...
									<tr class="even">
										...
										<td><integro:empty-if-null value="<%=form.getLeiCode()%>"/>
										<%if('Y' == form.getIsLeiValidated()){%>
									...
									<tr class="even">
										...
										<integro:empty-if-null value="<%=form.getTelephoneNo()%>"/>
										
										</td>
										<td class="fieldname">Fax No.</td>
										<td>
										<integro:empty-if-null value="<%=form.getStdCodeTelex()%>"/>
										<integro:empty-if-null value="<%=form.getTelex()%>"/>
										</td>
									</tr>
									<tr class="odd">
					   	   	  ...
					   	   	  <tr class="odd">
											...
											<td><html:text property="ecbfStatus" size="30"
													maxlength="50" disabled="true" value="NA" ></html:text>&nbsp; <br></td>
						...
						<jsp:include page="checker_co_borrower_details_summary.jsp" />
