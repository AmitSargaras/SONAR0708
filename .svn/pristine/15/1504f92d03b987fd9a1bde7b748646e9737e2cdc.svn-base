    ...
    <tr>
      <td>
          <h3>
              ...
              %>
            View Update PariPassu Document
              <%
                  }
              %>
          </h3>
  ...
  <tbody>
   ...
   %>
    <tr class="<%=rowClass%>">
        ...
        <a href="UpdatePariPassuCheckListAction.do?event=view_chk_update&&limitBkgLoc=IN&&orgCode=000&&checkListID=<%=paripassuChecklistId %>&&secType=PARIPASSU&&secSubType=PARIPASSU"  >View</a>
