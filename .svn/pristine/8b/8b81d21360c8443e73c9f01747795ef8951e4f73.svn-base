...
System.out.println("::::::::::::::::::custTypeTrxID:::::::::"+custTypeTrxID);
...
function closePage() {
	document.forms[0].action="LADReceipt.do?event=maker_return_todo_process";
	document.forms[0].submit();
}
function returnPage() {
	document.forms[0].action="LADReceipt.do?event=return_process&&custTypeTrxID=<%=custTypeTrxID%>";
	document.forms[0].submit();
}
                                                    ...
                                                    for (int z = 0; z < listLADSubItem.size(); z++) {
                                                       ...
                                                       String rowClass = "";
                                                        ...
                                                        <tr class="<%=rowClass%>">
                                                            ...
                                                            <%if("prepare_view_process_lad".equals(event)){ %>
                                                            <td width="10%"><a href="LADReceipt.do?event=view_attach_lad_image&id=<%=String.valueOf(item.getChklistDocId())%>&docType=<%=docType %>&docIdLAD=<%=String.valueOf(item.getChklistDocItemId()) %>&checklistId=<%=checklistId %>">View Images &nbsp;</a></td>
                                                            <%}else if("prepare_view_process_lad_doc".equals(event)){%>
                                                            <td width="10%"><a href="LADReceipt.do?event=view_attach_lad_process_image&id=<%=String.valueOf(item.getChklistDocId())%>&docType=<%=docType %>&docIdLAD=<%=String.valueOf(item.getChklistDocItemId()) %>&checklistId=<%=checklistId %>">View Images &nbsp;</a></td>
                                                            <%}else{ %>
                                                            <td width="10%"><a href="LADReceipt.do?event=view_attach_image&id=<%=String.valueOf(item.getChklistDocId())%>&docType=<%=docType %>&docIdLAD=<%=String.valueOf(item.getChklistDocItemId()) %>&checklistId=<%=checklistId %>">View Images &nbsp;</a></td>
                                                            <%} %>
                                                        </tr>
                                                        <%
                                                    }
