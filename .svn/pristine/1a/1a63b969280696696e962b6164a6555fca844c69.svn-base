...
function saveForm() {
	document.forms["CCReceiptForm"].event.value="save_complete";
    ...
    <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
         ...
         <!--   <tr class="even">
            ...
            <tr class="odd">
                  <td class="fieldname">Date Complete&nbsp;<font color="#0000FF">*</font></td>
...
<%-- modified for cr-17           --%>
      <!--      <tr class="even">
          ...
          <!--End table for  to  document  item Details-->
         <!--Start table for  Shared Document  CheckLists-->
      <%--    <jsp:include page="/checklist/ccreceipt/update_sharechecklist.jsp" />  --%>
         <!--End table for  to show list Shared Document  -->
