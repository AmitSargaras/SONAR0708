...
function submitForm(event) {
	...
	if(event=="maker_prepare_resubmit_create")
		...
		document.forms[0].action="caseBranch.do?event=maker_confirm_resubmit_create";
		
    }else{
      
    	document.forms[0].action="caseBranch.do?event=maker_edit_caseBranch";
    }
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <tr>
   <%if((event.equals("maker_prepare_resubmit_create"))){%>
                    <td><h3>Create Case Creation Branch</h3></td>
                    <%}else{ %>
                     <td><h3>Edit Case Creation Branch</h3></td>
                     <%} %>
