...
<%@ page
	...
	com.integrosys.cms.ui.holiday.MaintainHolidayForm,com.integrosys.cms.app.holiday.trx.IHolidayTrxValue,com.integrosys.cms.app.holiday.trx.OBHolidayTrxValue"%>
<%
	 MaintainHolidayForm holidayForm = (MaintainHolidayForm) request.getAttribute("MaintainHolidayForm");
IHolidayTrxValue holidayTrx = (IHolidayTrxValue)session.getAttribute("com.integrosys.cms.ui.holiday.MaintainHolidayAction.IHolidayTrxValue");
...
function submitPage(event) {
	...
	if(event=="maker_draft_close_process")
		...
		document.forms[0].action="holiday.do?event=maker_confirm_draft_close";
		
    }else{
      
    	document.forms[0].action="holiday.do?event=maker_confirm_close";
    }
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											<tr class="odd">
												...
												<td width="30%"><%=holidayForm.getDescription()%>&nbsp;
												</td>
											...
											<tr class="even">
												...
												<td width="30%"><%=holidayForm.getStartDate()%>&nbsp;
												</td>
												
											</tr>
											 <tr class="odd">
             
									              <td class="fieldname" width="20%">End Date</td>
									              <td width="30%"><%=holidayForm.getEndDate()%>&nbsp;</td>
           									...
           									<tr class="even">
												...
												<td width="30%"><html:checkbox name="MaintainHolidayForm" property="isRecurrent" disabled="true" />&nbsp;
												</td>
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tbody>
						...
						<tr>
							...
							<td class="even"><%=holidayTrx.getUserInfo()%>&nbsp;</td>
						</tr>
						<tr class="odd">
							<td class="fieldname">Last Remarks Made</td>
							<td><%=holidayTrx.getRemarks() != null
						? holidayTrx.getRemarks()
						: ""%>&nbsp;</td>
						</tr>
					</tbody>
				</table>
