...
<%
    ...
    List docList = (List) docsHeldMap.get(ICMSConstant.CHECKLIST_NON_BORROWER);
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
	...
	<tr> 
		<td> 
			<h3> Constitutional / Contractual Documents - Non-Borrower</h3>
		</td>
	</tr>
	<tr> 
		<td>
...
<%
	if (DocumentCheckListAction.EVENT_LIST_NON_BORROWER.equals(event)) {
%>
<table width="75" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td valign="top" ><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','img/print2.gif',1)" onclick="MM_openBrWindow('DocumentCheckList.do?event=print_non_borrower_list','','scrollbars=yes,toolbar=yes,menubar=yes,resizable=yes,width=760,height=450,left=5,top=5')" ><img src="img/print1.gif" name="Image2" border="0" id="Image2" /></a></td>
  </tr>
  <tr> 
    <td valign="top" >&nbsp;</td>
  </tr>
