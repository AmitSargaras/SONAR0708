...
<%
    ...
    com.integrosys.cms.app.chktemplate.bus.IItem item = null;
    if (ob != null) {
        item = ob.getItem();
    }
...
<table class="tblFormSection" width="70%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3><bean:message key="title.maintain.rec.doc.checklist.process.view"/></h3></td>
    </tr>
    <tr>
      <td><hr/></td>
    </tr>
          ...
          <tbody>
            <tr class="odd">
              ...
              <td class="<%=CompareOBUtil.compOB(stageOb.getItem(),item,"itemDesc")? "fieldname":"fieldnamediff"%>">
				<bean:message key="label.checklist.doc.description"/>&&nbsp;<font color="#00AAFF">* </font></td>
              <% }else{ %>
            ...
            %>
              <td class="<%="fieldname"%>"><bean:message key="label.checklist.frequency"/>&nbsp;<font color="#00AAFF">* </font></td>
            <%} else {
            ...
            <tr class="even">
             <%if(stageOb!=null) { %>
              <td class="<%=CompareOBUtil.compOB(stageOb,ob,"initialDocEndDate")? "fieldname":"fieldnamediff"%>">
				<bean:message key="label.checklist.doc.end.date"/>&nbsp;<font color="#00AAFF">* </font></td>
              <%}else{%>
            ...
            <tr class="even">
             <%if(stageOb!=null) { %>
              <td class="<%=CompareOBUtil.compOB(stageOb,ob,"initialDueDate")? "fieldname":"fieldnamediff"%>">Due Date</td>
              <%}else{%>
            ...
            <tr class="odd">
              <td class="<%=CompareOBUtil.compOB(stageOb,ob,"lastDocEntryDate")? "fieldname":"fieldnamediff"%>">
				<bean:message key="label.checklist.last.doc.entry.date"/></td>
              <td><bean:write name="RecurrentCheckListForm" property="lastDocEntryDate"/>&nbsp;</td>
            </tr>
            <tr class="even">
              <td class="<%=CompareOBUtil.compOB(stageOb,ob,"chaseReminderInd")? "fieldname":"fieldnamediff"%>">
				<bean:message key="label.checklist.chaser.reminder.required"/></td>
...
<table width="100"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td width="100" valign="baseline" align="center"> <a href="javascript:history.go(-1)" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3311','','img/return2.gif',1)"><img src="img/return1.gif" name="Image3311"  border="0" id="Image3311" /></a> 
    </td>
  </tr>
  <tr> 
    <td valign="baseline" align="center">&nbsp;</td>
