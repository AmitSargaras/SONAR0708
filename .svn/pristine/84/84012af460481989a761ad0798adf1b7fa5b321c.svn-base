<%@ page import="com.integrosys.cms.ui.dataprotection.DataProtectionUtil,
                 com.integrosys.cms.ui.collateral.marketablesec.marksecmainforeign.EquityTypeList,
...
function submitPage(num) {
    ...
    if (num == 1) {
    	document.forms[0].event.value="marksecmainforeign_create";
    }
	if (num == 2) {
    	document.forms[0].event.value="marksecmainforeign_update";
    }
    if (num == 3) {
...
<% int index =2;
  ...
  if ("marksecmainforeign_prepare".equals(request.getParameter("event")) || "marksecmainforeign_create".equals(request.getParameter("event"))) {
	index = 1;
  }
