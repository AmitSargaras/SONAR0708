drop procedure MIG_RUN_AB109
@

CREATE PROCEDURE MIG_RUN_AB109
	LANGUAGE SQL
BEGIN
	CALL "MIG_LOG_PROC_TIME"('MIG_RUN_AB109', 'MIG', 1);			
	...
	type_of_asset, manufacture_year, model_no, good_status, purchase_price, purchase_date, scrap_value)
	...
	AIRCRAFT_TYPE, YEAR_OF_MANUFACTURE, MODEL_NO, GOODS_STATUS, PURCHASE_PRICE, PURCHASE_DATE, SCRAP_VALUE
	FROM MIG_AB109
	where valid_ind = 'Y');
	...
	CALL "MIG_LOG_PROC_TIME"('MIG_RUN_AB109', 'MIG', 0);
