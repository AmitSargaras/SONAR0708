          ...
          <tbody>
            <tr class="odd">
              <td width="20%" class="fieldname"><bean:message key="label.valuation.old.valuer"/></td>
                ...
                <% String valuer = (String)session.getAttribute("com.integrosys.cms.ui.collateral.assetbased.AssetBasedAction.oldValuer");
              ...
              <img src="img/calendara.gif"  name="Image723" border="0" id="Image723" onclick="showCalendar('valDate', 'dd/mm/y')" onMouseOver="MM_swapImage('Image723','','img/calendarb.gif',1)" onMouseOut="MM_swapImgRestore()" />
              <html:errors property="valDate"/>
              </td>
            </tr>
            <tr class="even">
              <td width="20%" class="fieldname"><bean:message key="label.valuation.currency"/>&nbsp;<span class="mandatoryPerfection">*</span><font color="#0000FF"><span id="span21">&nbsp;</span></font></td>
               <td width="30%">
            ...
            <tr class="odd">
              ...
              <td class="fieldname"><bean:message key="label.security.valuation.cmv"/>&nbsp;<font color="#0000FF"><span id="span22">&nbsp;</span></font></td>
              <td>
