...
<form name="ProcessCustomerDetailsForm" method="POST" action="/cms/CustomerProcess.do?event=ChkLimitProfileApRej">
      ...
      <td><table  width="100%" class="tblinfo" style="margin-top:0" border="0" cellspacing="0" cellpadding="0">
          <thead>
            <tr>
              ...
              <td width="10%"><bean:message key="label.security.loc"/></td>
          ...
          <tbody>
             ...
             <tr class="odd">
              ...
              <td valign="top" width="5%"> <a href="CustomerProcess.do?event=chkLimitProfileApRej&trxID=20030715000301" >View
                </a></td>
            the value of limit id is 20030715000034
             <input type="hidden" name="instrID" value="20030715000023">
             <input type="hidden" name="subprofileID" value="20030704000012">
          ...
          <thead>
            <tr>
              ...
              <td width="24%"><bean:message key="label.global.legal.name"/><br/>
                <bean:message key="label.customer.name"/></td>
              <td width="5%"><bean:message key="label.global.action"/></td>
            </tr>
          </thead>
          <tbody>
