...
drop table MIG_PROC_TIME_LOG@
DROP PROCEDURE mig_log_proc_time
@
...
CREATE TABLE MIG_PROC_TIME_LOG(
...
CREATE PROCEDURE MIG_LOG_PROC_TIME (
...
BEGIN ATOMIC
 ...
 INSERT INTO MIG_PROC_TIME_LOG (proc_name, source_id, start_flag, time_stamp)
