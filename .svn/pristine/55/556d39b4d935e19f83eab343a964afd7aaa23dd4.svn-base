...
function submitForm() {
		...
		document.forms[0].action = "LimitsOfAuthorityMaster.do?event=maker_edit_limits_of_authority";
		document.forms[0].submit();
}

function saveForm() {
		enableAllFormElements();
		document.forms[0].action = "LimitsOfAuthorityMaster.do?event=maker_update_draft_limits_of_authority";
		document.forms[0].submit();
}
	...
	<body>
		<table width="70%" border="0" align="center" cellpadding="0"
			...
			<thead>
				<tr>
					<td>
						<h3>Edit Limits of Authority (LOA) Master</h3>
					</td>
				</tr>
				<tr>
					<td>
						...
						<tr class="odd">
							<td class="fieldname" width="30%">Segment<font color="red">*</font></td>
				                  <td width="20%">
                                    	...
                                    	<integro:common-code 
                                    		categoryCode="<%=CategoryCodeConstant.HDFC_SEGMENT%>" entryCode="<%=loaMasterForm.getSegment() %>"  descWithCode="false" />
                                    	</html:select>	
										&nbsp; &nbsp;
							...
							<td width="20%">
											...
											<html:text property="limitReleaseAmt" styleId="limitReleaseAmt" size="20" styleClass="amtClass" 
												onblur="javascript:formatAmountAsCommaSeparatedOnlyDigitNonBlank(this)"/>&nbsp;
											<br>	
				...
				<td>
					<center>
						<a href="javascript:cancelPage();"
							onmouseout="MM_swapImgRestore()"
							onmouseover="MM_swapImage('Image1','','img/cancel2.gif',1)">
