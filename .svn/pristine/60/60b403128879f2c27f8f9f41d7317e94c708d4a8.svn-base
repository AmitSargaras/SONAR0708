		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<tr id="financialdetails">
				...
				<table width="100%" height="100%" cellspacing="0" cellpadding="0"
					...
					<tr>
						<%
							if (value.getSubLine()!= null && value.getSubLine().equals("OPEN")) {
						%>
						<td align="right"><input type="button" name="button"
							id="detailBtn" value="Add Details" class="btnNormal"
							onclick="javascript : addSubLine('add_sub_line')"></td>
						<%
							} else {
						%>
						<td align="right"><input type="button" name="button"
					...
					<tr>
								...
								<logic:present name="partyGrpList">
									<logic:iterate id="ob" name="partyGrpList"
										...
										<tr class="<%=rowClass%>">
											...
											<td>
											<center><%=ob.getPartyGroup().getCustomerName()%></center>
											</td>
											<td>
											<center>GUARANTEE</center>
											</td>
											<td>
											<center><%=ob.getAmount()%></center>
											</td>
								 ...
								 <%if(partyGrpList != null && partyGrpList.size()==0 ){ %>
									<tr class="odd" id="sblnDetailsEmpty">
						...
						<%
							} else if (value.getSubLine() != null && value.getSubLine().equals("")) {
						%>
                         <html:errors property="sublineListEmptyError"/>
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<table border="0" cellspacing="0" cellpadding="0" class="tblInfo">
							<tbody>
								...
								<tr class="even">
									...
									<td><html:text property="nonFundedSharePercent" size="10" styleId="nonFundedSharePercent"
								...
								<tr class="even">
									...
									<td><html:text property="totalSanctionedLimit" styleId="totalSanctionedLimit" size="30"
										maxlength="30" readonly="true"></html:text>&nbsp;</td>
									<td class="fieldname">&nbsp;</td>
									<td>&nbsp;</td>
									<td class="fieldname">&nbsp;</td>
									<td>&nbsp;</td>
								...
								<tr class="even">
									...
									<td><html:text property="mpbf" size="23" maxlength="15" styleId="mpbf" onblur="javascript:formatAmountAsCommaSeparated(this)"></html:text>&nbsp;
