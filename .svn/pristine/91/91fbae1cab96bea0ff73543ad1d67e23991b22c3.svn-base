...
*
* Describe this JSP.
* Purpose: For Maker to update existing Auto Valuation Parameters
* Description: update the existing set of Auto Valuation Parameters
*
* @author $Author$<br>
* @version $Revision$
* Date: $Date$
...
<%
    ...
    if(event.equals("maker_prepare_edit")||event.equals("maker_prepare_change_list_edit")
            ||event.equals("maker_confirm_edit")) {
        submitEvent="maker_confirm_edit";
        changeListEvent="maker_prepare_change_list_edit";
    }
...
<%--<html:hidden name="AutoValuationParameterForm" property="parameterId"/>--%>
...
<table class="tblFormSection" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3><bean:message key="label.edit"/> <bean:message key="title.auto.valuation.property.parameters"/></h3></td>
    </tr>
    <tr>
      <td><hr/></td>
    </tr>
      ...
      <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblInput">
          <tbody>
            ...
            <tr class="even">
              ...
              <td>
                  <html:select name="AutoValuationParameterForm" property="unselectedState" size="7" multiple="true" styleClass="fixedSelectLength">
              ...
              <td>
                  <html:select name="AutoValuationParameterForm" property="selectedState" size="7" multiple="true" styleClass="fixedSelectLength">
                    <% for(int i=0; i<stateFullListLabel.size(); i++){
                         if(selectedStateVals!=null && Arrays.asList(selectedStateVals).contains(stateFullList.get(i))){  //if this value not in selected value print..
                    %>
                            <option value='<%=stateFullList.get(i)%>'><%=stateFullListLabel.get(i)%></option>
            ...
            <tr class="odd">
              ...
              <td>
                  <html:select name="AutoValuationParameterForm" property="unselectedDistrict" size="7" multiple="true" styleClass="fixedSelectLength">
              ...
              <td>
                  <html:select name="AutoValuationParameterForm" property="selectedDistrict" size="7" multiple="true" styleClass="fixedSelectLength">
                    <% for(int i=0; i<districtFullListLabel.size(); i++){
                         if(selectedDistrictVals!=null && Arrays.asList(selectedDistrictVals).contains(districtFullList.get(i))){  //if this value not in selected value print..
                    %>
                            <option value='<%=districtFullList.get(i)%>'><%=districtFullListLabel.get(i)%></option>
            ...
            <tr class="even">
              ...
              <td>
                  <html:select name="AutoValuationParameterForm" property="unselectedMukim" size="7" multiple="true" styleClass="fixedSelectLength">
              ...
              <td>
                  <html:select name="AutoValuationParameterForm" property="selectedMukim" size="7" multiple="true" styleClass="fixedSelectLength">
                    <% for(int i=0; i<mukimFullListLabel.size(); i++){
                         if(selectedMukimVals!=null && Arrays.asList(selectedMukimVals).contains(mukimFullList.get(i))){  //if this value not in selected value print..
                    %>
                            <option value='<%=mukimFullList.get(i)%>'><%=mukimFullListLabel.get(i)%></option>
            ...
            <tr class="odd">
              ...
              <td colspan="3" class="tblInput">
                <html:text name="AutoValuationParameterForm" property="postCode" size="20" maxlength="10" />
            ...
            <tr class="even">
              ...
              <td colspan="3">
                ...
                <html:text name="AutoValuationParameterForm" property="fromLandArea" size="20" maxlength="13"/>&nbsp;&nbsp;
                <html:select name="AutoValuationParameterForm" property="fromLandAreaMeasure">
                  <option value=""><bean:message key="label.please.select"/></option>
                  <html:options name="omvMeasureValue" labelName="omvMeasureLabel" />
                </html:select>
                &nbsp;&nbsp;&nbsp;<bean:message key="label.autovalparam.to"/>&nbsp;&nbsp;&nbsp;
                <html:text name="AutoValuationParameterForm" property="toLandArea" size="20" maxlength="13"/>&nbsp;&nbsp;
                <html:select name="AutoValuationParameterForm" property="toLandAreaMeasure">
                  <option value=""><bean:message key="label.please.select"/></option>
                  <html:options name="omvMeasureValue" labelName="omvMeasureLabel" />
                </html:select>
            ...
            <tr class="odd">
              ...
              <td colspan="3">
                <bean:message key="label.autovalparam.from"/>&nbsp;&nbsp;&nbsp;
                <html:text name="AutoValuationParameterForm" property="fromBuiltUpArea" size="20" maxlength="13"/>&nbsp;&nbsp;
                <html:select name="AutoValuationParameterForm" property="fromBuiltUpAreaMeasure">
                    <option value=""><bean:message key="label.please.select"/></option>
                    <html:options name="omvMeasureValue" labelName="omvMeasureLabel" />
                </html:select>
                &nbsp;&nbsp;&nbsp;<bean:message key="label.autovalparam.to"/>&nbsp;&nbsp;&nbsp;
                <html:text name="AutoValuationParameterForm" property="toBuiltUpArea" size="20" maxlength="13"/>&nbsp;&nbsp;
                <html:select name="AutoValuationParameterForm" property="toBuiltUpAreaMeasure">
                    <option value=""><bean:message key="label.please.select"/></option>
                    <html:options name="omvMeasureValue" labelName="omvMeasureLabel" />
                </html:select>
            ...
            <tr class="even">
              ...
              <td colspan="3">
                <html:text name="AutoValuationParameterForm" property="minCurrentOMV" size="20" maxlength="13"/>
      ...
      <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblInput">
          <tbody>
            <tr class="even">
              ...
              <td>
                <html:select name="AutoValuationParameterForm" property="omvIndicator">
                  <option value=""><bean:message key="label.please.select"/></option>
                  <html:options name="omvIndicatorValue" labelName="omvIndicatorLabel" />
                </html:select>&nbsp;&nbsp;
                <html:text name="AutoValuationParameterForm" property="omvValue" size="12" maxlength="8"/>
            ...
            <tr class="odd">
              ...
              <td><label>
                <html:textarea name="AutoValuationParameterForm" property="valuationDescription" cols="50" rows="4"></html:textarea>
