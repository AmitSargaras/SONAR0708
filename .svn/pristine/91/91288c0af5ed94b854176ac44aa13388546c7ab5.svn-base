...
<script language="JavaScript" type="text/javascript">
	...
	function deleteCountry(){
		var flag = <%=flg %>
		if( flag == true )
			alert('Please Disable Regions for this COUNTRY !!!');
		else
		{
			var ans = window.confirm('Are You Sure to Disable the COUNTRY ');
			if( ans == true )
			{
				document.forms[0].action		=	"Country.do";
				document.forms[0].event.value	=	"maker_delete_country";
				document.forms[0].submit();
			}
...
<td >&nbsp;</td>
			...
			<table width="80%" border="0" align="center" cellpadding="0"
				...
				<thead>
					<br>
					<tr><td><h3>Disable Country</h3></td></tr>
					<tr>
						<td>
							<hr />
						</td>
			...
			<table width="130" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="2">
						<center>
							<a href="javascript:deleteCountry()" onmouseout="MM_swapImgRestore()"
