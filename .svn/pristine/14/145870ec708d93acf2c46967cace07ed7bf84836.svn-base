...
function savePage () {
	document.forms[0].action="OtherGlobal.do?event=draft_doc_item";
...
<!--				-->
<!--				</td>-->
                        <td width="100" valign="baseline" align="center"> <a href="OtherGlobal.do?event=global_list&type=O&go=N" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image4411"  border="0" id="Image4411" /></a>
                        </td>
                      </tr>
                      <tr>
                        <td valign="baseline" align="center">&nbsp;</td>
