...
<%	
	List rbiCodeCategoryList = (List)request.getAttribute("rbiCodeCategoryList");	
...
function submitForm() {
    selectLists();
    document.forms[0].action="rbi_category.do?event=maker_confirm_resubmit_edit&TrxId=<%=request.getParameter("TrxId")%>";
    document.forms[0].submit();
}
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
           ...
           <tr class="odd">
              ...
              <input type="hidden" name="industryNameId" value="<%=obiCategory.getIndustryNameId()%>">
              <%--
               <html:select name="RbiCategoryForm"   property="industryNameId" >
		              <!-- <option value="">Please Select </option>	 -->
                      <html:options collection="industryNameValueList" property="code" labelProperty="category"/>
               </html:select>
              --%></td>
