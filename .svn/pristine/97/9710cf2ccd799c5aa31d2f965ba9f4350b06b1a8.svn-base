...
PincodeMappingForm pincodeMappingForm = (PincodeMappingForm) request
	...
	OBPincodeMapping ob = (OBPincodeMapping)session.getAttribute("com.integrosys.cms.app.pincodemapping.bus.OBPincodeMapping");
	int sno = 0;
	int startIndex = 0;
%>
...
function cancelPage(){
    document.forms[0].action="StatePincodeMapping.do?event=maker_list_state_pincode_mapping&startIndex=<%=request.getAttribute("startIndex")%>";
    
    document.forms[0].submit();
}
function submitForm() {
 	document.forms[0].action="StatePincodeMapping.do?event=maker_edit_state_pincode_mapping&trxId=<%=request.getAttribute("trxId")%>";
    document.forms[0].submit();
}

function saveForm() {

 	document.forms[0].action="StatePincodeMapping.do?event=maker_edit_draft_state_pincode_mapping&trxId=<%=request.getAttribute("trxId")%>";
    document.forms[0].submit();
}
...
<td >&nbsp;</td>
	...
	<table width="95%" border="0" align="center" cellpadding="0"
		...
		<thead>
			...
			<tr>
				<td>
				<h3>Edit State Pincode Mapping</h3>
				</td>
			</tr>
			<tr>
				<td>
