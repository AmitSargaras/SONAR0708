                ...
                <td colspan="3" valign="top" style="height:100%;width:100%;">
                    <table width="90%" class="tblFormSection" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:15px">
                      ...
                      <tr>
						...
						<td align="right" valign="bottom"><html:errors property="deleteNotificationError"/>
							<input name="delete" class=btnNormal type="button" value="Delete" onclick="deleteNotification()"/>
						</td>
                      </tr>
                        ...
                        <tr>
                          ...
                          <table  width="100%" class="tblinfo" style="margin-top:0" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
								...
								<td width="8%"><input type="checkbox" name="updateChk" value="checkbox" onclick="changeAllCheck()"/>Select All&nbsp;</td>
								<%} %>
                            </tr>
                            </thead>
                         <tbody>
                <logic:present name="notificationList">
                  ...
                  %>
                    <tr class=<%=rowClass%>>
						...
						<td >&nbsp;<a href="Notification.do?event=view&notificationID=<%=notification.getNotificationID()%>&<%=ICMSConstant.PARAM_NOTIFICATION_START_INDEX%>=<%=startInd%>" class="note"><%=notification.getNotificationTypeData().getNotificationTitle()%></a></td>
						<td align="center">&nbsp;<html:multibox property="notificationIDs" value="<%=String.valueOf(notification.getNotificationID())%>"/></td>
                    </tr>
                    </logic:iterate>
                </logic:present>
                <logic:notPresent name="notificationList" >
                <tr class="odd"><td colspan="3">
                    <bean:message key="label.global.not.found"/></td></tr>
                        ...
                        <tr><td colspan="3"><strong><a href="Notification.do?event=search&status=<%=ICMSConstant.STATE_NOTIFICATION_DELETED%>">Deleted Notification List</a></strong></td></tr>
