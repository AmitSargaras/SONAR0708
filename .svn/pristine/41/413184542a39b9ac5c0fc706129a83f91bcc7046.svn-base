...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.property.PropertyAction.serviceColObj");
    ...
    ICommercialShopHouse iCol = (ICommercialShopHouse) itrxValue.getStagingCollateral();
    ...
    PropCommShopForm colForm = (PropCommShopForm)request.getAttribute(formName);
...
<html:form action="PropCommShopCollateral.do">
<input type="hidden" name="event">
<input type="hidden" name="subTypeCode" value="<%=subtypeCode%>"/>    
<input type="hidden" name="indexID" />
<input type="hidden" name="subtype" value="PropCommShop"/>
