...
function submitForm() {
		document.forms[0].action = "ExcLineForSTPSRM.do?event=maker_edit";
		document.forms[0].submit();
		newShowSilkScreen();
}

function saveForm() {
		document.forms[0].action = "ExcLineForSTPSRM.do?event=maker_update_draft";
		document.forms[0].submit();
		newShowSilkScreen();
}
</script>
	...
	<body>
		<table width="70%" border="0" align="center" cellpadding="0"
			...
			<thead>
				<tr>
					<td>
						<h3>Edit Exclusion line for STP of SRM</h3>
					</td>
				</tr>
				<tr>
					<td>
							...
							<tbody>
								<tr class="odd">
				                  ...
				                  <td width="20%">
									...
									<td>
										<html:checkbox property="excluded" value="<%=form.getExcluded()%>"></html:checkbox>&nbsp;
									</td>
								</tr>
