								...
								<tr>
									...
									<%
										...
										String alphaIndexUrl = null;
												pageIndexUrl = "feed_stock_item.do?event=maker_rejected_delete_read&TrxId="+transId+"&startIndex=";
												alphaIndexUrl = "feed_stock_item.do?event=maker_rejected_delete_read&TrxId="+transId+"&loginId=";
												System.out.println("transId  "+transId);
									%>
