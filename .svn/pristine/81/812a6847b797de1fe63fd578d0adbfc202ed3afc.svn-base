...
<thead>
    <tr>
        <td height="34"><h3>Process Exchange Rate</h3></td>
    </tr>
    <tr>
        <td colspan="2"><hr/></td>
    </tr>
        ...
        <table id="tblExchange" width="100%" border="0" cellpadding="0" cellspacing="0" class="tblinfo" style="margin-top:0">
            <thead>
                <tr>
                        ...
                        <td width="5%">S/N</td>
                        <td width="9%">System Code&nbsp;<font color="#0000FF">* </font></td>
                        <td width="15%">Currency ISO Code</td>
                        <td width="20%">Currency Description</td>
                        
                        <td width="12%">Update Exchange Rate&nbsp;<font color="#0000FF">* </font></td>
            ...
            <logic:iterate id="result" name="compareResultsList"
                ...
                <tr class="<%=cssClass%>">
                    ...
                    <td>&nbsp;<integro:empty-if-null value="<%=feedEntry.getCurrencyIsoCode()%>"/></td>
                     <td>&nbsp;<integro:empty-if-null value="<%=feedEntry.getCurrencyDescription()%>"/></td>
                    <td class="amount">&nbsp;<integro:empty-if-null value="<%=UIUtil.formatWithCommaAndDecimal(updatedPrice)%>"/></td>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="odd"><html:textarea property="remarks" rows="4" style="width:90%"/>
                      </br>  <html:errors property="remarks"/></td>
                </tr>
                <tr>
