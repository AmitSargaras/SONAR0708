...
'CUST-ALLOC-0010', 'Smart Telcom Co.', 'Smart Telcom Co.', 
'56', 'C', 'MY', 'CUST-ALLOC-0010-BUS', 'ARBS');
...
from sci_le_main_profile where lmp_le_id = 'CUST-ALLOC-0010';
...
lsp_le_id, lsp_id, '80000010', 'ALLOC-AA-0010', cms_le_sub_profile_id, 'ACTIVE', 
'MY', '2', 'ARBS', 'N', 'BANKING', 'Y', 'Y', 'CO', 'CON'
from sci_le_sub_profile where lsp_le_id = 'CUST-ALLOC-0010';
...
where llp_le_id = 'CUST-ALLOC-0010';
...
cms_lsp_lmt_profile_id, '700000017', '27', 'HP',
'25', 'OUTER', 40000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 40000000, '210', 1, 'FAC-ALLOC-0017', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0010';
...
account_type, lmt_bca_ref_num, los_bca_ref_num)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for limit_seq), 2)) AS bigint), 
cms_lsp_lmt_profile_id, '700000018', '27', 'HP',
'25', 'OUTER', 20000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 20000000, '210', 1, 'FAC-ALLOC-0018', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0010';
...
account_type, lmt_bca_ref_num, los_bca_ref_num)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for limit_seq), 2)) AS bigint), 
cms_lsp_lmt_profile_id, '700000019', '27', 'HP',
'25', 'OUTER', 60000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 60000000, '210', 1, 'FAC-ALLOC-0019', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0010';
...
where los_lmt_id in ('FAC-ALLOC-0017','FAC-ALLOC-0018','FAC-ALLOC-0019') ;
...
'--', '--', '--', '-999999999', -999999999, -999999999
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0017','FAC-ALLOC-0018','FAC-ALLOC-0019');
...
'PT704', 'PT704-ALLOC-0002', 'PT704-ALLOC-0002', 'MY', subtype_name, security_type_name, 
'PT704', 'PT', 'MYR', 'ACTIVE', 'MYR', '12', 'ARBS', 'Y',
80000000, 'MYR', 72000000, 'MYR'
...
where sci_security_dtl_id in ('PT704-ALLOC-0002');	
...
cmv, cmv_currency, fsv, fsv_currency)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for collateral_seq), 2)) AS bigint), 
'MS600', 'MS600-ALLOC-0001', 'MS600-ALLOC-0001', 'MY', subtype_name, security_type_name, 
'MS600', 'MS', 'MYR', 'ACTIVE', 'MYR', '12', 'ARBS', 'Y',
50000000, 'MYR', 4000000, 'MYR'
from cms_security_sub_type where security_sub_type_id = 'MS600';

insert into cms_marketable_sec (cms_collateral_id)
select cms_collateral_id from cms_security 
where sci_security_dtl_id in ('MS600-ALLOC-0001');	
...
cmv, cmv_currency, fsv, fsv_currency)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for collateral_seq), 2)) AS bigint), 
'CS202', 'CS202-ALLOC-0001', 'CS202-ALLOC-0001', 'MY', subtype_name, security_type_name, 
'CS202', 'CS', 'MYR', 'ACTIVE', 'MYR', '12', 'ARBS', 'Y',
50000000, 'MYR', 4500000, 'MYR'
from cms_security_sub_type where security_sub_type_id = 'CS202';

insert into cms_cash (cms_collateral_id)
select cms_collateral_id from cms_security 
where sci_security_dtl_id in ('CS202-ALLOC-0001');	
...
cmv, cmv_currency, fsv, fsv_currency
from cms_security 
where sci_security_dtl_id in ('PT704-ALLOC-0002', 'MS600-ALLOC-0001', 'CS202-ALLOC-0001');	
...
and s.sci_security_dtl_id in ('PT704-ALLOC-0002');
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'MS600-ALLOC-0001'), 'MS600-ALLOC-0001',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp , 'I'
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0017', 'FAC-ALLOC-0018');	

insert into cms_limit_security_map
(charge_id, cms_collateral_id, sci_las_sec_id, cms_lsp_appr_lmts_id, sci_las_lmt_id, cms_lsp_lmt_profile_id, 
customer_category,create_date, update_status_ind)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'CS202-ALLOC-0001'), 'CS202-ALLOC-0001',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp , 'I'
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0018', 'FAC-ALLOC-0019');	

insert into cms_limit_security_map
(charge_id, cms_collateral_id, sci_las_sec_id, cms_lsp_appr_lmts_id, sci_las_lmt_id, cms_lsp_lmt_profile_id, 
customer_category,create_date, update_status_ind)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'PT704-ALLOC-0002'), 'PT704-ALLOC-0002',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp , 'I'
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0017', 'FAC-ALLOC-0019');	
...
and s.sci_security_dtl_id in ('PT704-ALLOC-0002', 'MS600-ALLOC-0001', 'CS202-ALLOC-0001');
...
and lmts.los_lmt_id in ('FAC-ALLOC-0017', 'FAC-ALLOC-0019');
...
'MYR', (current timestamp - 5 days), 'V9999', 50000000, 4000000, s.cms_collateral_id, 'S', 'ARBS'
from cms_security s
where s.sci_security_dtl_id in ('MS600-ALLOC-0001');

insert into cms_valuation
(valuation_id, valuation_currency, valuation_date, valuer, cmv, fsv, cms_collateral_id, source_type, source_id)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for VALUATION_SEQ), 2)) AS bigint), 
'MYR', (current timestamp - 5 days), 'V9999', 50000000, 420000000, s.cms_collateral_id, 'S', 'ARBS'
from cms_security s
where s.sci_security_dtl_id in ('CS202-ALLOC-0001');

insert into cms_valuation
(valuation_id, valuation_currency, valuation_date, valuer, cmv, fsv, cms_collateral_id, source_type, source_id)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for VALUATION_SEQ), 2)) AS bigint), 
'MYR', (current timestamp - 5 days), 'V9999', 80000000, 65000000, s.cms_collateral_id, 'S', 'ARBS'
from cms_security s
where s.sci_security_dtl_id in ('PT704-ALLOC-0002');
...
'37', 'ARBS', 'SIBS-ACT-0023', 'MY', 'N', 'A', 'L', 1, 40000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0024', 'MY', 'N', 'A', 'L', 1, 20000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0025', 'MY', 'N', 'A', 'L', 1, 60000000, 'I');
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	...
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0023'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0017';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0024'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0018';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0025'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0019';
commit work;