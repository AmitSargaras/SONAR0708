...
function submitForm() {
 	document.forms[0].action="systemBankBranch.do?event=maker_delete_systemBankBranch";
    document.forms[0].submit();
}
...
<td >&nbsp;</td>
	...
	<table width="80%" border="0" align="center" cellpadding="0"
		...
		<thead>
			...
			<tr>
				<td>
				<h3>Delete System Bank Branch</h3>
				</td>
			</tr>
			<tr>
				<td>
		...
		<tbody>
            ...
            <tr class="odd">
              ...
              <td width="30%"><integro:empty-if-null value="<%=systemBankBranchForm.getCustodian2()%>"/>&nbsp;</td>
							...
							<html:hidden name="MaintainSystemBankBranchForm"
								property="status"  />
							<html:hidden name="MaintainSystemBankBranchForm"
							...
							<html:hidden name="MaintainSystemBankBranchForm"
								property="systemBankBranchCode" />
							<html:hidden name="MaintainSystemBankBranchForm"
								property="systemBankBranchName" />
							<html:hidden name="MaintainSystemBankBranchForm"
								property="cityTown" />
							<html:hidden name="MaintainSystemBankBranchForm"
								property="region" />
