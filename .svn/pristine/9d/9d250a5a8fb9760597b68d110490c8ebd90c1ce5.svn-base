<%@ page import="java.util.*,com.integrosys.cms.ui.collateral.CategoryCodeConstant,java.util.List,java.util.ArrayList,,
                 ...
                 com.integrosys.cms.ui.facglobal.FacilityGlobalForm"%>
<%
/**
...
<%
    OBDocumentItemTrxValue trxVal = (OBDocumentItemTrxValue) session.getAttribute("com.integrosys.cms.ui.facglobal.FacilityGlobalAction.docTrxObj");
FacilityGlobalForm aForm = (FacilityGlobalForm) request.getAttribute("FacilityGlobalForm");	
String remarks = trxVal.getRemarks();
    System.out.println(":::::::::::::::::::::::remaks "+remarks);
...
<table class="tblFormSection" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3>Global Facility Document Template - Edit</h3></td>
    </tr>
    <tr>
      <td><hr/></td>
    </tr>
      ...
      <td> <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
            ...
            <tr class="even">
              ...
              <td>
                <bean:write name="FacilityGlobalForm" scope="request" property="itemCode" />
        ...
        <td class="fieldname">Skip Image Tagging&nbsp;<font color="red">*</font></td>
              <td><% if(aForm.getSkipImgTag().equalsIgnoreCase("ENABLE")){ System.out.println("---------------if loop--------------"); %>
               <input type="checkbox" checked="checked" value="ENABLE"  name="skipImgTag" id="skipImgTag" onclick="skipImageTagCheckbox()">
           
              <%}else{ System.out.println("---------------ELSE LOOP--------------"); %>
...
<!--				<td><html:radio name="FacilityGlobalForm" property="isPreApprove" value="Y" />Yes -->
<!--				<html:radio name="FacilityGlobalForm" property="isPreApprove" value="N" />No</td>-->
<!--			</tr>-->
			<tr class="odd">
...
<table width="150"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td width="100" valign="baseline" align="center"> <a href="#"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3311','','img/submit2.gif',1)" 
    	onClick="<%=(docCodeNonUnique.booleanValue()) ? "javascript: alert('There is already an existing document with the same code [" + aForm.getItemCode() + "]. \\nPlease close the transaction.')" : "submitPage()"%>" ><img src="img/submit1.gif" name="Image3311"  border="0" id="Image3311" /></a></td>
                        ...
                        <% } else {%>
                        <a href="FacilityGlobal.do?event=global_list&type=F&go=N&startIndex=<%=startIndex %>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image4411"  border="0" id="Image4411" /></a>
                        <% } %>
                        </td>
                      </tr>
                      <tr>
