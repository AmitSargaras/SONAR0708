...
function createExcludedFacility() {
	
 	document.forms[0].action = "excludedfacility.do?event=maker_prepare_create_excluded_facility_category&startIndex=<%=startIndex%>";
	...
	function searchExcludedFacility()
	{
		...
		if(searchType == '' && searchText == '')
        {
	        ...
	        document.forms[0].event.value       = "maker_list_excluded_facility_category";
	        document.forms[0].submit();
        }
        else
        {
		...
		<tr>
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
					<tr>
						<td width="82%">
						<h3>Excluded Facility Category</h3>
						</td>
						<td>&nbsp;</td>
						<%
							//if (isEditAccess) {
                   ...
                   <td  valign="bottom" align="right">						
						<input type="button" name="Submit" value="Add New" class="btnNormal" onclick="createExcludedFacility()" />
				   </td>    
               </tr>
               <tr>
              ...
              <%}else{ %>Disable<%} %>&nbsp;</td>
                                  <td> <select name="menu1" onchange="MM_jumpMenu('self',this,0)" style="width:110">
                                      ...
                                      <%if((event.equals("checker_excluded_facility_category"))||event.equals("checker_list_pagination")){%>
              ...
              <tr>
                <td height="25">
                    ...
                    <table  width="100%" border="0" cellspacing="0" cellpadding="0">
                         ...
                         <% if(sr != null) {
                        	 if((event.equals("checker_list_excluded_facility_category"))
                        			 ||event.equals("checker_search_list_excluded_facility_category")
					            ...
					            <tr>
					                <td valign="middle">
					                    <integro:pageindex
					                            ...
					                            url="excludedfacility.do?event=checker_list_excluded_facility_category&startIndex=&go=Y"/>
					                </td>
					            </tr>
					        </table>
					    </td>
					        ...
					        <table id="generalPurposeBar" width="100%" border="0" cellspacing="0" cellpadding="5" align="center">
					            <tr>
					                <td valign="middle">
					                    <integro:pageindex
					                            pageIndex="<%=new PageIndex(startIndex, 10, sr.getResultList().size())%>"
					                            url="excludedfacility.do?event=list_pagination&startIndex="/>
					                </td>
					            </tr>
					        </table>
					    </td>
