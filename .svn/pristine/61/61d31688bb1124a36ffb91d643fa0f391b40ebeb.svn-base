...
<%@ page import="com.integrosys.cms.ui.collateral.*,
                 ...
                 com.integrosys.cms.ui.collateral.property.ChargeForm,
                 java.util.HashMap,
...
<%
    ChargeForm aForm = (ChargeForm) request.getAttribute("ChargeForm");
...
<html:form action="PropertyCharge.do">
...
<tr class="even">
    ...
    <td colspan="2" valign="middle" style="border-left:0;border-right:0;text-align:center">
        ...
        <br/><br/>
        <input name="Button" type="button" class="btnNormal" style="width:80" onclick="moveDualList(limitID,limitMapID,false )" value="&lt;&lt;Remove"/>
    </td>
...
<tr class="even">
    ...
    <td class="fieldname"><bean:message key="label.security.charge.amount"/>&nbsp;<font color="#FF0000">*
...
<tr>
	...
	<tr class="even">
		...
		<td width="20%" class="fieldname"><bean:message key="label.charge.prop.caveat.presentation.no"/>&nbsp;
...
<td width="20%" class="fieldname">
	<bean:message key="label.charge.prop.caveat.expiry.date"/>
...
<td class="fieldname"><bean:message key="label.charge.prop.presentation.no"/></td>
<td>
...
<tr class="even">
<td class="fieldname"><bean:message key="label.charge.prop.presentation.date"/></td>
<td>
...
<td class="fieldname"><bean:message key="label.charge.prop.registered.date"/></td>
<td>
    ...
    <tr>
        ...
        <td width="100" valign="baseline" align="center">
            <a href="javascript:submitPage(<%=index%>)" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image142','','img/ok2.gif',1)">
                <img src="img/ok1.gif" name="Image142" border="0" id="Image142"/></a>
        </td>
        <td width="100" valign="baseline" align="center">
            ...
            <% } else { %>
            <td width="100" valign="baseline" align="center">
                <a href="javascript:submitPage(3)" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1422','','img/return2.gif',1)">
                <img src="img/return1.gif"  name="Image142"  border="0"  id="Image1422"/></a>
            </td>
            <% } %>
        </td>
    </tr>
