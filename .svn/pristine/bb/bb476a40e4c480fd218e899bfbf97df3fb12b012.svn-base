...
<%
	...
	String retEvent = "redirect_list_rbi_category";
	if(event.equals("checker_view_rbi_category"))
	{
	retEvent = "checker_list_rbi_category";
	}
...
function cancelPage(){
    document.forms[0].action="rbi_category.do?event=<%=retEvent%>";
