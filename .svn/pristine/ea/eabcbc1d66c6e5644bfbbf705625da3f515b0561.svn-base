...
import com.integrosys.simulator.host.stp.*;
 ...
 * @version 1.1
 */
public class TradeMessage extends com.integrosys.simulator.host.stp.STPMessage implements java.io.Serializable {
