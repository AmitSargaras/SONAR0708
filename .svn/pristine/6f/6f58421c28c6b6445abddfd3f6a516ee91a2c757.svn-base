      ...
      <table class="tblFormSection" id="backEdit1" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:0">      
        <tbody>   
          <tr>            
            ...
            <td><br />
              ...
              <td width="20%" class="fieldname" >Lien Amount<font color="red">*</font><span class="style11"></span></td>
                  <td width="20%"><html:text property="lienAmount" 
								maxlength="16" size="24" styleId="lienAmount" onblur="javascript:formatAmountAsCommaSeparated(this)"></html:text>&nbsp;
	        ...
	        <td width="20%" class="fieldname" >LCN No.<span class="style11"></span></td>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <tr>    
   <%if(event.equals("prepare_create_lien")){ %>  
      <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/save1.gif',1)">
     		<img src="img/save1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:saveOtherSystem('add_lien')"/></a>
