    ...
    <td colspan="2" align="center">
        ...
        <tbody>
	        ...
	        <tr >
			   ...
			   <%if(propertyValuation3.getRevalFrequency()!=null && propertyValuation3.getRevalFrequency()!=null){ %>
	           <td class="odd" width="30%">
	        <integro:common-code-single entryCode="<%=propertyValuation3.getRevalFrequency()%>"  display="true"
				...
				<%} %>
					 <%if(propertyValuation3.getNextValuationDate()!=null && !propertyValuation3.getNextValuationDate().equals("")){ %>
	            <td class="odd" width="30%"><integro:date object="<%=propertyValuation3.getNextValuationDate() %>" />&nbsp;
											</td>
				<%}else{ %>
				<td class="odd" width="30%">-&nbsp;</td>
				<%} %>
	        ...
	        <tr >
	            ...
	            <td  class="even" width="30%"><integro:common-code-single entryCode="<%=propertyValuation3.getChangeType()%>"  display="true"
	             ...
	             <td class="fieldname">
					...
					<%if(propertyValuation3.getOtherBankCharge()!=null && !propertyValuation3.getOtherBankCharge().equals("")){ %>
	            <td class="even" width="30%"><%=propertyValuation3.getOtherBankCharge() %>&nbsp;
											</td>
				<%}else{ %>
