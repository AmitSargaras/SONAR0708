<%@ page import="com.integrosys.cms.app.contractfinancing.bus.IPayment,
                 ...
                 com.integrosys.cms.ui.contractfinancing.advspayment.AdvsPaymentForm"%>
...
<%
    ...
    AdvsPaymentForm aForm = (AdvsPaymentForm) request.getAttribute("CF_AdvsPaymentForm");
...
<tbody>
    ...
    <tr class="odd">
        <td class="fieldname"><bean:message key="label.advancepayment.amount"/> <font color="#0000FF">*</font></td>
        <td>
...
<tr>
    <td style="text-align:right"><input name="Submit" type="button" class="btnNormal" value="Add" onClick="gotoPage('CF_AdvsPayment.do','maker_prepare_add_item')" style="width:60px"/>
    <input name="Submit" type="button" onClick="gotoPage('CF_AdvsPayment.do','delete_item')" class="btnNormal" value="Delete"  style="width:60px"/></td>
</tr>
<tr>
    <td height="3" ></td>
</tr>
        ...
        for(int i=0;i<paymentList.length;i++) {
            ...
            <tr class='<%=(count%2==0?"even":"odd")%>'>
                ...
                if(isEdit!=null && isEdit.equals("true")) {
                    ...
                    %>
                    <td><center><a href="CF_Payment.do?event=view&paymentIndex=<%=i%>">View</a></center></td>
                    <%
                }
                %>
            </tr>
