...
<%@ page import="com.integrosys.base.techinfra.logger.DefaultLogger,
                 ...
                 java.util.HashMap,
                 java.util.Locale,
                  com.integrosys.cms.app.fccBranch.trx.IFCCBranchTrxValue,
                 java.util.Arrays"%>
...
function saveForm() {
 	...
 	document.forms[0].action="fccBranch.do?event=maker_update_draft_fccBranch";
    document.forms[0].submit();
}

function submitForm () {
	document.forms[0].action="fccBranch.do?event=maker_confirm_resubmit_delete";
    document.forms[0].submit();
}
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <tr>
   <%if((event.equals("maker_prepare_resubmit_create"))){%>
                    <td><h3>Create FCC Branch</h3></td>
                    <%}else{ %>
                     <td><h3>Edit FCC Branch</h3></td>
                     <%} %>
          ...
          <tbody>
           ...
           <tr class="odd">
              <td class="fieldname">Branch Code<font color="red">*</font></td>
                  <td><html:text property="branchCode" maxlength="25" />&nbsp; <html:errors property="branchCodeError"/><html:errors property="fccBranchDuplicateError"/></td>    
            ...
            <tr class="even">
              ...
              <td width="30%"><html:text property="branchName" maxlength="50" />
              <html:errors property="branchNameError"/>
              </td>
              
          
             <td class="fieldname" >Status&nbsp;</td>
             <% if(  fccBranchTrx.getFromState().equals("PENDING_UPDATE") || fccBranchTrx.getFromState().equals("CLOSED") ){ %>
...
<html:hidden name="FCCBranchForm" property="createdBy"/>
<html:hidden name="FCCBranchForm" property="lastUpdatedOn"/>
<html:hidden name="FCCBranchForm" property="createdOn"/>
<html:hidden name="FCCBranchForm" property="lastUpdatedBy"/>
