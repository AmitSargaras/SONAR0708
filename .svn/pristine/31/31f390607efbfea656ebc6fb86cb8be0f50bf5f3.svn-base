...
<%  
	...
	//ICMSCustomerTrxValue trx = (ICMSCustomerTrxValue)request.getAttribute("com.integrosys.cms.app.customer.trx.ICMSCustomerTrxValue");
...
function submitPage() {
	...
	document.forms[0].event.value = "close_page";
