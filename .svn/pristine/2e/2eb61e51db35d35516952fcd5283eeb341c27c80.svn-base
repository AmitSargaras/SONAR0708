...
function showExtendedDebug() {
	...
	if (debugWindow == null) {
		...
		debugWindow = new Window('debug_window', {className: 'dialog',width:480, height:200, left:25, minWidth:250, top:50, zIndex:1000, opacity:1, showEffect: Element.show, resizable: true, title: "Debug"})
		...
		var cont = "<div id=\"debug_window_inspect\" style=\"width: 15px; height: 15px; background: transparent url(/cms/console/themes/default/inspect.gif) no-repeat 0 0; position:absolute; top:5px; left:70px; cursor:pointer; z-index:3000;\"></div>";
