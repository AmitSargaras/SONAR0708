...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function showSecurityType(){
        	...
        	switch (mrkts){
        		case '1':
        			document.forms[0].action = "feed_stock_list.do?event=selectMakerEdit";
        			document.forms[0].submit();
        			break;
        		case '2':
        			document.forms[0].action = "feed_bond_list.do?event=prepare";
        			document.forms[0].submit();
        			break;
        		case '3':
        			document.forms[0].action = "feed_mutual_funds_list.do?event=prepare";
        			document.forms[0].submit();
        			break;
        	}
        }
