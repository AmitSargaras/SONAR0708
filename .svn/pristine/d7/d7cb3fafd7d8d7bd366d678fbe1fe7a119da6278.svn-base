...
<%-- function downloadImage(){ //v3.0
		var aLocation = "Createfacilitylineupload.do?event=downloadReport&system="+'<%=system%>';
...
function goBack(){
	document.forms[0].action = "Createfacilitylineupload.do?event=excelupload";		
	document.forms[0].submit(); 
}
...
<html:form action="Createfacilitylineupload.do" >
...
<h3>Facility/Line Create Upload</h3>
...
<table width="130" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
  <td style="white-space:pre" align="left"><h3>Please Check Success/Fail Report For more information.</h3></td><br></br></tr>
  <tr><td>&nbsp;</td></tr>
 ...
 <td colspan="4">
						<center>
							...
							<a href="javascript:cancelPage()" onmouseout="MM_swapImgRestore()"
								onmouseover="MM_swapImage('Image4411','','img/ok1.gif',1)"><img
...
<thead>
<tr><td align="center">
<h3>Facility/Line Create Upload Error</h3>
<br></br></td></tr>
<tr>
						<td>
							<hr width="50%" />
