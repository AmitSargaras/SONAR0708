...
function cancelPage(){
    document.forms[0].action="collateralrocandinsurance.do?event=maker_list_collateral_roc";
    
    document.forms[0].submit();
}
function approvePage() {
	
    document.forms[0].action="collateralrocandinsurance.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="collateralrocandinsurance.do?event=<%=rejectEvent%>";
		document.forms[0].submit();
	}
	function cancelPage() {
...
<html:form action='collateralrocandinsurance.do?'>
					...
					<td>
						...
						<tr class="even">
							<td class="fieldname">Collateral Category<font color="red">*</font>
									...
									<html:errors property="collateralCategoryError" />
									</td>
	...
	<html:hidden name="CollateralRocForm"
									property="collateralRocDescription" />
