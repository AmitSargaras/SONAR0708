...
<%
	...
	String rejectEvent;
	if (event.equals("checker_view_excluded_facility_category")) {
		rejectEvent = "checker_excluded_facility_category";
	} else {
		rejectEvent = "maker_list_excluded_facility_category";
	}
	int sno = 0;
...
function cancelPage(){
    document.forms[0].action="excludedfacility.do?event=<%=rejectEvent%>&go=N";
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <br>
  <tr>
      <td><h3>Excluded Facility Category - View </h3></td>
  </tr>
  <tr>
    <td><hr/></td>
  </tr>
          ...
          <tbody>
						...
						<tr class="odd">
							<td class="fieldname">
												...
												<td><integro:common-code-single categoryCode="<%=CategoryCodeConstant.FACILITY_CATEGORY %>" entryCode="<%=excludedFacilityForm.getExcludedfacilityDescription()%>" display="true" descWithCode="false" />&nbsp;
												</td>
						</tr>
