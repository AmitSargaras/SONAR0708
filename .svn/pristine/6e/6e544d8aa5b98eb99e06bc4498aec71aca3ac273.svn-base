...
<%@ page
	...
	com.integrosys.cms.ui.otherbankbranch.OtherBranchForm,
...
function submitPage () {
	document.forms[0].action="OtherBranch.do?event=maker_confirm_close";
    document.forms[0].submit();
}
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											...
											<tr class="odd">
												...
												<td width="30%"><%=otherBranchForm.getOtherBranchCode()%>&nbsp;
												</td>
												<td class="fieldname" width="20%">
													Branch Name
												</td>
												<td width="30%"><%=otherBranchForm.getOtherBranchName()%>&nbsp;
												</td>
											</tr>
											...
											<tr class="odd">
												...
												<td width="30%"><%=otherBranchForm.getOtherBankName()%>&nbsp;
												</td>
											</tr>
											<tr class="even">
												...
												<td width="30%"><%=otherBranchForm.getBranchRbiCode()%>&nbsp;
												</td>
												<td class="fieldname" width="20%">
													&nbsp;
												</td>
											...
											<tr class="even">
												...
												<td><integro:empty-if-null value="<%=otherBranchForm.getBranchAddress()%>" />
												</td>
												<td class="fieldname">
													City/Town
												</td>
												<td><integro:empty-if-null value="<%=otherBranchForm.getBranchCity()%>" />
												</td>
											</tr>
											<tr class="odd">
												<td class="fieldname">
												...
												<td><integro:empty-if-null value="<%=otherBranchForm.getBranchState()%>" />
												</td>
												<td class="fieldname">
													Region
												</td>
												<td><integro:empty-if-null value="<%=otherBranchForm.getBranchRegion()%>" />
												</td>
											</tr>
											<tr class="even">
												...
												<td><integro:empty-if-null value="<%=otherBranchForm.getBranchCountry()%>" />
												</td>
												<td class="fieldname">
													Contact Number
												</td>
												<td><integro:empty-if-null value="<%=otherBranchForm.getBranchContactNo()%>" />
												</td>
											</tr>
											<tr class="odd">
												<td class="fieldname">
												...
												<td><integro:empty-if-null value="<%=otherBranchForm.getBranchContactMailId()%>" />
												</td>
												  <td class="fieldname">Fax Number</td>
                									<td><integro:empty-if-null value="<%=otherBranchForm.getBranchFaxNo() %>" /></td>
