...
<%@page import="com.integrosys.cms.app.leiDateValidation.bus.ILeiDateValidation"%>
...
function submitPage(event) {
	if(event=="maker_draft_close_process"){
		document.forms[0].action="leiDateValidation.do?event=maker_confirm_draft_close";
    }else {
    	document.forms[0].action="leiDateValidation.do?event=maker_confirm_close";
    }
    document.forms[0].submit();
}
</script>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								<tr class="even">
									...
									<td ><%=leiDateValidationForm.getPartyName()%> &nbsp;</td>

									<td class="fieldname" >Party ID</td>
									<td ><%=leiDateValidationForm.getPartyID()%>&nbsp;</td>
								</tr>
																<tr class="even">
									<td class="fieldname" >LEI Date Validation Period(In Months)</td>
									<td ><%=leiDateValidationForm.getLeiDateValidationPeriod()%> &nbsp;</td>
								...
								<tr class="even">
									...
									<td ><%=leiDateValidationForm.getStatus()%> &nbsp;</td>
								</tr>
							</tbody>
						</table>
					</td>
