      ...
      <td> <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
          <tbody>
            <tr class="even">
              ...
              <td width="30%" ><%=EquityTypeList.getInstance().getEquityTypeItem(aForm.getEquityType())%>&nbsp;</td>
            ...
            <tr class="odd">
              <td width="20%" class="<%=isProcess?(CompareOBUtil.compOB(stagingOB,originOB, "agentName")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.security.bank.agent"/>&nbsp;<span class="mandatory">*</span></td>
              <td width="30%" ><bean:write name="PortItemForm" property="nomineeName"/>&nbsp;</td>
              <td width="20%" class="<%=isProcess?(CompareOBUtil.compOB(stagingOB,originOB, "agentConfirmDate")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.security.confirmation.frm.bank.agent.date"/>&nbsp;<span class="mandatory">*</span></td>
            ...
            <tr class="even">
              <td class="<%=isProcess?(CompareOBUtil.compOB(stagingOB,originOB, "isCollateralBlacklisted")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.security.referred"/></td>
            ...
            <tr class="odd">
              <td class="<%=isProcess?(CompareOBUtil.compOB(stagingOB,originOB, "localStockExchange")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.security.local.stock.exchange"/></td>
              <td >
              <%
