...
List list2 =  (ArrayList) session.getAttribute("com.integrosys.cms.ui.manualinput.aa.AADetailAction.tagDetailList");
...
function getImageForDisplayCAMDoc(imagePath,imageName,status) {
	   /*var dep = 'imagePath';
	   var url = '/cms/MIAADetail.do?event=retrieveImage&pID='+imagePath+'&imageName='+imageName+'&status='+status;
	   sendLoadImagePathReq(dep, url);*/
	document.getElementById("imageFrame").src= '/cms/MIAADetail.do?event=retrieveImage&pID='+imagePath+'&imageName='+imageName+'&status='+status;
	}
...
//  var url = '/cms/ImageTagMap.do?event=retrieveImage&imageName="+imageName+"&status="+status+"&count="+count+"&pID="+imagePath;
  ...
  //alert("getImageGallary");
	...
	document.forms[0].action="MIAADetail.do?event=retrieveImageGallaryCAMNote&imageName="+imageName+"&status="+status+"&count="+count+"&pID="+imagePath+"&category"+catg+"&imageId="+s_value+"&unCheckId="+n_value;
	document.forms[0].submit();
}

function downloadImage(imagePath,imageName,status){ //v3.0
	var aLocation = "MIAADetail.do?event=downloadImage&imageName="+imageName+"&pID="+imagePath+"&status="+status;
...
function downloadImageZip() {
	...
	if(s_value!=''){
	    ...
	    //document.forms[0].submit();
	    var aLocation = "MIAADetail.do?event=downloadImage&custId=<%=custId%>&imageId="+s_value+"&unCheckId="+n_value;
	window.location.href = aLocation ;
...
function printPage() {
	...
	if(s_value!=''){
	    ...
	    //document.forms[0].submit();
	    //alert("ddddd11111111");
	   MM_openBrWindow1("MIAADetail.do?event=print_image&custId=<%=custId%>&customerName="+customerName+"&category="+catg+"&custLimitProfileID="+<%=custLimitProfileID%>+"&imageId="+s_value+"&unCheckId="+n_value,'_blank','scrollbars=no,toolbar=no,menubar=no,resizable=no,width=0,height=0,left=100,top=100');
	  // window.focus(); 
		} else{
...
<a href="MIAADetail.do?event=view">
	<img src="img/cancel1.gif" name="Image2" width="70" height="20" border="0" id="Image2" />
</a>
<%}else if("view_edit_cam_image".equals(event)){ %>
<a href="MIAADetail.do?event=return_maker_edit_aadetail">
	<img src="img/cancel1.gif" name="Image2" width="70" height="20" border="0" id="Image2" />
</a>
<%}else if("view_edit_cam_image_reject".equals(event)){ %>
<a href="MIAADetail.do?event=return_maker_edit_aadetail_reject">
<img src="img/cancel1.gif" name="Image2" width="70" height="20" border="0" id="Image2" />
</a>
<%}else if("view_close_cam_image_reject".equals(event)){ %>
<a href="MIAADetail.do?event=maker_close_aadetail">
<img src="img/cancel1.gif" name="Image2" width="70" height="20" border="0" id="Image2" />
</a>
<%}else if("checker_edit_aadetail_view_image".equals(event)){ %>
<a href="MIAADetail.do?event=checker_edit_aadetail">
<img src="img/cancel1.gif" name="Image2" width="70" height="20" border="0" id="Image2" />
</a>
<%}else if("maker_to_track_view_image".equals(event)){ %>
<a href="MIAADetail.do?event=to_track">
<img src="img/cancel1.gif" name="Image2" width="70" height="20" border="0" id="Image2" />
</a>
<%} %> 
</p>
