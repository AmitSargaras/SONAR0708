...
<%
	...
	boolean forRead = CustRelationshipListAction.EVENT_READ.equals(event) ||
    ...
    if( custRelTrxValue != null ) {
		status = custRelTrxValue.getStatus();
	}	
	                ...
	                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblInfo">
	                    <tbody>
	                        ...
	                        <tr>
	                            ...
	                            <td class="even"><%=custRelTrxValue.getUserInfo()%>&nbsp;</td>
	                        </tr>
	                        <tr class="odd">
	                            <td class="fieldname"><bean:message key="label.last.remarks.made"/></td>
	                            <td><integro:wrapper value="<%=custRelTrxValue.getRemarks()%>"/>&nbsp;</td>
	                        </tr>
	                    </tbody>
	                </table>
	            </td>
