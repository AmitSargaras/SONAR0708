...
<%@page import="com.integrosys.cms.app.caseBranch.bus.ICaseBranch"%>
...
function cancelPage(){
    document.forms[0].action="caseBranch.do?event=maker_list_caseBranch";
    
    document.forms[0].submit();
}
function approvePage() {
	
    document.forms[0].action="caseBranch.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="caseBranch.do?event=<%=rejectEvent%>";
    document.forms[0].submit();
}
function cancelPage(){
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											<tr class="odd">
												...
												<td width="30%"><%=caseBranchForm.getBranchCode()%>&nbsp;
												<html:errors property="caseBranchDuplicateCodeError"/>
												</td>
											...
											<tr class="even">
												...
												<td><%=branchMap.get(caseBranchForm.getBranchCode())%>&nbsp;
												</td>
											...
											<tr class="odd">
												...
												<td><integro:empty-if-null value="<%=caseBranchForm.getCoordinator1()%>"/>&nbsp;
												</td>
											...
											<tr class="even">
												...
												<td><integro:empty-if-null value="<%=caseBranchForm.getCoordinator1Email()%>"/>&nbsp;
												</td>
											...
											<tr class="odd">
												...
												<td><integro:empty-if-null value="<%=caseBranchForm.getCoordinator2()%>"/>&nbsp;
												</td>
											...
											<tr class="even">
												...
												<td><integro:empty-if-null value="<%=caseBranchForm.getCoordinator2Email()%>"/>&nbsp;
												</td>
												
											</tr>
											<tr class="odd">
											 <td class="fieldname" >Status&nbsp;</td>
              <td ><%if(caseBranchForm.getStatus().trim().equalsIgnoreCase("ACTIVE")){ %>Enable
              <%}else{ %>Disable<%} %>&nbsp;</td></tr>		
 
 <html:hidden name="MaintainCaseBranchForm"  property="status"  />
					...
					<tbody>
						<tr>
							...
							<td class="odd"><textarea name="remarks" rows="4"
								style="width: 90%"></textarea></br><html:errors property="caseBranchRemarksError"/></td>
						</tr>
						<tr>
