<%@ page import="com.integrosys.cms.app.collateral.trx.ICollateralTrxValue,
                 ...
                 com.integrosys.cms.ui.collateral.assetbased.assetrecspecagent.AssetRecSpecAgentForm" %>
...
<% ICollateralTrxValue itrxValue = (ICollateralTrxValue) session.getAttribute("com.integrosys.cms.ui.collateral.assetbased.AssetBasedAction.serviceColObj");
    ...
    AssetRecSpecAgentForm colForm = (AssetRecSpecAgentForm) request.getAttribute(formName);
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
        <td><h3><bean:messsage key="label.security.general"/></h3></td>
...
<tr class="odd">
    ...
    <td>
        ...
        <img src="img/calendara.gif" name="Image723" border="0" id="Image723"
             onclick="return showCalendar('leDate', 'dd/mm/y')" onmouseover="MM_swapImage('Image723','','img/calendarb.gif',1)" onmouseout="MM_swapImgRestore()"/>
...
<tr class="even">
    <td class="fieldname"><bean:message key="label.security.asset.amountdesc.assignment"/>&nbsp;<span class="mandatoryPerfection">*</span>
    </td>
    ...
    <td class="fieldname"><bean:message key="label.security.asset.nature.assignment"/>&nbsp;<span class="mandatoryPerfection">*</span>
    </td>
...
<%--<tr class="even">
    ...
    <% isUpdate = dpUtil.getIsSCCUpdatable(subtypeCode, "locApprBuyer", isSSC);%>
    <td class="<%=( (isUpdate && isSSC) || (!isUpdate && !isSSC) )?"edit":""%>">
        <html:select property="locApprBuyer" disabled="<%=!isUpdate%>">
            <option value=""><bean:message key="label.please.select"/></option>
