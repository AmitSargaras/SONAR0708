...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:10px">
    <thead>
        <tr>
            <td>
                <h3><bean:message key="label.group.other.limit"/></h3></td>
                            ...
                            <table class="tblinfo" style="margin-top:0" border="0" cellspacing="0" cellpadding="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <td width="16%" align="center"><bean:message key="label.other.limit.type"/></td>
                                        <td width="12%" align="center"><bean:message key="label.group.description"/></td>
                                        <td width="12%" align="center"><bean:message key="label.other.limit.amount"/></td>
                                        <td width="12%" align="center"><bean:message key="label.group.other.limit.last.reviewed.date"/></td>
