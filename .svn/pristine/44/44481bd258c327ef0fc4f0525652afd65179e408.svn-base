...
<%
    int sno = 0;
    List ccAddCheckList = (List)session.getAttribute("com.integrosys.cms.ui.checklist.cc.CCCheckListAction.ccAddCheckList");
...
<logic:notPresent name="ccAddCheckList">
<tr class="odd">
<td colspan="5" ><bean:message key="label.global.not.found"/></td>
</tr>
</logic:notPresent>
<%if(ccAddCheckList!=null){ %>
	<%if(ccAddCheckList.size()==0){ %>
	<tr class="odd">
		<td colspan="5" ><bean:message key="label.global.not.found"/></td>
	</tr>
<%} }%>
