...
<table width="100" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img/printWaiver2.gif',1)"><img src="img/printWaiver1.gif" name="Image1" border="0" id="Image1" onclick="MM_openBrWindow('GenerateReqWaiver.do?event=print_doc','','scrollbars=yes,toolbar=yes,menubar=yes,resizable=yes,width=760,height=450,left=5,top=5')"/></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
