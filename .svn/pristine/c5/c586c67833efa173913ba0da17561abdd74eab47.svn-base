...
function returnPage() {
    document.forms["FacilityReceiptForm"].event.value = "close_checklist_item";
    document.forms["FacilityReceiptForm"].submit();
}
function closePage() {
	document.forms["FacilityReceiptForm"].event.value="edit_staging_checklist_item";
	document.forms["FacilityReceiptForm"].submit();
}
...
<p align="center">
 <%if("view_image_page_to_do".equals(event)){ %>
       ...
       <%}else if("view_image_page_to_do_process".equals(event)){ %>
