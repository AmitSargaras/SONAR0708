							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
											<tr class="odd">
												...
												<td width="30%">
												<bean:write name="MaintainDirectorMasterForm" property="directorCode"/>
												&nbsp;
												</td>
												<td class="fieldname" width="20%">
													Director Name
												</td>
												<td width="30%"><bean:write name="MaintainDirectorMasterForm" property="name"/>&nbsp;
											...
											<tr class="odd">
												...
												<td width="30%"><bean:write name="MaintainDirectorMasterForm" property="dinNo"/>&nbsp;
												</br><html:errors property="directorMasterdinNoError"/>
												</td>
												<td class="fieldname" width="20%">
