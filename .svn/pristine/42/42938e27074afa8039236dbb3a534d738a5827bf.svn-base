...
HashMap pdfPagesMap = (HashMap) session.getAttribute("com.integrosys.cms.ui.image.ImageUploadAction.pdfPagesMap");
...
int totalCount = 0;
int listSize = 0;
System.out.println("selectedArrayMap:::::::::::"+selectedArrayMap.size());
...
<html:form action="/ImageTagMap">
	...
	<input type="hidden" name="customerName" value="<%=customerName%>">
		...
		<logic:greaterThan name="resultList" value="0">
         ...
         System.out.println("===========================2.0.0.0.0.=================:"+selectedArrayMap.size());
         ...
         %>
				...
				if(selectedArrayMap.containsKey(String.valueOf(obImageUploadAdd.getImgId()))){ 
					...
					if(pdfPagesMap.containsKey(String.valueOf(obImageUploadAdd.getImgId()))){
						System.out.println("+++++++++++++++++++++++++++++++215+++++++++++++++++-------:"+pdfFilePath);
				...
				%>
					<img src="<%=pdfFilePath+"_"+num+".jpeg" %>"  height="800" width="600" />
				<%}}else{%>
					<img src="<%=pdfFilePath+".jpeg" %>"  height="800" width="600" />
