...
<script language="JavaScript" type="text/JavaScript">		
		function submitForm() {
 	document.forms[0].action="leidetailsupload.do?event=leidetailsupload";
...
-->
	...
	<html:form action="/leidetailsupload" enctype="multipart/form-data">
				...
				<tbody>
					<tr>
						<td valign="bottom" align="center">
							<html:file property="fileUpload" size="50"></html:file></br><html:errors property="leiDetailsfileuploadError"/>
							<html:errors property="leiDetailsfileformatError"/>
						</td>
					</tr>
					<%
