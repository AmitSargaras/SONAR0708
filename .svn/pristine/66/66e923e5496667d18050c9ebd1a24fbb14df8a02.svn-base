...
<%
	...
	InsuranceCoverageDtlsForm insuranceCoverageForm = (InsuranceCoverageDtlsForm) request
...
<%@page import="com.integrosys.cms.app.insurancecoveragedtls.trx.IInsuranceCoverageDtlsTrxValue"%>
<html>
	...
	<head>
		...
		function approvePage() {
		    document.forms[0].action="InsuranceCoverageDtls.do?event=checker_approve_edit";
		    document.forms[0].submit();
		}
		function rejectPage() {
		    document.forms[0].action="InsuranceCoverageDtls.do?event=checker_reject_edit";
		    document.forms[0].submit();
		}
		function cancelPage(){
...
<html:form action='InsuranceCoverageDtls.do?'>
	...
	<table width="80%" border="0" align="center" cellpadding="0"
		...
		<thead>
			<tr>
				<td>
				<h3>Maintain Insurance Coverage</h3>
				</td>
			</tr>
			<tr>
				<td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
						<tr class="even">
							...
							<td width="30%"><%=insuranceCoverageForm.getInsuranceType()%>&nbsp;
							</td>
							<td class="fieldname" width="20%">Insurance Category Name</td>
							<td width="30%"><%=insuranceCoverageForm.getInsuranceCategoryName()%>&nbsp;
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tbody>
						...
						<tr class="even">
							...
							<td><%=insuranceCoverageDtlsTrx.getRemarks() != null ? insuranceCoverageDtlsTrx
						.getRemarks() : ""%>&nbsp;</td>
						</tr>
					</tbody>
				</table>
