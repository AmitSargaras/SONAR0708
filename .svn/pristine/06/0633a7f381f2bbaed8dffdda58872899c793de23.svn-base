<%@page import="com.integrosys.cms.ui.productMaster.ProductMasterForm"%>
...
<%
 ...
 ProductMasterForm productMasterForm = (ProductMasterForm) request.getAttribute("ProductMasterForm");
...
function submitPage(event) {
	if(event=="maker_draft_close_process"){
		document.forms[0].action="productMaster.do?event=maker_confirm_draft_close";
    }else {
    	document.forms[0].action="productMaster.do?event=maker_confirm_close";
    }
    document.forms[0].submit();
}
</script>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								<tr class="even">
									...
									<td ><%=productMasterForm.getProductCode()%> &nbsp;</td>
								...
								<tr class="even">
									...
									<td ><%=productMasterForm.getStatus()%> &nbsp;</td>
								</tr>
							</tbody>
						</table>
					</td>
