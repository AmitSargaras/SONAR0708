...
if(search==null)
    ...
    ArrayList docIds = (ArrayList)session.getAttribute("com.integrosys.cms.ui.checklist.secreceipt.SecurityReceiptAction.docNos");
    ...
    request.setAttribute("SecurityReceiptForm",aForm);
    if(cName.equals("")){
...
<%@page import="com.integrosys.base.uiinfra.common.ICommonEventConstant"%><html>
<head>
    ...
    if(temp=="") {
        return false;
	      ...
	      (selObj.options[selObj.selectedIndex].value == 'ALLOW_PERM_UPLIFT' ||
	       ...
	       alert("The document must de-link linkage to Security before deleting/perm-uplifting");
...
function searchDoc(){
	...
	document.forms[0].action      	= "SecurityReceipt.do?list="+list+"&searchType="+searchType+"&search="+search;
 	document.forms[0].event.value 	= "search_security_doc";
 	document.forms[0].submit();
}
...
<html:hidden name= "SecurityReceiptForm" property="limitProfileID" />
<html:hidden name= "SecurityReceiptForm"  property="checkListID" /> <!-- +++ -->
<html:hidden name= "SecurityReceiptForm"  property="legalID" />
<html:hidden name= "SecurityReceiptForm"  property="custCategory" />
<html:hidden name= "SecurityReceiptForm"  property="limitBkgLoc" />
<html:hidden name= "SecurityReceiptForm"  property="secType" />
<html:hidden name= "SecurityReceiptForm"  property="secSubType" />
<html:hidden name= "SecurityReceiptForm"  property="secName" />
<html:hidden name= "SecurityReceiptForm"  property="collateralID" />
<html:hidden  name= "SecurityReceiptForm" property="collateralRef" />
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td> <h3>Update Security Doc Receipt</h3>
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
          ...
          <tbody>
            <tr class="odd">
              ...
              <td width="30%"><%=secList.getSecurityTypeValue(secType,null)%></td>
...
<!--		      <td width="763">-->
<!--		         <html:radio property="lawFirmPanelFlag"  name="SecurityReceiptForm" value="Y" onclick="getlag()" />Yes &nbsp;-->
<!--                 <html:radio property="lawFirmPanelFlag"  name="SecurityReceiptForm" value="N" onclick="getlag()" /> No &nbsp;-->
<!--				<html:radio property="lawFirmPanelFlag"  name="SecurityReceiptForm" value="-" onclick="getlag()" /> N/A-->
<!--                 <html:errors property="lawFirmPanelFlag" />-->
<!--              </td>-->
<!--		    </tr>-->
<html:hidden property="lawFirmPanelFlag"  name="SecurityReceiptForm" value="-" />
		    </tbody>
		  </table>
		 </td>
	  </tr>
...
<!--			      <td width="763">-->
<!--			         <html:radio property="valuerFirmPanelFlag"  name="SecurityReceiptForm" value="Y" onclick="getlag()" />Yes &nbsp;-->
<!--	                 <html:radio property="valuerFirmPanelFlag"  name="SecurityReceiptForm" value="N" onclick="getlag()" /> No &nbsp;-->
<!--					<html:radio property="valuerFirmPanelFlag"  name="SecurityReceiptForm" value="-" onclick="getlag()" /> N/A-->
...
<!--		 </td>-->
<!--	  </tr>-->
<html:hidden property="valuerFirmPanelFlag"  name="SecurityReceiptForm" value="-"  />
...
<!--			      <td width="763">-->
<!--			         <html:radio property="insurerFirmPanelFlag"  name="SecurityReceiptForm" value="Y" onclick="getlag()" />Yes &nbsp;-->
<!--	                 <html:radio property="insurerFirmPanelFlag"  name="SecurityReceiptForm" value="N" onclick="getlag()" /> No &nbsp;-->
<!--					<html:radio property="insurerFirmPanelFlag"  name="SecurityReceiptForm" value="-" onclick="getlag()" /> N/A-->
...
<!--		 </td>-->
<!--	  </tr>-->
<html:hidden property="insurerFirmPanelFlag"  name="SecurityReceiptForm" value="-" />
	  <tr>
	  	<td>&nbsp;</td>
	  </tr> 
<!--	<tr>-->
...
<!--	</tr>-->
   <%
        ...
        //if (expressProcessAppTypeList!=null && expressProcessAppTypeList.indexOf(applicationType) != -1) {
          //  expressProcess = true;    
...
<logic:equal name="toDisplayCheckListItem" value="true">
	...
	//System.out.println("status:::::::::::"+OB.getItemStatus());
        %>
			<tr class="<%=rowClass%>">
...
--%>
			 ...
			 if(docStatus.equals("NOT_APPLICABLE"))
...
<% if(row==0){%>
            <tr class="odd">
              <td colspan="15">There are no securities linked</td>
            </tr>
<% }%>
          </tbody>
        </table></td>
...
<td><a href="#" onClick="saveForm()" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','img/save2.gif',1)"><img src="img/save1.gif" name="Image2"  border="0" id="Image2" /></a></td>
     <%if (ICMSConstant.STATE_REJECTED.equals(status) || ICMSConstant.STATE_DRAFT.equals(status)) { %>
        ...
        <%--else {%>
            <td width="100" valign="baseline" align="center">
                <a href="SecurityReceipt.do?event=list" onmouseout="MM_swapImgRestore()"   onmouseover="MM_swapImage('Image2','','img/cancel2.gif',1)">
