...
%>
<%
String actionStr1 = "com.integrosys.cms.ui.fccBranch.FCCBranchAction";
...
function cancelPage(){
    document.forms[0].action="fccBranch.do?event=maker_list_fccBranch&go=N";
...
function submitForm(event) {
	...
	if(event=="maker_prepare_resubmit_create")
		...
		document.forms[0].action="fccBranch.do?event=maker_confirm_resubmit_create";
		
    }else{
      
    	document.forms[0].action="fccBranch.do?event=maker_edit_fccBranch";
    }
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <tr>
   <%if((event.equals("maker_prepare_resubmit_create"))){%>
                    <td><h3>Create FCC Branch Master</h3></td>
                    <%}else{ %>
                     <td><h3>Edit FCC Branch Master</h3></td>
                     <%} %>
          ...
          <tbody>
           ...
           <tr class="odd">
												...
												<td class="fieldname" >
												 ...
												 <td><html:text property="branchCode"/> 
                  								<html:errors property="branchCodeError"/>
                  								<html:errors property="fccBranchDuplicateError"/></td>    
												
											<td class="fieldname" >
													Alias Branch Code <font color="red">*</font>
												</td>
												 <td><html:text property="aliasBranchCode"/> 
                  								<html:errors property="aliasBranchCodeError"/> <html:errors property="fccBranchCombinationDuplicateError"/></td>
												</tr>
          
            <tr class="odd">
            <td class="fieldname">Branch Name <font color="red">*</font></td>
  ...
  <%if((event.equals("maker_prepare_resubmit_create"))){%>
                   <td colspan="2">
                    ...
                    <td colspan="2">
						<a href="#" onmouseout="MM_swapImgRestore()"
							onmouseover="MM_swapImage('Image3311','','img/submit2.gif',1)"
							onClick=" submitForm('maker_edit_caseBranch')"><img src="img/submit1.gif"
								name="Image3311" border="0" id="Image3311" />
						</a>&nbsp;&nbsp;
					</td>
                     <%} %>
