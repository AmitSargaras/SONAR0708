...
<%
	...
	String rejectEvent;
	if (event.equals("checker_view_segment_wise_email")) {
		rejectEvent = "checker_list_segment_wise_email";
	} else {
		rejectEvent = "maker_list_segment_wise_email";
	}
...
<script language="JavaScript" type="text/JavaScript">
	...
	function cancelPage() {
		...
		document.forms[0].action="segmentWiseEmail.do?event=<%=rejectEvent %>&go=N";
		document.forms[0].submit();
	}
</script>
<!-- InstanceEndEditable -->
		...
		<table width="70%" border="0" align="center" cellpadding="0"
			...
			<thead>
				<tr>
					<td>
						<br>
						<h4>View Segment wise Email ID Mapping</h4>
					</td>
				</tr>
			</thead>
			<tbody>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <table  width="100%" class="tblinfo" style="margin-top:0" border="0" cellspacing="0" cellpadding="0">
                            <thead>
                            <tr>
                              <td width="5%" style="background-color: #99abc5; color: black;font-weight: bold;">Sr. No.</td>                            
                              <td width="20%" style="background-color:#CBD2DC; color: black;font-weight: bold;">Email ID</td>
                            </tr>
                            </thead>
                         	<tbody>
