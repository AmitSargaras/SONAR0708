...
<script language="JavaScript" type="text/JavaScript">		
		function submitForm() {
 	document.forms[0].action="Releaselinedetailsupload.do?event=releaselinedetailsupload";
...
-->
	...
	<html:form action="/Releaselinedetailsupload" enctype="multipart/form-data">
		<body >
				...
				<tbody>
					<tr>
						<td valign="bottom" align="center">
							<html:file property="fileUpload" size="50"></html:file></br><html:errors property="releaselinedetailsfileuploadError"/>
						</td>
					</tr>
					<%
