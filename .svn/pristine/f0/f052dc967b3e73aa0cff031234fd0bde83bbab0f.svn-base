...
'CUST-ALLOC-0002', 'MMM Multimedia Co.', 'MMM Multimedia Co.', 
'56', 'C', 'MY', 'CUST-ALLOC-0002-BUS', 'ARBS');
...
from sci_le_main_profile where lmp_le_id = 'CUST-ALLOC-0002';
...
lsp_le_id, lsp_id, '800000002', 'ALLOC-AA-0002', cms_le_sub_profile_id, 'ACTIVE', 
'MY', '2', 'ARBS', 'N', 'BANKING', 'Y', 'Y', 'HP', 'CON'
from sci_le_sub_profile where lsp_le_id = 'CUST-ALLOC-0002';
...
where llp_le_id = 'CUST-ALLOC-0002';
...
cms_lsp_lmt_profile_id, '700000002', '27', 'HP',
'25', 'OUTER', 80000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 70000000, '210', 1, 'FAC-ALLOC-0002', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0002';
...
where los_lmt_id in ('FAC-ALLOC-0002') ;
...
'--', '--', '--', '-999999999', -999999999, -999999999
from sci_lsp_appr_lmts where los_lmt_id = 'FAC-ALLOC-0002';
...
where cms_lsp_appr_lmts_id in (select cms_lsp_appr_lmts_id
	from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0002'));
...
'AB102', 'AB102-ALLOC-0001', 'AB102-ALLOC-0001', 'MY', subtype_name, security_type_name, 
...
select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB102-ALLOC-0001';	
...
sci_orig_security_currency, security_organisation,
cmv, cmv_currency, fsv, fsv_currency
from cms_security where sci_security_dtl_id = 'AB102-ALLOC-0001';
...
and s.sci_security_dtl_id in ('AB102-ALLOC-0001');
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB102-ALLOC-0001'), 'AB102-ALLOC-0001',
...
from cms_security s
where s.sci_security_dtl_id in ('AB102-ALLOC-0001');
...
from cms_security
where sci_security_dtl_id in ('AB102-ALLOC-0001');
...
'37', 'ARBS', 'SIBS-ACT-0002', 'MY', 'N', 'A', 'L', 1, 30000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0003', 'MY', 'N', 'A', 'L', 1, 20000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0004', 'MY', 'N', 'A', 'L', 1, 20000000, 'I');
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	...
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0002'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0002';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0003'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0002';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0004'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0002';
