...
<html>
        ...
        <script type="text/javascript" >
         <!--
            ...
            function closeItem()
            {
				...
				document.getElementById( 'event' ).value = '<%= ShareCounterConstants.SHARE_COUNTER_MAKER_CLOSE %>' ;
                                document.getElementById( 'hiddenForm' ).submit() ;
            }

			function goPageIndex(targetOffset)
			{
				document.getElementById( 'event' ).value = '<%=ShareCounterConstants.SHARE_COUNTER_TOTRACK%>'  ;
    ...
    if ( !( roleId == ICMSConstant.TEAM_TYPE_GAM_USER 
    		|| roleId == ICMSConstant.TEAM_TYPE_SCO_USER 
    		|| roleId == ICMSConstant.TEAM_TYPE_SC_CHECKER 
    		|| roleId == ICMSConstant.TEAM_TYPE_SC_CHECKER_WFH
    		) )
    {
        ...
        <table width="150"  border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td width="100%" valign="baseline" align="center"> 
                    <a href="ToDo.do?event=totrack&isMenu=Y" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3311','','img/return2.gif',1)">
