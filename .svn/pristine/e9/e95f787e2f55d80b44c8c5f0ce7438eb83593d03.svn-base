...
<input type="hidden" name="totalLonable" value="<%=totalLonable %>"></input>
  <tr>
      <td><h3>View Insurance - Waived</h3></td>
  </tr>
  <tr>
    <td><hr/></td>
  </tr>
               ...
               <tr class="even">
                ...
                <td width="30%">
                 ...
                 if(insuranceObj!= null){
                  ...
                  <integro:empty-if-null value="<%=waivedDate %>"/>&nbsp;
                </td>
                ...
                <td width="30%">  <%
        			...
        			for(int a=0; a<waiverCreditApproverList.size();a++){   
          			 LabelValueBean bean=(LabelValueBean) waiverCreditApproverList.get(a);
...
<table width="130" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <td colspan="4">
	...
	<%	if(event.equals("maker_view_insurance_waived")){%>		
				<center>
						...
						<%}else if(event.equals("checker_view_insurance_waived") && "prepare_close".equals(from_page)){ %>
						<center>
							...
							<%	}else if(event.equals("checker_view_insurance_waived")){%>		
							<center>
	...
	<% if(isChecker){%>
 <td colspan="4">
				<%if(event.equals("checker_view_insurance_waived") && "read".equals(from_page)){ %>
					...
					<%}else if(event.equals("maker_view_insurance_waived") && ("maker_cancle_create_insurance".equals(from_page) || "prepare_update".equals(from_page) || "maker_return_from_submit_insurance".equals(from_page) || "return_from_due_date_and_stock".equals(from_page))){ %>
