...
Locale locale = (Locale)session.getAttribute(ICommonEventConstant.GLOBAL_SCOPE+"."+com.integrosys.base.uiinfra.common.Constants.GLOBAL_LOCALE_KEY);
    ...
    List waiverCreditApproverList = (List)session.getAttribute("com.integrosys.cms.ui.checklist.otherreceipt.OtherReceiptAction.waiverCreditApproverList");
...
function saveForm() {
	document.forms["OtherReceiptForm"].event.value="save_waiver";
