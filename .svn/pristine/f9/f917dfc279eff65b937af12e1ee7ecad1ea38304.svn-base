...
<%@page import="com.integrosys.base.businfra.currency.Amount"%><%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"%>
...
if (!(currencyList == null)) {
	...
	String partyId = (String) session
	.getAttribute("com.integrosys.cms.ui.manualinput.customer.ManualInputCustomerAction.partyId");
	
	pageContext.setAttribute("partyId", partyId);
	
	Amount grpExpoAmt = (Amount)session
	.getAttribute("com.integrosys.cms.ui.manualinput.customer.ManualInputCustomerAction.grpExpoLimit");
	
	pageContext.setAttribute("grpExpoAmt", grpExpoAmt);
...
<%@page import="java.util.Locale"%><head>
						...
						<tbody>
								...
								<td>
									<% 
										if (formObj.getPartyGroupName() != null 
												&& partyId!=null && !"".equals(partyId) 
												&& formObj.getPartyGroupName().equals(String.valueOf(partyId)) 
												&& grpExpoAmt!=null && !"".equals(grpExpoAmt) ) {
									%>
										<html:text property="groupExposer" value="<%=String.valueOf( grpExpoAmt.getAmountAsBigDecimal()) %>" readonly="true" />
									<%
										} 
									%>
								</td>
							...
							<tr class="odd">
								...
								<input type="radio" id="isSensitive" name="isSensitive" value="Yes" checked="checked" disabled="disabled"/> Yes
									<input type="radio" id="isSensitive" name="isSensitive" value="No" disabled="disabled"/> No
								<%} %>
								<%if(formObj.getIsSensitive() == null || "".equals(formObj.getIsSensitive()) || formObj.getIsSensitive().equals("No")){ %>
								<input type="radio" id="isSensitive" name="isSensitive" value="Yes"  disabled="disabled"/> Yes
									<input type="radio" id="isSensitive" name="isSensitive" value="No" checked="checked" disabled="disabled"/> No
								<%} %>
 ...
 %>
									...
									<tr class="odd">
										...
										<td><html:textarea property="nameOfHoldingCompany"   styleId="nameOfHoldingCompany"
											 ...
											 <html:text property="type" styleId="type" maxlength="20"
												value="<%=formObj.getType()%>" disabled="true">
												<p>Rs</p>
											</html:text></td>
									</tr>
...
<%}%>												  
									...
									<%}%> 
										 ...
										 <%if(formObj.getCapitalForCommodityAndExchange()!=null && formObj.getCapitalForCommodityAndExchange().equals("Non Broker") ){%>
										  <input type="radio"  disabled="true"  	name="capitalForCommodityAndExchange"
												...
												<input type="radio"  disabled="disabled"  name="brokerType" value="Share Broker"/> Share Broker  &nbsp; </br> 
												<input type="radio"  disabled="disabled"  name="brokerType" value="CommodityBroker" />
												 CommodityBroker  &nbsp; </br> 
                                         <%}%> 
									</td>
										<td class="fieldname">
									...
									<tr class="odd">
										...
										<td>
										 ...
										 <%if(formObj.getConductOfAccountWithOtherBanks() !=null && formObj.getConductOfAccountWithOtherBanks().equals("classified") ){%>
									...
									<tr class="even">
										...
										<td>
										   ...
										   <input type="radio"  disabled="true"   checked="checked"   name="commericialRealEstate" value="Yes"/> Yes
											...
											<input type="radio"  disabled="true"      name="commericialRealEstate" value="No"/> No 
