...
<%@page
	import="com.integrosys.cms.app.pincodemapping.trx.IPincodeMappingTrxValue"%><html>
...
function submitForm(event) {
		...
		document.forms[0].action="StatePincodeMapping.do?event=maker_save_update&TrxId=<%=request.getAttribute("TrxId")%>";
    document.forms[0].submit();
}
					...
					<tbody>
						...
						<tr class="odd">
							...
							<td class="fieldname" width="30%">State Name<font color="red">*</font></td>
								...
								<html:errors property="dupStateIdError"/>&nbsp;
						...
						<td class="fieldname" width="30%">Last Action By</td>
							<td colspan="3"><%=pincodeMappingTrx.getUserInfo()%>&nbsp;</td>
						</tr>
