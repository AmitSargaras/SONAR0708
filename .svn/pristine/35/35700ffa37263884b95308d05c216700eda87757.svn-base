...
public class MakerUpdateTatDocOperationTest extends TransactionEngineTestCase {
	...
	public void testPerformProcessUsingDefaultTrxProcess() throws Exception {
		...
		MakerUpdateTatDocOperation op = new MakerUpdateTatDocOperation();
		...
		assertEquals("PENDING_UPDATE", processedTrxValue.getStatus());
	}
}
