...
'CUST-ALLOC-0003', 'Forever Florist', 'Forever Florist', 
'56', 'C', 'MY', 'CUST-ALLOC-0003-BUS', 'ARBS');
...
from sci_le_main_profile where lmp_le_id = 'CUST-ALLOC-0003';
...
lsp_le_id, lsp_id, '800000003', 'ALLOC-AA-0003', cms_le_sub_profile_id, 'ACTIVE', 
'MY', '2', 'ARBS', 'N', 'BANKING', 'Y', 'Y', 'CO', 'CON'
from sci_le_sub_profile where lsp_le_id = 'CUST-ALLOC-0003';
...
where llp_le_id = 'CUST-ALLOC-0003';
...
cms_lsp_lmt_profile_id, '700000003', '27', 'FK',
'25', 'OUTER', 50000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 50000000, '210', 1, 'FAC-ALLOC-0003', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0003';
...
account_type, lmt_bca_ref_num, los_bca_ref_num)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for limit_seq), 2)) AS bigint), 
cms_lsp_lmt_profile_id, '700000004', '27', 'FK',
'25', 'OUTER', 150000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 150000000, '210', 1, 'FAC-ALLOC-0004', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0003';
...
where los_lmt_id in ('FAC-ALLOC-0003', 'FAC-ALLOC-0004') ;
...
insert into cms_fac_general (cms_fac_master_id, currency_code, FAC_STATUS_CODE_NUM, FAC_STATUS_CODE_value)
select id, 'MYR', 'FACILITY_STATUS', 'A'
from cms_facility_master fm, sci_lsp_appr_lmts lmts
where fm.cms_lsp_appr_lmts_id = lmts.cms_lsp_appr_lmts_id
and lmts.los_lmt_id in ('FAC-ALLOC-0003', 'FAC-ALLOC-0004');
	
insert into cms_stg_fac_general (cms_fac_master_id, currency_code, FAC_STATUS_CODE_NUM, FAC_STATUS_CODE_value)
select cms_fac_master_id, fg.currency_code, FAC_STATUS_CODE_NUM, FAC_STATUS_CODE_value 
from cms_fac_general fg, cms_facility_master fm, sci_lsp_appr_lmts lmts
where fg.cms_fac_master_id = fm.id
and lmts.cms_lsp_appr_lmts_id = fm.cms_lsp_appr_lmts_id
and lmts.los_lmt_id in ('FAC-ALLOC-0003', 'FAC-ALLOC-0004');
...
where cms_lsp_appr_lmts_id in (select cms_lsp_appr_lmts_id
	from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0003', 'FAC-ALLOC-0004'));
...
'AB102', 'AB102-ALLOC-0002', 'AB102-ALLOC-0002', 'MY', subtype_name, security_type_name, 
'AB102', 'AB', 'MYR', 'ACTIVE', 'MYR', '12', 'ARBS', 'Y',
100000000, 'MYR', 85000000, 'MYR'
from cms_security_sub_type where security_sub_type_id = 'AB102';

insert into cms_asset (cms_collateral_id)
select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB102-ALLOC-0002';	
...
sci_orig_security_currency, security_organisation,
cmv, cmv_currency, fsv, fsv_currency
from cms_security where sci_security_dtl_id = 'AB102-ALLOC-0002';
...
and s.sci_security_dtl_id in ('AB102-ALLOC-0002');
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB102-ALLOC-0002'), 'AB102-ALLOC-0002',
...
'MYR', (current timestamp - 5 days), 'V9999', 100000000, 85000000, s.cms_collateral_id, 'S', 'ARBS'
from cms_security s
where s.sci_security_dtl_id in ('AB102-ALLOC-0002');
...
from cms_security
where sci_security_dtl_id in ('AB102-ALLOC-0002');
...
'37', 'ARBS', 'SIBS-ACT-0005', 'MY', 'N', 'A', 'L', 1, 30000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0006', 'MY', 'N', 'A', 'L', 1, 20000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0007', 'MY', 'N', 'A', 'L', 1, 70000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0008', 'MY', 'N', 'A', 'L', 1, 80000000, 'I');
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	...
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0005'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0003';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0006'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0003';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0007'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0004';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0008'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0004';
