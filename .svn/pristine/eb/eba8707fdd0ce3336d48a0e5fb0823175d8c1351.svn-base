...
<%@ page import="com.integrosys.cms.ui.cam.CAMGlobalForm" %>
<%
/**
...
<%
    OBDocumentItemTrxValue trxVal = (com.integrosys.cms.app.chktemplate.trx.OBDocumentItemTrxValue) session.getAttribute("com.integrosys.cms.ui.cam.CAMGlobalAction.docTrxObj");
    CAMGlobalForm aForm = (CAMGlobalForm)request.getAttribute("CAMGlobalForm");
    String critical= (String) session.getAttribute("com.integrosys.cms.ui.cam.CAMGlobalAction.critical");
    String mandatory = (String) session.getAttribute("com.integrosys.cms.ui.cam.CAMGlobalAction.mandatory");
    ...
    String migratedFlag = "N";
	 migratedFlag = (String)session.getAttribute("com.integrosys.cms.ui.cam.CAMGlobalAction.migratedFlag");	 
...
<table class="tblFormSection" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3>Global CAM Document Template - View</h3></td>
    </tr>
    <tr>
      <td><hr/></td>
    </tr>
      ...
      <td> <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
            <tr class="even">
              ...
              <td><bean:write name="CAMGlobalForm" scope="request" property="itemCode" />&nbsp;<br /><html:errors property="itemCode" /></td>
            </tr>
            <tr class="odd">
...
<!--              <td>&nbsp;<bean:write name="CAMGlobalForm" scope="request" property="docVersion" /></td>-->
<!--            </tr>-->
<!--            <tr class="odd">-->
<!--              <td class="fieldname">Expiry Date</td>-->
<!--              <td><bean:write name="CAMGlobalForm" scope="request" property="expDate" />&nbsp;</td>-->
<!--            </tr>-->
<!--            <tr class="even">-->
<!--				<td class="fieldname">Pre-Approval Document</td>-->
<!--				<td><html:radio name="CAMGlobalForm" property="isPreApprove" value="Y" disabled="true" />Yes -->
<!--				<html:radio name="CAMGlobalForm" property="isPreApprove" value="N" disabled="true" />No</td>-->
<!--			</tr>-->
...
<table width="100"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <%if(!toTrack && close) { %>
    <a href="CAMGlobal.do?event=close_doc_item" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/close2a.gif',1)"><img src="img/close1a.gif" name="Image4411"  border="0" id="Image4411" /></a>&nbsp;&nbsp;&nbsp;<a href="ToDo.do" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image4411"  border="0" id="Image4411" /></a>
    <%}else if(toTrack){%>
    ...
    <%}else{
    	if(viewOnly){
        	%>
            <a href="CAMGlobal.do?event=global_list&view=view&type=CAM&go=N&startIndex=<%=startIndex %>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4411"  border="0" id="Image4411" /></a>
        <%
        		}else{
        		%>
        <a href="CAMGlobal.do?event=global_list&type=CAM&go=N&startIndex=<%=startIndex %>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4411"  border="0" id="Image4411" /></a>
    <%}
    }%>
    </td>
  </tr>
