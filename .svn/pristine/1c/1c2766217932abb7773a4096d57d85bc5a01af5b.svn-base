...
set INTEGRO_HOME=D:\dev\abcms\branches\CLIMS_P3
set JAVA_HOME=D:\bea\jdk142_08
set ANT_HOME=D:\dev\Util\Ant
set BEA_HOME=D:\bea
set WEBLOGIC_HOME=%BEA_HOME%\weblogic81
set WLS_DOMAIN=abclims
set BUILD_FILE=%INTEGRO_HOME%\build.xml
SET WAS_APP_HOME=
set EAR_UPDATE_INFO_DIR=
