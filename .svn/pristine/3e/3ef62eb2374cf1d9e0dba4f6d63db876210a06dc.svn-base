	...
	<head>
		<script type="text/javascript">
			...
			function approvePage() {
				...
				if (x) {
					document.forms[0].action="MFSchemaDetailsUpload.do?event=checker_approve";
			...
			function rejectPage() {
			    document.forms[0].action="MFSchemaDetailsUpload.do?event=checker_reject";
			    document.forms[0].submit();
			}
	 ...
	 <html:form	action='MFSchemaDetailsUpload.do'>
		...
		<body>
			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
				<thead>
					<tr>
						<td><h3><bean:message key="menu.uploads.mfschemaDetailsUpload.name" /></h3></td>
					</tr>
				</thead>
				<tbody>
					<tr height="20">
