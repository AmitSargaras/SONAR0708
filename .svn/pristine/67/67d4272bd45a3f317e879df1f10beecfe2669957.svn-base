...
function cancelPage(){
    document.forms[0].action="City.do?event=view_list_city";
    document.forms[0].submit();
}
function submitForm() {
 	document.forms[0].action="City.do?event=maker_upload_city";
    document.forms[0].submit();
}
...
<html:form action="/City" enctype="multipart/form-data">
