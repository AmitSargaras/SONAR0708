...
* $Header: /home/cms2/cvsroot/cms2/public_html/commoditydeal/commoditydoc/financingdoc/chk_view_financing_doc.jsp,v 1.11 2006/10/27 08:39:01 hmbao Exp $
*
...
<%
    ...
    IFinancingDoc actualFinDoc = (IFinancingDoc)request.getAttribute("actualFinanceDoc");
    IFinancingDoc stageFinDoc = (IFinancingDoc)request.getAttribute("stageFinanceDoc");
%>
  ...
  <tbody>
    <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
        <tr class="odd">
          <td width="20%" class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "docTypeCode")?"fieldname":"fieldnamediff"%>">Sales Documentation Description&nbsp;<font color="#0000FF">* </font></td>
          <td width="30%"><integro:empty-if-null value="<%=SalesDocTypeList.getInstance().getSalesDocTypeItem(aForm.getSalesDocDesc())%>"/>&nbsp;
          </td>
        </tr>
        <tr class="even">
          <td width="20%" class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "otherDocType")?"fieldname":"fieldnamediff"%>">(if Others)</td>
          <td width="30%"><bean:write name="FinancingDocForm" property="salesDocDescOth"/>&nbsp;
          </td>
        </tr>
        <tr class="odd">
          <td width="20%" class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "goodsDesc")?"fieldname":"fieldnamediff"%>">Description of Goods</td>
        ...
        <%
            ...
            if (actualFinDoc != null) {
                actualAmt = actualFinDoc.getOrderAmount();
            }
            if (stageFinDoc != null) {
                stageAmt = stageFinDoc.getOrderAmount();
            }
        ...
        %>
        <tr class="even">
          <td width="20%" class="<%=isSame?"fieldname":"fieldnamediff"%>">Amount of Sales Order</td>
...
*/
            ...
            if (actualFinDoc != null) {
                actualQty = actualFinDoc.getOrderQuantity();
/*
                if (actualQty != null) {
...
*/
            ...
            if (stageFinDoc != null) {
                stageQty = stageFinDoc.getOrderQuantity();
/*
                if (stageQty != null) {
...
*/
            ...
            isSame = CompareOBUtil.compOB(stageQty, actualQty, "quantity");
/*
            if (isSame) {
                isSame = CompareOBUtil.compOB(stageUOM, actualUOM, "iD");
            }
*/
        %>
        <tr class="odd">
          <td width="20%" class="<%=isSame?"fieldname":"fieldnamediff"%>">Quantity</td>
        ...
        <tbody>
        <tr class="even">
          <td width="20%" class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "documentNo")?"fieldname":"fieldnamediff"%>">Sales Document No.</td>
          <td width="30%">
          <bean:write name="FinancingDocForm" property="salesDocNo"/>&nbsp;
          </td>
        </tr>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "orderExpDate")?"fieldname":"fieldnamediff"%>">Expiry Date</td>
          <td><bean:write name="FinancingDocForm" property="expiryDate"/>&nbsp;
          </td>
        </tr>
        <tr class="even">
          <td class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "bankCountryCode")?"fieldname":"fieldnamediff"%>">Country of Export Issuing Bank</td>
          <td><integro:empty-if-null value="<%=CountryList.getInstance().getCountryName(aForm.getCountryExportIssBank())%>"/>&nbsp;
          </td>
        </tr>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "bankName")?"fieldname":"fieldnamediff"%>">Export LC Issuing Bank</td>
          <td><bean:write name="FinancingDocForm" property="exportLCIssBank"/>&nbsp;
          </td>
        </tr>
        <tr class="even">
          <td class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "lCRefNo")?"fieldname":"fieldnamediff"%>">LC Reference</td>
          <td><bean:write name="FinancingDocForm" property="lcReference"/>&nbsp;
          </td>
        </tr>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "lCExpDate")?"fieldname":"fieldnamediff"%>"> LC Expiry Date</td>
          <td><bean:write name="FinancingDocForm" property="lcExpiryDate"/>&nbsp;
          </td>
        </tr>
        <tr class="even">
          <td class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "lOCDueDate")?"fieldname":"fieldnamediff"%>"> Due Date to Receive Letters of Credit</td>
          <td><bean:write name="FinancingDocForm" property="locDueDate"/>&nbsp;
          </td>
        </tr>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "counterParty")?"fieldname":"fieldnamediff"%>">Counter-Party</td>
          <td><bean:write name="FinancingDocForm" property="counterParty"/>&nbsp;
          </td>
        </tr>
        <tr class="even">
          <td class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "termsMatched")?"fieldname":"fieldnamediff"%>">Terms Matched (for Back-to-Back LC only)</td>
          <td>
          <% String value = "";
        ...
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(stageFinDoc, actualFinDoc, "remarks")?"fieldname":"fieldnamediff"%>">Remarks</td>
