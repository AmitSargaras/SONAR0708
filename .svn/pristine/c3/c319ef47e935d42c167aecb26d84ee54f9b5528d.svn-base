...
if(user1.getTeamTypeMembership().getMembershipID()==1006 || user1.getTeamTypeMembership().getMembershipID()==1013 && from_page.equalsIgnoreCase("read")){
	isMaker=true;
}else {
	isChecker=true;
}
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput" id="choiceTable">
          ...
          <tbody>
               <tr class="even">
                ...
                <td width="30%">&nbsp;
					<bean:write name="MaintainInsuranceGCForm" property="oldPolicyNo"/>
                </td>
              </tr>
 ...
 <td colspan="4">
	...
	<%	if(event.equals("maker_view_insurance_pending")){%>		
				<center>
							...
							<%}else if(event.equals("checker_view_insurance_pending") && "prepare_close".equals(from_page)){ %>
						<center>
	...
	<% if(isChecker){%>
 <td colspan="4">
				<%if(event.equals("checker_view_insurance_pending") && "read".equals(from_page)){ %>
				...
				<%} else if(event.equals("maker_view_insurance_pending") && ("maker_cancle_create_insurance".equals(from_page) || "prepare_update".equals(from_page) || "maker_return_from_submit_insurance".equals(from_page) || "return_from_due_date_and_stock".equals(from_page))){ %>
