...
<%
     ...
     * $Header: /home/cms2/cvsroot/cms2/public_html/tat/close_createTat.jsp,v 1.32 2006/10/27 08:48:33 hmbao Exp $
...
<html:form  action="Tat.do?event=createTat">
        ...
        <tbody>
            ...
            <tr class="even">
             <% Date tatCreateDt = DateUtil.convertDate(locale,aForm.getTatCreateDate());%>
              <td class="fieldname" width="20%">BCA Part I Received Date</td>
          ...
          <td><integro:empty-if-null value="<%=aForm.getBflIndUpdateDate()%>"/>&nbsp; </td>
            ...
            <tr class="even" width="20%">
              ...
              <td width="30%"> <%if(aForm.getDueDate()!=null && (!aForm.getDueDate().equals("-"))) {              %>
