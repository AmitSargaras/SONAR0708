...
<%@ page import="com.integrosys.cms.ui.collateral.marketablesec.marksecotherlistedforeign.MarksecOtherListedForeignForm"%>

<%
/**
* Copyright Integro Technologies Pte Ltd
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/marketablesec/marksecotherlistedforeign/MarksecOtherListedForeign_update.jsp,v 1.58 2006/11/23 02:59:11 jzhan Exp $
*
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.marketablesec.MarketableSecAction.serviceColObj");
	...
	IOtherListedForeign iCol = (IOtherListedForeign) itrxValue.getStagingCollateral();
    ...
    MarksecOtherListedForeignForm colForm = (MarksecOtherListedForeignForm) request.getAttribute(formName);
...
function submitPage(num, index) {
    ...
    if (num == 4) {
        document.forms[0].event.value="marksecotherlistedforeign_prepare";
        document.forms[0].indexID.value="-1";
        document.forms[0].itemType.value="PORTITEM";
    }
    if (num == 5) {
        document.forms[0].event.value="marksecotherlistedforeign_prepare_update_sub";
...
<html:form action="MarksecOtherListedForeignCollateral.do">
<input type="hidden" name="event">
<input type="hidden" name="subtype" value="MarksecOtherListedForeign"/>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
    ...
    <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
	 	...
	 	<td width="20%"  class="fieldname"><bean:message key="label.security.legal.enforceability.date"/>&nbsp;
			<span class="mandatoryPerfection">*</span><font color="#0000FF"><span id="span11">&nbsp;</span></font></td>
	 	<td width="30%">
