...
"$JAVA_HOME"/bin/java $JAVA_OPTS  com.integrosys.cms.ui.eventmonitor.EventMonitorClient com.integrosys.cms.app.eventmonitor.enableDisableUser.MonEnableDisableUser;
