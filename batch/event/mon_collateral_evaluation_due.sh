...
do 
echo $country "------------" 
"$JAVA_HOME"/bin/java com.integrosys.cms.ui.eventmonitor.EventMonitorClient com.integrosys.cms.app.eventmonitor.collateralevaluationdue.MonEvaluationDue $country;
done
