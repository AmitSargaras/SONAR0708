 ...
 * @since Oct 1, 2009
 */
public class StpFacIslamicRentalRenewDeletionCmdTest extends TestCase implements IStpConstants, IStpTransType {
    StpFacIslamicRentalRenewDeletionCmd cmd;
    ...
    protected void setUp() throws Exception {
        ...
        rentalRenewal.setRenewalRate(new BigDecimal(90));
        rentalRenewal.setRenewalTermCodeEntryCode("ABC");
        rentalRenewal.setPrimeRateNumberEntryCode("999");
        ...
        cmd = new StpFacIslamicRentalRenewDeletionCmd();
    ...
    public void testRentalRenewMsgDelete() throws Exception {
