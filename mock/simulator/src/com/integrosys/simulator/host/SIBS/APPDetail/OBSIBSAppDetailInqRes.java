package com.integrosys.simulator.host.SIBS.APPDetail;
...
public class OBSIBSAppDetailInqRes extends OBMessageHeader implements IOBHost {
	...
	public String printString() {
		...
		if (responseFixList != null) {
			for (int i = 0; i < responseFixList.size(); i++) {
				OBSIBSAppDetailInqRes appDetailInqRes = (OBSIBSAppDetailInqRes) responseFixList.get(i);
