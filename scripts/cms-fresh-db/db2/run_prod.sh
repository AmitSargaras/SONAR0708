...
"$DB2_HOME"/bin/db2 "create tablespace cms_small_data pagesize 4096 managed by database using (FILE '$DB_DATAPATH/CMS_SMALL_DATA' 1300000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_small_buf NO FILE SYSTEM CACHING"

"$DB2_HOME"/bin/db2 create bufferpool cms_buf size 4096 pagesize 8192 extended storage

"$DB2_HOME"/bin/db2 "create tablespace cms_data pagesize 8192 managed by database using (FILE '$DB_DATAPATH/CMS_DATA' 85000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_buf"

"$DB2_HOME"/bin/db2 create bufferpool cms_medium_buf size 2048 pagesize 16384 extended storage

"$DB2_HOME"/bin/db2 "create tablespace cms_medium_data pagesize 16384 managed by database using (FILE '$DB_DATAPATH/CMS_MEDIUM_DATA' 18000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_medium_buf"

"$DB2_HOME"/bin/db2 create bufferpool cms_large_buf size 1024 pagesize 32768 extended storage

"$DB2_HOME"/bin/db2 "create tablespace cms_large_data pagesize 32768 managed by database using (FILE '$DB_DATAPATH/CMS_LARGE_DATA' 1000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_large_buf"

"$DB2_HOME"/bin/db2 create bufferpool cms_index_buf size 8192 pagesize 8192 extended storage

"$DB2_HOME"/bin/db2 "create tablespace cms_index pagesize 8192 managed by database using (FILE '$DB_DATAPATH/CMS_INDEX' 500000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_index_buf"

"$DB2_HOME"/bin/db2 create bufferpool cms_batch_buf size 8192 pagesize 32768 extended storage

"$DB2_HOME"/bin/db2 "create tablespace cms_batch pagesize 32768 managed by database using (FILE '$DB_DATAPATH/CMS_BATCH' 5000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_batch_buf"

"$DB2_HOME"/bin/db2 create bufferpool cms_batch_idx_buf size 8192 pagesize 8192 extended storage

"$DB2_HOME"/bin/db2 "create tablespace cms_batch_index pagesize 8192 managed by database using (FILE '$DB_DATAPATH/CMS_BATCH_INDEX' 1000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_batch_idx_buf"
...
"$DB2_HOME"/bin/db2 "create tablespace cms_stp pagesize 16384 managed by database using (FILE '$DB_DATAPATH/CMS_STP' 20000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_stp_buf"
...
"$DB2_HOME"/bin/db2 create bufferpool cms_audit_buf size 4096 pagesize 4096 extended storage

"$DB2_HOME"/bin/db2 "create tablespace cms_audit_data pagesize 4096 managed by database using (FILE '$DB_DATAPATH/CMS_AUDIT_DATA' 1000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_audit_buf"

"$DB2_HOME"/bin/db2 update dbm cfg using maxagents 200

"$DB2_HOME"/bin/db2 update dbm cfg using FEDERATED YES IMMEDIATE
...
"$DB2_HOME"/bin/db2 update db cfg for "$DB_SCHEMA" using LOGPRIMARY 10

"$DB2_HOME"/bin/db2 update db cfg for "$DB_SCHEMA" using LOGSECOND  246
