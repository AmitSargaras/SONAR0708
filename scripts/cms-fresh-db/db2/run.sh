...
"$DB2_HOME"/bin/db2 alter bufferpool cms_small_buf size automatic

"$DB2_HOME"/bin/db2 alter bufferpool cms_buf size automatic

"$DB2_HOME"/bin/db2 alter bufferpool cms_medium_buf size automatic

"$DB2_HOME"/bin/db2 alter bufferpool cms_large_buf size automatic

"$DB2_HOME"/bin/db2 alter bufferpool cms_index_buf size automatic

"$DB2_HOME"/bin/db2 alter bufferpool cms_batch_buf size automatic

"$DB2_HOME"/bin/db2 alter bufferpool cms_batch_idx_buf size automatic

"$DB2_HOME"/bin/db2 alter bufferpool cms_stp_buf size automatic

"$DB2_HOME"/bin/db2 alter bufferpool cms_stp_idx_buf size automatic

"$DB2_HOME"/bin/db2 alter bufferpool cms_audit_buf size automatic

"$DB2_HOME"/bin/db2 alter bufferpool cms_temp_buf size automatic

"$DB2_HOME"/bin/db2 alter bufferpool cms_user_buf size automatic
