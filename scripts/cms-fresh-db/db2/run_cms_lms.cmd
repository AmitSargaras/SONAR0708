...
db2 create bufferpool cms_small_buf size 16384 pagesize 8k extended storage

db2 create tablespace cms_small_data pagesize 8k managed by database using (FILE '%DB_DATAPATH%\CMS_SMALL_DATA' 1000000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_small_buf

db2 create bufferpool cms_buf size 4096 pagesize 8k extended storage

db2 create tablespace cms_data pagesize 8k managed by database using (FILE '%DB_DATAPATH%\CMS_DATA' 25000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_buf

db2 create bufferpool cms_medium_buf size 3000 pagesize 16k extended storage

db2 create tablespace cms_medium_data pagesize 16384 managed by database using (FILE '%DB_DATAPATH%\CMS_MEDIUM_DATA' 8000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_medium_buf

db2 create bufferpool cms_large_buf size 2000 pagesize 32k extended storage

db2 create tablespace cms_large_data pagesize 32768 managed by database using (FILE '%DB_DATAPATH%\CMS_LARGE_DATA' 2000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_large_buf

db2 create bufferpool cms_index_buf size 8192 pagesize 8k extended storage

db2 create tablespace cms_index pagesize 8192 managed by database using (FILE '%DB_DATAPATH%\CMS_INDEX' 320000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_index_buf

db2 create bufferpool cms_batch_buf size 4096 pagesize 32k extended storage

db2 create tablespace cms_batch pagesize 32768 managed by database using (FILE '%DB_DATAPATH%\CMS_BATCH' 50000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_batch_buf

db2 create bufferpool cms_batch_idx_buf size 8192 pagesize 8k extended storage

db2 create tablespace cms_batch_index pagesize 8192 managed by database using (FILE '%DB_DATAPATH%\CMS_BATCH_INDEX' 100000) AUTORESIZE YES INCREASESIZE 100 M MAXSIZE NONE bufferpool cms_batch_idx_buf
...
db2 -tf cms_module_security_envelope_setup.sql -l cms_module_security_envelope_setup.log
...
db2 -tf cms_module_predeal_setup.sql -l cms_module_predeal_setup.log

rem -----
rem db2 -tf cms_FAP_pledgor_setup.sql -l cms_FAP_pledgor_setup.log
rem db2 -tf cms_FAP_pledge_setup.sql -l cms_FAP_pledge_setup.log
rem -----
...
rem --------------------------------------------------
rem ----------- System Interface Migration -----------
rem --------------------------------------------------
...
db2 -tf cms_system_interface_schema_setup.sql -l cms_system_interface_schema_setup.log

db2 -td@ -f cms_system_interface_function_setup.sql -l cms_system_interface_function_setup.log

db2 -td@ -f cms_system_interface_utility.sql -l cms_system_interface_utility.log

db2 -tf cms_system_interface_data_setup.sql -l cms_system_interface_data_setup.log
