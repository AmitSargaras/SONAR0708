...
'CUST-ALLOC-0014', 'Yuan Yuan Motor Co.', 'Yuan Yuan Motor Co.', 
'56', 'C', 'MY', 'CUST-ALLOC-0014-BUS', 'ARBS');
...
from sci_le_main_profile where lmp_le_id = 'CUST-ALLOC-0014';
...
lsp_le_id, lsp_id, '80000014', 'ALLOC-AA-0014', cms_le_sub_profile_id, 'ACTIVE', 
'MY', '2', 'ARBS', 'N', 'BANKING', 'Y', 'Y', 'CO', 'CON'
from sci_le_sub_profile where lsp_le_id = 'CUST-ALLOC-0014';
...
where llp_le_id = 'CUST-ALLOC-0014';
...
cms_lsp_lmt_profile_id, '700000029', '27', 'HP',
'25', 'OUTER', 300000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 300000000, '210', 1, 'FAC-ALLOC-0029', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0014';
...
account_type, lmt_bca_ref_num, los_bca_ref_num)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for limit_seq), 2)) AS bigint), 
cms_lsp_lmt_profile_id, '700000030', '27', 'HP',
'25', 'OUTER', 200000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 200000000, '210', 1, 'FAC-ALLOC-0030', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0014';
...
account_type, lmt_bca_ref_num, los_bca_ref_num)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for limit_seq), 2)) AS bigint), 
cms_lsp_lmt_profile_id, '700000031', '27', 'HP',
'25', 'OUTER', 500000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 500000000, '210', 1, 'FAC-ALLOC-0031', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0014';
...
where los_lmt_id in ('FAC-ALLOC-0029','FAC-ALLOC-0030', 'FAC-ALLOC-0031') ;
...
'--', '--', '--', '-999999999', -999999999, -999999999
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0029','FAC-ALLOC-0030', 'FAC-ALLOC-0031');
...
'AB101', 'AB101-ALLOC-0005', 'AB101-ALLOC-0005', 'MY', subtype_name, security_type_name, 
...
select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB101-ALLOC-0005';	
...
cmv, cmv_currency, fsv, fsv_currency)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for collateral_seq), 2)) AS bigint), 
'AB101', 'AB101-ALLOC-0006', 'AB101-ALLOC-0006', 'MY', subtype_name, security_type_name, 
'AB101', 'PT', 'MYR', 'ACTIVE', 'MYR', '12', 'ARBS', 'Y',
400000000, 'MYR', 300000000, 'MYR'
from cms_security_sub_type where security_sub_type_id = 'AB101';

insert into cms_asset (cms_collateral_id)
select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB101-ALLOC-0006';	
...
cmv, cmv_currency, fsv, fsv_currency)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for collateral_seq), 2)) AS bigint), 
'AB101', 'AB101-ALLOC-0007', 'AB101-ALLOC-0007', 'MY', subtype_name, security_type_name, 
'AB101', 'PT', 'MYR', 'ACTIVE', 'MYR', '12', 'ARBS', 'Y',
600000000, 'MYR', 500000000, 'MYR'
from cms_security_sub_type where security_sub_type_id = 'AB101';

insert into cms_asset (cms_collateral_id)
select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB101-ALLOC-0007';	
...
sci_orig_security_currency, security_organisation,
cmv, cmv_currency, fsv, fsv_currency
from cms_security where sci_security_dtl_id in ('AB101-ALLOC-0005','AB101-ALLOC-0006','AB101-ALLOC-0007');
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint), 
	...
	CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint),
	'ACTIVE', 'O', 'ARBS', 'N', 'Y'
from cms_security s where sci_security_dtl_id = 'AB101-ALLOC-0006';

insert into cms_charge_detail 
	(charge_detail_id, charge_amount, charge_currency_code, security_rank, charge_type, cms_collateral_id, 
	cms_ref_id, status, prior_charge_type, source_id, is_legal_enforce, caveat_waived_ind)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint), 
	500000000, 'MYR', 3, 'G', s.cms_collateral_id,
	CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint),
	'ACTIVE', 'O', 'ARBS', 'N', 'Y'
from cms_security s where sci_security_dtl_id = 'AB101-ALLOC-0007';
...
and s.sci_security_dtl_id in ('AB101-ALLOC-0005','AB101-ALLOC-0006','AB101-ALLOC-0007');
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB101-ALLOC-0005'), 'AB101-ALLOC-0005',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp , 'I'
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0029', 'FAC-ALLOC-0030');	

insert into cms_limit_security_map
(charge_id, cms_collateral_id, sci_las_sec_id, cms_lsp_appr_lmts_id, sci_las_lmt_id, cms_lsp_lmt_profile_id, 
customer_category,create_date, update_status_ind)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB101-ALLOC-0006'), 'AB101-ALLOC-0006',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp , 'I'
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0031');	
...
customer_category,create_date, update_status_ind)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB101-ALLOC-0007'), 'AB101-ALLOC-0007',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp , 'I'
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0029', 'FAC-ALLOC-0030','FAC-ALLOC-0031');	
...
and s.sci_security_dtl_id in ('AB101-ALLOC-0005')
and lmts.cms_lsp_appr_lmts_id = lsm.cms_lsp_appr_lmts_id
and lmts.los_lmt_id in ('FAC-ALLOC-0029', 'FAC-ALLOC-0030');
...
and s.sci_security_dtl_id in ('AB101-ALLOC-0006')
and lmts.cms_lsp_appr_lmts_id = lsm.cms_lsp_appr_lmts_id
and lmts.los_lmt_id in ('FAC-ALLOC-0031');
...
and s.sci_security_dtl_id in ('AB101-ALLOC-0007')
and lmts.cms_lsp_appr_lmts_id = lsm.cms_lsp_appr_lmts_id
and lmts.los_lmt_id in ('FAC-ALLOC-0029', 'FAC-ALLOC-0030','FAC-ALLOC-0031');
...
from cms_security s
where s.sci_security_dtl_id in ('AB101-ALLOC-0005');
...
from cms_security s
where s.sci_security_dtl_id in ('AB101-ALLOC-0006');
...
from cms_security s
where s.sci_security_dtl_id in ('AB101-ALLOC-0007');
...
from cms_security
where sci_security_dtl_id in ('AB101-ALLOC-0005','AB101-ALLOC-0006','AB101-ALLOC-0007');
...
'37', 'ARBS', 'SIBS-ACT-0035', 'MY', 'N', 'A', 'L', 1, 300000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0036', 'MY', 'N', 'A', 'L', 1, 200000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0037', 'MY', 'N', 'A', 'L', 1, 500000000, 'I');
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	...
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0035'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0029';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0036'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0030';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0037'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0031';
