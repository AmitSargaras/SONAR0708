...
values
(20070101000000 + next value for customer_seq, 'CUST-0002', 'BB Taxi Company', 'BB Taxi Company', 
'56', 'C', 'MY', 'CUST-0002-BUS', '5', '200', 'ARBS', 'C');
...
cms_le_main_profile_id, 'MY', '001', 'N'
from sci_le_main_profile where lmp_le_id = 'CUST-0002';
...
select 20070101000000 + next value for limit_profile_seq, lsp_le_id, lsp_id, 'AA-0002', 'MG-123123-12212',
cms_le_sub_profile_id, 'ACTIVE', 'MY', '001', 'ARBS', 'N', 'BANKING', 'Y', 'Y',
'5', '200', 'MG', 'CON'
from sci_le_sub_profile where lsp_le_id = 'CUST-0002';
...
select 20070101000000 + next value for limit_seq, cms_lsp_lmt_profile_id, 'FAC-0003', '27', 'HL',
'25', 'OUTER', 25000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210'
from sci_lsp_lmt_profile where llp_le_id = 'CUST-0002';
...
cms_limit_status, cms_bkg_country, cms_bkg_organisation, source_id,
lmt_fac_type_num, lmt_fac_type_value)
select 20070101000000 + next value for limit_seq, cms_lsp_lmt_profile_id, 'FAC-0004', '27', 'HS',
...
where lmt_id in ('FAC-0003', 'FAC-0004') ;
...
'--', '--', '--', '-999999999', -999999999, -999999999
from sci_lsp_appr_lmts where lmt_id = 'FAC-0003';
...
cms_lsp_appr_lmts_id, 'ACTIVE', cms_lsp_appr_lmts_id, 0, 1, -999999999, 'SYSTEM_CREATE',
'--', '--', '--', '-999999999', -999999999, -999999999
from sci_lsp_appr_lmts where lmt_id = 'FAC-0004';
...
where cms_lsp_appr_lmts_id in (select cms_lsp_appr_lmts_id
	from sci_lsp_appr_lmts where lmt_id in ('FAC-0003', 'FAC-0004'));
...
select 20070101000000 + next value for collateral_seq, 'AB101', 'AB101-0001', 'MY', subtype_name,
security_type_name, 'AB101', 'AB', 'MYR', 'ACTIVE', 'MYR', '001', 'ARBS', 'Y'
from cms_security_sub_type where security_sub_type_id = 'AB101';

insert into cms_asset (cms_collateral_id)
select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB101-0001';	
...
type_name, sci_security_subtype_value, sci_security_type_value, sci_security_currency, status,
sci_orig_security_currency, security_organisation
from cms_security where sci_security_dtl_id = 'AB101-0001';
...
select 20070101000000 + next value for col_limit_map_seq, 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB101-0001'), 'AB101-0001',
...
type_name, sci_security_subtype_value, sci_security_type_value, sci_security_currency, status,
sci_orig_security_currency, security_organisation, source_id, is_migrated_ind)
select 20070101000000 + next value for collateral_seq, 'GT400', 'GT400-0001', 'MY', subtype_name,
security_type_name, 'GT400', 'GT', 'MYR', 'ACTIVE', 'MYR', '001', 'ARBS', 'Y'
from cms_security_sub_type where security_sub_type_id = 'GT400';

insert into cms_guarantee (cms_collateral_id)
select cms_collateral_id from cms_security where sci_security_dtl_id = 'GT400-0001';	
...
type_name, sci_security_subtype_value, sci_security_type_value, sci_security_currency, status,
sci_orig_security_currency, security_organisation
from cms_security where sci_security_dtl_id = 'GT400-0001';

insert into cms_stage_guarantee (cms_collateral_id)
select cms_collateral_id from cms_security where sci_security_dtl_id = 'GT400-0001';
...
create_date)
select 20070101000000 + next value for col_limit_map_seq, 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'GT400-0001'), 'GT400-0001',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp 
from sci_lsp_appr_lmts where lmt_id = 'FAC-0004';	
...
type_name, sci_security_subtype_value, sci_security_type_value, sci_security_currency, status,
sci_orig_security_currency, security_organisation, source_id, is_migrated_ind)
select 20070101000000 + next value for collateral_seq, 'CS202', 'CS202-0001', 'MY', subtype_name,
security_type_name, 'CS202', 'CS', 'MYR', 'ACTIVE', 'MYR', '001', 'ARBS', 'Y'
from cms_security_sub_type where security_sub_type_id = 'CS202';

insert into cms_cash (cms_collateral_id)
select cms_collateral_id from cms_security where sci_security_dtl_id = 'CS202-0001';	
...
type_name, sci_security_subtype_value, sci_security_type_value, sci_security_currency, status,
sci_orig_security_currency, security_organisation
from cms_security where sci_security_dtl_id = 'CS202-0001';
...
create_date)
select 20070101000000 + next value for col_limit_map_seq, 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'CS202-0001'), 'CS202-0001',
	cms_lsp_appr_lmts_id, lmt_id, cms_limit_profile_id, 'MB', current timestamp 
from sci_lsp_appr_lmts where lmt_id = 'FAC-0003';	
...
from cms_security
where sci_security_dtl_id in ('AB101-0001', 'GT400-0001', 'CS202-0001');
