...
'CUST-ALLOC-0011', 'Simply Blue Product Co.', 'Simply Blue Product Co.', 
'56', 'C', 'MY', 'CUST-ALLOC-0011-BUS', 'ARBS');
...
from sci_le_main_profile where lmp_le_id = 'CUST-ALLOC-0011';
...
lsp_le_id, lsp_id, '80000011', 'ALLOC-AA-0011', cms_le_sub_profile_id, 'ACTIVE', 
'MY', '2', 'ARBS', 'N', 'BANKING', 'Y', 'Y', 'CO', 'CON'
from sci_le_sub_profile where lsp_le_id = 'CUST-ALLOC-0011';
...
where llp_le_id = 'CUST-ALLOC-0011';
...
cms_lsp_lmt_profile_id, '700000020', '27', 'HP',
'25', 'OUTER', 200000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 200000000, '210', 1, 'FAC-ALLOC-0020', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0011';
...
account_type, lmt_bca_ref_num, los_bca_ref_num)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for limit_seq), 2)) AS bigint), 
cms_lsp_lmt_profile_id, '700000021', '27', 'HP',
'25', 'OUTER', 50000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 50000000, '210', 1, 'FAC-ALLOC-0021', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0011';
...
account_type, lmt_bca_ref_num, los_bca_ref_num)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for limit_seq), 2)) AS bigint), 
cms_lsp_lmt_profile_id, '700000022', '27', 'HP',
'25', 'OUTER', 150000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 150000000, '210', 1, 'FAC-ALLOC-0022', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0011';
...
where los_lmt_id in ('FAC-ALLOC-0020','FAC-ALLOC-0021', 'FAC-ALLOC-0022') ;
...
'--', '--', '--', '-999999999', -999999999, -999999999
from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0020','FAC-ALLOC-0021', 'FAC-ALLOC-0022');
...
'AB101', 'AB101-ALLOC-0001', 'AB101-ALLOC-0001', 'MY', subtype_name, security_type_name, 
...
select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB101-ALLOC-0001';	
...
sci_orig_security_currency, security_organisation,
cmv, cmv_currency, fsv, fsv_currency
from cms_security where sci_security_dtl_id = 'AB101-ALLOC-0001';
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint), 
	200000000, 'MYR', 1, 'G', s.cms_collateral_id,
	CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint),
	'ACTIVE', 'O', 'ARBS', 'N', 'Y'
from cms_security s where sci_security_dtl_id = 'AB101-ALLOC-0001';

insert into cms_charge_detail 
	(charge_detail_id, charge_amount, charge_currency_code, security_rank, charge_type, cms_collateral_id, 
	cms_ref_id, status, prior_charge_type, source_id, is_legal_enforce, caveat_waived_ind)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint), 
	150000000, 'MYR', 2, 'S', s.cms_collateral_id,
	CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint),
	'ACTIVE', 'O', 'ARBS', 'N', 'Y'
from cms_security s where sci_security_dtl_id = 'AB101-ALLOC-0001';
...
insert into cms_charge_detail 
	...
	cms_ref_id, status, prior_charge_type, source_id, is_legal_enforce, caveat_waived_ind)
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint), 
	250000000, 'MYR', 3, 'G', s.cms_collateral_id,
	CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint),
	'ACTIVE', 'O', 'ARBS', 'N', 'Y'
from cms_security s where sci_security_dtl_id = 'AB101-ALLOC-0001';
...
and s.sci_security_dtl_id in ('AB101-ALLOC-0001');
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'AB101-ALLOC-0001'), 'AB101-ALLOC-0001',
...
and lmts.los_lmt_id in ('FAC-ALLOC-0020', 'FAC-ALLOC-0021');
...
and s.sci_security_dtl_id in ('AB101-ALLOC-0001')
and lmts.cms_lsp_appr_lmts_id = lsm.cms_lsp_appr_lmts_id
and lmts.los_lmt_id in ('FAC-ALLOC-0022');
...
and s.sci_security_dtl_id in ('AB101-ALLOC-0001')
and lmts.cms_lsp_appr_lmts_id = lsm.cms_lsp_appr_lmts_id
and lmts.los_lmt_id in ('FAC-ALLOC-0020', 'FAC-ALLOC-0021','FAC-ALLOC-0022');
...
from cms_security s
where s.sci_security_dtl_id in ('AB101-ALLOC-0001');
...
from cms_security
where sci_security_dtl_id in ('AB101-ALLOC-0001');
...
'37', 'ARBS', 'SIBS-ACT-0026', 'MY', 'N', 'A', 'L', 1, 200000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0027', 'MY', 'N', 'A', 'L', 1, 50000000, 'I');
...
values
( CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for customer_x_ref_seq), 2)) AS bigint), 
'37', 'ARBS', 'SIBS-ACT-0028', 'MY', 'N', 'A', 'L', 1, 150000000, 'I');
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	...
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0026'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0020';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0027'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0021';
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	(select xref.cms_lsp_sys_xref_id
	from sci_lsp_sys_xref xref
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0028'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0022';
