...
'CUST-ALLOC-0001', 'ABC Technologies Pte Ltd', 'ABC Technologies Pte Ltd', 
'56', 'C', 'MY', 'CUST-ALLOC-0001-BUS', 'ARBS');
...
from sci_le_main_profile where lmp_le_id = 'CUST-ALLOC-0001';
...
lsp_le_id, lsp_id, '80000001', 'ALLOC-AA-0001', cms_le_sub_profile_id, 'ACTIVE', 
'MY', '2', 'ARBS', 'N', 'BANKING', 'Y', 'Y', 'HP', 'CON'
from sci_le_sub_profile where lsp_le_id = 'CUST-ALLOC-0001';
...
where llp_le_id = 'CUST-ALLOC-0001';
...
cms_lsp_lmt_profile_id, '700000001', '27', 'HP',
'25', 'OUTER', 50000000, 'MYR', llp_le_id, llp_lsp_id,
'ACTIVE', cms_orig_country, cms_orig_organisation, 'ARBS',
'26', '210', 40000000, '210', 1, 'FAC-ALLOC-0001', 
'L', llp_bca_ref_num, los_bca_ref_num
from sci_lsp_lmt_profile where llp_le_id = 'CUST-ALLOC-0001';
...
where los_lmt_id in ('FAC-ALLOC-0001') ;
...
'--', '--', '--', '-999999999', -999999999, -999999999
from sci_lsp_appr_lmts where los_lmt_id = 'FAC-ALLOC-0001';
...
where cms_lsp_appr_lmts_id in (select cms_lsp_appr_lmts_id
	from sci_lsp_appr_lmts where los_lmt_id in ('FAC-ALLOC-0001'));
...
'PT700', 'PT700-ALLOC-0001', 'PT700-ALLOC-0001', 'MY', subtype_name, security_type_name, 
...
select cms_collateral_id from cms_security where sci_security_dtl_id = 'PT700-ALLOC-0001';	
...
sci_orig_security_currency, security_organisation,
cmv, cmv_currency, fsv, fsv_currency
from cms_security where sci_security_dtl_id = 'PT700-ALLOC-0001';
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for CMS_CHARGE_DETAIL_SEQ), 2)) AS bigint), 
	...
	'ACTIVE', 'O', 'ARBS', 'N', 'Y'
from cms_security s where sci_security_dtl_id = 'PT700-ALLOC-0001';
...
and s.sci_security_dtl_id in ('PT700-ALLOC-0001');
...
select CAST((TS_FMT(CURRENT_TIMESTAMP, 'yyyymmdd') || SUBSTR(DIGITS(next value for col_limit_map_seq), 2)) AS bigint), 
	(select cms_collateral_id from cms_security where sci_security_dtl_id = 'PT700-ALLOC-0001'), 'PT700-ALLOC-0001',
...
from cms_security s
where s.sci_security_dtl_id in ('PT700-ALLOC-0001');
...
from cms_security
where sci_security_dtl_id in ('PT700-ALLOC-0001');
...
'37', 'ARBS', 'SIBS-ACT-0001', 'MY', 'N', 'A', 'L', 1, 40000000, 'I');
...
lmt.lmt_le_id, lmt.lmt_id, lmt.lmt_lsp_id, lmt.cms_lsp_appr_lmts_id, 'ACTIVE', 
	...
	where xref.lsx_ext_sys_acct_num = 'SIBS-ACT-0001'), 'I'
from sci_lsp_appr_lmts lmt
where los_lmt_id = 'FAC-ALLOC-0001';
