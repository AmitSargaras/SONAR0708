drop table MIG_AB109;

drop table MIG_AB109_ERR;

drop table MIG_CHARGE_AB109;

drop table MIG_CHARGE_AB109_ERR;

drop table MIG_PLEDGOR_AB109;

drop table MIG_PLEDGOR_AB109_ERR;

drop table MIG_VAL_AB109;

drop table MIG_VAL_AB109_ERR;


CREATE TABLE MIG_AB109 (
	CIF_NUMBER VARCHAR(20),
	FAC_DESC VARCHAR(40),
	SOURCE_SECURITY_ID VARCHAR(19) NOT NULL,
	SECURITY_TYPE VARCHAR(40) DEFAULT 'Asset Based',
	SECURITY_SUB_TYPE VARCHAR(80) DEFAULT 'Aircraft',
	SECURITY_TYPE_ID CHAR(2) DEFAULT 'AB',
	SECURITY_SUB_TYPE_ID VARCHAR(5) DEFAULT 'AB109',
...
ALTER TABLE "MIG_AB109" 
	ADD CONSTRAINT "MIG_AB109_U" UNIQUE
		("SOURCE_SECURITY_ID",
		 "REGION");

CREATE TABLE MIG_AB109_ERR LIKE MIG_AB109
	IN "CMS_MIG" INDEX IN "CMS_MIG_INDEX";

ALTER TABLE MIG_AB109_ERR
	ADD DATE    TIMESTAMP;
...
ALTER TABLE "MIG_CHARGE_AB109" 
	ADD CONSTRAINT "MIG_CHARGE_AB109_U" UNIQUE
		("SOURCE_LIMIT_ID",
		 "SOURCE_SECURITY_ID",
		 "SECURITY_RANKING",
		 "REGION");

CREATE TABLE MIG_CHARGE_AB109_ERR LIKE MIG_CHARGE_AB109
	IN "CMS_MIG" INDEX IN "CMS_MIG_INDEX";

ALTER TABLE MIG_CHARGE_AB109_ERR
	ADD DATE    TIMESTAMP;
...
-- PLEDGOR
CREATE TABLE MIG_PLEDGOR_AB109 (
...
ALTER TABLE "MIG_PLEDGOR_AB109" 
	ADD CONSTRAINT "MIG_PGR_AB109_U" UNIQUE
		("CIF_NUMBER",
		 "SOURCE_LIMIT_ID",
		 "SOURCE_SECURITY_ID",
		 "REGION");

CREATE TABLE MIG_PLEDGOR_AB109_ERR LIKE MIG_PLEDGOR_AB109
	IN "CMS_MIG" INDEX IN "CMS_MIG_INDEX";

ALTER TABLE MIG_PLEDGOR_AB109_ERR
	ADD DATE    TIMESTAMP;

ALTER TABLE MIG_PLEDGOR_AB109_ERR
  ADD REASON	CLOB;
  
CREATE TABLE MIG_VAL_AB109 (
	SOURCE_SECURITY_ID VARCHAR(19) NOT NULL,
...
ALTER TABLE "MIG_VAL_AB109" 
	ADD CONSTRAINT "MIG_VAL_AB109_U" UNIQUE
		("SOURCE_SECURITY_ID",
		 "VALUATION_DATE",
		 "VALUATION_OMV",
		 "REGION");

CREATE TABLE MIG_VAL_AB109_ERR LIKE MIG_VAL_AB109
	IN "CMS_MIG" INDEX IN "CMS_MIG_INDEX";

ALTER TABLE MIG_VAL_AB109_ERR
	ADD DATE    TIMESTAMP;
