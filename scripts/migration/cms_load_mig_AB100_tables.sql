drop procedure MIG_RUN_AB100
@

CREATE PROCEDURE MIG_RUN_AB100
	LANGUAGE SQL
BEGIN
	CALL "MIG_LOG_PROC_TIME"('MIG_RUN_AB100', 'MIG', 1);			
	...
	SEC_ENVIRONMENTAL_RISKY_IND, DATE_SEC_CONFIRM_ENV_RISKY, REMARKS_SEC_ENV_RISKY, ASSET_DESC,
 	PHYSICAL_INSPECTION_FREQ_UOM 
 	FROM MIG_AB100
 	where valid_ind = 'Y');
	...
	CALL "MIG_LOG_PROC_TIME"('MIG_RUN_AB100', 'MIG', 0);					
