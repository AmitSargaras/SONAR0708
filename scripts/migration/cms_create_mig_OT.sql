...
drop table MIG_OT_ERR;

drop table MIG_CHARGE_OT;

drop table MIG_CHARGE_OT_ERR;

drop table MIG_PLEDGOR_OT;

drop table MIG_PLEDGOR_OT_ERR;

drop table MIG_VAL_OT;

drop table MIG_VAL_OT_ERR;

CREATE TABLE MIG_OT (
	CIF_NUMBER VARCHAR(20),
	FAC_DESC VARCHAR(40),
	SOURCE_SECURITY_ID VARCHAR(19) NOT NULL,
	SECURITY_TYPE VARCHAR(40) DEFAULT 'Others',
	SECURITY_SUB_TYPE VARCHAR(80),
	SECURITY_TYPE_ID CHAR(2) DEFAULT 'OT',
	...
	SEC_ENVIRONMENTAL_RISKY_IND CHAR(2),
...
ALTER TABLE "MIG_OT" 
	ADD CONSTRAINT "MIG_OT_U" UNIQUE
		("SOURCE_SECURITY_ID", "REGION");

CREATE TABLE MIG_OT_ERR LIKE MIG_OT
	IN "CMS_MIG" INDEX IN "CMS_MIG_INDEX";

ALTER TABLE MIG_OT_ERR
	ADD DATE    TIMESTAMP;
...
ALTER TABLE "MIG_CHARGE_OT" 
	ADD CONSTRAINT "MIG_CHARGE_OT_U" UNIQUE
		("SOURCE_LIMIT_ID",
		 "SOURCE_SECURITY_ID");

CREATE TABLE MIG_CHARGE_OT_ERR LIKE MIG_CHARGE_OT
	IN "CMS_MIG" INDEX IN "CMS_MIG_INDEX";

ALTER TABLE MIG_CHARGE_OT_ERR
	ADD DATE    TIMESTAMP;
...
ALTER TABLE "MIG_PLEDGOR_OT" 
	ADD CONSTRAINT "MIG_PGR_OT_U" UNIQUE
		("CIF_NUMBER",
		 "SOURCE_LIMIT_ID",
		 "SOURCE_SECURITY_ID");

CREATE TABLE MIG_PLEDGOR_OT_ERR LIKE MIG_PLEDGOR_OT
	IN "CMS_MIG" INDEX IN "CMS_MIG_INDEX";

ALTER TABLE MIG_PLEDGOR_OT_ERR
	ADD DATE    TIMESTAMP;
...
ALTER TABLE "MIG_VAL_OT" 
	ADD CONSTRAINT "MIG_VAL_OT_U" UNIQUE
		("SOURCE_SECURITY_ID",
		 "VALUATION_DATE",
		 "VALUATION_OMV");

CREATE TABLE MIG_VAL_OT_ERR LIKE MIG_VAL_OT
	IN "CMS_MIG" INDEX IN "CMS_MIG_INDEX";

ALTER TABLE MIG_VAL_OT_ERR
	ADD DATE    TIMESTAMP;
