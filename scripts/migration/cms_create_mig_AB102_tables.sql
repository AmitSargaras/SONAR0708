drop table MIG_AB102;

drop table MIG_AB102_ERR;

drop table MIG_CHARGE_AB102;

drop table MIG_CHARGE_AB102_ERR;

drop table MIG_PLEDGOR_AB102;

drop table MIG_PLEDGOR_AB102_ERR;

drop table MIG_VAL_AB102;

drop table MIG_VAL_AB102_ERR;


CREATE TABLE MIG_AB102 (
	CIF_NUMBER VARCHAR(20),
	FAC_DESC VARCHAR(40),
	SOURCE_SECURITY_ID VARCHAR(19) NOT NULL,
	SECURITY_TYPE VARCHAR(40) DEFAULT 'Asset Based',
	SECURITY_SUB_TYPE VARCHAR(80) DEFAULT 'Vehicles',
	SECURITY_TYPE_ID CHAR(2) DEFAULT 'AB',
	SECURITY_SUB_TYPE_ID VARCHAR(5) DEFAULT 'AB102',
	...
	YARD VARCHAR(40),
	PREVIOUS_OWNER_NAME VARCHAR(50),
	PREVIOUS_FINANCIER_NAME VARCHAR(50),
	TRANSMISSION_TYPE CHAR(1),
	ENERGY_SOURCE VARCHAR(10),
	HORSE_POWER INT,
	COLOR VARCHAR(10),
	REGISTRATION_NO VARCHAR(35),
	REGISTRATION_FEE DECIMAL(17,2),
...
ALTER TABLE "MIG_AB102" 
	ADD CONSTRAINT "MIG_AB102_U" UNIQUE
		("SOURCE_SECURITY_ID",
		"REGION");
		
CREATE TABLE MIG_AB102_ERR LIKE MIG_AB102
	IN "CMS_MIG" INDEX IN "CMS_MIG_INDEX";

ALTER TABLE MIG_AB102_ERR
	ADD DATE    TIMESTAMP;
...
ALTER TABLE "MIG_CHARGE_AB102" 
	ADD CONSTRAINT "MIG_CHARGE_AB102_U" UNIQUE
		("SOURCE_LIMIT_ID",
		 "SOURCE_SECURITY_ID",
		 "SECURITY_RANKING",
		 "REGION");

CREATE TABLE MIG_CHARGE_AB102_ERR LIKE MIG_CHARGE_AB102
	IN "CMS_MIG" INDEX IN "CMS_MIG_INDEX";

ALTER TABLE MIG_CHARGE_AB102_ERR
	ADD DATE    TIMESTAMP;
...
-- PLEDGOR
CREATE TABLE MIG_PLEDGOR_AB102 (
...
ALTER TABLE "MIG_PLEDGOR_AB102" 
	ADD CONSTRAINT "MIG_PGR_AB102_U" UNIQUE
		("CIF_NUMBER",
		 "SOURCE_LIMIT_ID",
		 "SOURCE_SECURITY_ID",
		 "REGION");

CREATE TABLE MIG_PLEDGOR_AB102_ERR LIKE MIG_PLEDGOR_AB102
	IN "CMS_MIG" INDEX IN "CMS_MIG_INDEX";

ALTER TABLE MIG_PLEDGOR_AB102_ERR
	ADD DATE    TIMESTAMP;

ALTER TABLE MIG_PLEDGOR_AB102_ERR
  ADD REASON	CLOB;
  
CREATE TABLE MIG_VAL_AB102 (
	SOURCE_SECURITY_ID VARCHAR(19) NOT NULL,
...
ALTER TABLE "MIG_VAL_AB102" 
	ADD CONSTRAINT "MIG_VAL_AB102_U" UNIQUE
		("SOURCE_SECURITY_ID",
		 "VALUATION_DATE",
		 "VALUATION_OMV",
		 "REGION");

CREATE TABLE MIG_VAL_AB102_ERR LIKE MIG_VAL_AB102
	IN "CMS_MIG" INDEX IN "CMS_MIG_INDEX";

ALTER TABLE MIG_VAL_AB102_ERR
	ADD DATE    TIMESTAMP;
