drop procedure dc_validate_ot
@

create procedure dc_validate_ot 
	language sql
begin
	...
	set v_insert_ind = 'insert into dc_error_log '||
		...
		'select current_timestamp, ''DC-ARBS'', ''DC_OT-''||REGION, CMS_COLLATERAL_ID, '||
