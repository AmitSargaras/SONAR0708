...
<%
     ...
     * $Header: /home/cms2/cvsroot/cms2/public_html/bfl/issue_draft_bfl.jsp,v 1.22 2006/10/27 08:10:27 hmbao Exp $
...
<html:form  action="Bfl.do?event=issue_draft_bfl">
	...
	if(event_from.equals("issue_draft_bfl"))
		rs = (HashMap) request.getAttribute("infoMap");
	else
	rs = (HashMap) request.getAttribute("infoMap_issue_draft_bfl");
						...
						<td colspan="3" valign="top" style="height:100%;width:100%;">
							...
							<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:10px" dwcopytype="CopyTableRow">
								...
								<thead>
									<tr>
										<td>
											<h3><bean:message key="label.bfl.issue.draft.status"/><br /></h3>
										</td>
									</tr>
									<tr>
										<td>
										...
										<table  width="100%" border="0" cellpadding="0" cellspacing="0" class="tblinfo" style="margin-top:0">
											<thead>
												<tr>
													...
													<td width="25%"><bean:message key="label.bfl.last.draft.issue.date"/></td>
											...
											<tbody>
												...
												{ %>
													<tr class="<%=rowClass%>">
														<td align="right" colspan="3"><bean:message key="label.bfl.draft.none"/></td>
													</tr>
												<%
												} %>
											</tbody>
...
%>
								...
								<h5 align="center">
									<bean:message key="label.bfl.draft.msg"/>
								</h5>
								...
								<table width="140" border="0" align="center" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td></td>
										<td><input type="button" name="Submit" value="Update Time Stamp" style="width:120px"  class="btnNormal" onclick="gotopage('Bfl.do?event=confirm_issue_draft_bfl')"/></td>
										<td>&nbsp;&nbsp;&nbsp;</td><td>&nbsp;</td>
									</tr>
									<tr>
										<td>&nbsp;</td>
