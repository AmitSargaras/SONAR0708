...
<%@ page import="java.util.ArrayList,
                 ...
                 com.integrosys.cms.ui.facmaster.FacilityMasterForm"%>
...
//    }
    ...
    if(isABCheck){
	    dynamicPropertySetupList = (IDynamicPropertySetup[]) session.getAttribute("com.integrosys.cms.ui.facmaster.FacilityMasterAction.dynamicPropertySetupList");
...
function addNew(){
    document.forms[0].event.value="add_facility_master";
...
function getRecList(){
	...
	document.forms[0].action="DocFacilityMaster.do?event=edit_template_item&go=Y&facDocCode="+facDocCode+"&facDocDesc="+facDocDesc+"&facDocTenureCount="+facDocTenureCount+"&facDocTenureType="+facDocTenureType;
    document.forms[0].submit();
}
...
function submitPage1() {
	...
	if(document.forms[0].subFlag.value=="1") {
		document.forms[0].action="DocFacilityMaster.do?event="+document.forms[0].event.value+"&facilityCategory="+formObj.facilityCategory.value+"&facilityType="+formObj.facilityType.value+"&system="+formObj.system.value;
		document.forms[0].submit();
	}else{
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:10px">
 ...
 <tr>
  ...
  <tr><td class="fieldname" >Facility Category</td>
                        <%-- <td>
                        <html:select   name="DocFacilityMasterForm"   property="facilityCategory" styleId="facCategory">
                        ...
                        <%} %> 
                       				                    ...
                       				                    <html:errors property="facilitycategoryerror"/>
                        </td> --%>
                        <td><input name="DocFacilityMasterForm" id="facCategory" property="facilityCategory" value="<%=category%>" readOnly/>
                        </td>
...
<<html:option value=""> Please Select </html:option>
                        ...
                        <html:errors property="facilitytypeerror"/>
                        </td> --%>
                        <td><input name="DocFacilityMasterForm" id="facType" property="facilityType" value="<%=type%>" readOnly/>
                        </td>
                        </tr>
                         ...
                         <html:option value="">-- Please Select --</html:option>
                           <html:options collection="systemList" labelProperty="label" property="value"  />
                            <%} %> 
											   ...
											   <html:errors property="systemfacerror"/>
                        </td> --%>
                        
                        <td><input name="DocFacilityMasterForm" id="facSys" property="system" value="<%=system%>" readOnly/>
                        </td>
...
<TR><TD colSpan=4 width="100%">&nbsp;</TD></TR>
 ...
 <!-- <TR><TD colSpan=4 width="100%">Please enter search criteria</TD></TR> -->
    ...
    <%-- <tr>
      <td> <h3><%=ss%>  ( <bean:write name="DocFacilityMasterForm" property="subTypeDesc"/> )</h3></td> --%>
