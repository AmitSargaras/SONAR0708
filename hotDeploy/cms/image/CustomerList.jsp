...
<%
    ...
    ImageUploadForm aForm;
    
    aForm = (ImageUploadForm) request.getAttribute("ImageUploadForm");
    
    if (aForm == null) {
    	System.out.println("Aform is null");
    	aForm = (ImageUploadForm) request.getAttribute("CustodianSearchForm");
    }
    
    System.out.println("aForm.getcustomername="+aForm.getCustomerName());
    System.out.println("aForm.getcategory="+aForm.getCategory());
    System.out.println("aForm.getstatementDoc="+aForm.getStatementDocName());
    System.out.println("aForm.getfromamount="+aForm.getFromAmount());
    ...
    SearchResult sresult=(SearchResult)session.getAttribute("com.integrosys.cms.ui.image.ImageUploadAction.customerList");
...
<%@page import="com.integrosys.cms.ui.image.ImageUploadForm"%><html>
<head>
...
<!--
    ...
    function submitForm(){
		...
		if(isadded){
			formObj = document.forms["ImageUploadForm"];
...
<html:hidden name="ImageUploadForm" property="documentDateType" />
    <html:hidden name="ImageUploadForm" property="statementDocName" />
    <html:hidden name="ImageUploadForm" property="othersDocsName" />
    <html:hidden name="ImageUploadForm" property="camDocName" />
    <html:hidden name="ImageUploadForm" property="docNamed" />
    <html:hidden name="ImageUploadForm" property="fromDateDoc" />
   	<html:hidden name="ImageUploadForm" property="toDatedoc" />
   	<html:hidden name="ImageUploadForm" property="fromAmount" />
	<html:hidden name="ImageUploadForm" property="toAmount" />
	<html:hidden name="ImageUploadForm" property="category" />
	<html:hidden name="ImageUploadForm" property="facilityDocName" />
    <html:hidden name="ImageUploadForm" property="securityDocName" />
...
<!--                  <input type="checkbox" name="itemID" value="<%=sno%>" />-->
 ...
 <!-- End Content -->
   ...
   <!-- General Purpose Bar -->
        <% String alphaURL="/ImageUpload.do?event=list&startIndex=";%>
<tr>
<td height="25">
			<table  id="generalPurposeBar" width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td valign="middle" align="right"  >
                         ...
                         <integro:pageindex pageIndex='<%=new PageIndex(aForm.getStartIndex(),records_per_page,aForm.getNumItems())%>' url='<%="ImageUpload.do?event=list&fromPage=pagination&startIndex="%>' submitFlag='<%=new Boolean(false)%>'/>
                        </td>
                      </tr>
               </table>
</td>
