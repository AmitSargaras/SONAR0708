 ...
 * $Header: /home/cms2/cvsroot/cms2/public_html/seccoltask/no_task.jsp,v 1.6 2006/10/27 08:47:18 hmbao Exp $
 * @author $Author: hmbao $<br>
 * @version $Revision: 1.6 $
 * @since $Date: 2006/10/27 08:47:18 $
 * Tag: $Name:  $
 */
 -->
...
<table width="50%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:30px">
  <thead>
    <tr> 
      <td><h3>Security Collaboration Task Information
          <hr/>
        </h3></td>
    </tr>
  </thead>
