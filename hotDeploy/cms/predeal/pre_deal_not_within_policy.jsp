...
<%
	...
	boolean editRejected = PreDealConstants.EVENT_MAKER_SUBMIT_UPDATE_REJECT.equals ( request.getAttribute ( PreDealConstants.NEXT_EVENT ) ) ;
								...
								<tr>
									<td height="111" class="odd" style="text-align:center">
										...
										<STRONG>
											...
											Your ear-marking has exceeded the bank's policy for counter's concentration cap limit.

											<br />

											Click "Submit" to proceed for wavier approval or "Cancel" to go back to previous screen.
