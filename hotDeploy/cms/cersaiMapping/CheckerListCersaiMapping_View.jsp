...
//ICersaiMapping[] masterValueList1 = (ICersaiMapping[])request.getAttribute("masterValueList");
...
//int st=0;
//if(startIndex !=null){
//	st=Integer.parseInt(startIndex);
//}
...
function MM_swapImgRestore() { //v3.0
	...
	function generateMasterValueList(dropdown) {
		...
		if (curSel != "") {
			document.forms[0].action = "cersaiMapping.do?event=checker_list_cersai_mapping_on_select_master";
			document.forms[0].submit();
		}
	}
...
<!--                         <strong>Access Country:</strong>-->
                  ...
                  <tbody>
                    <tr class=<%=rowClass%>>
                      ...
                      if(counter%2 == 0){
                      %>
                      <input value="<%=OB.getClimsValue()%>" style="width:430px;background-color:#E0E6E9;color:black;border-color:transparent;text-shadow: 0 0 0 #000000;" name="updatedClimsValue" id="readClimsValue<%=counter%>" disabled/><input type="hidden" name="climsValues" value="<%=OB.getClimsValue()%>" />  
                      <%} else{ %>
                      <input value="<%=OB.getClimsValue()%>" style="width:430px;background-color:white;color:black;border-color:transparent;text-shadow: 0 0 0 #000000;" name="updatedClimsValue" id="readClimsValue<%=counter%>" disabled/><input type="hidden" name="climsValues" value="<%=OB.getClimsValue()%>" /> 
                      <%} %>
                      </td>
                      <td width="40%">
                       <%
                      if(counter%2 == 0){
                      %>
                <input name="updatedCersaiValue" value="<%=OB.getCersaiValue()%>" style="width:430px;background-color:#E0E6E9;color:black;border-color:transparent;text-shadow: 0 0 0 #000000;"  id="editCersaiValue<%=counter%>" style="width:370px;" disabled/>
            	<%} else{ %>
            	<input name="updatedCersaiValue" value="<%=OB.getCersaiValue()%>" style="width:430px;background-color:white;color:black;border-color:transparent;text-shadow: 0 0 0 #000000;"  id="editCersaiValue<%=counter%>" style="width:370px;" disabled/>
            	<%} %>
            </td>  
					            ...
					            <tr>
					                <td valign="middle">
					                    <integro:pageindex
					                            ...
					                            url="cersaiMapping.do?event=checker_list_pagination_view&startIndex="/>
					                </td>
					            </tr>
					        </table>
					    </td>
