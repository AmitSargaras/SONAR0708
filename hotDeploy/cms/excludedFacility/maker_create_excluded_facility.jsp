...
function submitForm() {
 	document.forms[0].action="excludedfacility.do?event=maker_create_excluded_facility_category";
    document.forms[0].submit();
}

function saveForm() {
	
 	document.forms[0].action="excludedfacility.do?event=maker_draft_excluded_facility_category";
    document.forms[0].submit();
}
...
<html:form action="/excludedfacility" >
<body >
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
  <tr>
      <td><h3>Excluded Facility Category - Add New</h3></td>
  </tr>
  <tr>
    <td><hr/></td>
  </tr>
  ...
  <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput" id="choiceTable">
          ...
          <tbody>
				...
				<%-- <html:hidden name="ExcludedFacilityForm" property="actualExcludedfacilityCategoryCode" styleId="actualCode" />
                <html:hidden name="ExcludedFacilityForm" property="excludedfacilityCategory"  /> --%>
                ...
                <html:hidden name="ExcludedFacilityForm" property="createBy"/>
     			...
     			<html:hidden name="ExcludedFacilityForm" property="deprecated" value="N"/>
