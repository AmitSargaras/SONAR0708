...
function submitPage(event) {
	...
	if(event=="maker_draft_close_process")
		...
		document.forms[0].action="excludedfacility.do?event=maker_confirm_draft_close";
		
    }else{
      
    	document.forms[0].action="excludedfacility.do?event=maker_confirm_close";
    }
			...
			<table width="80%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<tr>
						<td>
							<h3>
								Excluded Facility Category - Close 
							</h3>
						</td>
					</tr>
					<tr>
