...
function submitForm(event) {
	...
	if(event=="maker_prepare_resubmit_create")
		...
		document.forms[0].action="excludedfacility.do?event=maker_confirm_resubmit_create";
		
    }else{
      
    	document.forms[0].action="excludedfacility.do?event=maker_edit_excluded_facility_category";
    }
