...
<%@page import="com.integrosys.cms.app.excludedfacility.trx.IExcludedFacilityTrxValue"%><html><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
function submitForm(event) {
		document.forms[0].action="excludedfacility.do?event=maker_save_update";
	    document.forms[0].submit();
}
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <tr>
   <%if((event.equals("maker_prepare_resubmit_create"))){%>
                    <td><h3>Excluded Facility Category</h3></td>
                    <%}else{ %>
