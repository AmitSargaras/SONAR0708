...
function showDebug(bShow) {
 if (debugWindow == null) {
  debugWindow = new Window('debug_window', {className: 'dialog',width:480, height:320, top:20, left:20, zIndex:1000, opacity:1, showEffect: Element.show, resizable: true, title: "Debug"})
