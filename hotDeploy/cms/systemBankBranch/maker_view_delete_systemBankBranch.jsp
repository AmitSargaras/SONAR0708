...
if(ind!=null && (!ind.equals("")))
	...
	String rejectEvent;
	if (event.equals("checker_view_systemBankBranch")) {
		rejectEvent = "checker_view_systemBank";
	} else {
		rejectEvent = "maker_view_systemBank";
	}
	int sno = 0;
...
<%@page import="com.integrosys.cms.app.systemBankBranch.trx.ISystemBankBranchTrxValue"%><html><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
function cancelPage(){
    document.forms[0].action="systemBank.do?event=<%=rejectEvent%>&bankCode=<%= systemBankBranchForm.getSystemBankId()%>";
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <br>
  <tr>
      <td><h3>View System Bank Branch</h3></td>
  </tr>
  <tr>
    <td><hr/></td>
  </tr>
            ...
            <tr class="odd">
              ...
              <td width="30%"><integro:empty-if-null value="<%=systemBankBranchForm.getCustodian2()%>"/>&nbsp;</td>
											...
											<tr class="even">
												...
												<td><%=systemBankBranchTrx.getSystemBankBranch().getCountry().getCountryName()%>&nbsp;
												</td>
											</tr>
											<tr class="odd">
											<td class="fieldname">
												...
												<td><%=systemBankBranchTrx.getSystemBankBranch().getRegion().getRegionName()%>&nbsp;
												</td>
												<td class="fieldname">
													State
												</td>
												<td><%=systemBankBranchTrx.getSystemBankBranch().getState().getStateName()%>&nbsp;
												</td>
											...
											<tr class="even">
												...
												<td><%=systemBankBranchTrx.getSystemBankBranch().getCityTown().getCityName()%>&nbsp;
												</td>
												<td class="fieldname">
													Pincode
												</td>
