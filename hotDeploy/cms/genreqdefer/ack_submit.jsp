<%@ page import="com.integrosys.base.businfra.transaction.ITrxResult,
...
<body onload="MM_preloadImages('img/printDeferral1.gif')">
  ...
  <tbody>
    <tr>
      <td><table width="100%" border="0" cellpadding="10" cellspacing="0" class="tblInfo">
          ...
          <tbody>
            <tr>
              <td height="111" class="odd" style="text-align:center">Your transaction
...
<table width="100" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img/printDeferral2.gif',1)"><img src="img/printDeferral1.gif" name="Image1" border="0" id="Image1" onclick="MM_openBrWindow('GenerateReqDefer.do?event=print_doc','','scrollbars=yes,toolbar=yes,menubar=yes,resizable=yes,width=760,height=450,left=5,top=5')"/></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
