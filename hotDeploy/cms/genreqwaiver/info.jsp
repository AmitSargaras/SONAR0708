 ...
 * $Header: /home/cms2/cvsroot/cms2/public_html/genreqwaiver/info.jsp,v 1.5 2006/10/27 08:46:08 hmbao Exp $
 * @author $Author: hmbao $<br>
 * @version $Revision: 1.5 $
 * @since $Date: 2006/10/27 08:46:08 $
 * Tag: $Name:  $
 */
 -->
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:30px">
  <thead>
    <tr>
      <td><h3>Request For Waiver Information
          <hr/>
        </h3></td>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td><table width="100%" border="0" cellpadding="10" cellspacing="0" class="tblInfo">
          ...
          <tbody>
            <tr>
    <%       if (ICMSErrorCodes.WAIVER_NOT_REQUIRED.equals(errCode))
	         {
    %>
                  ...
                  <tbody>
                    ...
                    <tr class="odd"> 
                      <td colspan="2" style="border right left top bottom:none">The 
                        Request for Waiver is not accessible due to one of the 
                    ...
                    <tr class="odd"> 
                      ...
                      <td style="border right left top bottom:none">There are 
                        no document items requested for waiver or </td>
                    </tr>
                    <tr class="odd"> 
                    ...
                    <tr class="odd"> 
                      ...
                      <td style="border right left top bottom:none">One or more 
                        ...
                        sent for Request for Waiver. Please ensure that the Request 
                        for Waiver is approved before proceeding. </td>
                    </tr>
                    <tr class="odd"> 
                      <td style="border right left top bottom:none">&nbsp;</td>
                      <td style="border right left top bottom:none">&nbsp;</td>
