...
List leiDetailsList =(List) session.getAttribute("com.integrosys.cms.app.leiDetailsUpload.LeiDetailsUploadAction.List");
...
function submitPage(){
    ...
    document.forms[0].action="leidetailsupload.do?event=maker_close_leidetails_file";
