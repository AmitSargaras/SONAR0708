<%@ page import="java.util.ArrayList,
                 ...
                 java.util.HashMap,
                 com.integrosys.cms.app.chktemplate.bus.OBTemplate,
...
//        System.out.println("Array Length staging"+itemTrxVal.getStagingTemplate().getTemplateItemList().length);
...
//	ArrayList result = res.getResultOBList();
//    ArrayList test1 = new ArrayList();
//    HashMap resultMap = res.getoBOperationMap();
/*
    ArrayList newList = new ArrayList();*/
    for (int i = 0; i < list.size(); i++) {
        CompareResult temp = (CompareResult) list.get(i);
//        System.out.println("Status ---"+temp.getObj());
//        System.out.println("Status key ---"+temp.getKey());
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3><%=colType%> (<%=subType%>) - <%=cName%></h3></td>
...
//    System.out.println(" I D S _ _ _ >"+OB.getTemplateItemID());
    String rowClass="";
    row++;
    if(row%2!=0){
       rowClass="odd";
