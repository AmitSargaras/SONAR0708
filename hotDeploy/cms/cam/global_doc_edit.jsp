...
<table class="tblFormSection" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3>Global CAM Document Template - Edit</h3></td>
    </tr>
    <tr>
      <td><hr/></td>
    </tr>
      ...
      <td> <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
            ...
            <tr class="even">
              ...
              <td>
                <bean:write name="CAMGlobalForm" scope="request" property="itemCode" />
...
<!--				<td><html:radio name="CAMGlobalForm" property="isPreApprove" value="Y" />Yes -->
<!--				<html:radio name="CAMGlobalForm" property="isPreApprove" value="N" />No</td>-->
<!--			</tr>-->
...
<table width="150"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td width="100" valign="baseline" align="center"> <a href="#"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3311','','img/submit2.gif',1)" 
    	onClick="<%=(docCodeNonUnique.booleanValue()) ? "javascript: alert('There is already an existing document with the same code [" + aForm.getItemCode() + "]. \\nPlease close the transaction.')" : "submitPage()"%>" ><img src="img/submit1.gif" name="Image3311"  border="0" id="Image3311" /></a></td>
                        ...
                        <% } else {%>
                        <a href="CAMGlobal.do?event=global_list&type=CAM&go=N&startIndex=<%=startIndex %>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image4411"  border="0" id="Image4411" /></a>
                        <% } %>
                        </td>
                      </tr>
                      <tr>
