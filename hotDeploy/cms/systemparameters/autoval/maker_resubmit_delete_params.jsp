...
*
* Describe this JSP.
* Purpose: For Maker to delete existing Auto Valuation Parameters
* Description: delete the existing Auto Valuation Parameters
*
* @author $Author:$<br>
* @version $Revision:$
* Date: $Date:$
...
<%
    ...
    if(event.equals("maker_prepare_resubmit_delete")){
        ...
        cancelEvent="ToDo.do";
//        headingLable="Re Process - Delete ";
        isRemarkNeeded = true;
    }else if(event.equals("maker_prepare_delete")){
        submitEvent="maker_confirm_delete";
        cancelEvent="AutoValParam.do?event=auto_val_param_list";
        headingLable="Delete ";
    }
