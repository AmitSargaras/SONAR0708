...
<%@ page import="com.integrosys.cms.app.commoncodeentry.trx.CommonCodeEntryApproveOperation"%>
<%@ page import="com.integrosys.cms.app.commoncodeentry.trx.ICommonCodeEntriesTrxValue"%>

<%@ page import="com.integrosys.cms.app.commoncodeentry.bus.ICommonCodeEntries"%>
<%@ page import="com.integrosys.cms.app.commoncodeentry.bus.OBCommonCodeEntry"%>
...
<%
		...
		if (request.getAttribute("request.ITrxValue") instanceof ICommonCodeEntriesTrxValue)
		{
			DefaultLogger.debug(this, "	----- found an instance of ICommonCodeEntriesTrxValue");
			
			ICommonCodeEntriesTrxValue trxValue = (ICommonCodeEntriesTrxValue)request.getAttribute("request.ITrxValue");

			//DefaultLogger.debug(this, "getStagingCommonCodeEntries: " + trxValue.getStagingCommonCodeEntries());
			//DefaultLogger.debug(this, "getCommonCodeEntriesList: " + trxValue.getCommonCodeEntriesList());
			//DefaultLogger.debug(this, "getCommonCodeEntries: " + trxValue.getCommonCodeEntries());

			CommonCodeEntryApproveOperation tempCommonCodeEntry = new CommonCodeEntryApproveOperation();			
			String categoryCode = tempCommonCodeEntry.getCommonCategoryCodeAfterApproved(trxValue).trim();
			tempCommonCodeEntry = null;
			
			DefaultLogger.debug(this, "	----- refreshing Category Code: '" + categoryCode + "'");
