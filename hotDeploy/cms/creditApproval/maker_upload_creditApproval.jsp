...
function submitForm() {
 	document.forms[0].action="credit_approval.do?event=maker_event_upload_creditApproval";
    document.forms[0].submit();
}
...
<html:form action="/credit_approval" enctype="multipart/form-data">
