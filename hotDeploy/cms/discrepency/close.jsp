...
String dafaultRecDate= df.format(new Date());
...
<%@page import="java.text.DateFormat"%><html><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function saveForm() {
        	...
        	document.forms["DiscrepencyForm"].action = "Discrepency.do?event=maker_edit_discrepency_close&searchstatus=<%=searchstatus%>&discType=<%=discType %>";
...
<%
	...
	String otdDate="";
	if(discrepencyTrx.getActualDiscrepency().getOriginalTargetDate()!=null){
	 otdDate=df.format(discrepencyTrx.getActualDiscrepency().getOriginalTargetDate());
	}
...
%>
 ...
 <script language="JavaScript" type="text/JavaScript">
        ...
        function setDifferenceBetDate() {
         	   ...
         	   var user_date = document.forms[0].nextDueDate1.value;
...
<td >&nbsp;</td>
 ...
 <input type="hidden" id="otd" value="<%=otdDate %>"/>
      <input type="hidden" id="creationDate" value="<%=creationDate %>"/>
       <input type="hidden" id="nextDueDate1" value="<%=nextDueDate %>"/>
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
    <thead>
    
     <%if(discrepencyTrx.getActualDiscrepency().getStatus().equals("DEFERED")) {%>
        <td><h3>Close Deferred Discrepancy Doc  </h3></td>
        <%}else{ %>
        <td><h3>Close Discrepancy Doc  </h3></td>
        <%} %>
    ...
    <tbody>
        <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
                ...
                <tr class="even">
                    ...
                    <tr class="odd">
										...
										<tr class="even">
											...
											<%if(discrepencyTrx.getActualDiscrepency().getStatus().equals("DEFERED")){ %>
										<tr class="even">
											<td class="fieldname" >Deferred Date</td>
											<td class="even" >
               ...
               originalDeferedDaysCal();
                    ...
                    <tr class="even">
                        ...
                        <html:text property="recDate" size="12" maxlength="12" readonly="true"  value="<%=dafaultRecDate %>" />
                        <%}else{ %>
                        <html:text property="recDate" size="12" maxlength="12" readonly="true"  />
                        <%} %>
                            <img src="img/calendara.gif" name="Image11" border="0" id="Image1" onclick="return showCalendar('recDate', 'dd/mm/y');"
                                 ...
                                 <html:errors property="recDateError"/>
                        </td>
                    </tr>
                    <%if(discrepencyTrx.getActualDiscrepency().getStatus().equals("DEFERED")){ %>
                    <tr class="odd">
         ...
         <html:hidden property="deferedCounter"/>
