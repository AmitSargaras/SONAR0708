...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function saveForm() {
        	...
        	document.forms["DiscrepencyForm"].action = "Discrepency.do?event=maker_submit_close_discrepancy&searchstatus=<%=searchstatus%>&discType=<%=discType %>&customerID=<%=customerID %>&startIndex=<%=startIndex%>";
