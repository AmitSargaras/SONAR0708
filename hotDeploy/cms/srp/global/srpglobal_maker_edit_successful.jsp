...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection" style="margin-top:30px">
  <thead>
    <tr> 
      <td><h3>Confirmation 
          <hr/>
  ...
  <tbody>
    <tr> 
      <td><table width="100%" border="0" cellpadding="10" cellspacing="0" class="tblInfo">
          ...
          <tbody>
            <tr> 
              <td height="111" class="odd" style="text-align:center">Your information 
