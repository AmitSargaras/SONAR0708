 ...
 * $Header: /home/cms2/cvsroot/cms2/public_html/genscc/ack_approve.jsp,v 1.3 2006/10/27 08:46:16 hmbao Exp $
 * @author $Author: hmbao $<br>
 * @version $Revision: 1.3 $
 * @since $Date: 2006/10/27 08:46:16 $
 * Tag: $Name:  $
 */
 -->
...
<table width="100" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img/printSCC1.gif',1)"><img src="img/printSCC1.gif" name="Image1" width="90" height="22" border="0" id="Image1" onclick="MM_openBrWindow('GenerateSCC.do?event=print_doc','','scrollbars=yes,toolbar=yes,menubar=yes,resizable=yes,width=760,height=400,left=5,top=5')"/></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
