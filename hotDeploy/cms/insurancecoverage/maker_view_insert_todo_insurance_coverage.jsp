								...
								<tr>
									...
									<%
										...
										String alphaIndexUrl = null;
												pageIndexUrl = "InsuranceCoverage.do?event=maker_rejected_delete_read&TrxId="+transId+"&startIndex=";
												alphaIndexUrl = "InsuranceCoverage.do?event=maker_rejected_delete_read&TrxId="+transId+"&loginId=";
