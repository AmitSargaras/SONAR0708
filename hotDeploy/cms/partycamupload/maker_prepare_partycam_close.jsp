...
List partyCamList =(List) session.getAttribute("com.integrosys.cms.ui.partycamupload.PartyCamUploadAction.List");;
...
function submitPage(){
    ...
    document.forms[0].action="Partycamupload.do?event=maker_close_partycam_file";
