<%@ page import="java.util.*,com.integrosys.cms.ui.collateral.CategoryCodeConstant,java.util.List,java.util.ArrayList,com.integrosys.base.techinfra.util.DateUtil,com.integrosys.cms.ui.common.CommonCodeList,
				 java.util.ArrayList,
...
<%
    OBDocumentItemTrxValue trxVal = (com.integrosys.cms.app.chktemplate.trx.OBDocumentItemTrxValue) session.getAttribute("com.integrosys.cms.ui.ccglobal.CCGlobalAction.docTrxObj");
...
<table class="tblFormSection" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px">
  <thead>
    <tr>
      <td> <h3>Global Constitutional / Contractual Document Template - View</h3></td>
    </tr>
    <tr>
      <td><hr/></td>
    </tr>
      ...
      <td> <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
            <tr class="even">
              ...
              <td>&nbsp;<bean:write name="CCGlobalForm" scope="request" property="itemCode" />&nbsp;<br /><html:errors property="itemCode" /></td>
            </tr>
            <tr class="odd">
              <td class="fieldname">Document Description&nbsp;<font color="#0000FF">* </font></td>
              <td>&nbsp;<bean:write name="CCGlobalForm" scope="request" property="itemDesc" /></td>
            </tr>
			<tr class="even">
				<td class="fieldname">Document Version</td>
				<td>&nbsp;<bean:write name="CCGlobalForm" scope="request" property="docVersion" /></td>
			</tr>
            <tr class="odd">
              <td class="fieldname">Expiry Date</td>
              <td>&nbsp;<bean:write name="CCGlobalForm" scope="request" property="expDate" /> </td>
            </tr>
			<tr class="even">
			<td class="fieldname"><bean:message key="label.cc.checklist.application.type"/></td>
				<bean:define id="appType" name="CCGlobalForm" property="loanApplicationType" type="java.lang.String" />
				<td>
			 <select id="loanApplicationTypeAvail" name="loanApplicationTypeAvail" size="10" multiple="multiple" style="width:260">
				...
				<!-- &nbsp;<integro:common-code display="true" categoryCode="APPLICATION_CODE_CC" descWithCode="false" entryCode="<%=appType%>"/> -->
				</td>
			</tr>
            <tr class="odd">
				<td class="fieldname">Type&nbsp;<font color="#0000FF">* </font></td>
				<td>
				<html:checkbox name ="CCGlobalForm" property="isForBorrower" value= "isBorrower" disabled="true"/>Borrower
	            <html:checkbox name ="CCGlobalForm" property="isForPledgor" value= "isPledgor" disabled="true"/>Chargor/Pledgor/Guarantor
	            </td>
			</tr>
			<tr class="even">
				<td class="fieldname">Pre-Approval Document&nbsp;<font color="#0000FF">* </font></td>
				<td>
				<html:radio name ="CCGlobalForm" property="isPreApprove" value= "Y" disabled="true"/>Yes
	        	<html:radio name ="CCGlobalForm" property="isPreApprove" value= "N" disabled="true"/>No
	            </td>
			</tr>
          </tbody>
        </table></td>
...
<table width="100"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <%if(!toTrack && close) { %>
    <a href="CCGlobal.do?event=close_doc_item" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/close2a.gif',1)"><img src="img/close1a.gif" name="Image4411"  border="0" id="Image4411" /></a>&nbsp;&nbsp;&nbsp;<a href="ToDo.do" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image4411"  border="0" id="Image4411" /></a>
    <%}else if(toTrack){%>
    ...
    <%}else{%>
        <a href="CCGlobal.do?event=global_list&type=CC&startIndex=<%=startIndex %>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4411"  border="0" id="Image4411" /></a>
    <%}%>
    </td>
  </tr>
  <tr>
