...
* $Header: /home/cms2/cvsroot/cms2/public_html/commoditydeal/commoditydoc/titledoc/chk_view_title_doc.jsp,v 1.19 2006/10/27 08:39:09 hmbao Exp $
*
...
<%
    ...
    ICommodityTitleDocument actual = (ICommodityTitleDocument)request.getAttribute("actualTitleDoc");
    ICommodityTitleDocument staging = (ICommodityTitleDocument)request.getAttribute("stageTitleDoc");
%>
<html>
  ...
  <tbody>
    <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
        <tbody>
        <tr class="even">
          <td width="44%" class="<%=CompareOBUtil.compOB(staging, actual, "processStageCode")?"fieldname":"fieldnamediff"%>">Process Stage&nbsp;<font color="#0000FF">* </font></td>
          <td width="56%"><integro:empty-if-null value="<%=ProcessStageList.getInstance().getProcessStageItem(aForm.getProcessStage())%>"/>&nbsp;</td>
        </tr>
        <%
            ITitleDocument actualTitleDoc = null;
            ITitleDocument stageTitleDoc = null;
            if (actual != null) {
                actualTitleDoc = actual.getTitleDocType();
            }
            if (staging != null) {
                stageTitleDoc = staging.getTitleDocType();
            }
        ...
        %>
        <tr class="odd">
          <td width="44%" class="<%=CompareOBUtil.compOB(stageTitleDoc, actualTitleDoc, "type")?"fieldname":"fieldnamediff"%>">Documentation Type</td>
          <td width="56%"><integro:empty-if-null value="<%=strDocType%>"/>&nbsp;</td>
        </tr>
        <tr class="even">
          <td width="44%" class="<%=CompareOBUtil.compOB(stageTitleDoc, actualTitleDoc, "titleDocumentID")?"fieldname":"fieldnamediff"%>">Documentation Description&nbsp;<font color="#0000FF">* </font></td>
          <td width="56%"><bean:write name="TitleDocForm" property="docDesc"/>&nbsp;</td>
        </tr>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "advEligibilityPct")?"fieldname":"fieldnamediff"%>" width="44%">Eligibility of Advance</td>
          <td width="56%"><bean:write name="TitleDocForm" property="eligibilityAdv"/>&nbsp;%</td>
        </tr>
        <tr class="even">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "isSecured")?"fieldname":"fieldnamediff"%>" width="44%">Secured&nbsp;<font color="#0000FF">* </font></td>
          <td width="56%"><% if (aForm.getSecured()!= null) { %>
            <%=aForm.getSecured().equals(ICMSConstant.TRUE_VALUE)?"Yes":"No"%>
            <% } %>&nbsp;</td>
        </tr>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "transactionDate")?"fieldname":"fieldnamediff"%>" width="44%">Date of Transaction&nbsp;<font color="#0000FF">* </font></td>
          <td width="56%">
  ...
  <tr>
    <td colspan="3">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
        ...
        <tbody>
        <%
            IWarehouseReceipt[] actualReceipt = null;
            IWarehouseReceipt[] stageReceipt = null;
            if (actual != null) {
                actualReceipt = actual.getWarehouseReceipts();
            }
            if (staging != null) {
                stageReceipt = staging.getWarehouseReceipts();
            }
            ArrayList list = null;
        if (actualReceipt != null || stageReceipt != null) {
	    List res = CompareOBUtil.compOBArray(stageReceipt,actualReceipt);
	    CompareResult[] resultList = (CompareResult[])res.toArray(new CompareResult[0]);
		Arrays.sort(resultList, new WarehouseReceiptComparator(WarehouseReceiptComparator.BY_WR_ISSUE_DATE));	    
	                
	     list = new ArrayList(Arrays.asList(resultList));
	            
            pageContext.setAttribute("warehouseReceipt",list);
        } else {
            list = null;
        }            
        ...
        <%
                ...
                int count = 0;
        %>
		<logic:present name="warehouseReceipt" >
        <logic:iterate id="compResult" name="warehouseReceipt"  type="com.integrosys.base.techinfra.diff.CompareResult"  >
        <%
            IWarehouseReceipt receiptObj = (IWarehouseReceipt)compResult.getObj();
        %>
        ...
        <td width="4%" class="<bean:write name="compResult" property="key" />"><%=count + 1%></td>
          ...
          <td style="text-align:center" width="15%">
            <a href="javascript:viewWarehouse(<%=String.valueOf(receiptObj.getRefID())%>)">View</a>
          </td>
        </tr>
        <%
            count++;
  ...
  <tbody>
    <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
        <tbody>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "bLShippingCompany")?"fieldname":"fieldnamediff"%>" width="44%">Shipping Company</td>
          <td width="56%"><bean:write name="TitleDocForm" property="shippingCompany"/>&nbsp;</td>
        </tr>
        <tr class="even">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "bLNo")?"fieldname":"fieldnamediff"%>" width="44%">Bill of Lading No.</td>
          <td width="56%"><bean:write name="TitleDocForm" property="billLadingNo"/>&nbsp;</td>
        </tr>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "bLDate")?"fieldname":"fieldnamediff"%>" width="44%">Bill of Lading Date </td>
          <td width="56%"><bean:write name="TitleDocForm" property="billLadingDate"/>&nbsp;</td>
        </tr>
        <tr class="even">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "bLRemarks")?"fieldname":"fieldnamediff"%>" width="44%">Remarks</td>
  ...
  <tbody>
    <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
        <tbody>
        <tr class="even">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "tRNo")?"fieldname":"fieldnamediff"%>" width="44%"> TR No.</td>
          <td width="56%"><bean:write name="TitleDocForm" property="trNo"/>&nbsp;</td>
        </tr>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "tRBillLadingNo")?"fieldname":"fieldnamediff"%>" width="44%">Bill of Lading Ref. No.</td>
          <td width="56%"><bean:write name="TitleDocForm" property="billLadingRefNo"/>&nbsp;</td>
        </tr>
        <%
            Amount actualTRAmt = null;
            Amount stageTRAmt = null;
            if (actual != null) {
                actualTRAmt = actual.getTRAmount();
            }
            if (staging != null) {
                stageTRAmt = staging.getTRAmount();
            }
            boolean isSame = CompareOBUtil.compOB(stageTRAmt, actualTRAmt, "currencyCode");
            isSame = isSame && CompareOBUtil.compOB(stageTRAmt, actualTRAmt, "amount");
        %>
        <tr class="even">
          <td class="<%=isSame?"fieldname":"fieldnamediff"%>" width="44%">TR Amount</td>
          <td width="56%"><bean:write name="TitleDocForm" property="trAmtCcy"/>&nbsp;
              <bean:write name="TitleDocForm" property="trAmtVal"/>
          </td>
        </tr>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "tRDate")?"fieldname":"fieldnamediff"%>" width="44%">TR Date</td>
          <td width="56%"><bean:write name="TitleDocForm" property="trDate"/>&nbsp;</td>
        </tr>
        <tr class="even">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "tRMaturityDate")?"fieldname":"fieldnamediff"%>" width="44%">TR Maturity Date</td>
          <td width="56%"><bean:write name="TitleDocForm" property="trMaturityDate"/>&nbsp;</td>
        </tr>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "tRRemarks")?"fieldname":"fieldnamediff"%>" width="44%">Remarks</td>
  ...
  <tbody>
    <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
        <tbody>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "otherDocNo")?"fieldname":"fieldnamediff"%>" width="44%"> Document No.</td>
          <td width="56%"><bean:write name="TitleDocForm" property="documentNo"/>&nbsp;</td>
        </tr>
        <tr class="even">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "otherDocDesc")?"fieldname":"fieldnamediff"%>" width="44%">Document Description</td>
          <td width="56%"><bean:write name="TitleDocForm" property="documentDesc"/>&nbsp;</td>
        </tr>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "otherDocDate")?"fieldname":"fieldnamediff"%>" width="44%">Document Date</td>
          <td width="56%"><bean:write name="TitleDocForm" property="documentDate"/>&nbsp;</td>
        </tr>
        <tr class="even">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "otherDocDueDate")?"fieldname":"fieldnamediff"%>" width="44%">Document Due Date</td>
          <td width="56%"><bean:write name="TitleDocForm" property="documentDueDate"/>&nbsp;</td>
        </tr>
        <tr class="odd">
          <td class="<%=CompareOBUtil.compOB(staging, actual, "otherDocRemarks")?"fieldname":"fieldnamediff"%>" width="44%">Remarks</td>
