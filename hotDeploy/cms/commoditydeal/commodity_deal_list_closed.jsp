...
* $Header: /home/cms2/cvsroot/cms2/public_html/commoditydeal/commodity_deal_list_closed.jsp,v 1.5 2006/10/27 08:38:43 hmbao Exp $
*
...
<%
 ...
 int teamMembershipID = 0;
  ...
  TOP_LOOP: for(int i=0;i<userTeam.getTeamMemberships().length;i++){//parse team membership to validate user first
    ...
    SearchResult rs = (SearchResult) request.getAttribute("closedDealList");
    Collection col ;
    if(rs!=null)
...
<input type="hidden" name="previous" value="<%=CommodityDealAction.EVENT_LIST_CLOSED%>"/>
<input type="hidden" name="dealID"/>

  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
    <thead>
      <tr>
        <td width="100%" colspan="2"><h3>
            <legend>List of Closed Deal </legend>
          </h3></td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
          ...
          <tr>
            <td width="2%">S/N</td>
            <td width="5%">Type</td>
            <td width="6%"><bean:message key="label.cmdt.profile.cmdt.prd.type"/>/<bean:message key="label.cmdt.profile.cmdt.prd.sub.type"/></td>
            <td width="5%">TP Deal Reference</td>
            <td width="7%">Deal No</td>
            <td width="9%">Deal Amount</td>
        ...
        <%     }       // end  of    if(deal!=null && deal.length!=0)
          ...
          %>
<% }else{%>
        <tr class="odd"><td colspan="16">There is no Deal.</td></tr>
<% } %>
          </tbody>
  ...
  <table width="54" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td><a href="javascript:submitPage()" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image51','','img/return2.gif',1)"><img src="img/return1.gif" name="Image51" border="0" id="Image5" /></a></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
