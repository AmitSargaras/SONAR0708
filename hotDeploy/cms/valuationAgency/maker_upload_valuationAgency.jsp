...
function submitForm() {
 	...
 	document.forms[0].action="ValuationAgency.do?event=maker_event_upload_valuation_agency";
    document.forms[0].submit();
}
...
<html:form action="/ValuationAgency" enctype="multipart/form-data">
				...
				<tbody>
					<tr>
						<td valign="bottom" align="center">
							<html:file property="fileUpload" size="50"></html:file></br><html:errors property="valuationAgencyCodeError"/>
						</td>
					</tr>
				</tbody>
			</table>
