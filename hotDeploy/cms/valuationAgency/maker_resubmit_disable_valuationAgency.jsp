      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
            ...
            <tr class="even">
              ...
              <td class="fieldname" width="20%">Valuation Agency Name*</td>
               <td><%=valuationAgencyForm.getValuationAgencyName()%>
               <!--<html:text property="valuationAgencyName" value="" />&nbsp;</br><html:errors property="valuationAgencyNameError" /> --></td>
           </tr>           
              ...
              <html:text property="address" value="" />&nbsp;</br> <html:errors property="valuationAgencyAddressError"/> --></td>
              <td class="fieldname">City/Town </td>
              <td><%=valuationAgencyTrx.getStagingValuationAgency().getCityTown().getCityName() %><!--
              <html:text property="cityTown" value=""/>&nbsp;</br>  <html:errors property="valuationAgencyCityError"/> --></td>
            </tr>
            <tr class="even">
              <td class="fieldname">State</td>
              <td><%=valuationAgencyTrx.getStagingValuationAgency().getState().getStateName() %><!--
              <html:text property="state" value="" />&nbsp;</br> <html:errors property="stateError"/> --></td>
               <td class="fieldname">Region</td>
               <td><%=valuationAgencyTrx.getStagingValuationAgency().getRegion().getRegionName()%><!--
               <html:text property="region" value="<%=%>" />&nbsp;</br> <html:errors property="regionError"/> --></td>
                  </tr>
            <tr class="odd">

                  <td class="fieldname">Country </td>
                          <td> <%=valuationAgencyTrx.getStagingValuationAgency().getCountry().getCountryName()%><!--
                          <html:text property="country" value="" />&nbsp;</br> <html:errors property="countryError"/> --></td>
