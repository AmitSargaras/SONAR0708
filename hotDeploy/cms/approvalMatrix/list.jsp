...
<thead>
    ...
    <logic:iterate id="feedEntry" name="stagingFeedGroup" property="feedEntries"
        ...
        <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
            ...
            <td>&nbsp;
            	<input type="text" name="level1" id="level1[<%=counter.intValue()%>]" value="<%=UIUtil.formatWithCommaAndDecimal(feedEntry.getLevel1())%>" onblur="javascript:formatAmountAsCommaSeparated(this)"></input>
            	<br/>
            	<html:errors property="<%=\"level1\"+String.valueOf(counter.intValue() - offset)%>"/>
            </td>
            <td>&nbsp;
            	<input type="text" name="level2" id="level2[<%=counter.intValue()%>]" value="<%=UIUtil.formatWithCommaAndDecimal(feedEntry.getLevel2())%>" onblur="javascript:formatAmountAsCommaSeparated(this)"></input>
            	<br/>
            	<html:errors property="<%=\"level2\"+String.valueOf(counter.intValue() - offset)%>"/>
            </td>
            <td>&nbsp;
            	<input type="text" name="level3" id="level3[<%=counter.intValue()%>]" value="<%=UIUtil.formatWithCommaAndDecimal(feedEntry.getLevel3()) %>" onblur="javascript:formatAmountAsCommaSeparated(this)"></input>
            	<br/>
            	<html:errors property="<%=\"level3\"+String.valueOf(counter.intValue() - offset)%>"/>
            </td>
            <td>&nbsp;
            	<input type="text" name="level4" id="level4[<%=counter.intValue()%>]" value="<%=UIUtil.formatWithCommaAndDecimal(feedEntry.getLevel4()) %>" onblur="javascript:formatAmountAsCommaSeparated(this)"></input>
            	<br/>
