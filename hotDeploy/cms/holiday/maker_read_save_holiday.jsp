...
<%
	...
	IHolidayTrxValue trxvalue = (IHolidayTrxValue)session.getAttribute("com.integrosys.cms.ui.holiday.MaintainHolidayAction.IHolidayTrxValue");
	System.out.println("getFromState>>>>>"+trxvalue.getFromState());
%>



<%@page import="com.integrosys.cms.app.holiday.trx.IHolidayTrxValue"%><html><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
function submitForm(event) {
		document.forms[0].action="holiday.do?event=maker_save_update";
	    document.forms[0].submit();
}
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <br>
  <tr>
  <%if("PENDING_PERFECTION".equalsIgnoreCase(trxvalue.getFromState())){ %>
