...
function submitForm() {
		...
		document.forms[0].action = "goodsMaster.do?event=maker_create_goods_master";
		document.forms[0].submit();
	}

function saveForm() {
		document.getElementById("restrictionType").disabled = false;
		document.forms[0].action = "goodsMaster.do?event=maker_draft_goods_master";
		document.forms[0].submit();
	}
...
function refreshRestrictionType(){
	...
	if(isFound){
		...
		//document.forms[0].restrictionType.value = "PROHIBITED";
		//document.forms[0].restrictionType.disabled = true;
	}
	else {
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								...
								<td class="even" width="20%" >									
									...
									<br/>
									<html:errors property="goodsParentCode" /> 
								</td>
				                   
								  <td class="fieldname" width="30%">Goods Code<font color="red">*</font></td>
								  <td width="20%">
								  	<html:text property="goodsCode" size="50" maxlength="100"></html:text>&nbsp; 
								  	<br><html:errors property="goodsCode" />
								  	<html:errors property="goodsCodeLengthError" /> 
				                  	<html:errors property="goodsCodeError" /> 
				                  	<html:errors property="goodsCodeInvalidCharacterError" /> 
				                  	
								  </td>
								</tr>
								<tr class="odd">
									<td class="fieldname">Goods Description<font color="red">*</font></td>
									 <td width="20%">
								  	<html:text property="goodsName" size="20" maxlength="20"></html:text>&nbsp; 
								  	<br><html:errors property="goodsName" />
								  ...
								  <td>		              
					               <html:select styleId="restrictionType" property="restrictionType">
