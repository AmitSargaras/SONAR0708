...
function approvePage() {
    document.forms[0].action="goodsMaster.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="goodsMaster.do?event=<%=rejectEvent%>";
	document.forms[0].submit();
}
function cancelPage() {
							...
							<tbody>
								<tr class="odd">
									...
									<td class="fieldname" >Goods Code<font
										color="red">*</font></td>
									<td ><%=goodsMasterForm.getGoodsCode()%> &nbsp;</td>
								...
								<td class="fieldname" >Goods Name<font
										color="red">*</font></td>
									<td ><%=goodsMasterForm.getGoodsName()%>&nbsp;</td>
								...
								<td class="fieldname">Status&nbsp;</td>
									<td>
										<%
											if (goodsMasterForm.getStatus().trim().equalsIgnoreCase("ACTIVE")) {
										%>Enable
										<%
											} else {
										%>Disable<%
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tbody>
								...
								<tr class="odd">
									...
									<td><%=goodsMasterTrx.getRemarks() != null ? goodsMasterTrx.getRemarks() : ""%>&nbsp;</td>
								</tr>
							</tbody>
						</table>
					</td>
