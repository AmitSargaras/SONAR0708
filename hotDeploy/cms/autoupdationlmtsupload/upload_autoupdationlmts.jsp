...
<script language="JavaScript" type="text/JavaScript">		
		function submitForm() {
 	document.forms[0].action="AutoupdationLmtsupload.do?event=autoupdationlmtsupload";
...
-->
	...
	<html:form action="/AutoupdationLmtsupload" enctype="multipart/form-data">
		<body >
			...
			<table width="80%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<tr>
						<td align="center">
							<h3>
								Auto Updation of Limit Scheduler 
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<button type="button" onclick="submitForm()" style='background-color: AliceBlue;'><b>RUN</b></button>
							</h3>
						</td>
					</tr>
					<tr>
				...
				<tbody>
					<%-- <tr>
						<td valign="bottom" align="center">
							<html:file property="fileUpload" size="50"></html:file></br><html:errors property="autoupdationlmtsfileuploadError"/>
							<html:errors property="autoupdationlmtsfileformatError"/>
						</td>
					</tr> --%>
					<%
  ...
  <%if(preUpload.equalsIgnoreCase("true")){%>  
      ...
      <td><table width="100%" border="0" cellpadding="10" cellspacing="0" class="tblInfo">
          ...
          <tbody>
            <tr>
              <td height="111" class="odd" style="text-align:center"><b>Previous Auto Updation of Limits Pending For Authorization!!!</b></td>
            </tr>
