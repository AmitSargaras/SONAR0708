...
LeiDateValidationForm leiDateValidationForm = (LeiDateValidationForm) request
	...
	if(null != request.getAttribute("new")){
		newPage = (Boolean) request.getAttribute("new");
	}
	String leiDateValidationPeriod = (String)request.getAttribute("LeiDateValidationPeriod");
	int sno = 0;
	int startIndex = 0;
	OBCustomerSearchResult searchResult = null;
	if(!(newPage)){
		 searchResult = (OBCustomerSearchResult)session.getAttribute("com.integrosys.cms.ui.leiDateValidation.LeiDateValidationAction.customerObject");
	}
%>
...
function submitForm() {
		document.forms[0].action = "leiDateValidation.do?event=maker_create_lei_date_validation";
		document.forms[0].submit();
	}
	...
	<body>
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<thead>
				...
				<tr>
					<td>
						<h3>Add LEI Date Validation Period Master</h3>
					</td>
				</tr>
				<tr>
					<td>
							...
							<tbody>
								<tr class="odd">
				                  ...
				                  <td width="20%">
				                  	...
				                  	<%if(searchResult!=null){ %>value="<%=String.valueOf(searchResult.getCustomerName())%>"<%} %>/>									
								  ...
								  <td width="20%">
									<input type="text" name="partyID" id="partyID" readonly="readonly"
									<%if(searchResult!=null){ %>value="<%=String.valueOf(searchResult.getLegalReference())%>"<%} %>/>&nbsp; 									
									...
									<td width="20%">
								  	<html:text property="leiDateValidationPeriod" size="50" maxlength="3" value='<%= leiDateValidationPeriod %>'  onkeypress="return isNumber(event);"></html:text>&nbsp; 
								  	<br>
