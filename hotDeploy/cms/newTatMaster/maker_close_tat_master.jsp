...
function closePage(){
    document.forms[0].action="tatmaster.do?event=maker_confirm_close";
          ...
          <tbody>
           <tr class="even">
            ...
            <tr class="odd">             
              ...
              <td width="30%"><%=tatForm.getTiming()%> &nbsp;[hh:mm]
              </td>             
            </tr>
            
            <tr class="odd">             
              <td class="fieldname" width="20%">Start Timing </td>
              <td width="30%"><%=tatForm.getStartTime()%> &nbsp;[hh:mm]
              </td>             
            </tr>
            
            <tr class="even">             
              <td class="fieldname" width="20%">End Timing </td>
             <td width="30%"><%=tatForm.getEndTime()%> &nbsp;[hh:mm]
              </td>                        
            </tr>
