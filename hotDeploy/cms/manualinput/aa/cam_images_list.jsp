   ...
   %>
    <tr class="<%=rowClass%>">
              ...
              <td valign="top"><center>	<a href="MIAADetail.do?event=view_cam_image&&camType=<%=camCheckList.getCamType() %>&&camNumber=<%=camCheckList.getCamNumber() %>&&camDate=<%=camCheckList.getCamDate()%>"  >View Images</a></center></td>
              	<%}else if("maker_edit_aadetail".equals(event)||"maker_edit_aadetail_confirm_error".equals(event)){ %>
              <td valign="top">	<center><a href="javascript:viewImage('<%=camCheckList.getCamType() %>','<%=camCheckList.getCamNumber() %>','<%=camCheckList.getCamDate()%>')"  >View Images</a></center></td>
              	<%} else if("maker_edit_aadetail_reject".equals(event)){ %>
              	<td valign="top"><center><a href="MIAADetail.do?event=view_edit_cam_image_reject&&camType=<%=camCheckList.getCamType() %>&&camNumber=<%=camCheckList.getCamNumber() %>&&camDate=<%=camCheckList.getCamDate()%>"  >View Images</a></center></td>
              ...
              <td valign="top"><center>	<a href="MIAADetail.do?event=view_close_cam_image_reject&&camType=<%=camCheckList.getCamType() %>&&camNumber=<%=camCheckList.getCamNumber() %>&&camDate=<%=camCheckList.getCamDate()%>"  >View Images</a></center></td>
              	...
              	<%} else if("checker_edit_aadetail".equals(event)){ %>
              <td valign="top"><center>	<a href="MIAADetail.do?event=checker_edit_aadetail_view_image&&camType=<%=camCheckList.getCamType() %>&&camNumber=<%=camCheckList.getCamNumber() %>&&camDate=<%=camCheckList.getCamDate()%>"  >View Images</a></center></td>
              	<%}else if("to_track".equals(event)){ %>
              	 <td valign="top"><center>	<a href="MIAADetail.do?event=maker_to_track_view_image&&camType=<%=camCheckList.getCamType() %>&&camNumber=<%=camCheckList.getCamNumber() %>&&camDate=<%=camCheckList.getCamDate()%>"  >View Images</a></center></td>
              	<%} %>
