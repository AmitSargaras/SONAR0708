	...
	var type = document.getElementById("actionType"+ind).value;
	 ...
	 if(type =="Edit"){
		...
		document.forms[0].action = "ManualInputCustomer.do?systemCustomerId=" +id +"&system="+name+"&index="+ind;		
	    	...
	    	document.forms[0].event.value = "edit_system_in_resubmit";
    	document.forms[0].submit();
	}
	else if( type == "Delete"){					
		document.forms[0].action = "ManualInputCustomer.do?systemCustomerId=" +id +"&system="+name+"&index="+ind;		
    	document.forms[0].event.value = "delete_system_in_resubmit";
    	document.forms[0].submit();
	}	    
}
...
if(lei == '<%=custObj.getLeiCode()%>' && "Y"=='<%=custObj.getIsLeiValidated()%>'){
	...
	if(rmCode.length>10){
		...
		xmlhttp.onreadystatechange=function()
		{
		 ...
		 if (xmlhttp.readyState==4 && xmlhttp.status==200)
		 {
			 ...
			 relationshipMgr = data.substr(p1+2, (p2-p1)-1);
				...
				<tr id="customerdetails">
					...
					<table width="100%" height="100%" cellspacing="0" cellpadding="0"
								...
								<tbody>
									...
									<tr class="odd">
										...
										<td width="30%"><html:text
											name="ManualInputCustomerInfoForm" property="relationshipMgrEmpCode" style="width:250px" onblur="javascript:populateRMData();" maxlength="10"/>
											<br><html:errors property="relationshipMgrEmpCodeError"/>
										</td>
									...
									<tr class="even">
										...
										<td width="30%"><html:text
											name="ManualInputCustomerInfoForm" property="rmRegion" styleId="rmRegion" readonly="true" style="width:250px"/>
										</td>
									...
									<tr class="even">
										...
										<td><html:text property="pan" size="15" maxlength="10"></html:text>&nbsp;
						...
						<tr id="addSystemDetails" style="display: none;">
							...
							<input onclick="javascript : addSystem('add_other_system_in_resubmit')"
								name="AddNew12" type="button" id="AddNew12"
