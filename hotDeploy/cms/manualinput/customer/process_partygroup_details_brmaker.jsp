...
function savecreate() 
{
    ...
    document.forms[0].event.value="maker_resubmit_create_customer_brmaker";
...
{
	document.forms[0].action = "ManualInputCustomer.do";
    document.forms[0].event.value="create_draft_customer_brmaker";
  //document.forms[0].event.value="create_customer";
    document.forms[0].submit();
}
function editDraft() 
{
	document.forms[0].action = "ManualInputCustomer.do";
    document.forms[0].event.value="update_draft_customer_brmaker";
  //document.forms[0].event.value="create_customer";
    document.forms[0].submit();
}
function saveedit() 
{
	document.forms[0].action = "ManualInputCustomer.do";
   document.forms[0].event.value="maker_resubmit_update_customer_brmaker";
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<td>
					    ...
					    <jsp:include page="process_summary_details_brmaker.jsp"></jsp:include>
