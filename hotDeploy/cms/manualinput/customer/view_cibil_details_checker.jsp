...
List otherBankList = (List) session.getAttribute("com.integrosys.cms.ui.manualinput.customer.ManualInputCustomerAction.otherBankList");
...
function getAction(ind) {
	...
	var type = document.getElementById("actionType"+ind).value;
	 ...
	 if(type =="View"){
    	...
    	document.forms[0].event.value = "checker_view_director";
