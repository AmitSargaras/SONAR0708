			...
			<tr id="financialdetails">
				...
				<table width="100%" height="100%" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						onclick="javascript : addSubLine('add_sub_line_in_resubmit')">
						</td>
						<%}else{ %>
						<td align="right"><input type="button" name="button"
							id="detailBtn" value="Add Details" class="btnNormal"
							disabled="disabled" onclick="javascript : addSubLine('add_sub_line_in_resubmit')">
						</td>
						<%} %>
					</tr>
					<tr>
							...
							<tbody>
								...
								<tr class="even">
									...
									<td><html:text property="totalNonFundedLimit" styleId="totalNonFundedLimit" size="30"
										maxlength="20" onkeyup="javascript:calculateFinancialDetail()" styleId="totalNonFundedLimit" onblur="javascript:formatAmountAsCommaSeparated(this)"></html:text>&nbsp;
								...
								<tr class="even">
									...
									<td><html:text property="memoExposure" styleId="memoExposure" size="30"
										...
										<html:errors property="memoExposurLengthError"/>
										</td>
