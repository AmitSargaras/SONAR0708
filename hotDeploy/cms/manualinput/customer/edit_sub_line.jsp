												...
												<logic:present
													...
													<logic:iterate id="OB" name="partyGrpList"
														...
														scope="page" length="10">
															...
															<html:text property="subLineName" size="30" maxlength="20" value="<%=OB.getPartyGroup().getCustomerName()%>"></html:text>&nbsp;
													<input type="hidden" name="partyId"  value="<%=OB.getPartyId()%>">
													
														
														
														<%if(event.equals("edit_subline_party")) {%>
														<input type="button"
															onclick="javascript:getPartyList('edit_display_party_list')"
															name="button2" id="button2" value="Go" class="btnNormal">
															<%}else if(event.equals("edit_subline_party_in_edit")){ %>
															<input type="button"
															onclick="javascript:getPartyList('edit_display_party_list_in_edit')"
															name="button2" id="button2" value="Go" class="btnNormal">
															
															<%}else if(event.equals("edit_subline_party_in_resubmit")){ %>
															<input type="button"
																onclick="javascript:getPartyList('edit_display_party_list_in_resubmit')"
																name="button2" id="button2" value="Go" class="btnNormal">
							...
							<tr>
							 <%if(event.equals("edit_subline_party")){ %>
								...
								<img src="img/save1.gif" name="ImageSave" width="70" height="20"
									...
									onclick="javascript:editPartyGroup('save_edited_party_group')" /></a> <a href="#"
									onmouseout="MM_swapImgRestore()"
								...
								<img src="img/save1.gif" name="ImageSave" width="70" height="20"
									border="0" id="ImageSave"
									onclick="javascript:editPartyGroup('save_edited_party_group_in_edit')" /></a> <a href="#"
									onmouseout="MM_swapImgRestore()"
									onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
								<img src="img/cancel1.gif" name="ImageCancel" width="70"
									height="20" border="0" id="ImageCancel" onclick="returnPage('edit_summary_details')" /></a>
								</td>
								 <%}else if(event.equals("edit_subline_party_in_resubmit")){ %>
								  <td align="center"><a href="#"
									onmouseout="MM_swapImgRestore()"
								...
								<img src="img/save1.gif" name="ImageSave" width="70" height="20"
									border="0" id="ImageSave"
									onclick="javascript:editPartyGroup('save_edited_party_group_in_resubmit')" /></a> <a href="#"
									onmouseout="MM_swapImgRestore()"
									onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
								<img src="img/cancel1.gif" name="ImageCancel" width="70"
									height="20" border="0" id="ImageCancel" onclick="returnPage('process_summary_details')" /></a>
								</td>
								...
								<img src="img/cancel1.gif" name="ImageCancel" width="70"
								    ...
								    <%}else if(event.equals("edited_party_group_in_edit")){ %>
								     <td align="center"><a href="#"
									onmouseout="MM_swapImgRestore()"
									onmouseover="MM_swapImage('ImageSave','','img/save1.gif',1)">
								<img src="img/save1.gif" name="ImageSave" width="70" height="20"
								...
								<img src="img/cancel1.gif" name="ImageCancel" width="70"
									height="20" border="0" id="ImageCancel" onclick="returnPage('edit_summary_details')" /></a>
								     ...
								     <%}else if(event.equals("edited_party_group_in_resubmit")){ %>
								     <td align="center"><a href="#"
									onmouseout="MM_swapImgRestore()"
									onmouseover="MM_swapImage('ImageSave','','img/save1.gif',1)">
								<img src="img/save1.gif" name="ImageSave" width="70" height="20"
