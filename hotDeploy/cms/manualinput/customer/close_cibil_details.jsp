...
<%@page import="com.integrosys.cms.ui.collateral.CategoryCodeConstant"%><script type="text/javascript" src="js/calendar.js"></script>
...
function getAction(ind) {
	...
	var type = document.getElementById("actionType"+ind).value;
	 ...
	 if(type =="View"){
    	...
    	document.forms[0].event.value = "close_maker_view_director";
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tbody>
							...
							--%><tr class="even">
								...
								<td>
								<%=(form.getClassActivity1().equals(""))?"-":form.getClassActivity1()+"-" %>
								<integro:common-code
								...
								<td>
								<%=(form.getClassActivity2().equals(""))?"-":form.getClassActivity2()+"-" %>
								<integro:common-code
												categoryCode="<%=CategoryCodeConstant.HDFC_RBI_CODE%>"
							...
							<tr class="odd">
								...
								<html:hidden property="regOffice"/>
								<%} %>
									</td>								<td class="fieldname">Registered office DUNS No.</td>
							...
							<tr class="even">
								...
								<td class="fieldname">Registered Office Address 2<font color="red">*</font></td>
								<td><integro:empty-if-null value="<%=form.getRegOfficeAddress2()%>"/></td>
							</tr>
							<tr class="even">
								<td class="fieldname">Registered Office Address 3<font color="red">*</font></td>
