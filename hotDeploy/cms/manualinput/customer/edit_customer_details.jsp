...
<%
    ...
    if( aform != null ) {
       // DefaultLogger.debug(this,  "form "+aform.getCustomerName());
        DefaultLogger.debug(this,  "form "+aform.getDomicileCountry());
        DefaultLogger.debug(this,  "form "+aform.getSource());
      
    }else {
        DefaultLogger.debug(this, "Form is  NULL in request");
    }
...
<%@page import="com.integrosys.cms.ui.manualinput.customer.ManualInputCustomerInfoForm"%><html><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  <tr>
   ...
   <tr>      
      <td align="center">
     		...
     		<img src="img/submit1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:save()"/></a>
