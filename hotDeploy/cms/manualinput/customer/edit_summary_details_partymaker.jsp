	...
	var type = document.getElementById("actionType"+ind).value;
	 ...
	 if(type =="Edit"){
		...
		document.forms[0].action = "ManualInputCustomer.do?systemCustomerId=" +id +"&system="+name+"&index="+ind;		
	    	...
	    	document.forms[0].event.value = "edit_system_in_edit_partymaker";
    	document.forms[0].submit();
	}
	else if( type == "Delete"){					
		document.forms[0].action = "ManualInputCustomer.do?systemCustomerId=" +id +"&system="+name+"&index="+ind;		
    	document.forms[0].event.value = "delete_system_in_edit_partymaker";
    	document.forms[0].submit();
	}	    
}
				...
				<tr id="customerdetails">
					...
					<table width="100%" height="100%" cellspacing="0" cellpadding="0"
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
									...
									<tr class="odd">
										...
										<td><html:text property="yearEndPeriod" size="30" maxlength="6"></html:text>(Enter Data in 'DD-MMM' format)
						...
						<tr id="addSystemDetails" style="display: none;">
							...
							<input onclick="javascript : addSystem('add_other_system_in_edit_partymaker')"
								name="AddNew12" type="button" id="AddNew12"
