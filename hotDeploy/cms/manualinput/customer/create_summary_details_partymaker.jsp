...
function getAction(id,name,ind) {
	...
	var type = document.getElementById("actionType"+ind).value;
	 ...
	 if(type =="Edit"){
    	...
    	document.forms[0].event.value = "edit_system_partymaker";
    	document.forms[0].submit();
	}
	else if( type == "Delete"){					
		document.forms[0].action = "ManualInputCustomer.do?systemCustomerId=" +id +"&system="+name+"&index="+ind;		
    	document.forms[0].event.value = "delete_system_partymaker";
    	document.forms[0].submit();
	}	    
}
...
if(lei == '<%=leiCode%>' && "Y"=='<%=isLeiValid%>'){
	...
	if(confirm("LEI "+lei +" is Already validated. Last Modified date :'<%=lastModifiedDate%>' and last validated date is : '<%=lastValidatedDateStr%>' Do you still want to validate the LEI Code? ")==true){
				...
				<tr id="customerdetails">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
									<tr class="odd">
										...
										<html:hidden property="cifId" value="<%=customerCifId%>" ></html:hidden>&nbsp;</td>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
									...
									<tr class="odd">
										...
										<td width="30%"><html:text
											name="ManualInputCustomerInfoForm" property="relationshipMgrEmpCode" style="width:250px"/>
										<br><html:errors property="relationshipMgrEmpCodeError"/></td>
										<td class="fieldname" width="20%">Relationship Manager</td>
										<td width="30%"><html:text
											name="ManualInputCustomerInfoForm" property="relationshipMgr" style="width:250px" readonly="true"/>
										<br><html:errors property="relationshipMgrError"/>
										</td>
									</tr>
									<tr class="even">
									...
									<!-- code start:Uma Khot 18/08/2015 Phase 3 CR:Rename Region to RM Region-->
										...
										<td width="30%"><html:text
											name="ManualInputCustomerInfoForm" property="rmRegion"
									...
									<tr class="odd">
										...
										<td><html:select property="industryName" name="ManualInputCustomerInfoForm"
											style="width:250px" onchange="javascript:refreshRbiIndustryCode(this)" style="width:250px">
									...
									<tr class="even">
										...
										<td><html:text property="pan" size="15" maxlength="10" styleId="pan"></html:text>&nbsp;
									...
									<tr class="even">
									    ...
									    <td><html:text property="leiExpDate" styleId="leiExpDate" style="width:80px"  size="12" maxlength="11" readonly="true" />
									...
									<tr class="even">
										...
										<td><html:text property="aadharNumber" size="30"
											maxlength="75"></html:text>
					...
					<td>
						...
						<tr id="addSystemDetails" style="display: none;">
							...
							<input onclick="javascript : addSystem('add_other_system_partymaker')"
								name="AddNew12" type="button" id="AddNew12"
