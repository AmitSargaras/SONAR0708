...
<%
	...
	System.out.println("666666666666666666656456456456456666666"
			+ customerTrxValue);
...
function showDetail(name){
	if(name == 'create_checker_cibil_details' && document.getElementById("status").value == 'ACTIVE'){
...
function rejectForm() {
	...
	document.forms[0].event.value = "checker_reject_create_customer";
    document.forms[0].submit();
...
function submitForm() {
	...
	if(answer == true){
		...
		document.forms[0].action = "ManualInputCustomer.do";
		document.forms[0].event.value = "checker_approve_create_customer";
	    document.forms[0].submit();
	}
	}
	else{
		...
		<input type="hidden" name="event">
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<tr align="left">
						<td width="25%" colspan="1"><input onclick="javascript : showDetail('create_checker_summary_details')"
							name="AddNew12" type="button" id="AddNew12" value="Summary Details"
							class="btnNormal" />&nbsp;&nbsp;  
						<input onclick="javascript : showDetail('create_checker_financial_details')"
							name="AddNew12" type="button" id="AddNew12" value="Financial Details"
							class="btnNormal" />&nbsp;&nbsp; 
						<input onclick="javascript : showDetail('create_checker_cri_details')"
							name="AddNew12" type="button" id="AddNew12" value="CRI Details"
							class="btnNormal" />&nbsp;&nbsp; 
					<input onclick="javascript : showDetail('create_checker_cibil_details')"
							name="AddNew12" type="button" id="AddNew12" value="CIBIL"
							class="btnNormal" />
						<input onclick="javascript : showDetail('create_checker_udf_details')"
							name="AddNew12" type="button" id="AddNew12" value="User Defined Fields (UDF)"
							class="btnNormal" />
						<input onclick="javascript : showDetail('create_checker_banking_method_details')"
					...
					<td>
						<%
							if (event.equals("create_checker_financial_details")) {
						%>		
						    <jsp:include page="create_checker_financial_details.jsp"></jsp:include>
						<%
							} else if (event.equals("create_checker_cri_details")) {
						%>
						    <jsp:include page="create_checker_cri_details.jsp"></jsp:include>
						<%
							} else if (event.equals("create_checker_cibil_details")) {
						%>
						    <jsp:include page="create_checker_cibil_details.jsp"></jsp:include>	
						<%
							} else if (event.equals("create_checker_udf_details")) {
						%>
						    <jsp:include page="create_checker_udf_details.jsp"></jsp:include>	
						<%
							}  else if (event.equals("create_checker_banking_method_details")) {
						%>
							<jsp:include page="create_checker_banking_method_details.jsp"></jsp:include>	
								<%
							}else {
							%>			
					    <jsp:include page="create_checker_summary_details.jsp"></jsp:include>
					<%
						}
					%>
					</td>
					...
					<td align="center">
					<%
						if (event.equals("create_checker_cibil_details")
									|| event.equals("checker_reject_create_customer") || event.equals("view_cibil_details") ) {
					%>
					<br><br>	
					<table width="95%" border="0" align="center" cellpadding="0"
					...
					<tbody>
						...
						<tr class="odd">
							...
							<td><%=customerTrxValue.getRemarks() != null ? customerTrxValue
									.getRemarks()
									: ""%>&nbsp;</td>
						</tr>
					</tbody>
			...
			%>
					...
					&nbsp;
					<%
						if (event.equals("create_checker_customer")
										|| event.equals("create_checker_summary_details")
										|| event.equals("create_checker_process")) {
					%>
					<a href="javascript:nextPage('create_checker_financial_details');"
						onmouseout="MM_swapImgRestore()"
					...
					&nbsp;
					<%
						} else if (event.equals("create_checker_financial_details")) {
					%>
					<a href="javascript:nextPage('create_checker_cri_details');"
						onmouseout="MM_swapImgRestore()"
						onmouseover="MM_swapImage('Image4411','','img/next2.gif',1)"><img
						src="img/next1.gif" name="Image4411" border="0" id="Image4411" />
					</a>
					...
					%>
					<a href="javascript:nextPage('create_checker_cibil_details');"
						onmouseout="MM_swapImgRestore()"
						onmouseover="MM_swapImage('Image4411','','img/next2.gif',1)"><img
						src="img/next1.gif" name="Image4411" border="0" id="Image4411" />
					</a>
					&nbsp;
					<%}else if(event.equals("create_checker_udf_details")){ %>
					<a href="javascript:nextPage('create_checker_banking_method_details');"
						onmouseout="MM_swapImgRestore()"
						onmouseover="MM_swapImage('Image4411','','img/next2.gif',1)"><img
						src="img/next1.gif" name="Image4411" border="0" id="Image4411" />
					</a>
