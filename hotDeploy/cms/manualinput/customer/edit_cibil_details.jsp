...
<%
	...
	if (transactionHistoryList != null) {
		pageContext.setAttribute("transactionHistoryList",
	...
	boolean flag = false;
	if (value.getPartyConsent().equals("Y")) {
		flag = true;
	} else {
		flag = false;
	}
...
<%@page
	import="com.integrosys.cms.app.systemBankBranch.bus.OBSystemBankBranch"%><script
...
<!--
	...
	function refreshOfficeRegionId(dropdown) {
		...
		var url = '/cms/ManualInputCustomer.do?event=refresh_region_id&countryId='
				+ curSel;
	...
	function refreshStateId(dropdown) {
		...
		var dep = 'officeState';
		var url = '/cms/ManualInputCustomer.do?event=refresh_state_id&regionId='
				+ curSel;
		sendLoadDropdownReq(dep, url);
	}
	...
	function refreshCityId(dropdown) {
		...
		var dep = 'officeCity';
		var url = '/cms/ManualInputCustomer.do?event=refresh_city_id&stateId='
				+ curSel;
		sendLoadDropdownReq(dep, url);
	}
	function getAction(ind) {
		...
		if (type == "Edit") {
			...
			document.forms[0].event.value = "edit_director_in_edit";
			document.forms[0].submit();
		} else if (type == "Delete") {
			document.forms[0].action = "ManualInputCustomer.do?index=" + ind;
			document.forms[0].event.value = "delete_director_in_edit";
			document.forms[0].submit();
		}
	}
	...
	function copyValue() {
		if (document.getElementById("regOffice").value == ''
				|| document.getElementById("regOffice").value == 'N') {
			document.getElementById("regOffice").value = "Y";
			document.forms[0].action = "ManualInputCustomer.do?event=copy_office_to_reg_edit";
			document.forms[0].submit();
		} else {
			document.getElementById("regOffice").value = "N";
...
<table width="100%" height="100%" cellspacing="0" cellpadding="0"
								...
								<tbody>
									<tr class="odd">
										<td class="fieldname" width="20%">Branch Code<font
											color="red">*</font></td>
										<td width="30%"><html:hidden property="branchCode"></html:hidden>
											<integro:empty-if-null value="<%=value.getMainBranch()%>" />
										</td>
										<td class="fieldname" width="20%">Borrower DUNS number</td>
										<td width="30%"><html:text property="borrowerDUNSNo"
												size="15" maxlength="9"></html:text>&nbsp; <br>
										<html:errors property="borrowerDUNSNoError" /> <html:errors
												property="borrowerDUNSNoLengthError" /> <html:errors
												property="specialCharacterBorrowerDUNSNoError" /></td>
									</tr>
									<tr class="even">
										<td class="fieldname" width="20%">Customer Name<font
											color="red">*</font></td>
										<td width="30%"><textarea id="customerNameShort"
												readonly="readonly" style="width: 300px; height: 30px;"><%=value.getCustomerNameShort()%></textarea>&nbsp;
											<br>
										<html:errors property="customerNameShortError" /></td>
									...
									<tr class="odd">
										...
										<td width="30%">
											<%
												if (value.getPartyConsent() == null
														|| value.getPartyConsent().equals("")) {
											%>

											<input type="checkbox" id="partyC"
											onclick="javascript:checkbox()"></input> <html:hidden
												property="partyConsent" /> <%
 	} else if (value.getPartyConsent().equals("Y")) {
 %>
											<input type="checkbox" id="partyC" checked="checked"
											onclick="javascript:checkbox()"></input> <html:hidden
												property="partyConsent" /> <%
							...
							-->
									<tr class="even">
										...
										<td><html:select name="ManualInputCustomerInfoForm"
												property="classActivity1" style="width:250px">
										...
										<td><html:select name="ManualInputCustomerInfoForm"
												property="classActivity2" style="width:250px">
												<option value="">Please Select</option>
												<html:options collection="classActivityList"
													labelProperty="label" property="value" />
											</html:select></td>
								...
								--%>
										<td class="fieldname" width="20%">Copy previous addresss
											as Registered address</td>
										...
										<td>
											...
											onclick="javascript:copyValue()"></input> <html:hidden
												property="regOffice" styleId="regOffice" /> <%
 	} else if (value.getRegOffice().equals("Y")) {
 %>
											<input type="checkbox" id="reg" checked="checked"
											onclick="javascript:copyValue()"></input> <html:hidden
												property="regOffice" styleId="regOffice" /> <%
 ...
 %>
										...
										<td><html:text property="regOfficeDUNSNo"
												styleId="regOfficeDUNSNo" size="15" maxlength="10"></html:text>&nbsp;
											<br>
										<html:errors property="regOfficeDUNSNoLengthError" /> <html:errors
												property="specialCharacterRegOfficeDUNSNoError" /></td>
									</tr>
									<!--<tr  class="even">
							<td class="fieldname" width="20%">Copy previous addresss as Registered address</td>
								
								<td width="30%"><html:checkbox property="regOffice" 
									onclick="javascript:copyValue()"></html:checkbox></td>
							<td  class="fieldname" width="20%">&nbsp;</td>
									<td width="30%">&nbsp;</td>
							</tr>
							-->
								<tr class="odd">
									...
									<td><html:text property="regOfficeAddress1"
											styleId="regOfficeAddress1" size="30" maxlength="75"></html:text>&nbsp;
										<br>
									<html:errors property="regOfficeAddress1Error" /> <html:errors
											property="regOfficeAddress1LengthError" /></td>
									
									<td class="fieldname">Registered Office Address 2</td>
									<td><html:text property="regOfficeAddress2"
											styleId="regOfficeAddress2" size="30" maxlength="75"></html:text>&nbsp;
										<br>
									<html:errors property="regOfficeAddress2Error" /> <html:errors
											property="regOfficeAddress2LengthError" /></td>
								</tr>
								<tr class="even">
									<td class="fieldname">Registered Office Address 3</td>
									<td><html:text property="regOfficeAddress3"
											styleId="regOfficeAddress3" size="30" maxlength="75"></html:text>&nbsp;
										<br> <html:errors
											property="regOfficeAddress3LengthError" /></td>

								    <td class="fieldname">Country<font color="red">*</font></td>
										<td><html:select property="regOfficeCountry"
												styleId="regOfficeCountry"
												name="ManualInputCustomerInfoForm"
												onchange="javascript:refreshRegRegionId(this)"
												style="width:250px">
												<option value="">Please Select</option>
												<html:options collection="countryRegList"
													labelProperty="label" property="value" />
											</html:select> <br>
										<html:errors property="regOfficeCountryError" /></td>
									</tr>
									<tr class="odd">
										<td class="fieldname">Pincode</td>
										<td><html:text property="regOfficePostCode"
												styleId="regOfficePostCode" size="10" maxlength="6"></html:text>&nbsp;
											<br>
											<html:errors property="regPostcodeError" />
										<html:errors property="regOfficePostCodeLengthError" /></td>
										<td class="fieldname">Region<font color="red">*</font></td>
										<td><html:select property="regOfficeRegion"
												styleId="regOfficeRegion" name="ManualInputCustomerInfoForm"
												onchange="javascript:refreshRegStateId(this)"
												style="width:250px">
												<option value="">Please Select</option>
												<html:options collection="regionRegList"
													labelProperty="label" property="value" />
											</html:select> <br>
										<html:errors property="regOfficeRegionError" /></td>
									</tr>
									<tr class="even">
										<td class="fieldname">State<font color="red">*</font></td>
										<td><html:select property="regOfficeState"
												styleId="regOfficeState" name="ManualInputCustomerInfoForm"
												onchange="javascript:refreshRegCityId(this)"
												style="width:250px">
												<option value="">Please Select</option>
												<html:options collection="stateRegList"
													labelProperty="label" property="value" />
											</html:select> <br>
										<html:errors property="regOfficeStateError" /></td>
										<td class="fieldname">City<font color="red">*</font></td>
										<td><html:select property="regOfficeCity"
												styleId="regOfficeCity" name="ManualInputCustomerInfoForm"
												style="width:250px">
												<option value="">Please Select</option>
												<html:options collection="cityRegList" labelProperty="label"
													property="value" />
											</html:select> <br>
										<html:errors property="regOfficeCityError" /></td>
									</tr>
									<tr class="even">
										<td class="fieldname">Telephone Number</td>
										<td><html:text property="stdCodeOfficeTelNo"
												styleId="stdCodeOfficeTelNo" size="5" maxlength="5"></html:text>
											<html:text property="regOfficeTelephoneNo"
												styleId="regOfficeTelephoneNo" size="30" maxlength="20"></html:text>&nbsp;
											<br>
										<html:errors property="regOfficeTelephoneNoLengthError" /> <html:errors
												property="specialCharacterRegOfficeTelephoneNoError" /> <html:errors
												property="specialCharacterRegOfficeStdTelephoneNoError" /></td>
										<td class="fieldname">Fax No.</td>
										<td><html:text property="stdCodeOfficeTelex"
												styleId="stdCodeOfficeTelex" size="5" maxlength="5"></html:text>
											<html:text property="regOfficeTelex" styleId="regOfficeTelex"
												size="30" maxlength="20"></html:text>&nbsp; <br>
										<html:errors property="regOfficeTelexLengthError" /> <html:errors
												property="specialCharacterRegOfficeTelexError" /> <html:errors
												property="specialCharacterRegOfficeStdTelexError" /></td>
									</tr>
									<tr class="odd">
										<td class="fieldname">Email</td>
										<td><html:text property="regOfficeEmail"
												styleId="regOfficeEmail" size="30" maxlength="50"></html:text>&nbsp;
											<br>
										<html:errors property="regOfficeEmailError" /></td>
										<td class="fieldname">&nbsp;</td>
										<td>&nbsp;</td>
									</tr>
						</tbody>
				...
				<tr>
					<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<td width="30%"><html:select
											property="willfulDefaultStatus" onchange="willfulDftSts(this.value)" >
								...
								<td width="30%"><html:text property="dateWillfulDefault" styleId="dateWillfulDefault" size="30" 
											maxlength="20" readonly="true"><br></br></html:text><html:errors property="dateWillfulDefault" />
							...
							<tr class="even">
								...
								<td width="30%"><html:text property="suitReferenceNo" styleId="suitReferenceNo" size="15"
							...
							<tr class="odd">
								...
								<td width="30%"><html:text property="suitAmount" styleId="suitAmount" size="28"
								...
								<td width="30%"><html:text property="dateOfSuit" styleId="dateOfSuit" size="30"
									...
									<tr class="even">
										...
										<html:radio
											...
											Yes 
											<html:radio property="isRBIWilfulDefaultersList"
										...
										<td><html:select property="nameOfBank"
											...
											Yes
											 <html:radio property="isDirectorMoreThanOne"
					...
					<tr>
						<td align="right">
							<h3 align="left">Other/Relationship Details</h3> <input
							onclick="javascript : addDirector('add_director_in_edit')"
					...
					<tr>
						<td><html:errors property="directorListEmptyError" />
									...
									<logic:present name="directorList">
										<logic:iterate id="ob" name="directorList"
											...
											<tr class="<%=rowClass%>">
												...
												<td>
													<center>
														<integro:empty-if-null value="<%=ob.getDinNo()%>" />
														&nbsp;
													</center>
												</td>
												<td>
													<center>
														<integro:empty-if-null value="<%=ob.getDirectorName()%>" />
														&nbsp;
													</center>
												</td>
												<td>
		...
		<%if (value.getIsDirectorMoreThanOne() == null
					...
					|| value.getIsDirectorMoreThanOne().equals("No")) {%>
	...
	<%} else {
		System.out.println("else -- value.getIsDirectorMoreThanOne()"+value.getIsDirectorMoreThanOne());
	%>
	<script language="JavaScript" >
	...
	<%if (value.getIsBorrDefaulterWithBank() == null
		...
		document.getElementById('detailsOfDefault').value = "";
		document.getElementById('extOfCompromiseAndWriteoff').value = "";
...
<html:hidden name="ManualInputCustomerInfoForm" property="creditMgrSegment" /> 	
	...
	<html:hidden name="ManualInputCustomerInfoForm" property="mainBranch" />

	<html:hidden name="ManualInputCustomerInfoForm" property="partyConsent" />

	<html:hidden name="ManualInputCustomerInfoForm" property="stdCodeTelNo" />

	<html:hidden name="ManualInputCustomerInfoForm" property="stdCodeTelex" />
	...
	<html:hidden name="ManualInputCustomerInfoForm" property="regOffice"
		styleId="regOffice" />
	<html:hidden name="ManualInputCustomerInfoForm"
		property="form6061Checked" />
	<html:hidden name="ManualInputCustomerInfoForm"
		property="isPanValidated" />
	<html:hidden name="ManualInputCustomerInfoForm"
		property="panValGenParamFlag" />
