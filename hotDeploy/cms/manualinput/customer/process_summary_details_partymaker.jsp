...
<%@page import="java.util.Date"%><%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"%>
...
<%
	...
	String customerCifId = custObj.getCifId();
	...
	var type = document.getElementById("actionType"+ind).value;
	 ...
	 if(type =="Edit"){
		...
		document.forms[0].action = "ManualInputCustomer.do?systemCustomerId=" +id +"&system="+name+"&index="+ind;		
	    	...
	    	document.forms[0].event.value = "edit_system_in_resubmit_partymaker";
    	document.forms[0].submit();
	}
	else if( type == "Delete"){					
		document.forms[0].action = "ManualInputCustomer.do?systemCustomerId=" +id +"&system="+name+"&index="+ind;		
    	document.forms[0].event.value = "delete_system_in_resubmit_partymaker";
    	document.forms[0].submit();
	}	    
}
function getvendorAction(name,id,ind) {
	...
	var type = document.getElementById("action"+ind).value;
	 ...
	 if(type =="Edit"){
		...
		document.forms[0].event.value = "edit_vendor_in_resubmit";
    	document.forms[0].submit();
	}
	else if( type == "Delete"){					
		document.forms[0].action = "ManualInputCustomer.do?vendorName=" +name +"&vendorId="+id+"&index="+ind;		
    	document.forms[0].event.value = "delete_vendor_in_resubmit";
    	document.forms[0].submit();
	}	    
}
...
function validatePANNo(){
	...
	if(pan!=null && pan!=""){
		...
		if(pan == '<%=custObj.getPan()%>' && "Y"=='<%=custObj.getIsPanValidated()%>'){
			...
			if(confirm("PAN "+pan +" is Already validated. Last Modified date :'<%=lastModifiedDate%>' and last validated date is : '<%=lastValidatedDateStr%>' Do you still want to validate the PAN No? ")==true){
				...
				xmlhttp.open("GET","/cms/ManualInputCustomer.do?event=validate_pan_no_with_NSDL&panNo="+pan+"&customerCifId="+<%=customerCifId%>+"&dateOfIncorporation="+dateOfIncorporation+"&partyNameAsPerPan="+partyNameAsPerPanEncoded,true);
...
<table width="100%" height="100%" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<tbody onload="javascript:hideCinLlpin()">
				<tr id="customerdetails">
					...
					<table width="100%" height="100%" cellspacing="0" cellpadding="0"
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
									<tr class="odd">
										...
										<td width="30%"><textarea id="name"  readonly="readonly"  style="width: 300px; height: 30px;"><%=value.getCustomerNameShort()%></textarea>&nbsp;</td>
									...
									<tr class="even">
										...
										<td width="30%"><input type="text" id="branch" readonly="readonly" value="<%=value.getMainBranch()==null?"":value.getMainBranch()%>"></input>&nbsp;</td>
										<td class="fieldname" width="20%">Group</td>
										<td width="30%"><html:select property="partyGroupName" styleId="partyGroupName"
									...
									<tr class="odd">
									  <!-- <td class="fieldname" width="20%">Region<font color="red">*</font></td> -->
									   <!-- code start:Uma Khot 18/08/2015 Phase 3 CR:Rename Region to RM Region -->
										<td class="fieldname" width="20%">RM Region<font color="red">*</font></td>
										...
										<td width="30%"><html:select
											...
											onchange="javascript:refreshRelationshipMgrId(this)" style="width:250px">
											<option value="">Please Select</option>
										...
										<td class="fieldname" width="20%">Relationship Manager<font color="red">*</font></td>
										<td width="30%"><html:select
											name="ManualInputCustomerInfoForm" property="relationshipMgr" style="width:250px">
											<option value="">Please Select</option>
									...
									<tr class="odd">
										...
										<td><html:select name="ManualInputCustomerInfoForm"
											property="entity" style="width:250px">
											<integro:common-code descWithCode="false"
									...
									<tr class="odd">
										...
										<td><span class="odd"> <html:select
											property="rbiIndustryCode" style="width:250px" style="width:250px">
									...
									<tr class="even">
										...
										<td><html:text property="pan" size="15" maxlength="10"  styleId='pan'></html:text>&nbsp;
											...
											<br>
											<%if('Y'== custObj.getIsPanValidated()){ %>
									...
									<tr class="even">
										...
										<td><html:text property="leiCode" size="30"
											...
											<%} %>
											<br>
											<% try{ if( 'Y'== custObj.getIsLeiValidated()){ %>
									...
									<tr class="odd">
										...
										<td><html:text property="stdCodeTelNo" size="5"
											...
											property="telephoneNo" size="30" maxlength="20"></html:text>&nbsp;
										...
										<td><html:text property="stdCodeTelex" size="5"
											maxlength="5"></html:text>&nbsp;<html:text
											property="telex" size="30" maxlength="20"></html:text>&nbsp;&nbsp;
						...
						<tr id="addVendorDetails" style="display: none;">
							...
							<input onclick="javascript : addSystem('add_vendor_name_in_resubmit')"
						...
						<tr id="addSystemDetails" style="display: none;">
							...
							<input onclick="javascript : addSystem('add_other_system_in_resubmit_partymaker')"
								name="AddNew12" type="button" id="AddNew12"
