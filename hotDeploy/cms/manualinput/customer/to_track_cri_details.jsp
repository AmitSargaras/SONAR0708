 ...
 %>
									...
									<input type="radio"
										...
										<td><html:select property="criCountryName" style="width:225"
												styleId="criCountryName" disabled="true" value="<%=formObj.getCountryName()%>" disabled="true">
									...
									<input type="radio"  disabled="true"  checked="checked"   name="ifBreachWithPrescriptions" value="Yes"
										...
										<td><html:textarea property="comments" styleId="comments" rows="3" cols="50"
												value="<%=formObj.getComments()%>" disabled="true">
											</html:textarea></td>
									</tr>
									...
									<tr class="odd">
										...
										<td><html:textarea property="landHolding" rows="3" cols="50" styleId="landHolding"
												value="<%=formObj.getLandHolding()%>" disabled="true">
											</html:textarea></td>
									</tr>
...
<%}%>
										...
										<html:select
												property="restrictedListIndustries" styleId="restrictedListIndustries" disabled="true" style="width:225" value="<%=formObj.getRestrictedListIndustries().trim()%>">
												<integro:common-code
...
<%}%>												  
										...
										<td><html:textarea property="stateImplications"
												...
												rows="3" cols="50" value="<%=formObj.getStateImplications()%>" disabled="true">
											</html:textarea></td>
									</tr>
									...
									<tr class="odd">
									  ...
									  <html:text
										...
										<img src="img/calendara.gif" name="Image724" border="0"
											...
											</html:text> </br> </br> </br> <html:text property="rbiDirectors" maxlength="100"
												style="width:250" value="<%=formObj.getRbiDirectors() %>">
