        ...
        <tbody>   
          <tr>            
            ...
            <td><br />
              ...
              <td width="20%" class="fieldname" >Vendor Name<span class="style11"></span></td>
                  <td width="20%"><html:text property="vendorName" size="16"
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <tr>  
    ...
    <%if(event.equals("delete_vendor")){ %>    
      <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/delete1.gif',1)">
     		<img src="img/delete1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:deleteOtherSystem('vendor_deleted')"/></a>
        ...
        <%}else if(event.equals("delete_vendor_in_edit")){ %>
         <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/delete1.gif',1)">
     		<img src="img/delete1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:deleteOtherSystem('vendor_deleted_in_edit')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
         ...
         <%} else if(event.equals("delete_vendor_in_resubmit")){ %>
         <td align="center">
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageSave','','img/delete1.gif',1)">
     		<img src="img/delete1.gif" name="ImageSave" width="70" height="20" border="0" id="ImageSave" onclick="javascript:deleteOtherSystem('vendor_deleted_in_resubmit')"/></a>
     		<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageCancel','','img/cancel2.gif',1)">
