...
<%@page import="com.integrosys.cms.app.partygroup.bus.IPartyGroup"%><html>
...
function approvePage() {
    ...
    document.forms[0].action="MIPartyGroup.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="MIPartyGroup.do?event=<%=rejectEvent%>";
    document.forms[0].submit();
}
function cancelPage(){
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
						...
						<tr class="odd">
							<td class="fieldname" width="30%">Party Group Exposure Limit</td>
