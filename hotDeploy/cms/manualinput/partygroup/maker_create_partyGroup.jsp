...
<%
	...
	IPartyGroupTrxValue partyGroupTrx = (IPartyGroupTrxValue) session
			.getAttribute("com.integrosys.cms.ui.patyGroup.MaintainPartyGroupAction.IPartyGroupTrxValue");
	int sno = 0;
	int startIndex = 0;
%>
...
function submitForm() {
 	document.forms[0].action="MIPartyGroup.do?event=maker_create_party_group";
    document.forms[0].submit();
}

function saveForm() {

 	document.forms[0].action="MIPartyGroup.do?event=maker_create_draft_party_group";
    document.forms[0].submit();
}
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
						<tr class="odd">
							...
							<td width="20%" class="even"><html:text property="partyCode" size="30" style="background:#B4CFEC" disabled="true"/>
								&nbsp;</td>
							...
							<html:errors property="dupPartyNameError"/></td>
						</tr>
						<tr class="even">
