  ...
  <script language="javascript">
   <!--
     ...
     function backToLimitList(){
         if(document.forms[0].event.value=='custread') {
        	 document.location.href = 'Limits.do?event=viewlimits&customerID=' +document.forms[0].customerID.value+'&limitProfileID=' +document.forms[0].limitProfileID.value ;
         }else{
	    	document.location.href = 'MILimitList.do?event=list_limit&limitProfileID=' + document.forms[0].limitProfileID.value + '&source=manualinput' + '&customerID=' + document.forms[0].customerID.value;
         }
     }
...
<td >&nbsp;</td>
    ...
    <table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="2" style="text-align:center"><a href="javascript:backToLimitList()"><img src="img/return1.gif" name="Image51" border="0" id="Image5" /></a></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
