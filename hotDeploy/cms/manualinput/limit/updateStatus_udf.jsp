...
<% 	
 XRefDetailForm value = (XRefDetailForm) request.getAttribute("XRefDetailForm");
	...
	//System.out.println("value.getUdfAllowed():"+value.getUdfAllowed()+" udf:"+value.getUdf1()+" :"+value.getUdf1_Label()
	//		+" udf 2:"+value.getUdf2()+" :"+value.getUdf2_Label());
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<jsp:include page="hidden_release_line_detail_updateStatus.jsp"></jsp:include>
...
<%System.out.println(" formObj.getUdfAllowed():"+formObj.getUdfAllowed()); %>
