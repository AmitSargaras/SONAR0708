 ...
 * $Header: /home/cms2/cvsroot/cms2/public_html/common/ack_save.jsp,v 1.7 2006/10/27 08:42:38 hmbao Exp $
          ...
          <tbody>
            <tr>
              <td height="111" class="odd" style="text-align:center">The transaction
                has been saved. <BR>Your Transaction ID is <B><%=trxId%></B></td>
            </tr>
            <tr>
