		...
		<tr>
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
					...
					<tr align="left">
						<td width="25%" colspan="1"><input onclick="javascript : showDetail('close_released_line_details')"
					    ...
					    <input onclick="javascript : udfTab2()"
							name="AddNew123" type="button" id="AddNew123" value="USER DEFINED FIELDS(UDF)-2"
							class="btnNormal" />&nbsp;&nbsp; 
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
					<td>
						<% if(event.equals("close_udf") || fromPage.equals("close_udf") ){ %>		
						    <jsp:include page="close_udf.jsp"></jsp:include>
						<%} else { %>			
					    <jsp:include page="close_released_line_details.jsp"></jsp:include>
					<%} %>
				...
				<tr><td>&nbsp;</td></tr>
					...
					<%}else {%>
                       <img src="img/prev1.gif" style="margin-left: 50%;"  name="Image4411" border="0" id="Image4411" 
									 onclick="javascript : showDetail('close_released_line_details')"
									 onmouseover="MM_swapImage('Image4411','','img/prev2.gif',1)"
									  onmouseout="MM_swapImgRestore()"/>&nbsp; 
						<%} %>		
