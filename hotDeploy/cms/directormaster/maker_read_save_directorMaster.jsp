...
<%
	...
	DefaultLogger.debug("maker_list_directorMaster.jsp", "size is " + directorMasterForm+ "<<<<<<<<<<<<<<");
...
function submitForm1() {	
	document.forms[0].action = "directorMaster.do"
	document.forms[0].event.value = "maker_save_update";    
    document.forms[0].submit();
}

function submitForm2() {	
	document.forms[0].action = "directorMaster.do";
	document.forms[0].event.value = "maker_save_create";
    document.forms[0].submit();
}
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <tr>
   <%if((event.equals("maker_prepare_resubmit_create"))){%>
                    ...
                    <%}else{ %>
                     <td><h3>Edit Director Master</h3></td>
                     <%} %>
          ...
          <tbody>
            ...
            <tr class="even">
             <td class="fieldname" width="20%">Director Code</td>
              <td width="30%"><bean:write name="MaintainDirectorMasterForm" property="directorCode"/>&nbsp;</td>
              <td class="fieldname" width="20%">Director Name
              <br/><bean:message key="error.string.directorAndCreditapprover.name"/></td>
              <td width="30%"><html:text property="name" name="MaintainDirectorMasterForm"/>&nbsp;
              <br/><html:errors property="directorMasterNameError"/></td>
            </tr>
            <tr class="odd">
            <td class="fieldname" width="20%">DIN</td>
                 <td width="30%"><html:text property="dinNo" name="MaintainDirectorMasterForm" maxlength="9" />&nbsp;
                 <br/><html:errors property="directorMasterdinNoError"/></td>
   ...
   <%if( event.equals("maker_update_save_process") || event.equals("maker_save_update") ){%>
                   <td colspan="2">
						<a href="#" onmouseout="MM_swapImgRestore()"
							...
							onClick=" submitForm1()"><img src="img/submit1.gif"
                    ...
                    <td colspan="2">
						<a href="#" onmouseout="MM_swapImgRestore()"
							onmouseover="MM_swapImage('Image3311','','img/submit2.gif',1)"
							onClick=" submitForm2()"><img src="img/submit1.gif"
								name="Image3311" border="0" id="Image3311" />
						</a>
					</td>
                     <%} %>
