...
<%
	...
	boolean forRead = ShareHolderListAction.EVENT_READ.equals(event) ||
    ...
    if( custShareHolderTrxValue != null ) {
		status = custShareHolderTrxValue.getStatus();
	}	
...
function editForm()
{
	document.forms[0].event.value = "<%=ICommonEventConstant.EVENT_PREPARE%>";		
	document.forms[0].submit();
	                ...
	                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblInfo">
	                    <tbody>
	                        ...
	                        <tr>
	                            ...
	                            <td class="even"><%=custShareHolderTrxValue.getUserInfo()%>&nbsp;</td>
	                        </tr>
	                        <tr class="odd">
	                            <td class="fieldname"><bean:message key="label.last.remarks.made"/></td>
	                            <td><integro:wrapper value="<%=custShareHolderTrxValue.getRemarks()%>"/>&nbsp;</td>
	                        </tr>
	                    </tbody>
	                </table>
	            </td>
