...
<%="In Maker Read Disable director master.jsp" %>
<%
...
function submitForm() {
 	document.forms[0].action='directorMaster.do?event=maker_enable_directorMaster';
    document.forms[0].submit();
}
...
<html:form action='directorMaster.do?'>
	...
	<table width="80%" border="0" align="center" cellpadding="0"
		...
		<thead>
			...
			<tr>
				<td>
				<h3>ENABLE/DISABLE Director Master</h3>
				</td>
			</tr>
			<tr>
				<td>
