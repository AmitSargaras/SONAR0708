...
function submitPage () {
	...
	<html:form action="directorMaster.do?event=maker_confirm_resubmit_edit">
		<body>
								...
								<tbody>
											<tr class="odd">
												...
												<td class="fieldname" width="20%">
													...
													<br/><bean:message key="error.string.directorAndCreditapprover.name"/>
												</td>
												
												<td width="30%"><html:text property="name"/>&nbsp;<br/><html:errors property="directorMasterNameError"/>
												</td>
											</tr>
											<tr class="odd">
            							...
            							<td class="fieldname" width="20%">DIN</td>
                						 <td width="30%"><html:text property="dinNo"/>&nbsp;
			...
			<table width="130" border="0" align="center" cellpadding="0"
				...
				<tr>
				 ...
				 <tr>
                    ...
                    <td valign="baseline" align="center"><a href="#"
