...
function submitForm() {
		document.forms[0].action = "valuationAmountAndRating.do?event=maker_create_valuation_amount_and_rating";
		document.forms[0].submit();
	}

function saveForm() {
		document.forms[0].action = "valuationAmountAndRating.do?event=maker_draft_valuation_amount_and_rating";
		document.forms[0].submit();
	}
...
function searchCustomer(){ //v3.0
	...
	document.forms[0].action = "valuationAmountAndRating.do?event=list";
	document.forms[0].submit();
}
</script>
<!-- InstanceEndEditable -->
							...
							<tbody>
								<tr class="even">
								  <td class="fieldname" >Criteria<font color="red">*</font></td>
				                   ...
				                   <td width="20%"><html:select property="criteria" style='width: 270px;' styleId="criteriais">
								  ...
								  <td width="20%" style="width: 200px;">
								  	<html:text property="valuationAmount" styleId="valuamt" size="50" maxlength="100" onblur="javascript:formatAmountAsCommaSeparated(this);">
