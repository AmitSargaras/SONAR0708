...
if(self.Node&&self.Node.prototype) {
	...
	Node.prototype.removeAdjacentElement=remove_Adj_El;
...
function remove_Adj_El(oElement){
	var p=this.parentNode;
	return p.removeChild(oElement);
}
