...
List facilitydetailsList =(List) session.getAttribute("com.integrosys.cms.ui.facilitydetailsupload.FacilitydetailsUploadAction.List");
...
function submitPage(){
    ...
    document.forms[0].action="Facilitydetailsupload.do?event=maker_close_facilitydetails_file";
