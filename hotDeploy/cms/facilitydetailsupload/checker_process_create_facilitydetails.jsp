...
<%
	...
	IFileUploadTrxValue itrxValue = (IFileUploadTrxValue) session.getAttribute("com.integrosys.cms.ui.facilitydetailsupload.FacilitydetailsUploadAction.IFileUploadTrxValue");
	List facilitydetailsList = (List) session.getAttribute("com.integrosys.cms.ui.facilitydetailsupload.FacilitydetailsUploadAction.facilitydetailsList");
	
	if (facilitydetailsList != null) {
		pageContext.setAttribute("facilitydetailsList", facilitydetailsList);
	}
	...
	DefaultLogger.debug(this,"facilitydetailsList size : "+ facilitydetailsList.size());
	
	int sno = 0;
	String heading = "Facility Update Upload";
	String approve_event = "checker_approve_create_facilitydetails";
...
<%@page import="com.integrosys.cms.app.common.util.CommonUtil"%><html:form
	action='Facilitydetailsupload.do?'>
	<head>
...
function downloadImage(){ //v3.0
		var aLocation = "Facilitydetailsupload.do?event=downloadReport&system=";
...
function approvePage() {
	...
	//	if (x == 'Y') {
		if (x == true) {
		    document.forms[0].action="Facilitydetailsupload.do?event="+'<%=approve_event%>';
...
function rejectPage() {
    document.forms[0].action="Facilitydetailsupload.do?event=checker_reject_create_facilitydetails";
    document.forms[0].submit();
}
function cancelPage(){
