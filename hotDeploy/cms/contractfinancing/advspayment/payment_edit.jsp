<%@ page import="com.integrosys.base.techinfra.logger.DefaultLogger,
                 com.integrosys.cms.ui.contractfinancing.advspayment.PaymentForm"%>
...
<tbody>
<tr class="odd">
    <td class="fieldname"><bean:message key="label.advancepayment.date.payment.received"/> <font color="#0000FF">*</font></td>
    <td colspan="2">
...
<tr class="even">
    <td class="fieldname"><bean:message key="label.advancepayment.amount.distributed"/> <font color="#0000FF">*</font></td>
    <td colspan="2">
...
<tr class="odd">
    <td rowspan="9" class="fieldname"><bean:message key="label.advancepayment.distributed.account"/></td>
    <td>
...
<tr>
    ...
    if(event.equals("maker_prepare_create")||event.equals("create")){
        ...
        <a href="javascript:gotoPage('CF_AdvsPayment.do','maker_prepare_update')" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image51','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image51" width="70" height="20" border="0" id="Image51" /></a><%
    }
    else{
