...
<%
	SearchResult searchResult = (SearchResult) session
			.getAttribute("com.integrosys.cms.ui.pincodemapping.PincodeMappingAction.pincodeMappingList");
...
<script language="JavaScript" type="text/JavaScript">
	...
	function createPincodeMapping() {
		...
		document.forms[0].action = "StatePincodeMapping.do?event=maker_prepare_create_state_pincode_mapping";
	...
	function searchPincode()
	{
		...
		if(searchType == '' && searchText == '')
        {
	        ...
	        document.forms[0].event.value       = "maker_list_state_pincode_mapping";
	        document.forms[0].submit();
        }
		else{
			 if(searchType !='' || searchText!='')
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<table width="100%" height="100%" cellspacing="0" cellpadding="0"
						...
						<thead>
							...
							<tr>
								<td><label>Search :&nbsp;</label> <select id="selType">
									...
									</select> &nbsp;<input type="text" id="srcText" maxlength="30" /> 
									<html:errors property="searchTextFilterError"/>
									<html:errors property="searchTextValueError"/>&nbsp;<img
									alt="Search" src="./img/search.gif"
									onclick="javascript:searchPincode()"></td>
								<td>&nbsp;</td>
								<td valign="bottom" align="right"><input type="button"
									name="Submit" value="Add New" class="btnNormal"
									onclick="createPincodeMapping()" /></td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0"
										...
										<tbody>
											<logic:present name="pincodeMappingList">
												<logic:iterate id="ob" name="pincodeMappingList" length="10"
													...
													<tr class="<%=rowClass%>">
														...
														<td><select name="menu1"
															onchange="MM_jumpMenu('self',this,0)" style="width: 110">
																...
																%>
																<option
																	value='StatePincodeMapping.do?event=maker_view_state_pincode_mapping&trxId=<%=ob.getId()%>&startIndex=<%=startIndex%>'>View</option>
																...
																<option
																	value='StatePincodeMapping.do?event=maker_prepare_delete_state_pincode_mapping&trxId=<%=ob.getId()%>&startIndex=<%=startIndex%>'>Delete</option>
																<%
																	}
																%>
																<%
			...
			<tr id="generalPurposeBarTR">
				<td height="25">
					<table width="100%" id="generalPurposeBar" border="0"
						...
						<tr>
							...
							<%
								String pageIndexUrl = null;
									...
									pageIndexUrl = "StatePincodeMapping.do?event=list_pagination&startIndex=";
							%>
							<%
								if (searchResult != null) {
							%>
