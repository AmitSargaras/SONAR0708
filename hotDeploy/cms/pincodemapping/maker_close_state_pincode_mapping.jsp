...
function submitPage(event) {
	...
	if(event=="maker_draft_close_process")
		...
		document.forms[0].action="StatePincodeMapping.do?event=maker_confirm_draft_close";
		
    }else{
      
    	document.forms[0].action="StatePincodeMapping.do?event=maker_confirm_close";
    }
...
<html:form action='StatePincodeMapping.do?'>
	...
	<table width="95%" border="0" align="center" cellpadding="0"
		...
		<thead>
			...
			<tr>
				<td>
				<h3>Close State Pincode Mapping</h3>
				</td>
			</tr>
			<tr>
				<td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
						<tr class="odd">
							...
							<td width="20%"><%=pincodeMappingForm.getStateName()%>&nbsp;</td>
						...
						<tr class="even" width="30%">
							...
							<td colspan="3"><%=pincodeMappingTrx.getRemarks() != null ? pincodeMappingTrx.getRemarks() : ""%>&nbsp;</td>
						</tr>
					</tbody>
				</table>
				</td>
	...
	<table width="130" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<a href="#"
				...
				src="img/close1a.gif" width="70" height="20" name="Image3311"
				border="0" id="Image3311" /> </a>&nbsp;&nbsp;
			</td>	
				 <%
 	} else {
 %> 
 ...
 <a href="#"
				...
				src="img/close1a.gif" name="Image3311" border="0" id="Image3311" />
			</a>&nbsp;&nbsp;</td> <%
 	}
 %>
			<td valign="baseline" align="center"><a href="ToDo.do"
				onmouseout="MM_swapImgRestore()"
