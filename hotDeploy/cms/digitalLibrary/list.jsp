...
<%@page import="com.integrosys.cms.app.digitalLibrary.bus.OBDigitalLibraryGroup"%>
...
<%
    ...
    IDigitalLibraryGroup actualFeedGroup =null;
    ...
    if(feedGroupTrxValue!=null){
    	 stagingFeedGroup = feedGroupTrxValue.getStagingDigitalLibraryGroup();
    	 actualFeedGroup = feedGroupTrxValue.getDigitalLibraryGroup();
    }	
    ...
    int totalEntries = 0;
    totalEntries=stagingFeedGroup!=null?stagingFeedGroup.getFeedEntries().length:totalEntries;
    
    if(stagingFeedGroup!=null){
    	pageContext.setAttribute("stagingFeedGroup", stagingFeedGroup);
    }else{
    	stagingFeedGroup=new OBDigitalLibraryGroup();
    	pageContext.setAttribute("stagingFeedGroup",stagingFeedGroup);
    }
...
<thead>
    ...
    <logic:iterate id="feedEntry" name="stagingFeedGroup" property="feedEntries"
        ...
        <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
            ...
            <input type="hidden" name="climsDocCategory" value="<%=feedEntry.getClimsDocCategory() %>" /> --%>
            <html:textarea readonly="true" rows="3" cols="100" property="climsDocCategory" value="<%=feedEntry.getClimsDocCategory() %>"></html:textarea>
            
            </td>
             <% if(feedEntry.getDigiLibDocCategory() == null ){
            	feedEntry.setDigiLibDocCategory("");
            }%>
            <td>&nbsp;
           
           		<html:select property="digiLibDocCategory" value="<%=feedEntry.getDigiLibDocCategory()%>" style="width: 80%;">
            		<integro:common-code categoryCode="<%=CategoryCodeConstant.DIGITAL_LIBRARY_DOCUMENT_CATEGORY_CODE %>" 
                        descWithCode="false" entryCode="<%=feedEntry.getDigiLibDocCategory()%>"/>
                </html:select> 
            <br/>
            </td>
        </tr>
...
<br><br>
<%
    if (feedGroupTrxValue!=null && feedGroupTrxValue.getStatus().equals(ICMSConstant.STATE_REJECTED)) {
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td width="75" valign="baseline" align="center">
            ...
            <img src="img/submit1.gif" name="Image3" id="Image3"/>
