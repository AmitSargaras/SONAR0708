         ...
         <%if(!"PropCommGeneralForm".equals(formName)){ %>
	        <tr >   
	            ...
	            <td class="even" width="30%">
	              <integro:amount  param="amount"  decimal="2" amount="<%=UIUtil.convertToAmount(locale,CommonUtil.getBaseCurrency(),colForm.getValuationAmount())%>" />      
	          </td>
	          <%}else{ %>
	          ...
	          <%} %>
				...
				<% }%>
					 <%if(colForm.getValuationDate()!=null && !colForm.getValuationDate().equals("")){ %>
	            <td class="even" width="30%"><%=colForm.getValuationDate() %>&nbsp;
	        ...
	        <tr >
			   ...
			   <%if(colForm.getCommonRevalFreq()!=null && colForm.getCommonRevalFreq()!=null){ %>
	           <td class="odd" width="30%">
	        <integro:common-code-single entryCode="<%=colForm.getCommonRevalFreq()%>"  display="true"
				...
				<%} %>
					 <%if(colForm.getNextValDate()!=null && !colForm.getNextValDate().equals("")){ %>
	            <td class="odd" width="30%"><%=colForm.getNextValDate() %>&nbsp;
											</td>
				<%}else{ %>
				<td class="odd" width="30%">-&nbsp;</td>
				<%} %>
	        ...
	        <tr >
	            ...
	            <td  class="even" width="30%"><integro:common-code-single entryCode="<%=colForm.getTypeOfChange()%>"  display="true"
	             ...
	             <td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"otherBankCharge")?"fieldname":"fieldnamediff"):"fieldname"%>">
					...
					<%if(colForm.getOtherBankCharge()!=null && !colForm.getOtherBankCharge().equals("")){ %>
	            <td class="even" width="30%"><%=colForm.getOtherBankCharge() %>&nbsp;
											</td>
				<%}else{ %>
				<td class="even" width="30%">-&nbsp;</td>
				<%} %>
