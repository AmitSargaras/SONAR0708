...
<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
    ...
    <td> 
        <% if (propertyValuation3.getEnvironmentRiskyStatus() != null) { %>
            <integro:empty-if-null value="<%=SecEnvRiskyList.getInstance().getSecEnvRiskyItem(propertyValuation3.getEnvironmentRiskyStatus().trim())%>"/>
        <%} else{ %>
            -
        <% }%>
    </td>
    ...
    <td><integro:date object="<%=propertyValuation3.getEnvironmentRiskDate()%>"/>&nbsp;</td>
</tr>
...
<script language="JavaScript" type="text/JavaScript">
   ...
   <%
    String EnvRiskyStatus = propertyValuation3.getEnvironmentRiskyStatus() ;
