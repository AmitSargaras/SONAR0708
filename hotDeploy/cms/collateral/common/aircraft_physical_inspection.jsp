...
<!--  Added by Pramod Katkar for New Filed CR on 21-08-2013-->
 <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
    ...
    <%if( null!=colForm.getIsPhysInsp() || !"".equals(colForm.getIsPhysInsp())){ %>
          <html:radio property="isPhysInsp" styleId="isPhysInsp" value="true" onclick="enable()" ><bean:message key="label.common.yes"/></html:radio> &nbsp;&nbsp;
        <html:radio property="isPhysInsp" styleId="isPhysInsp" value="false" onclick="disable()">
        <bean:message key="label.common.no"/></html:radio>
       <%}else{ %>
       <input type="radio" name="isPhysInsp" id="isPhysInsp" value="true" onclick="enable()" checked="checked">Yes</input>
			<input type="radio" id="isPhysInsp" name="isPhysInsp" value="false" onclick="disable()" >No</input>
       <%} %>
...
<%if(!strSubType.equals("AssetSpecGold")) {%>
<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
    <td class="fieldname">
...
<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
          <td class="fieldname">
				...
				<html:select name="AssetAircraftForm"   property="goodStatus" >
 ...
 <td class="fieldname">
			     ...
			     <td><html:text property="scrapValue" maxlength="15" size="23" styleId="scrapValue" onblur="javascript:formatAmountAsCommaSeparated(this)"/>&nbsp;
