...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/document/docDeedSub/DocDeedSub_read_helper.jsp,v 1.39 2007/03/15 15:56:15 jerlin Exp $
    *
    ...
    * Date: $Date: 2007/03/15 15:56:15 $
    * Tag: $Name:  $
    */
%>
<%
    IDeedSub oldCollateral = (IDeedSub)itrxValue.getCollateral();
    IDeedSub newCollateral = (IDeedSub)itrxValue.getStagingCollateral();
    String formName = "DocDeedSubForm";
    DocDeedSubForm aForm = (DocDeedSubForm)request.getAttribute(formName);
    String prefix = "Doc";
		   ...
		   <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
			...
			<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				...
				<td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"documentDate")?"fieldname":"fieldnamediff"):"fieldname"%>">
					<bean:message key="label.security.deed.subordination.date"/>&nbsp;
                  	<span class="mandatory">*</span></td>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
              ...
              <td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral.getDocumentAmount(),((oldCollateral==null)?null:oldCollateral.getDocumentAmount()),"amount")?"fieldname":"fieldnamediff"):"fieldname"%>">
                  <bean:message key="label.security.doc.amt"/>&nbsp;
                  	<span class="mandatory">*</span></td>
              <td><bean:write name="DocDeedSubForm" property="amountLetter"/>&nbsp;</td>
            </tr>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
              ...
              <td><bean:write name="DocDeedSubForm" property="minAmount"/>&nbsp;</td>
              ...
              <td><bean:write name="DocDeedSubForm" property="maxAmount"/>&nbsp;</td>
            </tr>
...
<%-- @ include file="/collateral/document/priority_ranking_view.jsp" --%>    
...
<%-- <%@ include file="/collateral/document/view_valuation.jsp"%> --%>
