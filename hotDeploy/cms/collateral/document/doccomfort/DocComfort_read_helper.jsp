<%@ page import="com.integrosys.base.techinfra.diff.CompareOBUtil,
                 ...
                 com.integrosys.cms.app.collateral.bus.type.document.subtype.comfort.IComfort,
...
%>
<%
    IComfort oldCollateral = (IComfort)itrxValue.getCollateral();
    IComfort newCollateral = (IComfort)itrxValue.getStagingCollateral();

    String prefix = "Doc";
    String subtype = "DocComfort";
    String formName = "DocComfortForm";
    String action = "doccomfort.DocComfortAction";
    String formActionName = subtype + "Collateral.do";
    DocComfortForm aForm = (DocComfortForm)request.getAttribute(formName);
    ...
    <td colspan="2">
        ...
        <tbody>
            <%
               ...
               String subTypeName =  iCol.getCollateralSubType().getSubTypeName();
            %>
			...
			<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				...
				<td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"documentDate")?"fieldname":"fieldnamediff"):"fieldname"%>">
					<%if(subTypeName.equals("Letter of Awareness")){ %>
					<bean:message key="label.security.letter.awareness.date"/>
					<%}else{ %>
					<bean:message key="label.security.letter.comfort.date"/>
					<%} %>
					&nbsp;
                  	<span class="mandatory">*</span></td>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				...
				<td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral.getDocumentAmount(),((oldCollateral==null)?null:oldCollateral.getDocumentAmount()),"amount")?"fieldname":"fieldnamediff"):"fieldname"%>">
					<bean:message key="label.security.doc.amt"/>&nbsp;
                  	<span class="mandatory">*</span></td>
				<td><bean:write name="DocComfortForm" property="amountLetter"/>&nbsp;</td>
            </tr>
            ...
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
				...
				<td><bean:write name="DocComfortForm" property="minAmount"/>&nbsp;</td>
				...
				<td><bean:write name="DocComfortForm" property="maxAmount"/>&nbsp;</td>
            </tr>
