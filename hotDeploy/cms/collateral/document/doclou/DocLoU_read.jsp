...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/document/doclou/DocLoU_read.jsp,v 1.22 2007/02/28 14:44:30 Jerlin Exp $
    *
...
<%	
    ...
    IUndertaking iCol = (IUndertaking) itrxValue.getCollateral();
