    ...
    <script language="JavaScript" type="text/JavaScript">
       ...
       function submitPage(num) {
           ...
           if (num == 2) {
               ...
               document.forms[0].event.value="delete_cheque_detail";
           }
           if (num == 3) {
...
<% int index = 2;
    ...
    if ("view_chequeDetail".equals(request.getParameter("event")) ) {
        index = 3;
    }
...
<tr>
      <td>
       ...
       <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
           ...
           <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
	          ...
	          <td width="20%" class="fieldname">Branch Name</td> 
	                 ...
	                 <html:select name="AssetPostDatedChqsForm"
											property="branchName" style="width:250px" value="<%=obj1.getBankCode() %>" disabled="true"  >
               ...
               <%if(obj1.getOtherbranch()!=null){ %>
                  <td width="30%"><integro:empty-if-null value="<%=obj1.getOtherbranch().getOtherBranchName() %>"/>
                 <%}else if(obj1.getSystemBankBranch()!=null){ %>
                     <td width="30%"><integro:empty-if-null value="<%=obj1.getSystemBankBranch().getSystemBankBranchName() %>"/>
                  <%}%>
           ...
           <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                 ...
                 <td width="30%">
               <integro:empty-if-null value="<%= obj1.getPacketNumber() %>"/> 
     ...
     <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
	  ...
	  <td width="20%" class="fieldname">Cheque Amount</td>
       <%--           <% obj.setChequeAmt( String.valueOf(cheque[0].getChequeAmount().getAmount())); %> --%>
              <% if(obj1.getChequeAmount()!=null){ %>  
	 ...
	 <%}else{ %>
	   ...
	   <td width="20%" class="fieldname">Cheque Number From</td>
                  <td width="30%">
                   <%if(String.valueOf(obj1.getChequeNoFrom())!=null){ %>
	            ...
	            <td width="20%" class="fieldname">Cheque Number To</td>
                  <td width="30%">
                   <%if(String.valueOf(obj1.getChequeNoTo())!=null){ %>
	...
	%>
              ...
              <td width="30%"><integro:empty-if-null value="<%= dtr.format(obj1.getStartDate()) %>"/>
              <%}else{ %>
              <td width="30%"><integro:empty-if-null value=""/>
                <%} %>
                </td>
                 <td width="20%" class="fieldname">Maturity Date&nbsp;<bean:message key="label.mandatory"/></td>
            <%if(obj1.getMaturityDate()!=null){ %>
            <td width="30%"><integro:empty-if-null value="<%= dtr.format(obj1.getMaturityDate())%>"/>
            <%}else{ %>
              <td width="30%"><integro:empty-if-null value=""/>
                <%} %>
                </td>
	...
	<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
              ...
              <td width="30%"><integro:empty-if-null value="<%= dtr.format(obj1.getIssueDate()) %>"/>
              <%}else{ %>
              <td width="30%"><integro:empty-if-null value=""/>
                <%} %>
                </td>
            ...
            <td width="30%"><integro:empty-if-null value="<%= dtr.format(obj1.getExpiryDate())%>"/>
            <%}else{ %>
              <td width="30%"><integro:empty-if-null value=""/>
                <%} %>
                </td>
...
<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
		...
		<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
            ...
            <td width="30%"><integro:empty-if-null value="<%=dtr.format(obj1.getReturnDate()) %>"/>
            <%}else{ %>
              <td>
                <%} %>
                </td>
  ...
  <tr><%if (index == 3) {%>
        <td width="100" valign="baseline" align="center">
         ...
         <%}else{ %>       
           ...
           <%} %>     
        <td width="100" valign="baseline" align="center">
            <a href="javascript:submitPage(1)" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)">
