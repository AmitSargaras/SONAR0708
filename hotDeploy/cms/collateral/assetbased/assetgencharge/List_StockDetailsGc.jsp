...
<script>
function viewStockDetail(event,assetId) {
	document.forms[0].action ="GenChargeDueDateStocks.do?event="+event+"&assetId="+assetId;
                      ...
                      <tbody>
						...
						<td class="index"><%=dno%></td>
                          ...
                          <td>
                            ...
                            <td>
                              <center> <a href="javascript:viewStockDetail('view_each_stock_and_date','<%=ob.getGeneralChargeDetailsID()%>')">View </a></center>
                         </td>     
                         </tr>               
                               </logic:iterate>
                               <% if (dno == 0 ) { %>
