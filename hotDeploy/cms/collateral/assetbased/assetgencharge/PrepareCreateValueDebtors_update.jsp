...
//End Santosh
	...
	function submitPage(num) {
		...
		if (num == 1) {
			document.forms[0].action="AssetGenChargeStockDetails.do?event=create_value_debtors";
		} else if (num == 2) {
		    document.forms[0].action="AssetGenChargeStockDetails.do?event=edit_value_debtors";
		} else if (num == 3) {
...
<tr class="even">
	...
	<%if(fromPage==null && !"update_stock_detail".equals(fromPage) ) {%>
	   ...
	   <%} %>
	<%-- <integro:common-code categoryCode="CREDIT_OWNER" descWithCode="false" /> --%>
...
<tr class="odd">
	...
	<%}else if("VARIABLE".equals(assetsMarginTypeNew)) { %>
	...
	<td>
	<%if("FIXED".equals(assetsMarginTypeNew)) {%>
	<html:text name="AssetGenChargeStockDetailsForm" property="margin" value="<%=assetsFixedMarginValueNew%>" readonly="true" onkeyup="javascript:calculateLonable()" />
	<%}else{ %>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <%if(evnt!=null && "edit_prepare_value_debtors".equals(evnt) ) {%>
