...
pageContext.setAttribute("MaintainInsuranceGCForm", insuranceForm);
...
System.out.println("maker_create_insgc_pending.jsp   stockdocMonth:"+stockdocMonth+"  stockdocYear:"+stockdocYear);
...
function submitForm() {
	...
	document.forms[0].action='AssetInsuranceCollateral.do?event=maker_submit_insurance_pending&collateralID=<%=itrxValue.getReferenceID()%>&calculatedDP=<%=dp%>&dpCalculateManually=<%=dpCalculateManually%>';
          ...
          <tbody>
              ...
              <img src="img/calendara.gif" alt="calender" name="Image723" border="0" id="Image725"
                ...
                <td width="30%">
			        ...
			        <br><html:errors property="oldPolicyNoError"/>              
                </td>
              </tr>
