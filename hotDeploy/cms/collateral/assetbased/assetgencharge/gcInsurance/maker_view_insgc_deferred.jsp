 ...
 <td colspan="4">
	...
	<%	if(event.equals("maker_view_insurance_deferred")){%>		
				<center>
						...
						<%}else if(event.equals("checker_view_insurance_deferred") && "prepare_close".equals(from_page)){ %>
						<center>
	...
	<% if(isChecker){%>
 <td colspan="4">
				<%if(event.equals("checker_view_insurance_deferred") && "read".equals(from_page)){ %>
				...
				<%}else if(event.equals("maker_view_insurance_deferred") && ("maker_cancle_create_insurance".equals(from_page) || "prepare_update".equals(from_page) || "maker_return_from_submit_insurance".equals(from_page) || "return_from_due_date_and_stock".equals(from_page))){ %>
