...
<%
    ...
    IReceivableSpecificAgent oldCollateral = (IReceivableSpecificAgent) itrxValue.getCollateral();
    IReceivableSpecificAgent newCollateral = (IReceivableSpecificAgent) itrxValue.getStagingCollateral();
    ...
    String subtype = "AssetRecSpecAgent";
    String prefix = "Asset";
...
<tr class="odd">
    <td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"isOwnProceedsOfReceivables")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.security.asset.proceeds.receivables.control"/></td>
       ...
       <% } %>&nbsp;</td>
       <td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"isExchangeCtrlObtained")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.security.exchange.ctr.app"/>&nbsp;<span class="mandatoryPerfection">*</span></td>
    <td><integro:empty-if-null value="<%=ExchangeControlList.getInstance().getExchangeControlItem(iCol.getIsExchangeCtrlObtained())%>"/>&nbsp;</td>
</tr>

<%--<tr class="odd">
    <td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"approvedBuyer")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.security.asset.approved.buyer"/></td>
    <td><integro:empty-if-null value="<%=iCol.getApprovedBuyer()%>"/>&nbsp;</td>
...
<%--<tr class="even">
    ...
    <td><% if (iCol.getIsOwnProceedsOfReceivables()) { %>
        ...
        <% } else { %>
            <bean:message key="label.common.no"/>
       <% } %>&nbsp;</td>
    <td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"approvedBuyerLocation")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.security.asset.loc.approved.buyer"/></td>
...
<tr class="even">
 ...
 <!--added  for gcms-->
                ...
                <tr class="even">
                    ...
                    <td><bean:write property="projectName"name="AssetRecSpecAgentForm" />&nbsp;</td>
                ...
                <tr class="odd">
                     ...
                     <td><bean:write property="blanketAssignment" name="AssetRecSpecAgentForm" />&nbsp;</td>
                     <td class="fieldname">&nbsp;</td>
                     <td>&nbsp; </td>
                 </tr>
                <!--end  for gcms-->
