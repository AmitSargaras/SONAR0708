<%@ page import="com.integrosys.cms.ui.common.TrxObject"%>
...
<%
//    TrxObject trxObj = (TrxObject)request.getAttribute("request.trxObject");
//    pageContext.setAttribute("trxObj",trxObj);
%>
