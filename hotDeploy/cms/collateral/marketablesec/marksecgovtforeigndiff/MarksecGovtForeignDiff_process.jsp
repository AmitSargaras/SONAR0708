...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/marketablesec/marksecgovtforeigndiff/MarksecGovtForeignDiff_process.jsp,v 1.14 2006/10/27 08:35:26 hmbao Exp $
    *
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td colspan="2"><h3><bean:message key="label.security.title.process.marketable"/></h3></td>
    </tr>
  </thead>
</table>
...
<%@ include file="MarksecGovtForeignDiff_read_helper.jsp" %>
