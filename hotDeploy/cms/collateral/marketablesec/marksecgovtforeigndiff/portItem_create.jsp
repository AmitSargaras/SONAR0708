...
function submitPage(num) {
    ...
    if (num == 1) {
    	document.forms[0].event.value="marksecgovtforeigndiff_create";
    }
	if (num == 2) {
    	document.forms[0].event.value="marksecgovtforeigndiff_update";
    }
    if (num == 3) {
...
int index =2;
  ...
  if ("marksecgovtforeigndiff_prepare".equals(request.getParameter("event")) || "marksecgovtforeigndiff_create".equals(request.getParameter("event"))) {
	index = 1;
  }
%>
      ...
      <td colspan="2"> <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
          <tbody>
            ...
            <td>
             ...
             <td>
			  <html:text property="secMaturityDate" readonly="true" style="width:90px" size="15" maxlength="11" />
            ...
            <tr class="odd">
              <td class="fieldname"><bean:message key="label.security.guarantee.by.government"/></td>
               
              <td>
              <html:radio property="isGuaranteeByGovt" value="true"/><bean:message key="label.common.yes"/>
              &nbsp;&nbsp;
              <html:radio property="isGuaranteeByGovt" value="false"/><bean:message key="label.common.no"/>
              </td>
              <td class="fieldname"><bean:message key="label.security.government.name"/></td>
              <td>
              <html:text property="govtName" maxlength="50"/>&nbsp;
              <html:errors property="govtName"/>
              </td>
            </tr>
            <tr class="even">
