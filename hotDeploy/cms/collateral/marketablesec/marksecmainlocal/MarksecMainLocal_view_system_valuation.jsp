    ...
    <tbody>
        <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
                ...
                <td width="20%" class="fieldname">
					<span class=stp><bean:message key="label.valuation.date.omv"/></span></td>
                <td width="30%">
                    <% if (!isIValNull) { %>
        ...
        <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
            ...
            <td>
               ...
               %>
                        <integro:amount param="amount" amount="<%=iVal.getCMV()%>"/>
                <% }
                    }%>
                &nbsp;
            </td>
            ...
            <td>
                ...
                %>
                    <integro:amount param="amount" amount="<%=iVal.getFSV()%>"/>
                <% }
                }%>
                &nbsp;
            </td>
