<%@page import="com.integrosys.cms.ui.bonddetailsupload.IBondDetailsUploadConstants"%>
<%@page import="com.integrosys.cms.ui.bonddetailsupload.BondDetailsUploadAction"%>
...
<%
	List totalUploadedList = (List)session.getAttribute(BondDetailsUploadAction.class.getName() + "." + IBondDetailsUploadConstants.SESSION_TOTAL_UPLOADED_LIST);
	List totalFailedList = (List)session.getAttribute(BondDetailsUploadAction.class.getName() + "." + IBondDetailsUploadConstants.SESSION_TOTAL_FAILED_LIST);
...
<head>
	<script type="text/javascript">
		...
		function downloadImage(){ //v3.0
			var aLocation = "BondDetailsUpload.do?event=download_report";
		...
		function submitPage(){
		    document.forms[0].action="BondDetailsUpload.do?event=maker_close";
		    document.forms[0].submit();
		}
								...
								<td>
									<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
										<thead>
											<tr>
												<td>
													<h3><bean:message key="menu.uploads.bonddetailsupload.name"/></h3>
												</td>
											</tr>
											<tr>
												<td>&nbsp;</td>
