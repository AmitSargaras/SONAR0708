...
<html>
	<head>
		<script type="text/javascript">
			function submitForm() {
			 	document.forms[0].action="BondDetailsUpload.do?event=upload";
	...
	<html:form action="/BondDetailsUpload" enctype="multipart/form-data">
		<body>
				...
				<logic:equal value="false" name="stillPending">	
					<thead>
						...
						<tr>
							<td align="center">
								<h3>
									<bean:message key="menu.uploads.bonddetailsupload.name" />
								</h3>
							</td>
						</tr>
						<tr>
