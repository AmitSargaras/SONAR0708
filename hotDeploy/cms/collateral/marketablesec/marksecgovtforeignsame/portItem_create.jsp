...
function submitPage(num) {
    ...
    if (num == 1) {
    	document.forms[0].event.value="marksecgovtforeignsame_create";
    }
	if (num == 2) {
    	document.forms[0].event.value="marksecgovtforeignsame_update";
    }
    if (num == 3) {
...
<% int index =2;
  ...
  if ("marksecgovtforeignsame_prepare".equals(request.getParameter("event")) || "marksecgovtforeignsame_create".equals(request.getParameter("event"))) {
	index = 1;
  }
