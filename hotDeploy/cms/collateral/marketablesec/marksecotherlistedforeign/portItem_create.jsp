...
<%
	...
	DataProtectionUtil dpUtil = DataProtectionUtil.getInstance();
...
function submitPage(num) {
    ...
    if (num == 1) {
    	document.forms[0].event.value="marksecotherlistedforeign_create";
    }
	if (num == 2) {
    	document.forms[0].event.value="marksecotherlistedforeign_update";
    }
    if (num == 3) {
...
<% int index =2;
  ...
  if ("marksecotherlistedforeign_prepare".equals(request.getParameter("event")) || "marksecotherlistedforeign_create".equals(request.getParameter("event"))) {
	index = 1;
  }
      ...
      <td colspan="2"> <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
          <tbody>
            ...
            <tr class="odd">
              ...
              <td>
              <html:select property="nomineeName">
	                <option value="" ><bean:message key="label.please.select"/> </option>
            ...
            <td>
              ...
              <td class="fieldname"><bean:message key="label.security.maturity.date"/>&nbsp;<span class="mandatoryPerfection">*</span>
              </td>
		...
		<html:text property="secMaturityDate" readonly="true" size="15" maxlength="11" />
            ...
            <tr class="odd">
              <td class="fieldname"><bean:message key="label.security.issuer.name"/>&nbsp;<span class="mandatory">*</span></td>
              <td>
            ...
            <tr class="odd">
              ...
              <td >
              <html:radio property="localStockExchange" value="true"/><bean:message key="label.common.yes"/> &nbsp;&nbsp;
			...
			<tr class="odd">
			    ...
			    <td>
			        <html:select property="baselComplaintUT">
			            <option value=""><bean:message key="label.please.select"/> </option>
			            <html:options name="baselCompliantID" labelName="baselCompliantValue"/>
			        </html:select>
			        <html:errors property="baselComplaintUT"/>
			    </td>
			    <td class="fieldname">&nbsp;</td>
			    <td>&nbsp;</td>
			</tr>
