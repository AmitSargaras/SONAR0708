...
<%
Boolean stillPending = (Boolean) request.getAttribute("stillPending");

if(stillPending == null)
	stillPending = false;

pageContext.setAttribute("stillPending", stillPending);
...
<html>
	<head>
		<script type="text/javascript">
			function submitForm() {
			 	document.forms[0].action="MFSchemaDetailsUpload.do?event=upload";
	...
	<html:form action="/MFSchemaDetailsUpload" enctype="multipart/form-data">
		<body>
			<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
				<logic:equal value="false" name="stillPending">	
					<thead>
						<tr>
							<td>&nbsp;</td>
						</tr>
						...
						<tr>
							<td align="center">
								<h3>
									<bean:message key="menu.uploads.mfschemaDetailsUpload.name" />
								</h3>
							</td>
						</tr>
						<tr>
					...
					<tbody>
						<tr>
							<td valign="bottom" align="center">
								...
								<br>
								<html:errors property="fileuploadError"/>
							</td>
						</tr>
						<tr>
							<td>
				...
				<logic:equal value="true" name="stillPending">
					<thead>
    					<tr>
      						<td><h3>Opps!!!</h3><hr></td>
    					</tr>
