<%@ page import="com.integrosys.cms.ui.dataprotection.DataProtectionUtil,
                 com.integrosys.cms.ui.collateral.marketablesec.markseccustsec.EquityTypeList,
...
function submitPage(num) {
    ...
    if (num == 1) {
    	document.forms[0].event.value="markseccustsec_create";
    }
	if (num == 2) {
    	document.forms[0].event.value="markseccustsec_update";
    }
    if (num == 3) {
...
if ("markseccustsec_prepare".equals(request.getParameter("event")) 
		|| "markseccustsec_create".equals(request.getParameter("event"))){
	index = 1;
}
  ...
  <tbody>
    <tr>
      <td colspan="2"> <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
          <tbody>
            <tr class="even">
              <td width="20%" class="fieldname"><bean:message key="label.security.equity.type"/></td>
              <% EquityTypeList equityType = EquityTypeList.getInstance();
              String equity = (String)equityType.getEquityTypeID().iterator().next();%>
              <td width="30%" ><integro:empty-if-null value="<%=EquityTypeList.getInstance().getEquityTypeItem(equity)%>"/>&nbsp;
              <input type="hidden" name="equityType" value="<%=equity%>"/>
              </td>
            ...
            <tr class="odd">
              <td width="20%" class="fieldname"><bean:message key="label.security.bank.agent"/>&nbsp;<span class="mandatory">*</span></td>
              <td> 
              <html:text property="nomineeName" maxlength="50"/>&nbsp;
              <html:errors property="nomineeName"/>
              </td>
              <td width="20%" class="fieldname"><bean:message key="label.security.confirmation.frm.bank.agent.date"/>&nbsp;<span class="mandatory">*</span></td>
              <td> 
			  <html:text property="dateConfirmNomine" readonly="true" size="15" maxlength="11" />
              ...
              <html:errors property="dateConfirmNomine"/>
              </td>
            </tr>
            ...
            <tr class="odd">
              ...
              <td> 
              <html:text property="noOfUnit" maxlength="10"/>&nbsp;
            ...
            <td>
             ...
             <td> 
		<html:text property="secMaturityDate" size="15" readonly="true" maxlength="11" />
