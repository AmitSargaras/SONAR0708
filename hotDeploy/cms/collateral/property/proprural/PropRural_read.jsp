...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/property/proprural/PropRural_read.jsp,v 1.23 2006/10/27 08:37:53 hmbao Exp $
    *
...
<%	
    ...
    ILandVacantRural iCol = (ILandVacantRural) itrxValue.getCollateral();
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
	...
	<%@ include file="PropRural_read_helper.jsp" %>
  </tbody>
</table>
