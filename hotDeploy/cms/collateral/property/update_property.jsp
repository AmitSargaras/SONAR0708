...
<!--End CR - Tightening of property fields -->	
  	...
  	<span id="span_tenure_period" style="visibility:hidden" ><span class="mandatory">*</span></span>
		...
		<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">              
			...
			<td colspan="3"><html:textarea property="remarksProperty" rows="5" cols="120" style="width:100%" />&nbsp;
		                <html:errors property="remarksProperty"/>&nbsp;</td>
		</tr>
...
alert("yearly");
  ...
  if(thisDate.getDate()<10){
	...
	if(date1 != null){
 	...
 	document.all.nextPhysInspDate.value = final_date;
	}
