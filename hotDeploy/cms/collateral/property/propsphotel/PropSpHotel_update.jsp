<%@ page import="com.integrosys.cms.app.collateral.trx.ICollateralTrxValue,
                 ...
                 com.integrosys.cms.ui.collateral.property.propsphotel.PropSpHotelForm"%>
<%@ page import="com.integrosys.cms.ui.collateral.CollateralAction" %>

<%
    /**
    * Copyright Integro Technologies Pte Ltd
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/property/propsphotel/PropSpHotel_update.jsp,v 1.86 2006/11/23 03:03:34 jzhan Exp $
    *
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.property.PropertyAction.serviceColObj");
    ISpecialPurposeHotel iCol = (ISpecialPurposeHotel) itrxValue.getStagingCollateral();
    ...
    PropSpHotelForm colForm = (PropSpHotelForm) request.getAttribute(formName);
...
<html:form action="PropSpHotelCollateral.do">
<input type="hidden" name="event">
<input type="hidden" name="itemType"/>
<input type="hidden" name="indexID" />
<input type="hidden" name="subtype" value="PropSpHotel"/>
