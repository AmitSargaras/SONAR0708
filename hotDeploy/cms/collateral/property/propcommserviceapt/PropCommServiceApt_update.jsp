<%@ page import="com.integrosys.cms.app.collateral.trx.ICollateralTrxValue,
				 ...
				 com.integrosys.cms.ui.collateral.property.propcommshop.PropCommShopForm" %>
<%@ page import="com.integrosys.cms.ui.collateral.property.propcommserviceapt.PropCommServiceAptForm" %>
...
<%
	 ...
	 * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/property/propcommshop/PropCommShop_update.jsp,v 1.86 2006/11/23 03:01:27 jzhan Exp $
	 *
...
<% ICollateralTrxValue itrxValue = ( ICollateralTrxValue ) session.getAttribute ( "com.integrosys.cms.ui.collateral.property.PropertyAction.serviceColObj" );
	...
	ICommercialServiceApartment iCol = ( ICommercialServiceApartment ) itrxValue.getStagingCollateral ();
	String subtypeCode = iCol.getCollateralSubType ().getSubTypeCode ();

	String formName = "PropCommServiceAptForm";
	PropCommServiceAptForm colForm = ( PropCommServiceAptForm ) request.getAttribute ( formName );
...
<html:form action="PropCommServiceAptCollateral.do">
<input type="hidden" name="event">
<input type="hidden" name="subTypeCode" value="<%=subtypeCode%>"/>
<input type="hidden" name="indexID"/>
<input type="hidden" name="subtype" value="PropCommServiceApt"/>
