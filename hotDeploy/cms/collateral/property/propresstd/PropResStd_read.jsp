...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/property/propresstd/PropResStd_read.jsp,v 1.22 2006/10/27 08:37:46 hmbao Exp $
    *
...
<%	
    ...
    IResidentialStandard iCol = (IResidentialStandard) itrxValue.getCollateral();
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
	...
	<%@ include file="PropResStd_read_helper.jsp" %>
  </tbody>
</table>
