<%@ page import="com.integrosys.cms.app.collateral.trx.ICollateralTrxValue,
                 com.integrosys.cms.app.collateral.bus.type.guarantee.subtype.personal.IPersonal"%>
<%@ page import="org.apache.commons.lang.StringUtils" %>

<%
/**
* Copyright Integro Technologies Pte Ltd
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/guarantees/gteindiv/GteIndiv_process.jsp,v 1.16 2006/10/27 08:33:26 hmbao Exp $
*
* Purpose: Process to approve Collateral
* Description: Type - Guarantee, Subtype - Individual
*
* @author $Author: hmbao $<br>
* @version $Revision: 1.16 $
* Date: $Date: 2006/10/27 08:33:26 $
*/
%>
...
<%@ include file="GteIndiv_read_helper.jsp" %>
