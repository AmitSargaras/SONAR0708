...
<%
    IPersonal oldCollateral = (IPersonal) itrxValue.getCollateral();
    IPersonal newCollateral = (IPersonal) itrxValue.getStagingCollateral();
    String prefix = "Gte";
...
<%@page import="com.integrosys.cms.app.collateral.bus.type.guarantee.subtype.personal.IPersonal"%><tbody>
<tr>
    <td colspan="2">
...
<tr>
    <td colspan="2">
        ...
        <tbody>
				...
				<td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"guarantersName")?"fieldname":"fieldnamediff"):"fieldname"%>" width="20%">
			      	<bean:message key="label.security.guaranters.name"/>&nbsp;<span class="mandatoryPerfection"> * </span></td>
			            <td width="30%"><integro:wrapper value="<%=newCollateral.getGuarantersName() %>" lineLength="50"/>&nbsp;
			            </td>  
			            
			           <td class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"collateralMaturityDate")?"fieldname":"fieldnamediff"):"fieldname"%>" width="20%">
	         		<bean:message key="label.security.net.worth"/> &nbsp;<span class="mandatoryPerfection"> * </span></td>
	         	<td width="30%"><integro:currency amount="<%=iCol.getGuaranteeAmount()%>" param="amount"/>&nbsp;</td>    
				</tr>
				<tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
