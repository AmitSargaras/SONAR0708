...
<%@ page import="com.integrosys.cms.ui.collateral.guarantees.gteinwardlc.GteInwardLCForm" %>
<%@ page import="com.integrosys.cms.app.collateral.bus.type.guarantee.subtype.gteinwardlc.IGteinwardLC" %>
...
<%
     ...
     * Description: Type - Guarantee, Subtype - Inward LC
     *
...
<% ICollateralTrxValue itrxValue = (ICollateralTrxValue) session.getAttribute("com.integrosys.cms.ui.collateral.guarantees.GuaranteesAction.serviceColObj");
    ...
    IGteinwardLC iCol = (IGteinwardLC) itrxValue.getStagingCollateral();
    String subtypeCode = iCol.getCollateralSubType().getSubTypeCode();
    GteInwardLCForm colForm = (GteInwardLCForm) request.getAttribute("GteInwardLCForm");
    String prefix = "Gte";
...
<html:form action="GteInwardLCCollateral.do">
<input type="hidden" name="event"/>
<input type="hidden" name="itemType"/>
<input type="hidden" name="indexID"/>
<input type="hidden" name="subtype" value="GteInwardLC"/>
