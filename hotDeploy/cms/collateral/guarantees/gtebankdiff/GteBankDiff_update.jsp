<%@ page import="com.integrosys.cms.app.collateral.trx.ICollateralTrxValue,
                 ...
                 com.integrosys.cms.ui.collateral.guarantees.gtebankdiff.GteBankDiffForm" %>
<%@ page import="com.integrosys.cms.ui.collateral.CollateralAction" %>

<%
/**
* Copyright Integro Technologies Pte Ltd
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/guarantees/gtebankdiff/GteBankDiff_update.jsp,v 1.58 2006/11/23 02:52:03 jzhan Exp $
*
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.guarantees.GuaranteesAction.serviceColObj");
    ...
    IBankDifferentCurrency iCol = (IBankDifferentCurrency) itrxValue.getStagingCollateral();

    String subtypeCode = iCol.getCollateralSubType().getSubTypeCode();

    GteBankDiffForm colForm = (GteBankDiffForm) request.getAttribute("GteBankDiffForm");
    String prefix = "Gte";
...
<html:form action="GteBankDiffCollateral.do">
...
<%@ include file="/collateral/common/update_basic_security_fields.jsp" %>
            <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
              ...
              <td>
                <html:text property="holdingPeriod"/>&nbsp;
    ...
    <tr>
      <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
          <tbody>
            ...
            <tr class="even">
              <td width="20%" class="fieldname"><bean:message key="label.security.ref.num.guarantee"/></td>
              <td width="30%">
              <html:text property="guaRefNo" maxlength="25"/>&nbsp;
                <html:errors property="guaRefNo"/>
              </td>
              <td width="20%" class="fieldname"><bean:message key="label.security.guarantee.amt"/>&nbsp;
            ...
            <tr class="odd">
              <td  class="fieldname"><bean:message key="label.security.guarantee.date"/>&nbsp;
              	<span class="mandatory">*</span>&nbsp;<span class="mandatoryPerfection">*</span></td>
              <td>
            ...
            <tr class="odd">
              ...
              <td width="30%">
              <html:radio property="bankCountryRiskAppr" value="<%=ICMSConstant.TRUE_VALUE%>"/>Yes
              &nbsp;&nbsp;
              <html:radio property="bankCountryRiskAppr" value="<%=ICMSConstant.FALSE_VALUE%>"/>No
              &nbsp;&nbsp;
              <html:radio property="bankCountryRiskAppr" value="<%=ICMSConstant.NOT_AVAILABLE_VALUE%>"/>Not Applicable
              </td>
