<%@ page import="com.integrosys.cms.app.collateral.trx.ICollateralTrxValue,
                 ...
                 com.integrosys.cms.ui.collateral.guarantees.gtegovt.GteGovtForm, 
...
IGovernment iCol=null;
if (itrxValue!=null) {
	iCol = (IGovernment) itrxValue.getStagingCollateral();

	pageContext.setAttribute("obj", iCol);
}

String subtypeCode = iCol.getCollateralSubType().getSubTypeCode();
GteGovtForm colForm = (GteGovtForm) request.getAttribute("GteGovtForm");
String prefix = "Gte";
String subtype = "GteGovt";
...
<%@page import="com.integrosys.cms.ui.collateral.guarantees.gtegovt.GteGovtForm"%><html>
<head>
...
<link href="<%=context%>css/smartlender-print.css" media="print"
    ...
    <script language="JavaScript" type="text/JavaScript">
	    ...
	    function refreshRegionId(dropdown)
		{
		 ...
		 var dep = 'region';
		 var url = '/cms/GteGovtCollateral.do?event=refresh_region_id&countryId='+curSel;
		...
		function refreshStateId(dropdown)
		{
		 ...
		 var dep = 'state';
		 var url = '/cms/GteGovtCollateral.do?event=refresh_state_id&regionId='+curSel;
		 sendLoadDropdownReq(dep, url);
		}
		...
		function refreshCityId(dropdown)
		{
		 ...
		 var dep = 'city';
		 var url = '/cms/GteGovtCollateral.do?event=refresh_city_id&stateId='+curSel;
		 sendLoadDropdownReq(dep, url);
		}
		...
		function refreshCurrency(dropdown)
		{
			...
			var cur=document.getElementById('collateralCurrency').value;
			 ...
			 var urlc = '/cms/GteGovtCollatera.do?event=refresh_currency&currencyId='+curSel;
...
<html:form action="GteGovtCollateral.do">
         ...
         <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
	         ...
	         <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
			      ...
			      <td class="fieldname"> <bean:message key="label.security.country"/>&nbsp;
	            	<span class="mandatoryPerfection"> * </span>&nbsp;</td>          
			      <td><html:select name="GteGovtForm" property="country" onchange="javascript:refreshRegionId(this)">
	                ...
	                <td class="fieldname"> <bean:message key="label.security.region"/></td>          
			      	<td><html:select name="GteGovtForm" property="region"  onchange="javascript:refreshStateId(this)">
                  			<option value=""><bean:message key="label.please.select"/></option>
			 ...
			 <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
			 		...
			 		<td class="fieldname"> <bean:message key="label.security.state"/></td>          
			      	<td><html:select name="GteGovtForm" property="state"  onchange="javascript:refreshCityId(this)">
                  			<option value=""><bean:message key="label.please.select"/></option>
	                ...
	                <td class="fieldname"> <bean:message key="label.security.city"/></td>          
			      	<td><html:select name="GteGovtForm" property="city"  >
	                  		<option value=""><bean:message key="label.please.select"/></option>
