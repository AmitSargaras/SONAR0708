...
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/guarantees/gteslcdiff/GteSLCDiff_read_helper.jsp,v 1.49 2006/07/27 01:55:26 jzhan Exp $
*
...
* Date: $Date: 2006/07/27 01:55:26 $
*/
%>

<%
    ISBLCDifferentCurrency oldCollateral = (ISBLCDifferentCurrency) itrxValue.getCollateral();
    ISBLCDifferentCurrency newCollateral = (ISBLCDifferentCurrency) itrxValue.getStagingCollateral();
    String prefix = "Gte";
...
<%@ include file="/collateral/common/common_fields_read.jsp" %>
    ...
    <tr>
      <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
          <tbody>
            <tr class="even">
              <td   class="<%=isProcess?(CompareOBUtil.compOB(newCollateral,oldCollateral,"description")?"fieldname":"fieldnamediff"):"fieldname"%>"><bean:message key="label.security.desc.guarantees"/></td>
            ...
            <td class="<%=isProcess?((CompareOBUtil.compOB(newCollateral.getGuaranteeAmount(),((oldCollateral==null)?null:oldCollateral.getGuaranteeAmount()),"amount"))?"fieldname":"fieldnamediff"):"fieldname"%>">
               ...
               <td><bean:write name="GteSLCDiffForm" property="amtGuarantee"/>&nbsp;</td>
            </tr>
            <tr class="odd">
