...
* $Header: /home/cms2/cvsroot/cms2/public_html/collateral/guarantees/gtebanksame/GteBankSame_process.jsp,v 1.15 2006/10/27 08:32:47 hmbao Exp $
*
...
<%	ICollateralTrxValue itrxValue = (ICollateralTrxValue)session.getAttribute("com.integrosys.cms.ui.collateral.guarantees.GuaranteesAction.serviceColObj");
	...
	System.out.println("Security Org = "+itrxValue.getCollateral().getSecurityOrganization());
...
<%@ include file="GteBankSame_read_helper.jsp" %>
