<%@ page import="com.integrosys.cms.app.collateral.trx.ICollateralTrxValue,
                 ...
                 com.integrosys.cms.ui.collateral.guarantees.gtecorprel.GteCorpRelForm" %>
<%@ page import="com.integrosys.cms.ui.collateral.CollateralAction" %>

<%
    /**
     * Copyright Integro Technologies Pte Ltd
     * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/guarantees/gtecorprel/GteCorpRel_update.jsp,v 1.58 2006/11/23 02:53:09 jzhan Exp $
     *
...
<% ICollateralTrxValue itrxValue = (ICollateralTrxValue) session.getAttribute("com.integrosys.cms.ui.collateral.guarantees.GuaranteesAction.serviceColObj");
    ...
    GteCorpRelForm colForm = (GteCorpRelForm) request.getAttribute("GteCorpRelForm");
    String prefix = "Gte";
...
<tr class="even">
    ...
    <td class="fieldname"><bean:message key="label.security.guarantee.amt"/>&nbsp;<span class="mandatory">*</span>&nbsp;<span class="mandatoryPerfection">*</span></td>
    <td>
...
<tr class="odd">
    <td class="fieldname"><bean:message key="label.security.guarantee.date"/>&nbsp;<span class="mandatory">*</span>&nbsp;<span class="mandatoryPerfection">*</span></td>
    <td>
