    ...
    <td colspan="2" align="center">
        ...
        <tbody>
	        ...
	        <tr >
			   ...
			   <%if(propertyValuation2.getRevalFrequency()!=null && propertyValuation2.getRevalFrequency()!=null){ %>
	           <td class="odd" width="30%">
	        <integro:common-code-single entryCode="<%=propertyValuation2.getRevalFrequency()%>"  display="true"
				...
				<%} %>
					 <%if(propertyValuation2.getNextValuationDate()!=null && !propertyValuation2.getNextValuationDate().equals("")){ %>
	            <td class="odd" width="30%"><integro:date object="<%=propertyValuation2.getNextValuationDate() %>" />&nbsp;
											</td>
				<%}else{ %>
				<td class="odd" width="30%">-&nbsp;</td>
				<%} %>
	        ...
	        <tr >
	            ...
	            <td  class="even" width="30%"><integro:common-code-single entryCode="<%=propertyValuation2.getChangeType()%>"  display="true"
	             ...
	             <td class="fieldname">
					...
					<%if(propertyValuation2.getOtherBankCharge()!=null && !propertyValuation2.getOtherBankCharge().equals("")){ %>
	            <td class="even" width="30%"><%=propertyValuation2.getOtherBankCharge() %>&nbsp;
											</td>
				<%}else{ %>
