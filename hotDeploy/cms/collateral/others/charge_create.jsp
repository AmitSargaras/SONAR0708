<%@ page import="com.integrosys.cms.ui.collateral.*,
                 ...
                 com.integrosys.cms.ui.collateral.others.ChargeForm,
                 java.util.HashMap,
...
function setVisibility(elementID1,elementID,visibility){
  	...
  	document.getElementById(elementID1).style.visibility = visibility;
}
      ...
      <td> <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
          <tbody>
            <tr class="even">
              ...
              %>
              <html:select property="limitMapID" multiple="true" size="10" style="<%=style%>" >
              <%
                  if (mapId != null) {
              ...
              <td style="border-left:0;border-right:0"><bean:message key="label.security.selected.limit.ids"/> &nbsp;&nbsp;<html:errors property="limitID"/><br />
            ...
            <tr class="even">
              ...
              <td  class="fieldname"><bean:message key="label.security.amount.charge"/> &nbsp;<font color="#FF0000">*</font><font color="#0000FF">* </font></td>
            ...
            <tr class="even">
              <td width="20%" class="fieldname"><bean:message key="label.security.charge.prior.charge"/>&nbsp;
                <span id="mandPerfChargeePrior" class="mandatoryPerfection" style="visibility:hidden">*</span>&nbsp;
              	<span id="mandSubmChargeePrior" class="mandatory" style="visibility:hidden">*</span></td>
		...
		<tr>
			...
			<tbody>
			<tr class="even">
				<td width="20%" class="fieldname"><bean:message key="label.charge.caveat.waived.ind"/>&nbsp;
					<font color="#0000FF">*</font></td>
				<td width="30%">
					<html:radio property="caveatWaivedInd" value="<%=ICMSConstant.TRUE_VALUE%>" onclick="setVisibility('caveat_reference_no','span_expiry_date','hidden')"><bean:message key="label.common.yes"/></html:radio>
					&nbsp;
					<html:radio property="caveatWaivedInd" value="<%=ICMSConstant.FALSE_VALUE%>" onclick="setVisibility('caveat_reference_no','span_expiry_date','visible')"><bean:message key="label.common.no"/></html:radio>
					&nbsp;
					<html:errors property="caveatWaivedInd"/>
				</td>
				<td width="20%" class="fieldname"><bean:message key="label.charge.caveat.reference"/>&nbsp;
					<span id="caveat_reference_no" style="visibility:hidden" ><font color="#0000FF">*</font></span>
				</td>
				<td width="30%">
				    <html:text property="caveatReferenceNo" maxlength="40"/>
				    <html:errors property="caveatReferenceNo"/>	
				</td>
			</tr>
		
		<tr class="odd">
		<td width="20%" class="fieldname">
			<bean:message key="label.limit.expiry.date"/>
			<span id="span_expiry_date" style="visibility:hidden" ><font color="#0000FF">*</font></span>
		</td>
		<td width="30%">
		...
		<td class="fieldname"><bean:message key="label.charge.presentation.no"/></td>
		<td>
			<html:text property="presentationNo" maxlength="15"/>
			<html:errors property="presentationNo"/>
		</td>
		</tr>
		
		<tr class="even">
		<td class="fieldname"><bean:message key="label.charge.presentation.date"/></td>
		<td>
		    <html:text property="presentationDate" readonly="true"/>
		    <img src="img/calendara.gif" name="Image723" border="0" id="Image723" onclick="return showCalendar('presentationDate', 'dd/mm/y');" 
		         onmouseover="MM_swapImage('Image723','','img/calendarb.gif',1)" onmouseout="MM_swapImgRestore()"/>
		    <html:errors property="presentationDate"/>
		</td>
		<td class="fieldname"><bean:message key="label.charge.date.lodged"/></td>
		<td>
		    <html:text property="lodgedDate" readonly="true"/>
		    <img src="img/calendara.gif" name="Image723" border="0" id="Image723" onclick="return showCalendar('lodgedDate', 'dd/mm/y');" 
		         onmouseover="MM_swapImage('Image723','','img/calendarb.gif',1)" onmouseout="MM_swapImgRestore()"/>
		    <html:errors property="lodgedDate"/>
		</td>
		</tr>
		<tr class="odd">
		<td class="fieldname"><bean:message key="label.charge.solicitor.name"/></td>
		<td>
			<html:text property="solicitorName" maxlength="100" size="30"/>
		...
		<tr class="even">
		<td class="fieldname"><bean:message key="label.charge.folio"/></td>
		<td>
			<html:text property="folio" maxlength="10"/>
			<html:errors property="folio"/>
		</td>
		<td class="fieldname"><bean:message key="label.charge.jilid"/></td>
		<td>
		...
		<tr class="odd">
		<td class="fieldname"><bean:message key="label.charge.partyCharge"/>&nbsp;<span class="mandatory">*</span></td>
		<td>
			<%if(select1){ %>
...
<table width="150"  border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                      <% if (!isSSC) { %>
         <td width="100" valign="baseline" align="center"><a href="javascript:submitPage(<%=index%>)" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image142','','img/ok2.gif',1)"><img src="img/ok1.gif" name="Image142"  border="0" id="Image142" /></a></td>
        <td width="100" valign="baseline" align="center"> <a href="javascript:submitPage(3)" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image4411"  border="0" id="Image4411" /></a>
         <% } else { %>
        <td width="100" valign="baseline" align="center"><a href="javascript:submitPage(3)" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image143','','img/return2.gif',1)"><img src="img/return1.gif" name="Image143"  border="0" id="Image143" /></a></td>
         <%} %>
...
<script>
    rankChanged();    
	  if (document.forms[0].caveatWaivedInd[1].checked){
	     setVisibility('caveat_reference_no','span_expiry_date','visible');
	  }
	 setPriorChargeType();
</script>
