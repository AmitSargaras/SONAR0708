...
<%
    ...
    * $Header: /home/cms2/cvsroot/cms2/public_html/collateral/others/othersa/Othersa_process.jsp,v 1.5 2006/10/27 08:36:40 hmbao Exp $
    *
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td colspan="2"><h3><bean:message key="label.security.title.process.others"/></h3></td>
    </tr>
  </thead>
</table>
