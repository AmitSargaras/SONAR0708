               ...
               <tr class="even">
                ...
                <td width="30%">
                 ...
                 if(aForm!= null){
                	 ...
                	 if(aForm.getWaivedDate()!=null && (!"".equals(aForm.getWaivedDate()))){
                          waivedDate=df.format(df.parse(aForm.getWaivedDate()));
                	    }
 ...
 <td colspan="4">
	...
	<%	if(event.equals("maker_view_insurance_waived")){%>		
				<center>
							...
							<%	}else if(event.equals("checker_view_insurance_waived") && "read".equals(from_event)){%>		
							<center>
	...
	<% if(isChecker){%>
 <td colspan="4">
				<%if(event.equals("checker_view_insurance_waived") && "read".equals(from_event)){ %>
