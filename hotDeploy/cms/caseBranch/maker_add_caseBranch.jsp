...
function cancelPage(){
    document.forms[0].action="caseBranch.do?event=maker_list_caseBranch&go=N";
    
    document.forms[0].submit();
}
function submitForm() {

 	document.forms[0].action="caseBranch.do?event=maker_create_caseBranch";
    document.forms[0].submit();
}

function saveForm() {

 	document.forms[0].action="caseBranch.do?event=maker_draft_caseBranch";
    document.forms[0].submit();
}
...
<html:form action="/caseBranch" onreset="showSpanCustodian()">
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
  <tr>
      <td><h3>Add New Case Creation Branch</h3></td>
  </tr>
  <tr>
    <td><hr/></td>
  </tr>
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput" id="choiceTable">
          ...
          <tbody>
            ...
            <tr class="odd">
              ...
              <td width="30%"><html:text property="coordinator1Email" maxlength="100" />
              <html:errors property="coordinator1EmailError"/>
              </td>
            ...
            <tr class="odd">
              ...
              <td width="30%"><html:text property="coordinator2Email" maxlength="100" />
              <html:errors property="coordinator2EmailError"/>
              </td>
 ...
 <html:hidden name="MaintainCaseBranchForm" property="coordinator2Email" />
     ...
     <html:hidden name="MaintainCaseBranchForm" property="deprecated" value="N"/>
