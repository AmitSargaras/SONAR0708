...
<%@ page
	import="com.integrosys.base.techinfra.logger.DefaultLogger,
                 ...
                 java.util.Locale,
                 java.util.Arrays,
                 com.integrosys.cms.ui.caseBranch.MaintainCaseBranchForm,com.integrosys.cms.app.caseBranch.trx.ICaseBranchTrxValue,com.integrosys.cms.app.caseBranch.trx.OBCaseBranchTrxValue"%>
...
%>
<%
String actionStr1 = "com.integrosys.cms.ui.caseBranch.MaintainCaseBranchAction";
...
function submitForm() {
 	document.forms[0].action="caseBranch.do?event=maker_delete_caseBranch";
    document.forms[0].submit();
}
...
<td >&nbsp;</td>
		...
		<tbody>
			<tr>
              ...
              <%}else{ %>Disable<%} %>&nbsp;</td></tr>	
							...
							<html:hidden name="MaintainCaseBranchForm"
								property="status" value="DISABLE" />
 ...
 <html:hidden name="MaintainCaseBranchForm" property="coordinator2Email" />
     ...
     <html:hidden name="MaintainCaseBranchForm" property="deprecated"  value="Y" />
