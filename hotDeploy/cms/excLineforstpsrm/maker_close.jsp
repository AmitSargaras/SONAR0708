...
function submitPage(event) {
	if(event=="maker_draft_close_process"){
		document.forms[0].action="ExcLineForSTPSRM.do?event=maker_confirm_draft_close";
    }else {
    	document.forms[0].action="ExcLineForSTPSRM.do?event=maker_confirm_close";
    }
    document.forms[0].submit();
    newShowSilkScreen();
}
	...
	<body>
		<table width="70%" border="0" align="center" cellpadding="0"
			...
			<thead>
				<tr>
					<td>
						<h3>Close Exclusion line for STP of SRM</h3>
					</td>
				</tr>
				<tr>
					<td>
