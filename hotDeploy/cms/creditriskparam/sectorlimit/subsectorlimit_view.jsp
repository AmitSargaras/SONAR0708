...
<script language="javascript">
    function goBack() {
		if (document.forms[0].fromEvent.value == '<%= SubSectorLimitAction.EVENT_VIEW%>') {      
        	document.forms[0].event.value = '<%= SubSectorLimitAction.EVENT_VIEW%>';
        	document.forms[0].submit();
    	}else if (document.forms[0].fromEvent.value == '<%= SubSectorLimitAction.EVENT_PREPARE_DELETE%>') {
        	document.forms[0].event.value = '<%= SubSectorLimitAction.EVENT_PREPARE_DELETE%>';
        	document.forms[0].submit();
    	}
        else {
        	history.go(-1)
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblInfo">
                        <tbody>
                            <tr class="odd">
                                ...
                                <td width="60%"><bean:write name="SubSectorLimitForm" property="subSectorCode"/>
                                </td>
                            </tr>
							<tr class="even">
								<td class="fieldname">
								...
								<td><bean:write name="SubSectorLimitForm" property="secCode"/>&nbsp;</td>
							</tr>
                            <tr class="odd">
                                <td class="fieldname">
                                	<bean:message key="label.sectorlimit.aBank.percentage"/>
								</td>
                                <td><bean:write name="SubSectorLimitForm" property="limitPercentage"/>&nbsp;</td>
                            </tr>
                            <tr class="even">
                                <td class="fieldname">
                                	<bean:message key="label.sectorlimit.convBank.percentage"/>
								</td>
                                <td><bean:write name="SubSectorLimitForm" property="conventionalBankPercentage"/>&nbsp;</td>
                            </tr>
							<tr class="odd">
                                <td class="fieldname">
                                	<bean:message key="label.sectorlimit.islamicBank.percentage"/>
								</td>
                                <td><bean:write name="SubSectorLimitForm" property="islamicBankPercentage"/>&nbsp;</td>
                            </tr>
							<tr class="even">
                                <td class="fieldname">
                                	<bean:message key="label.sectorlimit.invBank.percentage"/>
								</td>
                                <td><bean:write name="SubSectorLimitForm" property="investmentBankPercentage"/>&nbsp;</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
