...
<%
	...
	boolean forRead = ExemptedInstListAction.EVENT_TOTRACK.equals(event) ||
						ExemptedInstListAction.EVENT_LIST_READ.equals(event);
	
    // Get the exempted institution trx value from session.
    ...
    if (exemptedInstTrxValue == null)
    	exemptedInstTrxValue = new OBExemptedInstTrxValue();
...
<!--  td height="34"> <h3><bean:message key="title.cust.relationship.info"/></h3></td -->
	...
	<tbody>
		...
		<%
			...
			System.out.println("exemptedInst : " + exemptedInst);
