...
<%
    ...
    String fromEvent = (String)request.getParameter("event");
    String headingLabel="View";
    boolean isTrack = true;
    
    if(fromEvent.equals("maker_prepare_close")){
        headingLabel="Close";
        isTrack = false;
    }
%>
...
<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection"
    ...
    <thead>
        ...
        <tr>
            <td height="34"><h3><%=headingLabel%> <bean:message key="title.bank.entity.branch.param.name"/></h3></td>
...
<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblInfo">
  <tbody>
    <tr class="odd">
      ...
      <td class="even">&nbsp;<integro:empty-if-null value="<%=actionForm.getLastActionBy()%>"/></td>
    </tr>
    <tr class="even">
