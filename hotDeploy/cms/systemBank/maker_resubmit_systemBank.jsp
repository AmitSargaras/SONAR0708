...
function submitPage () {
	document.forms[0].action="systemBank.do?event=maker_confirm_resubmit_edit";
    document.forms[0].submit();
}
						...
						<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tbody>
              							...
              							<td><html:textarea  property="address" />&nbsp;</br> <html:errors property="systemBankAddressError"  /></td>
