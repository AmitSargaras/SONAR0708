														...
														<table width="100%" border="0" align="center"
															...
															<%if(!event.equals("maker_rejected_delete_read")){ %>
																...
																<tr class="odd">
																	...
																	<td><%=mutualfundsFeedGroupTrxValue.getRemarks() != null ? mutualfundsFeedGroupTrxValue
								.getRemarks()
								: ""%>&nbsp;
																	</td>
																</tr>
								...
								<tr>
									...
									<%
										...
										String alphaIndexUrl = null;
												pageIndexUrl = "feed_mutual_funds_item.do?event=maker_rejected_delete_read&TrxId="+transId+"&startIndex=";
												alphaIndexUrl = "feed_mutual_funds_item.do?event=maker_rejected_delete_read&TrxId="+transId+"&loginId=";
												System.out.println("transId  "+transId);
									%>
