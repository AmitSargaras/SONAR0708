...
<%@ page
	import="com.integrosys.cms.ui.npaTraqCodeMaster.NpaTraqCodeMasterForm,
	com.integrosys.base.techinfra.logger.DefaultLogger,com.integrosys.component.user.app.bus.ICommonUser,
	...
	com.integrosys.base.uiinfra.common.ICommonEventConstant,com.integrosys.base.techinfra.util.DateUtil,
	com.integrosys.base.techinfra.propertyfile.PropertyManager,java.util.HashMap,java.util.Locale,java.util.Arrays,
	com.integrosys.cms.app.npaTraqCodeMaster.trx.INpaTraqCodeMasterTrxValue,
...
function cancelPage(){
    document.forms[0].action="npaTraqCodeMaster.do?event=maker_list_npa_traq_code_master&go=N";
	document.forms[0].submit();
	}
function submitForm() {
		document.forms[0].action = "npaTraqCodeMaster.do?event=maker_create_npa_traq_code_master";
		document.getElementById("propertyTypeCodeDesc").disabled=false;
		document.forms[0].submit();
	}

function saveForm() {
		document.forms[0].action = "npaTraqCodeMaster.do?event=maker_draft_npa_traq_code_master";
		document.getElementById("propertyTypeCodeDesc").disabled=false;
		document.forms[0].submit();
	}
	...
	<body>
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<thead>
				...
				<tr>
					<td>
						<h3>Add NPA TRAQ Code Master</h3>
					</td>
				</tr>
				<tr>
					<td>
