			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
                   ...
                   <td  valign="bottom" align="right">						
						<input type="button" name="Submit" value="Add New" class="btnNormal" onclick="createNpaTraqCodeMaster()" />
				   </td>    
               </tr>
				</thead>
				<tbody>
                        ...
                        %>
                                <tr class="<%=rowClass%>">
                                  ...
                                  <td> <select name="menu1" onchange="MM_jumpMenu('self',this,0)" style="width:110">
                                      ...
                                      <%if((event.equals("checker_npa_traq_code_master"))||event.equals("checker_list_pagination")){%>
                                      ...
                                      <%}else{ %>
                                      	...
                                      	<option value='npaTraqCodeMaster.do?event=maker_delete_npa_traq_code_master_read&npaTraqCode=<%=ob.getId()%>&startIndex=<%=startIndex%>'>Delete</option>
									  <%} %>
                                    </select> 
                                  </td>
                                </tr>
              ...
              <tr>
                <td height="25">
                    ...
                    <table  width="100%" border="0" cellspacing="0" cellpadding="0">
                         ...
                         <% if(sr != null) {
                        	 if((event.equals("checker_list_npa_traq_code_master"))
                        			 ||event.equals("checker_search_list_npa_traq_code_master")
					            ...
					            <tr>
					                <td valign="middle">
					                    <integro:pageindex
					                            ...
					                            url="npaTraqCodeMaster.do?event=checker_list_npa_traq_code_master&startIndex=&go=Y"/>
					                </td>
					            </tr>
					        </table>
					    </td>
					        ...
					        <table id="generalPurposeBar" width="100%" border="0" cellspacing="0" cellpadding="5" align="center">
					            <tr>
					                <td valign="middle">
					                    <integro:pageindex
					                            pageIndex="<%=new PageIndex(startIndex, 10, sr.getResultList().size())%>"
					                            url="npaTraqCodeMaster.do?event=list_pagination&startIndex="/>
					                </td>
					            </tr>
					        </table>
					    </td>
