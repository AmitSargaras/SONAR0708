...
<%@ page
	...
	com.integrosys.cms.ui.common.CountryList,com.integrosys.component.bizstructure.app.bus.ITeam,com.integrosys.cms.ui.common.constant.IGlobalConstant,
	com.integrosys.base.uiinfra.common.ICommonEventConstant,com.integrosys.base.techinfra.util.DateUtil,com.integrosys.base.techinfra.propertyfile.PropertyManager,
...
function submitForm() {
		document.forms[0].action = "npaTraqCodeMaster.do?event=maker_confirm_resubmit_delete";
...
function refreshSubType(dropdown){	
	...
	if(currVal=="PT"){
		...
		document.getElementById("propertyTypeCodeDesc").value="";
	...
	<body>
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<thead>
				...
				<tr>
					<td>
						<h3>Edit NPA TRAQ Code Master</h3>
					</td>
				</tr>
				<tr>
					<td>
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tbody>
						...
						<tr class="odd">
							...
							<td><%=npaTraqCodeMasterTrx.getRemarks() != null
						? npaTraqCodeMasterTrx.getRemarks()
						: ""%>&nbsp;</td>
						</tr>
					</tbody>
				</table>
