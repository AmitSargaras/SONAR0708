...
<%
    ...
    IGroupOtrLimit obj = (IGroupOtrLimit) request.getAttribute(CustGroupUIHelper.stg_groupOtrLimitObj);
...
<html:form action="GroupOtrLimit.do">
    ...
    <table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
        <thead>
            <tr>
                <td><h3><bean:message key="label.group.other.limit"/>- View </h3></td>
            ...
            <tr>
                <td colspan="2">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
                        <tbody>
                            <tr class="even">
                                <td width="38%" class="fieldname"><bean:message key="label.group.other.limit.type"/>
                                    <span class="mandatory"> * </span></td>
                                <td width="62%"><bean:write name="GroupOtrLimitForm" property="otrLimitTypeCD"/></td>
                            </tr>
                            <tr class="odd">
                                <td class="fieldname"><bean:message key="label.group.description"/></td>
                                <td width="62%"><bean:write name="GroupOtrLimitForm" property="desc"/></td>
                            </tr>
                            <tr class="odd">
                                <td class="fieldname"><bean:message key="label.group.other.limit.currency"/></td>
                                <td width="62%"><bean:write name="GroupOtrLimitForm" property="currencyCD"/></td>
                            </tr>

                            <tr class="even">
                                <td class="fieldname"><bean:message
                                        key="label.group.other.limit.last.reviewed.date"/></td>
                                <td width="62%"><bean:write name="GroupOtrLimitForm" property="lastReviewedDt"/></td>
                            </tr>

                            <tr class="even">
                                <td class="fieldname"><bean:message key="label.group.other.limit.amount"/></td>
                                <td><bean:write name="GroupOtrLimitForm" property="limitAmt"/></td>
                            </tr>
                            <tr class="odd">
                                <td class="fieldname"><bean:message key="label.security.remarks"/></td>
                                <td><bean:write name="GroupOtrLimitForm" property="remarks"/></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
    ...
    <table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td width="100" valign="baseline" align="center">
                <a href="CustGrpIdentifier.do?event=<%=event%>&from_event=process&itemType=<%=itemType%>"
                   target="_parent" onMouseOut="MM_swapImgRestore()"
                   ...
                   onMouseOver="MM_swapImage('Image3311','','img/return2.gif',1)"><img src="img/return1.gif"
                                                                                       name="Image3311" border="0"
                                                                                       id="Image3311"/></a>
