...
<%@ page
	import="com.integrosys.base.techinfra.logger.DefaultLogger,com.integrosys.cms.ui.common.constant.IGlobalConstant,
                 com.integrosys.base.uiinfra.common.ICommonEventConstant,
                 com.integrosys.cms.app.common.constant.ICMSConstant,com.integrosys.base.businfra.search.SearchResult,com.integrosys.base.uiinfra.tag.PageIndex,com.integrosys.cms.ui.user.MaintainUserForm,com.integrosys.cms.app.common.constant.ICMSConstant,com.integrosys.base.uiinfra.common.ICommonEventConstant,com.integrosys.cms.ui.login.CMSGlobalSessionConstant,com.integrosys.cms.ui.bizstructure.MaintainTeamUtil,com.integrosys.component.user.app.bus.CommonUserSearchCriteria,java.util.List,java.util.Vector"%>
		...
		<tr>
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<thead>
                   ...
                   <td>&nbsp;</td>
                   <% if (!roleType.equals("1005")) {%>
                   <td  valign="bottom" align="right"  colspan="2">						
						<input type="button" name="Submit" value="Add New" class="btnNormal" onclick="createRiskType()" />
				   </td>  
				   <% } %>
               </tr>
               <tr>
                        ...
                        %>
                                <tr class="<%=rowClass%>">
                                  ...
                                  <td> <select name="menu1" onchange="MM_jumpMenu('self',this,0)" style="width:110">
                                      ...
                                      <%if((event.equals("checker_risk_type"))||event.equals("checker_list_pagination")){%>
                                      <option value='riskType.do?event=checker_view_risk_type&productCode=<%=ob.getId()%>&startIndex=<%=startIndex%>'>View</option>
                                       <%}else{ %>
                                      
                                      <option value='riskType.do?event=maker_view_risk_type&productCode=<%=ob.getId()%>&startIndex=<%=startIndex%>'>View</option>
