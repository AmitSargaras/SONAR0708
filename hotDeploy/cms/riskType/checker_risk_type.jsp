...
function approvePage() {
    document.forms[0].action="riskType.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="riskType.do?event=<%=rejectEvent%>";
	document.forms[0].submit();
}
function cancelPage() {
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								<tr class="odd">
									...
									<td class="fieldname" >Risk Type Name<font
										color="red">*</font></td>
									<td style="width: 200px; word-break: break-all;"><%=riskTypeForm.getRiskTypeName()%> &nbsp;</td>

									<td class="fieldname" >Risk Type Code<font
										color="red">*</font></td>
									<td style="width: 200px; word-break: break-all;"><%=riskTypeForm.getRiskTypeCode()%>&nbsp;</td>
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tbody>
								...
								<tr class="odd">
									...
									<td><%=riskTypeTrx.getRemarks() != null ? riskTypeTrx.getRemarks() : ""%>&nbsp;</td>
								</tr>
							</tbody>
						</table>
					</td>
