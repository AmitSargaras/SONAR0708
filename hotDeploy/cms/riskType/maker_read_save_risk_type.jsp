...
function submitForm() {
		document.forms[0].action = "riskType.do?event=maker_save_update";
		document.forms[0].submit();
	}
							...
							<tbody>
								<tr class="even">
								  <td class="fieldname" >Risk Type Name<font color="red">*</font></td>
				                   ...
				                   <td width="20%"><html:text property="riskTypeName" maxlength="100" style='width: 270px;' styleId="riskTypeName">
