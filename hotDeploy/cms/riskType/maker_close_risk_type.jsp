...
function submitPage(event) {
	if(event=="maker_draft_close_process"){
		document.forms[0].action="riskType.do?event=maker_confirm_draft_close";
    }else {
    	document.forms[0].action="riskType.do?event=maker_confirm_close";
    }
    document.forms[0].submit();
}
</script>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								<tr class="even">
									...
									<td ><%=riskTypeForm.getRiskTypeName()%> &nbsp;</td>

									<td class="fieldname" >Risk Type Code</td>
									<td ><%=riskTypeForm.getRiskTypeCode()%>&nbsp;</td>
								</tr>
