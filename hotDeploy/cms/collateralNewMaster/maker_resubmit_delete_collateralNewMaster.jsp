...
<%@ page import="com.integrosys.base.techinfra.logger.DefaultLogger,
                 ...
                 java.util.HashMap,
                 java.util.Locale,
                  com.integrosys.cms.app.collateralNewMaster.trx.ICollateralNewMasterTrxValue,
                 java.util.Arrays"%>
...
<%
	...
	ICollateralNewMasterTrxValue systemBankBranchTrx = (ICollateralNewMasterTrxValue)session.getAttribute("com.integrosys.cms.ui.collateralNewMaster.MaintainCollateralNewMasterAction.ICollateralNewMasterTrxValue");
...
function submitForm () {
	document.forms[0].action="collateralNewMaster.do?event=maker_confirm_resubmit_delete";
    document.forms[0].submit();
}
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
           ...
           <tr class="odd">
												...
												<br/><html:errors property="newCollateralCodeError"/>
