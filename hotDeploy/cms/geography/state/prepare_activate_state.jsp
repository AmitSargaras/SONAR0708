...
<script language="JavaScript" type="text/javascript">
	...
	function activateState(){
		var flag = <%=flg %>
		if( flag == true )
			alert('Please Enable the REGION for this STATE !!!');
		else
		{
			var ans = window.confirm('Are You Sure to Enable the STATE ');
			if( ans == true )
			{
				document.forms[0].action		=	"State.do";
				document.forms[0].event.value	=	"maker_activate_state";
				document.forms[0].submit();
			}
		}
	}
...
<html:hidden property="event"/>
	...
	<table width="80%" border="0" align="center" cellpadding="0"
		...
		<thead>
			<br>
			<tr><td><h3>Enable State</h3></td></tr>
			<tr>
				<td>
					<hr />
				</td>
	...
	<table width="130" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td colspan="2">
				<center>
					<a href="javascript:activateState()" onmouseout="MM_swapImgRestore()"
