...
<script language="JavaScript" type="text/javascript">
	...
	function activateRegion(){
		var flag = <%=flg %>
		if( flag == true )
			alert('Please Enable the COUNTRY for this REGION !!!');
		else
		{
			var ans = window.confirm('Are You Sure to Enable the REGION ');
			if( ans == true )
			{
				document.forms[0].action		=	"Region.do";
				document.forms[0].event.value	=	"maker_activate_region";
				document.forms[0].submit();
			}
		}
	}
...
<html:hidden property="event"/>
		<body>
			...
			<table width="80%" border="0" align="center" cellpadding="0"
				...
				<thead>
					<br>
					<tr><td><h3>Enable Region</h3></td></tr>
					<tr>
						<td>
							<hr />
						</td>
			...
			<table width="130" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="2">
						<center>
							<a href="javascript:activateRegion()" onmouseout="MM_swapImgRestore()"
