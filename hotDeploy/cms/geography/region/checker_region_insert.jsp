...
function cancelPage(){
    document.forms[0].action="Region.do?event=checker_view_list_country";
    
    document.forms[0].submit();
}
function approvePage() {
	
    document.forms[0].action="Region.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="Region.do?event=<%=rejectEvent%>";
    document.forms[0].submit();
}
function cancelPage(){
														...
														<table width="100%" border="0" align="center"
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="even"><%=regionTrxValue.getUserInfo()%>&nbsp;
																	</td>
																</tr>
																<tr class="odd">
																	<td class="fieldname">
																	...
																	<td><%=regionTrxValue.getRemarks() != null ? regionTrxValue.getRemarks() : ""%>&nbsp;
																	</td>
																</tr>
															</tbody>
														</table>
															...
															<tr>
																...
																<%
																	String pageIndexUrl = null;
																			...
																			pageIndexUrl = "Region.do?event=checker_process_create_insert&TrxId="+transId+"&startIndex=";
																%>
