...
%>
<%
	SearchResult searchResult = (SearchResult) session.getAttribute("com.integrosys.cms.ui.geography.region.RegionAction.regionList");
	int counter = 0;
	int noofItems = 0;
	int index = 0;
	int sno = 0;
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tbody>
							<logic:greaterThan name="regionSize" value="0">
								<logic:iterate id="OB" name="regionList" type="com.integrosys.cms.app.geography.region.bus.OBRegion" scope="page" 
									...
									<tr class="<%=rowClass%>">
										...
										<td><select name="chooseAction"
											...
											<option value="Region.do?checkerEvent=yes&event=view_region_by_index&regionId=<%=i%>&startIndex=<%=startIndex%>">View</option>
										</select></td>
									</tr>
								</logic:iterate>
					            ...
					            <tr>
					                <td valign="middle">
					                    <integro:pageindex
					                            ...
					                            url="Region.do?event=checker_paginate&startIndex="/>
					                </td>
					            </tr>
					        </table>
					    </td>
