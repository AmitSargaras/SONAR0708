                    ...
                    <td colspan="2">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">                            
                            ...
                            <logic:greaterThan name="countrySize" value="0">
                             ...
                             <logic:iterate id="OB" name="countryList" type="com.integrosys.cms.app.geography.country.bus.OBCountry" scope="page" 
                              ...
                              <tr class="<%=rowClass%>">                                      
                                ...
                                <select name="chooseAction"
									...
									<option value="Country.do?checkerEvent=yes&event=view_country_by_index&countryId=<%=i%>&startIndex=<%=startIndex%>">View</option>
								</select>
								</td>
					            ...
					            <tr>
					                <td valign="middle">
					                    <integro:pageindex
					                            ...
					                            url="Country.do?event=checker_paginate&startIndex="/>
					                </td>
					            </tr>
					        </table>
					    </td>
