...
FCCBranchForm fccBranchForm = (FCCBranchForm) request
	...
	String rejectEvent;
	if (event.equals("checker_view_fccBranch")) {
		rejectEvent = "checker_list_fccBranch";
	} else {
		rejectEvent = "maker_list_fccBranch";
	}
	int sno = 0;
	 int startIndex = 0;
...
function cancelPage(){
    document.forms[0].action="fccBranch.do?event=<%=rejectEvent %>&go=N";
