        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblInfo">
          <tbody>
            ...
            <tr class="odd">
              ...
              <td class="fieldname"><bean:message key="label.isda.deal.value.date"/></td>
              <td><integro:date object="<%=parameters.getValueDate()%>"/>&nbsp;</td>
            </tr>

            <tr class="even">
              <td class="fieldname"><bean:message key="label.isda.deal.amount.deal"/></td>
