...
<head>
<title><bean:message key="label.grp.exposure"/></title>
              ...
              <td class="even" style="text-align:center" valign="middle"> 
                <table width="350" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
                  <tr class="even"> 
                      ...
                      <td style="border:none" width="200"><strong><font size="2"><bean:message key="label.work.in.progress"/></font></strong></td>
                  </tr>
                  <tr class="even">  
                    <td colspan="2" style="border:none;text-align:center"><br/>
                      <bean:message key="label.rpt.avail.by.tmr"/> <br/> 
                        <br />
		                </td>
                  </tr>
                </table> </td>
