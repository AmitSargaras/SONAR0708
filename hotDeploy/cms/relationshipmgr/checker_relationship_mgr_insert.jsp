...
<%
	...
	SearchResult sr = (SearchResult) request
			.getAttribute("relationshipMgrList");
...
function cancelPage(){
    document.forms[0].action="RelationshipMgr.do?event=list_relationship_mgr";
    
    document.forms[0].submit();
}
function approvePage() {
	
    document.forms[0].action="RelationshipMgr.do?event=<%=submitEvent%>";
    document.forms[0].submit();
}
function rejectPage() {
    document.forms[0].action="RelationshipMgr.do?event=<%=rejectEvent%>";
    document.forms[0].submit();
}
function cancelPage(){
									...
									<td colspan="4">
										<table width="100%" border="0" cellspacing="0" cellpadding="0"
											...
											<thead>
												<tr>
													<td width="5%">S/N</td>
													<td width="16%">RM Code</td>
													<td width="30%">RM Name</td>
													<td width="16%">RM Mail ID</td>
													<td width="30%">Region</td>
													<td width="16%">Reporting Head Name</td>
													<td width="16%">Reporting Head Mail ID</td>
											...
											<tbody>
													...
													offset="<%=String.valueOf(startIndex)%>"
                               						length="<%=String.valueOf(10)%>"
														...
														<tr class="<%=rowClass%>">
															...
															<td><integro:empty-if-null value="<%=ob.getRelationshipMgrCode()%>" />&nbsp;
															</td>
															<td><integro:empty-if-null value="<%=ob.getRelationshipMgrName()%>" />
															</td>
															<td><integro:empty-if-null value="<%=ob.getRelationshipMgrMailId()%>" />
															</td>
															<td><integro:empty-if-null value="<%=ob.getRegion().getRegionName()%>" />
															</td>
															<td><integro:empty-if-null value="<%=ob.getReportingHeadName()%>" />
															</td>
															<td><integro:empty-if-null value="<%=ob.getReportingHeadMailId()%>" />
															</td>
												...
												<logic:notPresent name="relationshipMgrList">
													<tr class="odd">
														<td colspan="10">
															<bean:message key="label.global.not.found" />
														</td>
														...
														<table width="100%" border="0" align="center"
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="even"><%=relationshipMgrTrx.getUserInfo()%>&nbsp;
																	</td>
																</tr>
																<tr class="odd">
																	<td class="fieldname">
																	...
																	<td><%=relationshipMgrTrx.getRemarks() != null ? relationshipMgrTrx.getRemarks() : ""%>&nbsp;
																	</td>
																</tr>
															</tbody>
														</table>
															...
															<tr>
																...
																<%
																	String pageIndexUrl = null;
																			...
																			pageIndexUrl = "RelationshipMgr.do?event=checker_process_create_insert&TrxId="+transId+"&startIndex=";
																%>
