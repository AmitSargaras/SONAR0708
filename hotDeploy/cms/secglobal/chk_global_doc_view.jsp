      ...
      <td> <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
          ...
          <% if(isDocCodePresent) { %>
            <tr class="even">
              ...
              <td>&nbsp;<bean:write name="SecurityGlobalForm" scope="request" property="itemCode" />
            ...
            <tr class="even">
            <td class="fieldname" width="20%">CERSAI Applicable&nbsp; <font color="red">* </font> </td>
              <td width="30%"><%if(ICMSConstant.YES.equals(stageOb.getIsApplicableForCersaiInd())){ %>Yes
              <%}else{ %>No<%} %>&nbsp;</td>
            </tr>
