      ...
      <td> <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <%=aForm.getTenureCount()%> &nbsp; <integro:common-code-single  entryCode="<%=aForm.getTenureType()%>"
            ...
            <td class="fieldname" >CERSAI Applicable&nbsp;</td>
              <td ><%if(ICMSConstant.YES.equals(aForm.getIsApplicableForCersaiInd())){ %>Yes
              <%}else{ %>No<%} %>&nbsp;</td>
            </tr>
...
<table width="100"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <%if(!toTrack && close) { %>
    <a href="SecurityGlobal.do?event=close_doc_item" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/close2a.gif',1)"><img src="img/close1a.gif" name="Image4411"  border="0" id="Image4411" /></a>&nbsp;&nbsp;&nbsp;<a href="ToDo.do" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image4411"  border="0" id="Image4411" /></a>
    <%}else if(toTrack){%>
    ...
    <%}else{
    	if(viewOnly){
        	%>
            <a href="SecurityGlobal.do?event=global_list&view=view&type=S&go=N&startIndex=<%=startIndex %>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4411"  border="0" id="Image4411" /></a>
        <%
        		}else{
        		%>
        <a href="SecurityGlobal.do?event=global_list&type=S&go=N&startIndex=<%=startIndex %>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4411','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4411"  border="0" id="Image4411" /></a>
    <%}
    }%>
    </td>
  </tr>
