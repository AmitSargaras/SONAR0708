...
List tagDetailList = (List) session.getAttribute("com.integrosys.cms.ui.cutomer.CustomerProcessDetailsAction.tagDetailList");
String sessioncamType = (String) session.getAttribute("com.integrosys.cms.ui.cutomer.CustomerProcessDetailsAction.session.camType");
String sessioncamDate= (String) session.getAttribute("com.integrosys.cms.ui.cutomer.CustomerProcessDetailsAction.session.camDate");
String sessioncamNumber = (String) session.getAttribute("com.integrosys.cms.ui.cutomer.CustomerProcessDetailsAction.session.camNumber");
