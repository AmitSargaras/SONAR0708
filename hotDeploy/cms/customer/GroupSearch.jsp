...
<%
     ...
     * $Header: /home/cms2/cvsroot/cms2/public_html/customer/GroupSearch.jsp,v 1.2 2006/10/27 08:43:04 hmbao Exp $
...
<input type="hidden" value="" name="gobutton">
                    ...
                    <table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection"  id="custsearch">
                      <tr>
                            ...
                            <tbody>
                              <tr class="odd">
                                <td width="37%" class="fieldname">Group Name :</td>
                                <td width="48%"><html:text property="groupName" maxlength="40" /> <html:errors property="legalName" /></td>
                                <td width="15%"><input onclick="submitPage(1)" name="AddNew1" type="button" id="AddNew1" value="Go"  class="btnNormal" style="margin-right:5px;margin-left:10;width:50px" />
                                </td>
                              </tr>
                              <tr class="even">
                                <td class="fieldname">Group ID :</td>
                                <td><html:text property="groupID" maxlength="10" /> <html:errors property="legalId" /></td>
                                <td><input onclick="submitPage(2)" name="AddNew2" type="button" id="AddNew2" value="Go"  class="btnNormal" style="margin-right:5px;margin-left:10;width:50px" />
                                </td>
                              </tr>
                            </tbody>
                          </table></td>
