...
<head>
    ...
    <link href="<%=context%>css/smartlender.css" rel="stylesheet" type="text/css"/>
...
<%
    ...
    String subProfileID = (String) request.getParameter("subProfileID");
    System.out.println("popup_customerProfileDetails.jsp, subProfileID = " + subProfileID);

    OBCMSCustomer obCMSCustomer =  null;
    OBLimitProfile limitprofile = null ; //(OBLimitProfile) request.getAttribute("limitprofileOb")
    if (subProfileID != null){
       HashMap result  = CounterpartyUIHelper.getCustomerProfileDetailsByGroupId(subProfileID) ;
      if (result != null && !result.isEmpty()){
        obCMSCustomer = (OBCMSCustomer) result.get("customerOb");
        limitprofile = (OBLimitProfile) result.get("limitprofile");
      }
    }        
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
            ...
            <tbody>
                <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                    ...
                    <td width="30%"><integro:empty-if-null value="<%=legal.getLegalName()%>"/>&nbsp;</td>
                </tr>
                ...
                <tr class="even">
                    ...
                    <td><integro:empty-if-null value="<%=obCMSCustomer.getCustomerReference()%>"/>&nbsp;</td>
                    <td class="fieldname"><bean:message key="label.customer.subprofile.name"/></td>
                    <td><integro:empty-if-null value="<%=obCMSCustomer.getCustomerName()%>"/>&nbsp;</td>
                </tr>
                <% } %>
                ...
                <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                    ...
                    <td><integro:empty-if-null value="<%=legal.getLegalRegNumber()%>"/>&nbsp;</td>
                ...
                <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                    ...
                    <td><integro:common-code display="true" categoryCode="ID_TYPE" descWithCode="false" entryCode="<%=legal.getIDType()%>"/></td>
                </tr>
                <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                ...
                <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                    ...
                    <td><integro:common-code display="true" categoryCode="5" descWithCode="false" entryCode="<%=legal.getCustomerSegment()%>" /> &nbsp;</td>
                    <td class="fieldname">&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                    <td class="fieldname" width="20%">Business Group</td>
                    <td><integro:empty-if-null value="<%=legal.getBusinessGroup()%>"/>&nbsp;</td>                   
                    <td class="fieldname">Business Sector</td>
                    <td><integro:common-code display="true" categoryCode="BIZ_SECTOR" descWithCode="false" entryCode="<%=legal.getBusinessSector()%>" />&nbsp;</td>
                </tr>
                <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                    <td class="fieldname">Customer Type </td>
                    <td><integro:common-code display="true" categoryCode="8" descWithCode="false" entryCode="<%=legal.getCustomerType()%>" />&nbsp;</td>
                    <td class="fieldname">Customer Legal Constitution</td>
                    <td><integro:common-code display="true" categoryCode="56" descWithCode="false" entryCode="<%=legal.getLegalConstitution()%>" />&nbsp;</td>
                </tr>
            </tbody>
        </table>
    </td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInfo">
                    ...
                    <tbody>
                        ...
                        <tr class="<%=(rowIdx++)%2==0?"even":"odd"%>">
                            ...
                            <td><integro:common-code display="true" categoryCode="INCOME_RANGE" descWithCode="false" entryCode="<%=legal.getIncomeRange()%>"/>&nbsp;</td>
