...
function submitPage() {
 	...
 	document.forms[0].action="GenerateLAD.do?event=update_lad&ladReceiveDate="+value;
    document.forms[0].submit();
}
function cancelPage(){
	
    document.forms[0].action="GenerateLAD.do?event=display&operation=LADGBNR";
    document.forms[0].submit();
}
//-->
</script>
...
<tr>
             ...
             Lad Receive Date <font color="RED"> *</font>
             </td>           
			<td  valign="bottom" >
			<input type="text" name="ladReceiveDate" id="11" />
			 <img src="img/calendara.gif" alt="calender" name="Image723" border="0" id="Image725"
			             onclick="showCalendar('ladReceiveDate', 'dd/mm/y')"
			             onmouseover="MM_swapImage('Image723','','img/calendarb.gif',1)"
			             onmouseout="MM_swapImgRestore()"/>&nbsp; <html:errors property="ladRecDateError"/>
			</td>
	</tr>									
	</table>
