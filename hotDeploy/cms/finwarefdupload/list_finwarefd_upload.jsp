...
function cancelPage(){
    document.forms[0].action="FinwareFdupload.do?event=txtupload";
...
<%
	...
	IUbsErrorLog errLog = (IUbsErrorLog)session.getAttribute("com.integrosys.cms.ui.finwarefdupload.FinwareFdUploadAction.objUbsErrorLogService");// request.getAttribute("objUbsErrorLog");
	List ubsErrorLogList=(ArrayList) session.getAttribute("com.integrosys.cms.ui.finwarefdupload.FinwareFdUploadAction.ubsErrorLogList");
...
<html:form action="/FinwareFdupload" >
...
<thead >
    <tr>
        <td height="34"><h3>Finware Fd Upload</h3></td>
    </tr>
    <tr>
    <td>	<hr/></td>
    </tr>
                    ...
                    <table id="generalPurposeBar" width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <%
                           ...
                           pageIndexUrl = "FinwareFdupload.do?event=paginate&startIndex=";// Pagination is common for uploads
