...
function saveForm() {
	document.forms["SecurityReceiptForm"].event.value="save_update_narration";
...
<table width="620" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    ...
    <tr>
      <td><h3> Doc Description - Update Narration</h3></td>
    </tr>
    <tr>
      <td><hr /></td>
    </tr>
...
--%>            
              ...
              <td><html:select disabled="true" property="actionParty">
...
<%-- start here for cr-17 --%>
        ...
        <table width="620" border="0" align="center" cellspacing="0" cellpadding="0" class="tblInput">
                <tbody>
               <tr class="even">
                  <td class="fieldname">Narration</td>
                  <td><html:textarea name="SecurityReceiptForm" rows="10" cols="80"  property="docRemarks" onkeyup="limitTextInput(this,1600,'Narration')"/><html:errors property="docRemarks" /></td>
                </tr>
              </tbody>
        </table>
        <table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td><a href="#" onclick = "saveForm()" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img/ok2.gif',1)"><img src="img/ok1.gif" name="Image1"  border="0" id="Image1" /></a></td>
                <td><a href="#" onclick="cancelForm()"  onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','img/cancel2.gif',1)"><img src="img/cancel1.gif" name="Image4"  border="0" id="Image4" /></a></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
