...
<%
    ...
    String lableDocDate = "Doc Due Date";
...
function saveForm(){
    /*if (document.forms["UpdatePariPassuCheckListForm"].isPolicy.value == "true"){
		if (document.forms["UpdatePariPassuCheckListForm"].docEffDate.value != document.forms["CAMReceiptForm"].docOldEffDate.value) {
			document.forms["UpdatePariPassuCheckListForm"].isEffDateChanged.value="true";
		}
	}*/
	document.forms["UpdatePariPassuCheckListForm"].event.value="save_update";
...
<!--            </tr>-->
            ...
            <!-- <tr class="even">
              <td class="fieldname">Activity Date</td>
            ...
            <tr class="even">
                        <td class="fieldname">Doc Due Date&nbsp;<font color="RED">*</font></td>
