  ...
  <tbody>
   ...
   %>
    <tr class="<%=rowClass%>">
        ...
        <a href="UpdatePariPassuCheckListAction.do?event=prepare_update&&limitBkgLoc=IN&&orgCode=000&&checkListID=<%=paripassuChecklistId %>&&secType=PARIPASSU&&secSubType=PARIPASSU"  >Update</a>
