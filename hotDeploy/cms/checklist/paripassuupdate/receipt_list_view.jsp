...
<%
	...
	ArrayList deferCreditApproverList = (ArrayList)session.getAttribute("com.integrosys.cms.ui.checklist.paripassuupdate.UpdatePariPassuCheckListAction.deferCreditApproverList");
    
    ArrayList waiverCreditApproverList = (ArrayList)session.getAttribute("com.integrosys.cms.ui.checklist.paripassuupdate.UpdatePariPassuCheckListAction.waiverCreditApproverList");
    //System.out.println("::::::::::::::::"+checkListTrxVal);
  //  System.out.println("::::::::::::::::"+checkList);
   // System.out.println("::::::::::::::::"+deferCreditApproverList);
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    <tr>
      <td> <h3><%=("Cancel".equals(flag)?"Close":flag)%> Pari Passu Check List</h3>
...
%>
			<tr class="<%=rowClass%>">
             ...
             <td>
				...
				<integro:date object="<%= OB.getEffectiveDate()%>"/>
				<%} else {%> <center>-</center> <%}%>
              </td>
...
--%>
<%-- End CR-380 --%>
<%if((!toTrack && "Close".equals(flag))||toTrack) { %>
<p/>
<p/>
<p/>
...
<table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  if(!toTrack && "Close".equals(flag)) { %>
    ...
    <%}else{%>
    <td><a href="UpdatePariPassuCheckListAction.do?event=list" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','img/return2.gif',1)"><img src="img/return1.gif" name="Image4" width="70" height="20" border="0" id="Image4" /></a></a></td>
    <% }%>
  </tr>
  <tr>
    <td>&nbsp;</td>
