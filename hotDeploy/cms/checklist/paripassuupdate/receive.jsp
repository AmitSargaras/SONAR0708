<%@ page import="com.integrosys.cms.app.common.constant.ICMSConstant,
                ...
                com.integrosys.cms.ui.checklist.paripassuupdate.UpdatePariPassuCheckListForm" %>
...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function saveForm() {
            ...
            document.forms["UpdatePariPassuCheckListForm"].event.value = "save_receive";
                ...
                <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" class="tblInput">
                    <tbody>
                        <tr class="even">
                            ...
                            <td><html:textarea name="UpdatePariPassuCheckListForm" rows="5" cols="80" property="docRemarks"
