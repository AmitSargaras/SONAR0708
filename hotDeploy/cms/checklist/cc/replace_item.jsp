...
<%
    ICheckListItem checkListItem = (ICheckListItem)session.getAttribute("com.integrosys.cms.ui.checklist.cc.CCCheckListAction.checkListItem");
	...
	System.out.println(">>>>>> replace_item - index : " + index);
...
<%		if (itemRefList!=null && itemRefList.size()>0)
		{
%>       
