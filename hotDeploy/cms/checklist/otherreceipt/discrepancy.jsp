...
System.out.println("aForm getDocRemarks:"+aForm.getDocRemarks()+ "doc date:"+aForm.getDocDate()+" orig target date:"+aForm.getOriginalTargetDate()
		+" expiry date:"+aForm.getDocExpDate()+" received dt:"+aForm.getReceivedDate());
%>
...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function saveForm() {
            ...
            document.forms["OtherReceiptForm"].event.value = "save_discrepancy";
...
<html:form action="OtherReceipt">
    ...
    <%if("DISCREPANCY".equals(aForm.getItemStatus())){ %>
    <html:hidden property="documentStatus"  value="UPDATE_DISCREPANCY"/>
    <%}else{ %>
    <html:hidden property="documentStatus"  value="PENDING_DISCREPANCY"/>
    <%} %>
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
    <thead>
        ...
        <tr>
            <td><h3> Doc Description - Discrepancy</h3></td>
        </tr>
        <tr>
            <td><hr/></td>
        </tr>
