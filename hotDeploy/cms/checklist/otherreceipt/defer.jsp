...
String nonFundedLimit=cust.getTotalNonFundedLimit();
...
<%@page import="com.integrosys.cms.app.customer.bus.ICMSCustomer"%><html><!-- InstanceBegin template="/Templates/ContentPage.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
function saveForm() {
	...
	//if(chkResult==true ){
		document.forms["OtherReceiptForm"].event.value="save_defer";
...
/* moved validation into OtherReceiptFormValidator.java
...
--%>
            <tr class="even">
              ...
              <html:text property="deferDate" size="12" maxlength="12" readonly="true" onchange="setDifferenceBetDate();" value="<%=deferDate %>"/>
                <img src="img/calendara.gif"  name="Image11" border="0" id="Image1" onclick="return showCalendar('deferDate', 'dd/mm/y');" onmouseover="MM_swapImage('Image11','','img/calendarb.gif',1)" />
                <html:errors property="deferDate" />    
            ...
            <%}else if("1".equals(checkListItem.getDeferCount())&& checkListItem.getItemStatus().equals("PENDING_DEFER")){ %>
            <tr class="odd">
              <td class="fieldname">Next Due Date <font color="RED">* </font></td>
              <td><html:text property="expectedReturnDate" size="12" maxlength="12" readonly="true"  onchange="originalDeferedDaysCal();"/>
                <img src="img/calendara.gif"  name="Image11a" border="0" id="Image1a" onclick="return showCalendar('expectedReturnDate', 'dd/mm/y');" onmouseover="MM_swapImage('Image11a','','img/calendarb.gif',1)" />
            ...
            <%}else if(!"1".equals(checkListItem.getDeferCount())|| checkListItem.getItemStatus().equals("DEFERRED")){ %>
