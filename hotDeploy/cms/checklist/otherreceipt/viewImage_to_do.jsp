...
<%
OtherReceiptForm OtherReceiptForm = (OtherReceiptForm) request.getAttribute("OtherReceiptForm");
String catg="";
String docTye="";
...
function closePage() {
	document.forms["OtherReceiptForm"].event.value="edit_staging_checklist_item";
	document.forms["OtherReceiptForm"].submit();
}
function returnPage() {
    document.forms["OtherReceiptForm"].event.value = "close_checklist_item";
    document.forms["OtherReceiptForm"].submit();
}
