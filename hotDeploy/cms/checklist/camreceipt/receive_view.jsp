...
function submitInactive() {
	var index=<%=index%>;
	//alert("index "+index);
	document.forms["CAMReceiptForm"].event.value="conform_inactive";
	document.forms["CAMReceiptForm"].submit();
}
...
<input type="hidden" id="expectedReturnDate" value="<%=nextDate %>"/>
<input type="hidden" id="originalTargetDate" value="<%=otdDate %>"/>
<input type="hidden" id="deferDate" value="<%=deferDate %>"/>
