...
if(item==null){
 item = (ICheckListItem) session.getAttribute("com.integrosys.cms.ui.checklist.camreceipt.CAMReceiptAction.checkListItem");
}
...
<%@page import="com.integrosys.cms.app.checklist.trx.ICheckListTrxValue"%><html>
<head>
