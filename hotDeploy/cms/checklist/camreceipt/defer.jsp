...
if(form.getItemStatus().equals("AWAITING") ){
...
String expiryDate=form.getDocExpDate();
    ...
    ICheckListItem checkListItem =(ICheckListItem)session.getAttribute("com.integrosys.cms.ui.checklist.camreceipt.CAMReceiptAction.checkListItem");
  
    List deferCreditApproverList = (List)session.getAttribute("com.integrosys.cms.ui.checklist.camreceipt.CAMReceiptAction.deferCreditApproverList");
...
function saveForm() {
	...
	//if(chkResult==true ){
		document.forms["CAMReceiptForm"].event.value="save_defer";
...
/* moved validation into CAMReceiptFormValidator.java
...
--%>
            <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="tblInput">
                ...
                <tr class="odd">
                    ...
                    <td><html:textarea name="CAMReceiptForm" rows="5" cols="80" property="docRemarks" onkeyup="limitTextInput(this,1600,'Narration')"/><html:errors property="docRemarks" /></td>
                </tr>
                </tbody>
            </table>
             <table width="100%">
