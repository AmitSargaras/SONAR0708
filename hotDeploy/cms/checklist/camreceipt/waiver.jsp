...
String docAmt="";
if(form.getDocAmt()!=null && !form.getDocAmt().trim().equals("") && !form.getDocAmt().trim().equalsIgnoreCase("null")){
...
Locale locale = (Locale)session.getAttribute(ICommonEventConstant.GLOBAL_SCOPE+"."+com.integrosys.base.uiinfra.common.Constants.GLOBAL_LOCALE_KEY);
    ...
    List waiverCreditApproverList = (List)session.getAttribute("com.integrosys.cms.ui.checklist.camreceipt.CAMReceiptAction.waiverCreditApproverList");
...
function saveForm() {
	document.forms["CAMReceiptForm"].event.value="save_waiver";
