...
List transactionHistoryList = (List) session.getAttribute("com.integrosys.cms.ui.checklist.annexure.AnnexureAction.transactionHistoryList");
if(transactionHistoryList!=null && transactionHistoryList.size()!=0){
	System.out.println("7777777777777777777777in if777777777777777777");
	pageContext.setAttribute("transactionHistoryList", transactionHistoryList);
	}	else   	{
		System.out.println("7777777777777777777777in else777777777777777777");
