...
<%
    ...
    boolean viewLoger = false;
    if (event.equals("VIEW_PENDING_LODGE") || event.equals("VIEW_LODGED") || event.equals("VIEW_PENDING_RELODGE")) {
        viewLoger = true;
    }
%>
...
function saveForm() {
	document.forms["CCReceiptForm"].event.value="save_relodge";
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  <thead>
    ...
    <tr>
      <td> <h3> Doc Description - Lodge</h3></td>
    </tr>
    <tr>
      <td><hr /></td>
    </tr>
  ...
  <tbody>
    <tr>
      <td>
       <!--start table for  document  item Details-->
...
--%>
			<tr class="odd">
              <td class="fieldname">Date Lodged
              <%if(!viewLoger){ %>&nbsp;<font color="#0000FF">*</font><%} %></td>
              <%if(!viewLoger){ %>
              <td><html:text property="lodgedDate" size="12" maxlength="10" readonly="true" />
                <img src="img/calendara.gif"  name="Image11" border="0" id="Image1" 
                onclick="return showCalendar('lodgedDate', 'dd/mm/y');" 
...
--%>
          <table width="100%" border="0" align="center"  cellspacing="0" cellpadding="0" class="tblInput">
            ...
            <tr class="odd">
              ...
              <%if(!viewLoger){ %>
                 <td>
                    <html:textarea name="CCReceiptForm" rows="5" cols="80" property="docRemarks" onkeyup="limitTextInput(this,1600,'Narration')"/>
        ...
        <!--End table for  document  item Details-->
