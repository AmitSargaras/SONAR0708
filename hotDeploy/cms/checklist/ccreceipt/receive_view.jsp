...
<%
    ...
    ICheckListItem item = (ICheckListItem) session.getAttribute("com.integrosys.cms.ui.checklist.ccreceipt.CCReceiptAction.checkListItem");
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <!--   <tr class="even">
            ...
            <tr class="even">
              ...
              <td>&nbsp;<integro:common-code categoryCode="ACTION_PARTY" entryCode="<%=aForm.getActionParty()%>" display="true" descWithCode="false"/>
            </tr>
