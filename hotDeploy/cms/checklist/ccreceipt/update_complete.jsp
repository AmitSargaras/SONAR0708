...
function saveForm() {
	document.forms["CCReceiptForm"].event.value="save_update";
...
<%--
            <%if(isComplete){ %>
            <tr class="even">
                  <td class="fieldname">Date Complete</td>
                  <td><html:text property="completedDate" size="12" maxlength="10" readonly="true" />
...
<%-- start here for cr-17 --%>
         <!--   <tr class="even">
           ...
           <%--  End table for  to  document  item  in Details
          <jsp:include page="/checklist/ccreceipt/update_sharechecklist.jsp" />
           start  for  to  show  Narration  --%>
            <table width="100%" border="1" cellspacing="0" cellpadding="0" class="tblInput">
             <tbody>
             <tr class="even">
                 <td class="fieldname">Remarks</td>
                 <td><html:textarea name="CCReceiptForm" rows="5" style="width:97%"  property="docRemarks" onkeyup="limitTextInput(this,1600,'Narration')"/><html:errors property="docRemarks" /></td>
            </tr>
          </tbody>
        </table>
