...
function saveForm(){
	...
	document.forms["FacilityReceiptForm"].event.value="save_update";
...
<!--            </tr>-->
            ...
            <tr class="even">
              ...
              <td><html:text property="docAmt" size="32" maxlength="22" value="<%=UIUtil.mapOBAmount_FormString(locale, UIUtil.convertToAmount(locale,CommonUtil.getBaseCurrency(),docAmt)) %>" styleId="docAmt" onblur="javascript:formatAmountAsCommaSeparated(this)" />
            ...
            <tr class="even">
              ...
              <td><html:text property="hdfcAmt" size="32" maxlength="22" value="<%=UIUtil.mapOBAmount_FormString(locale, UIUtil.convertToAmount(locale,CommonUtil.getBaseCurrency(),hdfcAmt)) %>" styleId="hdfcAmt" onblur="javascript:formatAmountAsCommaSeparated(this)"/>
