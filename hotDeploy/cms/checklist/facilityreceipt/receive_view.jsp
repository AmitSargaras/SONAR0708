...
Locale locale = (Locale)session.getAttribute(ICommonEventConstant.GLOBAL_SCOPE+"."+com.integrosys.base.uiinfra.common.Constants.GLOBAL_LOCALE_KEY);
    ...
    ICheckListItem stageOb = (ICheckListItem) request.getAttribute("stageOb");
    if(stageOb!=null){
    System.out.println("form image id === "+stageOb.getFacImageTagUntagId());
    /* form.setFacImageTagUntagId(stageOb.getFacImageTagUntagId());
    form.setFacImageTagUntagImgName(stageOb.getFacImageTagUntagImgName());
    form.setFacImageTagUntagStatus(stageOb.getFacImageTagUntagStatus()); */
    
    String facListImages = stageOb.getFacImageTagUntagImgName();
  ...
  if(",".equals(untagImagesNames.substring(untagImagesNames.length() - 1))){
   ...
   // form.setFacImageTagUntagImgName(imageName);
    ...
    boolean state=false;
    if(form.getItemStatus().equals("PENDING_DEFER")){
    	state=true;
    }else if (form.getItemStatus().equals("DEFERRED")){
    	state=false;
    }
    ...
    ICheckListItem item = (ICheckListItem) session.getAttribute("com.integrosys.cms.ui.checklist.facilityreceipt.FacilityReceiptAction.checkListItem");
...
if("prepare_inactive".equals(event)|| form.getDocumentStatus().equals("PENDING_INACTIVE")||form.getDocumentStatus().equals("INACTIVE")){
...
--%>
 ...
 <jsp:include page="view_audit_details_individual.jsp"></jsp:include>
           ...
           <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
              <%if("prepare_inactive".equals(event)){ %>
                <td align="right">
                    <a href="#" onClick="submitInactive()" ><img src="img/submit1.gif" name="Image4411"  border="0" id="Image4411" /></a>
                </td>
