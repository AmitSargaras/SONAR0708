...
<%
  ...
  /*  String monitorType = stageOb.getItem().getMonitorType();
    ...
    System.out.println("ICheckListItem =>"+item);
    pageContext.setAttribute("checkListItem",item);
    // cr 36
...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function tagUntagImage(){
        	document.forms["RecurrentDocReceiptForm"].event.value = "<%=RecurrentDocReceiptAction.EVENT_PREPARE_TAG_UNTAG_IMAGE_VIEW%>";
      ...
      /*  System.out.println("stageOb.getFromState()::::::::"+checkListTrxVal.getFromState());
        ...
        */
        ...
        <tr class=<%=aa%> >
            ...
            <td>&nbsp;
                <bean:write name="RecurrentDocReceiptForm" property="expectedReturnDate"/>
            </td>
             <%bb++;  if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
        </tr>
        ...
        <%if(isWaiver){ %>
            ...
            <td>&nbsp;
                <bean:write name="RecurrentDocReceiptForm" property="waivedDate"/>
            </td>
             <%bb++;  if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
        </tr>
        ...
        <%if(isComplete){ %>
            ...
            <td>&nbsp;
                <bean:write name="RecurrentDocReceiptForm" property="completedDate"/>
            </td>
             <%bb++;  if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
        </tr>
        ...
        <%if(received){ %>
            ...
            <td>&nbsp;
                <bean:write name="RecurrentDocReceiptForm" property="receivedDate"/>
            </td>
             <%bb++;  if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
        </tr>
        ...
        <tr class=<%=aa%> >
            ...
            <td>&nbsp;
                <bean:write name="RecurrentDocReceiptForm" property="tempUpliftedDate"/>
            </td>
             <%bb++;  if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
        </tr>
         <tr class=<%=aa%> >
        ...
        <%if(permUpliftedDate){ %>
            ...
            <td>&nbsp;
                <bean:write name="RecurrentDocReceiptForm" property="permUpliftedDate"/>
            </td>
             <%bb++;  if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
        </tr>
...
<!--        </tr>-->
        ...
        <tr class=<%=aa%> >
            <td style="width:116" class="<%=CompareOBUtil.compOB(stageOb,ob,"docJust")? "fieldname":"fieldnamediff"%>">Justification</td>
            <td><integro:htmltext value="<%=stageOb.getDocJust()%>" lineLength="80"/>&nbsp;</td>
             <%bb++;  if(bb%2!=0){ aa = "even"; }else{ aa = "odd"; } %>
        </tr>
...
//      if (request.getParameter("event") != null && "view_receipt".equals(request.getParameter("event"))) {
        ...
        %>
             <td width="75" valign="baseline" align="center">
                <a href="RecurrentDocReceipt.do?event=view&checkListID=<%=checkListID%>&limitBkgLoc=<%=limitBkgLoc%>&secType=<%=secType%>&secSubType=<%=secSubType%>&collateralID=<%=collateralID%>&limitProfileID=<%=limitProfileID%>"
