...
List waiverCreditApproverList = (List)session.getAttribute("com.integrosys.cms.ui.checklist.recurrentDocreceipt.RecurrentDocReceiptAction.waiverCreditApproverList");
                ...
                <td width="30%">
                 ...
                 if(insuranceObj!= null){
                	 ...
                	 if(insuranceObj.getWaivedDate()!=null && (!"".equals(insuranceObj.getWaivedDate()))){
                          waivedDate=df.format(insuranceObj.getWaivedDate());
                	    }
