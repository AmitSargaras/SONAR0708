                                                    ...
                                                    for (int z = 0; z < listLADSubItem.size(); z++) {
                                                       ...
                                                       String rowClass = "";
                                                        ...
                                                        <tr class="<%=rowClass%>">
                                                            ...
                                                            <%}else{ %>
                                                            <td width="10%"><a href="LADReceipt.do?event=view_attach_image_close&id=<%=String.valueOf(item.getChklistDocId())%>&docType=<%=docType %>&docIdLAD=<%=String.valueOf(item.getChklistDocItemId()) %>&checklistId=<%=checklistId %>">View Images &nbsp;</a></td>
                                                            <%} %>
                                                        </tr>
                                                        <%
                                                    }
