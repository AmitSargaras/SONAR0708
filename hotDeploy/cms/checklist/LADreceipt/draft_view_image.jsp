...
function closePage() {
	document.forms[0].action="LADReceipt.do?event=return_close_draft";
	document.forms[0].submit();
}
function returnPage() {
	document.forms[0].action="LADReceipt.do?event=return_process_draft";
	document.forms[0].submit();
}
...
//  var url = '/cms/ImageTagMap.do?event=retrieveImage&imageName="+imageName+"&status="+status+"&count="+count+"&pID="+imagePath;
  ...
  //alert("getImageGallary");
	...
	document.forms[0].action="LADReceipt.do?event=draft_lad_img&imageName="+imageName+"&status="+status+"&count="+count+"&pID="+imagePath+"&category"+catg+"&imageId="+s_value+"&unCheckId="+n_value;
	document.forms[0].submit();
}
...
//  var url = '/cms/ImageTagMap.do?event=retrieveImage&imageName="+imageName+"&status="+status+"&count="+count+"&pID="+imagePath;
  ...
  //alert("getImageGallary");
	...
	//alert("category is "+catg);
	//alert("count is "+count);
	document.forms[0].action="LADReceipt.do?event=draft_lad_process_img&imageName="+imageName+"&status="+status+"&count="+count+"&pID="+imagePath+"&category"+catg+"&imageId="+s_value+"&unCheckId="+n_value;
	document.forms[0].submit();
}
																	...
																	<tr class=<%=rowClass%>>
																		...
																		<%
																			String subs = obImageUploadAdd.getImgFileName();
																						//subs = subs.substring();
																		%>
<%if("process_draft_view_image".equals(event)){ %>
																		<td width="25%">
																			&nbsp;
