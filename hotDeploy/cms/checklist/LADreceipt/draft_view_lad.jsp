...
function returnPage() {
	document.forms[0].action="LADReceipt.do?event=return_process_draft&&custTypeTrxID=<%=custTypeTrxID%>";
	document.forms[0].submit();
}
                                                    ...
                                                    for (int z = 0; z < listLADSubItem.size(); z++) {
                                                       ...
                                                       String rowClass = "";
                                                        ...
                                                        <tr class="<%=rowClass%>">
                                                            ...
                                                            <%if("draft_process_view__lad".equals(event)){ %>
                                                            <td width="10%"><a href="LADReceipt.do?event=view_process_image_draft&id=<%=String.valueOf(item.getChklistDocId())%>&docType=<%=docType %>&docIdLAD=<%=String.valueOf(item.getChklistDocItemId()) %>&checklistId=<%=checklistId %>">View Images &nbsp;</a></td>
                                                            <%}else{ %>
                                                            <td width="10%"><a href="LADReceipt.do?event=view_close_image_draft&id=<%=String.valueOf(item.getChklistDocId())%>&docType=<%=docType %>&docIdLAD=<%=String.valueOf(item.getChklistDocItemId()) %>&checklistId=<%=checklistId %>">View Images &nbsp;</a></td>
                                                            <%} %>
                                                        </tr>
                                                        <%
                                                    }
...
<!--    <td><a href="#" onmouseout="MM_swapImgRestore()" onclick="submitPage();" onmouseover="MM_swapImage('Image4411','','img/generate1.gif',1)"><img src="img/generate1.gif" name="Image4411"  border="0" id="Image4411" /></a></td>-->
  ...
  <p align="center">
 <%   if ("draft_process_view__lad".equals(event)||"return_draft_process_view__lad".equals(event)) { %>
