...
<%
	...
	int sno = 0;
	int startIndex = 0;
	ILimitsOfAuthorityMasterTrxValue trx = (ILimitsOfAuthorityMasterTrxValue)session.getAttribute("com.integrosys.cms.ui.limitsOfAuthorityMaster.LimitsOfAuthorityMasterAction.limitsOfAuthorityMasterTrxValue");
...
function submitForm() {
		...
		document.forms[0].action = "LimitsOfAuthorityMaster.do?event=maker_confirm_resubmit_edit";
		document.forms[0].submit();
}
	...
	<body>
		<table width="70%" border="0" align="center" cellpadding="0"
			...
			<thead>
				<tr>
					<td>
						<h3>Add Limits of Authority (LOA) Master</h3>
					</td>
				</tr>
				<tr>
					<td>
