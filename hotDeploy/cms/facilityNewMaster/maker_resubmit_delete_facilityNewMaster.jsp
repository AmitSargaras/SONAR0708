...
<%@ page import="com.integrosys.base.techinfra.logger.DefaultLogger,
                 ...
                 java.util.HashMap,
                 java.util.Locale,
                  com.integrosys.cms.app.facilityNewMaster.trx.IFacilityNewMasterTrxValue,
                 java.util.Arrays"%>
...
<%
IFacilityNewMasterTrxValue systemBankBranchTrx = (IFacilityNewMasterTrxValue)session.getAttribute("com.integrosys.cms.ui.facilityNewMaster.MaintainFacilityNewMasterAction.IFacilityNewMasterTrxValue");
	...
	System.out.println("riskTypeAllowed "+riskTypeAllowed);
...
function submitForm () {
	document.forms[0].action="facilityNewMaster.do?event=maker_confirm_resubmit_delete";
    document.forms[0].submit();
}
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tblFormSection">
  ...
  <tr>
   <%if((event.equals("maker_prepare_resubmit_create"))){%>
                    <td><h3>Create FacilityNewMaster</h3></td>
                    <%}else{ %>
                     <td><h3>Edit FacilityNewMaster</h3></td>
                     <%} %>
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblInput">
          ...
          <tbody>
           									...
           									<tr class="odd">
												...
												<td><html:text property="newFacilityName" maxlength="75" value="<%=facilityNewMasterForm.getNewFacilityName()%>"></html:text>
												<br/><html:errors property="specialCharacterNameError"/>
												<html:errors property="newFacilityNameError" />		</td>	
											</tr>
...
<!--									                      <html:options collection="facilityCategoryList" property="label" labelProperty="value"/>-->
										...
										<integro:common-code categoryCode="<%=CategoryCodeConstant.SYSTEM%>" />
												...
												<td><html:text property="lineNumber" maxlength="20" />&nbsp;</br><html:errors property="lineNumberError"/>
												</td>
											...
											<tr class="even">
												...
												<html:select name="MaintainFacilityNewMasterForm"   property="purpose" >
											      <option value="">Please Select </option>	
									                    ...
									                    </html:select>&nbsp;</br><html:errors property="systemBankCustodianError"/> </td>
									                    
												<td class="fieldname">
													Weightage %
												</td>
												<td><html:text property="weightage" maxlength="8" />&nbsp;</br><html:errors property="systemBankCustodianError"/>
             ...
             <td class="fieldname" >Status&nbsp;</td>
              <% if(  trxvalue.getFromState().equals("PENDING_UPDATE") || trxvalue.getFromState().equals("CLOSED") ){ %>
